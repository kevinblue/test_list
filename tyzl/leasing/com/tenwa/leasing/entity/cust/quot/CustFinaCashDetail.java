 ...
 * 
 * @author 孙传良
 * @date 2013-3-7下午03:53:45
 * @info 客户会计现金流明细
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "客户会计现金流明细")
@Table(name="CUST_FINA_CASH_DETAIL")
public class CustFinaCashDetail implements CashDetail, Comparable<CashDetail> {
