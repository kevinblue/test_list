...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/tracywindy/tracywindyComboBox.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/tracywindy/tracywindyCommonUserSelection.js"></script>
<script type="text/javascript">
...
<body>
	<div id="id_createNewWorkflowWindow" class="mini-window" title="创建新流程"
		style="display: none; width: 400px; height: 310px;">
		<table align="center" style="width: 100%; position: relative;">
			<tr>
				<td class="input_label_desc">流程分类:</td>
				<td class="input_value"><div style="float: left;"
						id="id_workflowTypeComboContainer"></div>
					<span class="content-required">*</span></td>
			</tr>
			<tr>
				<td class="input_label_desc">显示名称:</td>
				<td class="input_value"><input type="text" id="id_displayName" /><span
					class="content-required">*</span></td>
			</tr>
			<tr>
				<td class="input_label_desc">流程编号:</td>
				<td class="input_value"><input type="text" id="id_worflowCode" /><span
					class="content-required">*</span></td>
			</tr>
			<tr>
				<td class="input_label_desc">流程关键字:</td>
				<td class="input_value"><input type="text" id="id_name" /><span
					class="content-required">*</span></td>
			</tr>
			<tr>
				<td class="input_label_desc">版本号:</td>
				<td class="input_value"><input type="text" id="id_version" /><span
					class="content-required">*</span></td>
			</tr>
			<tr style="display: none;">
				<td class="input_label_desc">设计器版本:</td>
				<td class="input_value"><select id="id_jpdlVersion"
					style="width: 194px;">
						<option value="4.4" selected>jbpm4.4</option>
						<option value="4.3">jbpm4.3</option>
				</select> <span class="content-required">*</span></td>
			</tr>
			<tr>
				<td class="input_label_desc">流程描述:</td>
				<td class="input_value"><input type="text" id="id_description" /><span
					class="content-required">&nbsp;&nbsp;</span></td>
			</tr>
			<tr>
				<td colspan=3><div style="width: 100%; height: 5px;">&nbsp;</div></td>
			</tr>
			<tr>
				<td colspan=3><div
						style="width: 100%; border-top: 1px solid #DDD;"></div></td>
			</tr>
			<tr>
				<td colspan=3><div style="width: 100%; height: 5px;">&nbsp;</div></td>
			</tr>
			<tr>
				<td class="input_label_desc" colspan=3><span
					style="float: left; margin-left: 100px;">排在&nbsp;&nbsp;</span><span
					style="float: left;" id="id_menuPositionContainer"></span><span
					style="float: left;" id="id_constantLabel">&nbsp;&nbsp;之后</span></td>
			</tr>
			<tr class='content-separator'>
				<td colspan='2'><a class="mini-button"
					onclick="toCreateNewWorkflowPage"><span>确定</span></a> <a
					class="mini-button" onclick='__toCreateNewWorkflowPageClose'><span>取消</span></a>
				</td>
			</tr>
		</table>
	</div>
	...
	<form action="" method="post" id="id_workflow_form">
		<input type="hidden" id='id_form_workflow_id' name="id" /> <input
			type="hidden" id='id_form_workflow_code' name="code" /> <input
			type="hidden" id='id_form_workflow_type' name="type" /> <input
			type="hidden" id='id_form_workflow_position' name="position" /> <input
			type="hidden" id='id_form_display_name' name="display_name" /> <input
			type="hidden" id='id_form_workflow_name' name="workflow_name" /> <input
			type="hidden" id='id_form_workflow_version' name="workflow_version" />
		<input type="hidden" id='id_form_workflow_jpdlVersion'
			name="workflow_jpdlVersion" /> <input type="hidden"
			id='id_form_workflow_description' name="workflow_description" /> <input
			type="hidden" id='id_form_workflow_isDeployed'
			name="workflow_isDeployed" /> <input type="hidden"
			id='id_form_workflow_designerWorkflowJsonString'
			name="workflow_designerWorkflowJsonString" />
	</form>
	...
	<script type="text/javascript" language="javascript">
		...
		function toCreateNewWorkflowPage() {
			...
			if (!name) {
				mini.alert("流程关键字不能为空");
				return;
			}
			if (!version) {
				mini.alert("流程版本号不能为空");
				return;
			}
			if (!jpdlVersion) {
				mini.alert("设计器版本不能为空");
				return;
			}
			if (!/^\d+$/.test(version)) {
				mini.alert("流程版本号必须为数字");
				return;
			}
			mini.mask({
				el : document.body,
			...
			$("#id_form_queryText_id").val(
					mini.get('id_workflows_table').getGlobalQueryText());
			...
			$("#id_form_workflow_position").val(
					getTracywindyObject('id_comboMenuPosition').getValue());
			...
			window
					.open(
							...
							"left=0px,top=0px,height="
									...
									+ "px,width="
									+ swidth
									+ "px,scrollbars=yes,fullscreen=yes,status=yes,toolbar=no,menubar=no,location=no");
		...
		function setFormFieldValue(rowData) {
			...
			var jpdlVersion = rowData['processdefinitionjpdlversion'];
			$("#id_form_display_name").val(
					rowData['processdefinitiondisplayname']);
			...
			$("#id_form_workflow_position").val(
					rowData['processdefinitionkey'] + "-"
							+ rowData['processdefinitionversion']);
			$("#id_form_workflow_version").val(
					rowData['processdefinitionversion']);
			$("#id_form_workflow_jpdlVersion").val(jpdlVersion);
			$("#id_form_workflow_description").val(
					rowData['processdefinitiondescription']);
		}
		...
		function toProcessActivePicture(rowData) {
			...
			window
					.open(
							"${pageContext.request.contextPath}/workflow/jbpm/getActivedRects.action?deployId="
									+ deployId
									+ "&maxDotX="
									+ maxDotX
									+ "&maxDotY="
												...
												success : function(res) {
													...
													mini
															.alert(
																	...
																	'提示',
																	function() {
																		var workflowsTable = mini
																				.get("id_workflows_table");
																		workflowsTable
																				.setParams({
																					queryText : '<mini:param  name="queryText"/>'
																				});
																		workflowsTable
																				.reload();
																	});
									...
									tenwa
											.ajaxRequest({
												...
												success : function(res) {
													...
													workflowsTable
															.setParams({
																queryText : unescape(decodeURIComponent("<mini:param  name='queryText'/>"))
															});
	...
	<div id="id_workflow_setting" class="mini-window" title="流程节点设置"
		style="display: none; width: 825px; height: 420px;">
		<div id="id_workflow_activity_detail"
			style="width: 100%; height: 100%; position: relative;"></div>
	</div>


	<div id="id_workflow_key_setting" class="mini-window" title="流程关键字设置"
		...
		<table width="100%;" style="table-layout: fixed;">
			...
			<tr>
				<td class="td-label">关键字七<font color="red">(付款单号)</font>：
				</td>
				<td class="td-input"><input id="id_keySeven" /></td>
			</tr>
			<tr>
				<td class="td-label">关键字八<font color="red">(合同流水号)</font>：
				</td>
				<td class="td-input"><input id="id_keyEight" /></td>
			</tr>
			<tr>
				<td class="td-label">关键字九<font color="red">(项目立项流水号)</font>：
				</td>
				<td class="td-input"><input id="id_keyNine" /></td>
			</tr>
			<tr>
				<td class="td-label">关键字十<font color="red">(互斥标识)</font>：
				</td>
				<td class="td-input"><input id="id_keyTen" /></td>
			</tr>
			<tr style="text-align: center;">
				<td colspan="2"
					style="padding-top: 10px; border-top: 1px solid silver;"><a
					class="mini-button" onclick="saveKeyToWorkflow">保存</a> <a
					class="mini-button" onclick="__saveKeyToWorkflowClose">取消</a></td>
			</tr>
		</table>
	</div>


	<div id="id_workflow_activity_setting" class="mini-window"
		title="流程节点明细设置" style="display: none; width: 700px; height: 385px;">
		<form id="id_workflow_activity_setting_form">
			<table width="100%;" style="table-layout: fixed;">
				<tr>
					<td
						style="text-align: left; padding-left: 20px; height: 30px; line-height: 30px; border-bottom: 1px solid silver;"
						colspan=4>节点类型：&nbsp;&lt;&nbsp;<label
						style="color: red; font-weight: BOLD;" id="id_activityType"></label>&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						节点名称：&nbsp;&lt;&nbsp;<label style="color: red; font-weight: BOLD;"
						id="id_activityName"></label>&nbsp;&gt;&nbsp;
					</td>
				</tr>
			</table>
			<!-- 标签栏 -->
			<div class="mini-tabs" style="height: 260px;">
				<div title="基本信息" style="overflow: hidden;">
					<table width="100%;"
						style="table-layout: fixed; line-height: 20px; text-align: left;">
						<tr style="display: none;">
						...
						<tr>
							...
							<td class="td-input" colspan=3><input
						...
						<tr>
							...
							<td colspan=3><input
								style="width: 400px; border: 1px solid silver;" type="text"
								value="" id="id_formPath" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="td-label">提交按钮：</td>
							<td colspan=3><input style="position: relative; top: 3px;"
								value="save" type="checkbox" name="submitButtons" />&nbsp;保存 <input
								style="position: relative; top: 3px;" value="read"
								type="checkbox" name="submitButtons" />&nbsp;传阅 <input
								style="position: relative; top: 3px;" value="assignment"
								type="checkbox" name="submitButtons" />&nbsp;工作指派 <input
								style="position: relative; top: 3px;" value="signature"
								type="checkbox" name="submitButtons" />&nbsp;会签 <input
								style="position: relative; top: 3px;" value="back"
								type="checkbox" name="submitButtons" />&nbsp;退回</td>
						</tr>
						<tr>
							<td class="td-label">退回路由：</td>
							<td colspan=3 id="id_backRoutesContainer"></td>
						</tr>
						<tr>
							<td class="td-label">意见互斥：</td>
							<td colspan=3 style="text-align: left; padding-left: 10px;">是<input
								type="radio" name="isNeedAdviseExclude" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;否<input
								type="radio" name="isNeedAdviseExclude" value="0" /></td>
						</tr>
						<tr>
							<td class="td-label">意见互斥路由：</td>
							<td colspan=3 id="id_excludeMessageActivitiesContainer"></td>
						</tr>
						<tr>
							<td class="td-label">填写意见：</td>
							<td colspan=3 style="text-align: left; padding-left: 10px;">是<input
								type="radio" name="isNeedAdvise" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;否<input
								type="radio" name="isNeedAdvise" value="0" /></td>
						</tr>
						<tr>
							<td class="td-label">检查附件：</td>
							<td colspan=3 style="text-align: left; padding-left: 10px;">是<input
								type="radio" name="isAttachmentChecked" value="true" />&nbsp;&nbsp;&nbsp;&nbsp;否<input
								type="radio" name="isAttachmentChecked" value="false" /></td>
						</tr>
						<tr style="display: none">
							<td class="td-label">自动处理：</td>
							<td colspan=3 style="text-align: left; padding-left: 10px;">是<input
								type="radio" name="isAutoActivity" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;否<input
								type="radio" name="isAutoActivity" value="0" /></td>
						</tr>
					</table>
				</div>
				<div title="待办" style="overflow: hidden;">
					<table width="100%;"
						...
						<tr class="need-set-value-cls-">
							...
							<td class="td-input" colspan=3><textarea
									id="id_initiator_display"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea> <textarea id="id_initiator"
									style="display: none; width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
							<td class="td-input"><a
								style="display: none; width: 80px; margin-left: -35px;"
								class="mini-button" href="javascript:void(0);"
								id="id_initiator_button">选择{0}</a></td>
						</tr>
						<tr>
							<td class="td-label">处理方式：</td>
							<td class="td-input" id="id_dealMethodContainer"></td>
							<td class="td-label n-passed-cls" style="display: none">处理人数：</td>
							<td style="display: none" class="td-input n-passed-cls"><input
								type="text" value="" id="id_passedCount" /></td>
						</tr>
						<!-- 待办提醒-->
						<tr>
							<td class="td-label">提醒方式：</td>
							<td colspan=3>
								<!-- --> <input style="position: relative; top: 3px;"
								value="waitToDo" type="checkbox" disabled="disabled" checked />&nbsp;待办
								<input style="position: relative; top: 3px;" value="sms"
								type="checkbox" name="messageTypes" />&nbsp;短信 <input
								style="position: relative; top: 3px;" value="mail"
								type="checkbox" name="messageTypes" />&nbsp;邮件 <!-- 
						...
						<tr>
							...
							<td class="td-input" colspan=3><textarea
									id="id_messageContent" name="messageContent"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
						</tr>
					</table>
				...
				<div title="条件路由">
					<table width="100%;"
						...
						<tr class="need-set-value-cls-conditionRoute">
							...
							<td class="td-input" colspan=2><textarea
									value="workflowNextRouteCallBack" id="id_conditionRouteValue"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
						</tr>
						<tr class="need-set-value-cls-conditionRoute-label"
							style="display: none;">
							<td colspan=3>
				...
				<div title="传阅 " style="overflow: hidden;">
					<table width="100%;"
						...
						<tr class="need-set-value-cls-read">
							...
							<td class="td-input" colspan=3><textarea
									id="id_autoReadInitiator_display"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea> <textarea id="id_autoReadInitiator"
									style="display: none; width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
							<td class="td-input"><a
								style="display: none; width: 80px; margin-left: -35px;"
								class="mini-button" href="javascript:void(0);"
								id="id_autoReadInitiator_button">选择{0}</a></td>
						</tr>
						<!-- 传阅提醒 -->
						<tr>
							<td class="td-label">提醒方式：</td>
							<td colspan=3><input style="position: relative; top: 3px;"
								value="waitToDo" type="checkbox" disabled="disabled" checked />&nbsp;待办
								<input style="position: relative; top: 3px;" value="sms"
								type="checkbox" name="readMessageTypes" />&nbsp;短信 <input
								style="position: relative; top: 3px;" value="mail"
								type="checkbox" name="readMessageTypes" />&nbsp;邮件 <!-- 
						...
						<tr>
							<td class="td-label">提醒内容：</td>
							<td class="td-input" colspan=3><textarea
									id="id_readMessageContent" name="readMessageContent"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
						</tr>
					</table>
				...
				<div title="会签" style="overflow: hidden;">
					<table width="100%;"
						...
						<tr class="need-set-value-cls-signature">
							...
							<td class="td-input" colspan=3><textarea
									id="id_autoSignatureInitiator_display"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea> <textarea id="id_autoSignatureInitiator"
									style="display: none; width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
							<td class="td-input"><a
								style="display: none; width: 80px; margin-left: -35px;"
								class="mini-button" href="javascript:void(0);"
								id="id_autoSignatureInitiator_button">选择{0}</a></td>
						</tr>
						<!-- 会签提醒-->
						<tr>
							<td class="td-label">提醒方式：</td>
							<td colspan=3><input style="position: relative; top: 3px;"
								value="waitToDo" type="checkbox" disabled="disabled" checked />&nbsp;待办
								<input style="position: relative; top: 3px;" value="sms"
								type="checkbox" name="signatureMessageTypes" />&nbsp;短信 <input
								style="position: relative; top: 3px;" value="mail"
								type="checkbox" name="signatureMessageTypes" />&nbsp;邮件 <!-- 
						...
						<tr>
							<td class="td-label">提醒内容：</td>
							<td class="td-input" colspan=3><textarea
									id="id_signatureMessageContent" name="signatureMessageContent"
									style="width: 300px; margin-left: 0px; height: 50px; overflow: auto; border: 1px solid silver;">
								</textarea></td>
						</tr>
					</table>
		...
		<table width="100%;">
			<tr style="text-align: center;">
				<td style="padding: 10px;"><a class="mini-button"
					onclick="saveChangeToActivity">保存</a> <a class="mini-button"
					onclick="__saveChangeToActivityClose">取消</a></td>
			</tr>
		</table>
	</div>
	...
	<script type="text/javascript">
		...
		function workflowActivitiesSetting(rowData) {
			...
			var table_activities = mini
					.get('id_workflow_activity_detail_table');
					...
					.confirm(
							...
							function(action) {
								if (action == 'ok') {
									window
											.open(
													"${pageContext.request.contextPath}/jbpm/startDeployedProcess.action?processDefinitionId="
															+ escape(encodeURIComponent(processDefinitionId)),
													"_blank");
								}
							});
		}
	...
	<script type="text/javascript">
		function getChineseActorType(actorType) {
			...
			case 'requestInitiator': {
				chineseActorType = '流程发起人';
				break;
			}
			case 'user': {
				chineseActorType = '指定人员';
				break;
			}
			case 'requestInitiatorRelation': {
				chineseActorType = '发起人关系';
				break;
			}
			case 'submitRelation': {
				chineseActorType = '提交人关系';
				break;
			}
			case 'requestInitiatorDefinedRelation': {
				chineseActorType = '预定义的发起人关系';
				break;
			}
			case 'submitDefinedRelation': {
				chineseActorType = '预定义的提交人关系';
				break;
			}
			case 'dept': {
				chineseActorType = '部门';
			...
			case 'step': {
				chineseActorType = '历史步骤';
				break;
			}
			case 'formField': {
				chineseActorType = '表单域';
				break;
			}
			case 'sql': {
				chineseActorType = '自定义';
				break;
			}
			default: {
				chineseActorType = "";
		...
		jQuery(function() {
			tenwa
					.createTable({
						...
						columns : [
								...
								{
									header : '参与人',
									field : 'displayactorvalue',
									renderer : function(e) {
										var rowData = e.record;
										var actorType = rowData['actortype'];
										var displayValue = rowData['displayactorvalue'];
										var hiddenValue = rowData['actorvalue'];
										return renderActorValue(actorType,
												displayValue, hiddenValue);
									}
								},
								{
									header : '条件路由类型',
									field : 'conditionroutetype',
									renderer : function(e) {
										var rowData = e.record;
										if (("start" == rowData.activitytype)
												|| ("end" == rowData.activitytype)) {
											return "";
										}
								...
								{
									header : '传阅参与人',
									field : 'autoreadactorvalue',
									visible : false
								},
								{
									header : '传阅参与人',
									field : 'autoreaddisplayactorvalue',
									width : 160,
									renderer : function(e) {
										var rowData = e.record;
										var actorType = rowData['autoreadactortype'];
								...
								{
									header : '传阅人发送内容',
									field : 'readmessagecontent'
								},
								{
									header : '会签参与人类型',
									field : 'autosignatureactortype',
									width : 160,
									renderer : function(e) {
										var rowData = e.record;
								...
								{
									header : '会签参与人',
									field : 'autosignatureactorvalue',
									visible : false
								},
								{
									header : '会签参与人',
									field : 'autosignaturedisplayactorvalue',
									width : 160,
									renderer : function(e) {
										var rowData = e.record;
										var actorType = rowData['autosignatureactortype'];
								...
								},
								{
									...
									renderer : function(e) {
										...
										if ("Single" == (dealMethod)) {
											dealMethodChineseName = "单人处理";
										}
										;
										if ("AllPassed" == (dealMethod)) {
											dealMethodChineseName = "多人全部";
										}
										;
										if ("OnePassed" == (dealMethod)) {
											dealMethodChineseName = "多人任一";
										}
										;
										if ("NPassed" == (dealMethod)) {
											dealMethodChineseName = "N人处理";
										}
										;
								...
								},
								{
									...
									renderer : function(e) {
										var realValue = "";
										if ("1" == e.record.isneedadvise) {
											realValue = "是";
										} else if ("0" == e.record.isneedadvise) {
											realValue = "否";
										}
										return realValue;
									}
								...
								{
									header : '是否自动节点',
									field : 'isautoactivity',
									visible : false,
									renderer : function(e) {
										var realValue = "";
										if ("1" == e.record.isautoactivity) {
											realValue = "是";
										} else if ("0" == e.record.isautoactivity) {
											realValue = "否";
										}
										return realValue;
									}
									...
									header : '附件类型编号',
									field : 'attachmenttypeids',
									visible : false
								}, {
									header : '退回路由节点',
									field : 'backactivities'
								}, {
									header : '是否意见互斥',
									field : 'isneedadviseexcludedesc'
								}, {
									header : '意见互斥路由节点',
									field : 'excludemessageactivitiesdesc'
								} ]
					});
			//选择action
			new tracywindyComboBox(
			...
			new tracywindyComboBox({
				...
				onSelect : function(combo, rowData) {
					...
					if ("pageCallBack" == conditionRouteType) {
						...
						jQuery(".need-set-value-cls-conditionRoute-label")
								.show();
					} else {
			...
			//选择参与人
			initNodeContainer("id_initiatorTypeContainer",
					"id_initiator_display", "id_initiator",
					"id_initiator_button", "");
			//选择结束时传阅参与人类型
			initNodeContainer("id_autoReadInitiatorTypeContainer",
					"id_autoReadInitiator_display", "id_autoReadInitiator",
					"id_autoReadInitiator_button", "read");
			//选择结束时会签参与人类型 
			initNodeContainer("id_autoSignatureInitiatorTypeContainer",
					"id_autoSignatureInitiator_display",
					"id_autoSignatureInitiator",
					"id_autoSignatureInitiator_button", "signature");

			jQuery("input[type='radio'][name='isNeedAdviseExclude']")
					.bind(
							'click',
							function() {
		...
		function initNodeContainer(initiatorTypeContainer, initiatorDisplayId,
				initiatorHiddenId, choseButtonId, attachmentId) {
			...
			new tracywindyComboBox({
				...
				width : 160,
				renderTo : initiatorTypeContainer
						|| 'id_initiatorTypeContainer',
				loadMode : 'local',
				readOnly : true,
				...
				datas : [ {
					...
					name : '发起人关系',
					value : 'requestInitiatorRelation'
				}, {
					name : '提交人关系',
					value : 'submitRelation'
				}, {
					name : '预定义的发起人关系',
					value : 'requestInitiatorDefinedRelation'
				}, {
					name : '预定义的提交人关系',
					value : 'submitDefinedRelation'
				}, {
					name : '部门',
					value : 'dept'
				}, {
				...
				onSelect : function(combo, rowData) {
					...
					initNodeInitiator(value, rawValue, initiatorTypeContainer,
							initiatorDisplayId, initiatorHiddenId,
							choseButtonId, attachmentId);
				}
			});
		}
		function initNodeInitiator(value, rawValue, initiatorTypeContainer,
				initiatorDisplayId, initiatorHiddenId, choseButtonId,
				attachmentId) {
			...
			case "step": {
				...
				$choseButton[0].onclick = (function(value) {
					return function(e) {
						getTracywindyObject('id_' + value + attachmentId)
								.show();
					};
				})(value);
				break;
		...
		function modifyActivity(rowData) {
			...
			var initiatorType = rowData['actortype'];
			//自动传阅
			var autoSignatureInitiator = (rowData['autosignatureactorvalue'] || "")
					.replace(/\\n/g, "\r\n");
			...
			//自动会签
			var autoReadInitiator = (rowData['autoreadactorvalue'] || "")
					.replace(/\\n/g, "\r\n");
			...
			var currentCheckedRadio = jQuery("input[type='radio'][name='isNeedAdvise'][value='"
					+ isNeedAdvise + "']")[0];
			...
			var currentCheckedRadio2 = jQuery("input[type='radio'][name='isNeedAdviseExclude'][value='"
					+ isNeedAdviseExclude + "']")[0];
			...
			var currentCheckedAttachmentRadio = jQuery("input[type='radio'][name='isAttachmentChecked'][value='"
					+ isAttachmentChecked + "']")[0];
			...
			var currentCheckedAutoActivityRadio = jQuery("input[type='radio'][name='isAutoActivity'][value='"
					+ isAutoActivity + "']")[0];
			...
			jQuery("#id_autoSignatureInitiator_display").val(
					autoSignatureDisplayInitiator);
			//自动传阅
			jQuery("#id_autoReadInitiator").val(autoReadInitiator);
			jQuery("#id_autoReadInitiator_display").val(
					autoReadDisplayInitiator);
			...
			if (("start" == activityType) || (("end" == activityType))) {
				...
				jQuery("input[name='submitButtons']").attr("disabled",
						"disabled");
				jQuery("input[type='radio'][name='isNeedAdvise']").attr(
						"disabled", "disabled");
				jQuery("input[type='radio'][name='isNeedAdviseExclude']").attr(
						"disabled", "disabled");
				jQuery("input[type='radio'][name='isAttachmentChecked']").attr(
						"disabled", "disabled");
				jQuery("input[type='radio'][name='isAutoActivity']").attr(
						"disabled", "disabled");
				//信息
				jQuery("#id_messageContent")[0].disabled = true;
				jQuery("input[name='messageTypes']").attr("disabled",
						"disabled");
				jQuery("#id_readMessageContent")[0].disabled = true;
				jQuery("input[name='readMessageTypes']").attr("disabled",
						"disabled");
				jQuery("#id_signatureMessageContent")[0].disabled = true;
				jQuery("input[name='signatureMessageTypes']").attr("disabled",
						"disabled");
				...
				jQuery("input[name='signatureMessageTypes']").removeAttr(
						"disabled");

				jQuery("input[type='radio'][name='isNeedAdvise']").removeAttr(
						"disabled");
				jQuery("input[type='radio'][name='isNeedAdviseExclude']")
						.removeAttr("disabled");
				jQuery("input[type='radio'][name='isAttachmentChecked']")
						.removeAttr("disabled");
				jQuery("input[type='radio'][name='isAutoActivity']")
						.removeAttr("disabled");
			...
			combo_autoSignatureInitiatorType
					.setValue(autoSignatureInitiatorType);
			...
			//选择参与人
			initNodeInitiator(combo_initiatorType.getValue(),
					combo_initiatorType.getRawValue(),
					"id_initiatorTypeContainer", "id_initiator_display",
					"id_initiator", "id_initiator_button", "");
			//选择结束时传阅参与人类型
			initNodeInitiator(combo_autoReadInitiatorType.getValue(),
					combo_autoReadInitiatorType.getRawValue(),
					"id_autoReadInitiatorTypeContainer",
					"id_autoReadInitiator_display", "id_autoReadInitiator",
					"id_autoReadInitiator_button", "read");
			//选择结束时会签参与人类型 
			initNodeInitiator(combo_autoSignatureInitiatorType.getValue(),
					combo_autoSignatureInitiatorType.getRawValue(),
					"id_autoSignatureInitiatorTypeContainer",
					"id_autoSignatureInitiator_display",
					"id_autoSignatureInitiator",
					"id_autoSignatureInitiator_button", "signature");
			//设置选择历史步骤
			...
			var stepSelectionSignature = getTracywindyObject('id_step'
					+ "signature");
					...
					.confirm(
							...
							function(action) {
								if (action == 'ok') {
									...
									var initiatorType = combo_initiatorType
											.getValue();
									var initiator = jQuery("#id_initiator")
											.val();
									var conditionRouteType = combo_conditionRouteType
											.getValue();
									var conditionRouteValue = jQuery(
											"#id_conditionRouteValue").val();
									var displayInitiator = jQuery(
											"#id_initiator_display").val();
									var autoSignatureInitiatorType = combo_autoSignatureInitiatorType
											.getValue();
									var autoSignatureInitiator = jQuery(
											"#id_autoSignatureInitiator").val();
									var autoSignatureDisplayInitiator = jQuery(
											"#id_autoSignatureInitiator_display")
											.val();
									var autoReadInitiatorType = combo_autoReadInitiatorType
											.getValue();
									var autoReadInitiator = jQuery(
											"#id_autoReadInitiator").val();
									var autoReadDisplayInitiator = jQuery(
											"#id_autoReadInitiator_display")
											.val();

									var dealMethod = combo_dealMethod
											.getValue();
									var passedCount = jQuery("#id_passedCount")
											.val();
									var activityAction = getTracywindyObject(
											'combo_activityAction').getValue();
									var attachmentType = getTracywindyObject(
											'combo_attachmentType')
											.getRawValue();
									var attachmentTypeIds = getTracywindyObject(
											'combo_attachmentType').getValue();
									var formPath = jQuery("#id_formPath").val();
									var formTitle = jQuery("#id_formTitle")
											.val();
									var submitButtons = getOperationButtons();
									var isNeedAdvise = jQuery(
											"input[type='radio'][name='isNeedAdvise']:checked")
											.val();
									var isNeedAdviseExcludeStr = jQuery(
											"input[type='radio'][name='isNeedAdviseExclude']:checked")
											.val();
									var isNeedAdviseExclude = isNeedAdviseExcludeStr == '1' ? true
											: false;
									var isAttachmentChecked = jQuery(
											"input[type='radio'][name='isAttachmentChecked']:checked")
											.val();

									var isAutoActivity = jQuery(
											"input[type='radio'][name='isAutoActivity']:checked")
											.val();
									var backRoutesNodes = getTracywindyObject(
											'combo_backRoutes').getRawValue();
									var excludeMessageActivitiesDesc = getTracywindyObject(
											'combo_excludeMessageActivities')
											.getRawValue();
									var excludeMessageActivities = getTracywindyObject(
											'combo_excludeMessageActivities')
											.getValue();
									//信息
									var messageTypes = getMessageTypes();
									var messageContent = jQuery(
											"#id_messageContent").val();
									var readMessageTypes = getReadMessageTypes();
									var readMessageContent = jQuery(
											"#id_readMessageContent").val();
									var signatureMessageTypes = getSignatureMessageTypes();
									var signatureMessageContent = jQuery(
											"#id_signatureMessageContent")
											.val();

									jQuery("input[name='messageTypes']")
											.removeAttr("disabled");
									var params = {
										id : id,
									...
									tenwa
											.ajaxRequest({
												...
												success : function(res) {
													mini
															.get(
																	'id_workflow_activity_detail_table')
															.reload();
													mini.unmask(document.body);
													mini
															.get(
																	"id_workflow_activity_setting")
															.hide();
												},
												failure : function(res) {
													mini.unmask(document.body);
		...
		function setDataChecks(buttonsValue, checkName) {
			...
			if (buttonsValue) {
				...
				for (var i = 0; i < splitButtonsArr.length; i++) {
					$(
							"input[name='" + checkName + "'][value='"
									+ splitButtonsArr[i] + "']").click();//attr("checked",true);
				}
			}
		}

		function getDataChecks(checkName) {
			var operationButtonsCheckBox = $("input[name='" + checkName
					+ "']:checked");
	...
	<script type="text/javascript">
		...
		var processDefinitionsColumns = [
				...
				},
				{
					...
					renderer : function(e) {
						...
						var deploy = "";
						if (rowData.deployid) {
							deploy += '<a href="javascript:void(0);" onclick="removeDeploy(\''
									+ rowData.id
									+ '\',\''
									+ rowData.deployid
									+ '\')">撤销发布</a>';
							if (rowData.processdefinitiondeployedtime < rowData.processdefinitionupdatetime) {
								deploy += '/<a href="javascript:void(0);" onclick="workflowSynchronized(\''
										+ rowData.deployid + '\')">流程同步</a>';
							}
							...
							deploy += '<a href="javascript:void(0);" onclick="publishDeploy(\''
									+ rowData.id + '\')">发布</a>';
							deploy += '/<a href="javascript:void(0);" onclick="removeDesignedWorkflow(\''
									+ rowData.id + '\')">删除</a>';
						}
						return deploy;
					}
					...
					header : '显示名称',
					field : 'processdefinitiondisplayname',
					width : 200
				}, {
					header : '流程编号',
					field : 'code'
					...
					header : '设计器版本',
					field : 'processdefinitionjpdlversion',
					width : 80
				}, {
					header : '流程描述',
					field : 'processdefinitiondescription',
					width : 100
				}, {
					header : '关键字段一',
					field : 'keyone',
					...
					header : '关键字段七<font color="red">(付款单号)</font>',
					field : 'keyseven',
					width : 150
				}, {
					header : '关键字段八<font color="red">(合同流水号)</font>',
					field : 'keyeight',
					width : 150
				}, {
					header : '关键字段九<font color="red">(项目立项流水号)</font>',
					field : 'keynine',
					width : 150
				}, {
					header : '关键字段十<font color="red">(互斥标识)</font>',
					field : 'keyten',
					width : 150
				} ];
		...
		tenwa
				.createTable({
					...
					showPager : true,
					start : parseInt("<mini:param  name='pageStart' defaultValue='0'/>"),
					params : {
						queryText : unescape(decodeURIComponent("<mini:param  name='queryText'/>"))
					/* ,
					...
					callBack : function() {
						...
						this
								.setHideColumnHidden('processdefinitionjpdlversion');
					}
				});
	</script>
</body>
