...
tools.push({
	...
	handler: function(miniTable, buttonText){
		...
		if(row){
			...
			startProcess("租金红冲流程-1",attachmentParams);
		}else{
...
jQuery(function(){
	tenwa.createTable({
		...
		xmlFileName: '/eleasing/workflow/rent/rent_red/rent_red_open_list.xml',
		columns: [
			{type: 'indexcolumn'},
			{type: 'checkcolumn'},
			{field: 'id', header: 'id', visible: false},
			{field:'contract_put_number',header:'投放编号',allowSort:true,queryConfig:{width:165}},
			{field: 'project_name', header: '项目名称',queryConfig:{width: 165}},
			{field: 'incomerent', header: '租金实收',summary : true,dataType : "currency"},
			{field: 'cust_name', header: '承租人',queryConfig:{width: 165,newLine: true}},
