...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;" bodyStyle="border:0px;">
	<div title="待调息" name="todo_regulating_of_breathing" iconCls="icon-cut" >
		 <jsp:include page="common/todo_regulating_of_breathing.jsp" ></jsp:include>
	</div>
	...
	<div title="本次调息" name="current_regulating_of_breathing" iconCls="icon-cut">
	     <jsp:include page="common/current_regulating_of_breathing.jsp" ></jsp:include>
	</div>
</div>
	   ...
	   <tr>
		   <td class="td-content-title" >
			<input type="hidden" id="id_adjust_contractids" name="adjust_contractids" value="<mini:param  name="adjust_contractids"/>">
	   		...
	   		<textarea style="width:99.6%;height:250px;float:left;" id="tx_text_memo" class="td-content-input td-content-readonly" readOnly name="tx_text_memo" ><mini:param  name="tx_text_memo" /></textarea>
