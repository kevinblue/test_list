...
<input  style="display:none;"	class="mini-textarea" id="id_json_fund_charge_old_str" name="json_fund_charge_old_str" value='<mini:param  name="json_fund_charge_old_str" defaultValue="[]"/>'></input>
