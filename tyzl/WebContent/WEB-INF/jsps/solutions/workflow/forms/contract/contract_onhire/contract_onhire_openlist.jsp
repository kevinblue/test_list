...
jQuery(function(){
	tenwa.createTable({
		id: "contract_onhire",
		renderTo: "id_table_container_contract_onhire",
		...
		xmlFileName: '/eleasing/workflow/contract/contract_onhire/contract_onhire_open_list.xml',
		columns: [
			{type: 'indexcolumn'},
			{type: 'checkcolumn'},
			{field: 'id', header: 'id', visible: false},
			{field: 'contract_put_number', header: '投放编号',allowSort:true,queryConfig:{}},
...
<body>
<div id="id_table_container_contract_onhire"></div>
</body>
</html>