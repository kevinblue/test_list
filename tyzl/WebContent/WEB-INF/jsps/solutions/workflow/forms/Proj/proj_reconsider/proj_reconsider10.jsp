...
<script type="text/javascript">
	...
	{
		var cflag=miniui_ext.submitFormValidation(["id_proj_metting","id_proj_credit_isapproval"]);
	...
	function workflowNextRouteCallBack(buttonText,requestNextRoute){
		var rote1="TO 11.董事会审批(3000万以上)";
		var rote2="TO 12.业务部项目经理组织实施(500万到3000万以下)";
		if(buttonText == "Submit"){
			var equipt=mini.get("equipamt").getValue();
			equipt=equipt.replace(/,/g,"");
			equipt=parseFloat(equipt)
			if(equipt>=30000000){
			    requestNextRoute.value = rote1;
			}else{
				requestNextRoute.value = rote2;
			}
		}
	}
</script>
		...
		<div class="mini-tabs" activeIndex="0"   style="width: 99%" id="tabDetailsBase"  onactivechanged="changTab">
		   ...
		   <div title="文件清单" name="proj_file_detail"   iconCls="icon-cut" >
		    ...
		    <div title="评审会议记录" name="proj_file_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_meeting_record.jsp" ><jsp:param value="false" name="isView"/></jsp:include>
		    </div>
		    <div title="信审结论" name="proj_file_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_credit_info.jsp"></jsp:include>
		    </div>
	   </div>
	</div>
<script type="text/javascript">
