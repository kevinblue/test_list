...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		...
		data: JsonUtil.decode('<mini:param  name="json_proj_guarantee_detail_str" defaultValue="[]"/>'),
		columns: [
			{type:'indexcolumn'},
			{type:'checkcolumn'},
				    ...
				    formEditorConfig:{
				          ...
				          allowInput:false,
				             colspan:3,
				               width:'100%',
				        fieldVisible:true,
				         params:{cust_type:'cust_type.assuror',checkcust:"and cic.creator_='"+"${sessionScope['login_userid']}"+"'",xmlFileName:'/eleasing/workflow/contract/contract_approval/contract_custinfo.xml'},
			...
			{field:'assurerelation',header:'关系',visible:false,
  			...
  			{field:'assurenaturename',header:'担保单位性质', 
				    formEditorConfig:{
				        fieldVisible:false,
				   fillFromFieldName:'assurenature',
				        fillProperty:'name'}},
			{field:'assurenature',header:'担保单位性质',visible:false,
					formEditorConfig:{
				             newLine:true,
				                type:'combobox',
				            required:true,
				          ...
				          valueField:'value',
				        fieldVisible:true,
				              params:{dictid:'assure_nature',xmlFileName:'/eleasing/workflow/contract/contract_approval/contract_dict_data.xml'}}},
