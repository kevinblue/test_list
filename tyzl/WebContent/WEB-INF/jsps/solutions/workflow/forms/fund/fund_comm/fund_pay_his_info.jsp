...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		...
		tools: toolsArray2,
		data: JsonUtil.decode('<mini:param  name="json_pay_his_str" defaultValue="[]"/>'),
		columns: [
			{type: 'indexcolumn'},
			{type: 'checkcolumn'},
			{field: 'id', header: 'id', visible: false},
			{field:'roll_back',header:'是否已被红冲',renderer : function(e){var rollback = e.record.rollback;if(rollback=="0"){return "否";}else{return "是";}}},	
