...
<script type="text/javascript">
  ...
  jQuery(function(){
		dict('id_one_classify','oneclassify','wordtempletypefirst','<mini:param  name="oneclassify"/>',null,'');
		dict('id_two_classify','twoclassify','wordtempletypetwo','<mini:param  name="twoclassify"/>',null,'');
		dict('id_three_classify','threeclassify','wordtempletypethree','<mini:param  name="threeclassify"/>',null,'');
		dict('id_four_classify','fourclassify','wordtempletypefour','<mini:param  name="fourclassify"/>',null,'');
		dict('id_five_classify','fiveclassify','wordtempletypefive','<mini:param  name="fiveclassify"/>',null,'');
	});
</script>
</head>
<body>
