		...
		<table id="id_table_cust_info_edit">
		    ...
		    <tr>
		     ...
		     <tr>
		        ...
		        <td >
					<input id="industry" name="industry" label="客户所属行业门类" class="mini-buttonedit mini-queryinput" allowInput="false" 
		             		required="true"/>
		        </td>
		   ...
		   <!--  <tr>
		    ...
		    <tr>
		        ...
		        <td><input name="taxregcode" class="mini-textbox miniext-form-fit" vtype="maxLength:50" label='纳税人识别号' required="true"/></td>
	    </tr>
	     <tr>
		    ...
		    <tr>
		        ...
		        <td ><input name="personrep" class="mini-textbox miniext-form-fit" label='法人代表' vtype="maxLength:100" required="true" /></td>
		    	<td class="miniext-form-td">法人身份证号：</td>
		        <td><input name="personidcard" class="mini-textbox miniext-form-fit" label='法人身份证号' onvalidation="onIDCardsCompanyValidation" required="true"/> </td>
		    </tr>
		    <tr>
		    ...
		    <tr>
		        ...
		        <td ><input name="custactphone" class="mini-textbox miniext-form-fit" vtype="maxLength:50"  label='联系人电话'/> </td>
		    </tr>
		   <tr>
		    ...
		    <tr>
		        ...
		        <td><input name="buslicense" class="mini-textbox miniext-form-fit" vtype="maxLength:50" required="true"/> </td>
		    ...
		    <tr>
		        ...
		        <td id="custfile1" colspan="2" title="组织机构代码证">
		        </td>
		    </tr>
		    <tr>
		        ...
		        <td id="custfile2" colspan="2" title="营业执照">
		        </td>
		    </tr>
		    <tr>
...
<div id="addfile" class="mini-window" title="上传"
	...
	<form action="" id="id_uploadCustFileForm" enctype="multipart/form-data"  target="attachment_file_upload_real_submit_frame" method="post">
		...
		<tr><td class="input_label_desc"></td><td class="input_value" id="id_upload_location">
		<input type="file" name="name_upload_file_name" id="id_uploadAttachmentFile" /><span class="content-required">*</span></td></tr>
...
function checkORGRight(obj) {
	...
	var custtype = mini.get("custtype").getText();
	if (!custtype.match("承租人") && !custtype.match("担保人") && !custtype.match("其他类型") && !custtype.match("抵押人")) {
		return true;
	}
...
jQuery(function(){
	//页面加载数据
	var data = miniui_ext.initPageData("/eleasing/jsp/cust_info/cust_company/get_custinfocompany_byid.xml","form1","<mini:param  name='id'/>");
	//如果是修改操作、则把组织机构代码属性设为只读
	draftchanged();
	oncountrychanged();
	
	//将页面上一些信息设置为必填项
	miniui_ext.initrequired("form1","custscale,taxregcode,personrep,personidcard,creditcardyesorno,buslicense,regcapital,regaddress,companyaddress,operatemaster",true);
	...
	tenwa.createQueryInput({
		...
		windowWidth: 600,
		params: {
			xmlFileName: '/eleasing/jsp/cust_info/cust_common/get_industry_bypid.xml'
		}
	});
	for(var i=1;i<=4;i++)
	{
...
function save(e){
	...
	for(var text in texts){
		...
		if($("#custfile2").html()!=""&&$("#custfile4").html()!=""){
							a=true;
		   }
			if(a==false){
				mini.alert("营业执照、法定代表人身份证必须同时上传！");
				return;
			}
		}
	}
