...
<div style="width: 100%;height: 100%;overflow: auto;">
	<div id="form1" style="padding: 5px;">
		<table id="id_table_cust_detail" cellpadding="0" cellspacing="0" align="center">
		    ...
		    <tr>
		        ...
		        &nbsp;&nbsp;&nbsp;&nbsp;<input name="custfile1" class="mini-textbox  asLabel"  /></td>
		        <td></td>
		    ...
		    <tr>
		        ...
		        &nbsp;&nbsp;&nbsp;&nbsp;<input name="custfile2" class="mini-textbox  asLabel" /></td>
		        <td></td>
		    ...
		    <tr>
		        ...
		        &nbsp;&nbsp;&nbsp;&nbsp;<input name="custfile3" class="mini-textbox  asLabel" width="100%"/></td>
		        <td></td>
		    ...
		    <tr>
		        ...
		        &nbsp;&nbsp;&nbsp;&nbsp;<input name="custfile4" class="mini-textbox  asLabel" width="100%"/></td>
		        <td></td>
	...
	<div id="tabDeatils" class="mini-tabs" activeIndex="0" style="width: 100%;" bodyStyle="padding:0;border:0;">
	    ...
	    <div title="集团客户财务报表分析" name="cliqueFinancialReport" iconCls="icon-cut">
	    	<jsp:include page="../cust_finance/clique_finance_report.jsp" ></jsp:include>
	    </div>
	    <div title="客户财务报表" name="custFinancialReport" iconCls="icon-cut">
	    	<jsp:include page="../cust_finance/cust_finance.jsp" ></jsp:include>
	    </div>
	    <div title="下属子公司" name="custSubsidiary" iconCls="icon-cut">
	    	<jsp:include page="../cust_subsidiary/cust_subsidiary_list.jsp" ></jsp:include>
	    </div>
	</div>
...
$.ajax({
    url: urlPrefix+"/eleasing/jsp/cust_info/cust_clique/get_custinfoclique_byid.xml&id=<mini:param  name='id'/>",
    cache: false,
...
function upd(){
	var urlFlag = getRootPath()+"/leasing/cust_info/cust_clique/input_cust_clique_list.bi?id=<mini:param  name='id'/>";
	var saveUrl = getRootPath() + "/acl/updateCustClique.acl";
	mini.open({
        url: urlFlag+"&opertype=update&saveurl="+saveUrl,
        title: "编辑集团客户信息", width: 800, height: 500,
        onload: function () {
