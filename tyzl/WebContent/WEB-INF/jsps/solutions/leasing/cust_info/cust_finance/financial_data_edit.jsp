...
<div style="width:100%;height:8%;line-height:40px;" >
	...
	<div id="id_table_financial_data_edit" class="mini-datagrid" style="width:100%;height:92%;" 
        url="${pageContext.request.contextPath}/table/getTableData.action?tracywindyRandom=1&decorate=none&xmlFileName=/eleasing/jsp/cust_info/cust_financial/select_project_year.xml&custid=<mini:param  name="custid"/>" idField="id" 
