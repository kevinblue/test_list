	    ...
	    var table = new tracywindyOperationTable({
	   		resetFormCallback:function(table,$form,operFlag){
				if("add" == operFlag){
				    ...
				    jQuery("#fromuser").val('<mini:user valuetype="id"/>');
				    jQuery("#fromusername").val('<mini:user/>');
				}
	     	},
	         ...
	         title:'发布',
	         width:parseInt("<mini.param name='tableWidth'/>")||pageWidth,
	         height:parseInt("<mini.param name='tableHeight'/>")||pageHeight,
	         id:'id_table',
