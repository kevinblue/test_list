...
<script type="text/javascript">
	var globalTimestamp = "<mini:param  name='currentTimestamp' scope='page'/>";
	var globalLocale = "<mini:param  name='currentLocale' scope='page'/>";
	var globalSkin = "<mini:param  name='currentSkin' scope='page'/>";
	...
	var urlPrefix = "${pageContext.request.contextPath}/table/getTableData.action?tracywindyRandom=1&decorate=none&xmlFileName=";
</script>