...
public class RollBackAdjustInterestController extends BaseController  {
	...
	public String rollBackAdjustInterest(HttpServletRequest request,HttpServletResponse response)  throws Exception {
		//参数初始化
		Map<String,String> requestmodel = QueryUtil.getRequestParameterMapByAjax(request);
		Map<String,String> model = new HashMap<String,String>();
		String adjustId   = requestmodel.get("adjustid");
		String docid      = requestmodel.get("docid");
		String already_json_val = requestmodel.get("already_json_val");
