...
public class FundRentPlanBean {
	...
	private List<String> calPlanDateList = new ArrayList<String>(); // 租金测算日期
	private List<String> yearRateList = new ArrayList<String>();// 年利率
	private List<String> rentList = new ArrayList<String>(); // 租金列表
	private List<String> aclRentList = new ArrayList<String>(); // 实际还款租金列表
	...
	public List<RentPlanBean> convertToRentPlanList() {
		...
		for (int i = 0; i < rentList.size(); i++) {
			...
			temp.setActualRent(aclRentList.get(i));
			temp.setYearRate(yearRateList.get(i));
			temp.setPlanDate(planDateList.get(i));
			temp.setCalPlanDate(calPlanDateList.get(i));
	...
	public List<String> getCalPlanDateList() {
		return calPlanDateList;
	}

	public void setCalPlanDateList(List<String> calPlanDateList) {
		this.calPlanDateList = calPlanDateList;
	}

	public List<String> getAclRentList() {
		return aclRentList;
	}

	public void setAclRentList(List<String> aclRentList) {
		this.aclRentList = aclRentList;
	}
