...
public class ScaleImageUtils {
	...
	public static void createThumbAppImage(AppImage appImage) throws Exception {
		...
		File imageFile = new File(StrTools.fileNameCheck(appImage.getImagePath()));
		...
		ImageIO.write(thumbImage, type, new File(StrTools.fileNameCheck(appImage.getThumbImagePath())));
	}
