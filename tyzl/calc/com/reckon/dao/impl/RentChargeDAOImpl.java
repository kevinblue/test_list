...
public class RentChargeDAOImpl {
	...
	public int addAjust(AdjustBean adb) throws Exception {
		...
		ini = conn.executeUpdate(sql,new ArrayList(),new ArrayList(), "变更表insert语句:");
		return ini;
	}
	...
	public void deleteAjust(AdjustBean adb) throws Exception {
		...
		String sql = " delete fund_rent_adjust_temp  where  doc_id=?";
		paramValue.add(adb.getDocId());
		...
		// logger.info( + sql);
		conn.executeUpdate(sql,paramValue,paramType, "删除fund_rent_adjust_temp：");
	}
