...
public interface RentConditionDataOperator {
	 ...
	 * @throws Exception
	 */
     void saveProjectContionAndRentAndFundToDatabase(ProjInfo project,Map<String,String> variablesMap,String conditionString,String rentstr,String rentFlowStr,String financeStr,String financeFlowStr,String fundStr) throws Exception;
     /**
 	 ...
 	 * @throws Exception
 	 */
     void LoadProjectContionAndRentAndFundToMap(ProjInfo project,Map<String,String> variablesMap,String conditionString,String rentstr,String rentFlowStr,String financeStr,String financeFlowStr,String fundStr) throws Exception;
     /**
  	 ...
  	 * @throws Exception
  	 */
     void LoadProjectContionAndRentAndFundToContractMap(String contractid,ProjInfo project,Map<String,String> variablesMap,String conditionString,String rentstr,String rentFlowStr,String financeStr,String financeFlowStr,String fundStr) throws Exception;
      ...
      * */
     void saveOrLoadRentAndFinalBefore(ContractInfo contractInfo,Map<String,String> variablesMap,String conditionString,String rentstr,String rentFlowStr,String financeStr,String financeFlowStr,String fundStr,String type) throws Exception;
     ...
     /**
  	 ...
  	 * @throws Exception
  	 */
     void saveContractContionAndRentAndFundToDatabase(ContractInfo contractInfo,Map<String,String> variablesMap,String conditionString,String rentstr,String rentFlowStr,String financeStr,String financeFlowStr,String fundStr) throws Exception;
     /**
   	 * @info 加载数据到前台，交易结构，租金计划，现金流，应收应付计划从项目层到合同层
   	 ...
   	 * @throws Exception
   	 */
     void LoadContractContionAndRentAndFundToMap(ContractInfo contractInfo,Map<String,String> variablesMap,String conditionString,String rentstr,String rentFlowStr,String financeStr,String financeFlowStr,String fundStr) throws Exception;
