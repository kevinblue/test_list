 ...
 * Generated at: 2017-02-13 04:56:14 UTC
...
public final class proj_005fequip_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_mini_005fparam_005f1(_jspx_page_context))
        return;
      out.write("'),\r\n");
      out.write("\t\t\tafterShowWindowCallBack:function(miniTable,miniForm,cflag){\r\n");
      out.write("\t\t\t   //回租下，供应商和制造商非必填\r\n");
      out.write("\t\t\t   var leasetyp=mini.get(\"id_leasform\").getValue();\r\n");
      out.write("\t\t\t   if(leasetyp==\"lease_form2\" || leasetyp==\"lease_form4\"){\r\n");
      out.write("\t\t\t\t   getMiniEditFormField(\"proj_equip.vndr\").setRequired(false);\r\n");
      out.write("\t\t\t\t   getMiniEditFormField(\"proj_equip.manufacturer\").setRequired(false);\r\n");
      out.write("\t\t\t   }\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tcolumns: [\r\n");
      ...
      out.write("\tvar equipnum =getMiniEditFormField(\"proj_equip.equipnum\").getInputText().trim();\r\n");
      out.write("\tvar price = getMiniEditFormField(\"proj_equip.price\").getInputText().trim().replace(/,/g,\"\");\r\n");
      out.write("\tequipnum = equipnum || 0;\r\n");
      out.write("\tprice = price || 0;\r\n");
      out.write("\tvar s=e.sender;\r\n");
      out.write("    if (!price.match(/^(:?(:?\\d+.\\d+)|(:?\\d+))$/)){price=0;\r\n");
      out.write("    getMiniEditFormField(\"proj_equip.price\").text=0;}else{\r\n");
      out.write("    \t\r\n");
      out.write("    }\r\n");
      out.write("\tvar temp = Number(equipnum) * Number(price);\r\n");
      out.write("\tif(isNaN(temp)){temp=0;}\r\n");
      out.write("\tgetMiniEditFormField(\"proj_equip.equipprice\").setValue(formatNumberThousand(decimal(temp,2)));\r\n");
      ...
      out.write("\t\ttotalPrice += parseFloat(jsondata[i]['nowtotal']);\r\n");
      out.write("\t}\r\n");
  ...
  private boolean _jspx_meth_mini_005fparam_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_common/proj_equip_detail.jsp(17,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_mini_005fparam_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_common/proj_equip_detail.jsp(38,26) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_mini_005fparam_005f1.setName("json_proj_equip_str");
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_common/proj_equip_detail.jsp(38,26) name = defaultValue type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
