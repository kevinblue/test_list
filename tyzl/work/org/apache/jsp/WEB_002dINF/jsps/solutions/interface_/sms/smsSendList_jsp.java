 ...
 * Generated at: 2017-06-14 01:18:52 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.interface_.sms;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class smsSendList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\tif(rowData.sendflag != '0'){\r\n");
      out.write("\t\t\t\t\t\t\t\talert(\"只能修改未发送的邮件。\");\r\n");
      out.write("\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\tvar fdata=miniForm.getData();\r\n");
      out.write("\t\t\t\t\tvar pattern =  /\\d{11}/;\r\n");
      out.write("\t\t\t        if (pattern.test(fdata.phonenumber) == false) {\r\n");
      out.write("\t\t\t            mini.alert(\"电话号码格式错误\");\r\n");
      out.write("\t\t\t\t\t    return false;\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t        return true;\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\taddRemoteOperUrl:getRootPath()+\"/acl/addSmsTask.acl\",\r\n");
      out.write("\t\t\t\teditRemoteOperUrl:getRootPath()+\"/acl/updateSmsTask.acl\",\r\n");
      out.write("\t\t\t\tremoveRemoteOperUrl:getRootPath()+\"/acl/removeSmsTask.acl\",\r\n");
      out.write("\t\t\t\tremoteOper:true,\r\n");
      out.write("\t\t\t\tid : 'table_id1',\r\n");
      out.write("\t\t\t\twidth : globalClientWidth,\r\n");
      out.write("\t\t\t\theight : globalClientHeight,\r\n");
      out.write("\t\t\t\ttitle : '短信发送信息',\r\n");
      ...
      out.write("\t\t\t\txmlFileName : '/interface/sms/sms_task_list.xml',\r\n");
      ...
      out.write("\t\t\t\t\t\tvar operTitle = \"重新发送\";\r\n");
      out.write("\t\t\t\t\t\tvar operAction = \"sendSmsAgain\";\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(0 == checkedRowDatas.length){\r\n");
      out.write("\t\t\t\t\t\t\talert(\"请选择要\"+operTitle+\"的记录！！\");\r\n");
      out.write("\t\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tif(!window.confirm(\"选中的记录将一律被重新发送，继续请点击确定！\")) return;\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tmini.unmask(document.body);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmini.alert(operTitle + \" 成功！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tcase \"FAILURE\": {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmini.unmask(document.body);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmini.alert(operTitle + \" 失败！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\thandler : function(miniTable, buttonText) {\r\n");
      out.write("\t\t\t\t\t\t\tvar checkedRowDatas = miniTable.getSelecteds();\r\n");
      out.write("\t\t\t\t\t\t\tvar operTitle = \"立即发送\";\r\n");
      out.write("\t\t\t\t\t\t\tvar operAction = \"sendSmsNow\";\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tif(0 == checkedRowDatas.length){\r\n");
      out.write("\t\t\t\t\t\t\t\talert(\"请选择要\"+operTitle+\"的记录！！\");\r\n");
      out.write("\t\t\t\t\t\t\t\treturn;\r\n");
      ...
      out.write("\t\t\t\t\t\t    for(var i = 0;i<checkedRowDatas.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar checkedRowdata = checkedRowDatas[i];\r\n");
      out.write("\t\t\t\t\t\t\t\tif(\"待发送\"!=checkedRowdata.sendflagname){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"电话号码：\"+checkedRowdata.phonenumber+\"不是待发送状态,不能再发送!!!\" );\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tvar id = checkedRowdata.id;\r\n");
      out.write("\t\t\t\t\t\t\t\ttempIdArr.push(id);\r\n");
      ...
      out.write("\t\t\t\t   \t{field : 'phonenumber',header : '电话号码',\r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig : \r\n");
      out.write("\t\t\t\t   \t\t{\r\n");
      out.write("\t\t\t\t   \t\t\tcolspan: 3,\r\n");
      out.write("\t\t\t\t\t\t\twidth: 505,\r\n");
      out.write("\t\t\t\t\t\t\tvtype: 'Mobile',\r\n");
      out.write("\t\t\t\t   \t\t\trequired: true,\r\n");
      out.write("\t\t\t\t   \t\t\t\r\n");
      out.write("\t\t\t\t   \t\t\tonvalidation :function(e){\r\n");
      ...
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'noticetime',header : '预计发送时间',dateFormat : \"yyyy-MM-dd HH:mm:ss\",queryConfig : {},\r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field: 'smstypename', header: '发送时机', formEditorConfig:{\r\n");
      out.write("\t\t\t\t   \t\tfieldVisible: false,\r\n");
      out.write("\t\t\t\t\t\tfillFromFieldName : 'emailtype',\r\n");
      out.write("\t\t\t\t\t\tfillProperty : 'name'\r\n");
      out.write("\t\t\t\t\t}},\r\n");
      out.write("\t\t\t\t   \t{field : 'smstype',header : '发送时机',visible: false,queryConfig : {},\r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\tdata :[{name : '延时',value:'DELAYED'},{name : '立即',value:'IMMEDIATELY'}]\r\n");
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field: 'smscontent', header: '短信内容', \r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig:{\r\n");
      ...
      out.write("\t\t\t\t\t    }\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("                    {field: 'sendtime', header: '实际发送时间',dateFormat : \"yyyy-MM-dd HH:mm:ss\", formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("                    {field: 'sendflagname', header: '发送状态', formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("                    {field: 'sendresult', header: '反馈消息', formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("                    {field: 'creator', header: '创建人', formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("                    {field: 'createdate', header: '创建时间',dateFormat : \"yyyy-MM-dd HH:mm:ss\", formEditorConfig:{fieldVisible: false}}\r\n");
      out.write("\t\t\t\t]\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
