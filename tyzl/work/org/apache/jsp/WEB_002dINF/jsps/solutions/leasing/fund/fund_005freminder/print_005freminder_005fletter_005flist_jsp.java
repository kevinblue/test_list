 ...
 * Generated at: 2017-05-24 07:32:01 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.fund.fund_005freminder;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class print_005freminder_005fletter_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t /* if(0 == row[0].status){\r\n");
      out.write("\t\t\t\t    \t\tmini.alert(\"催款函状态为已打印,不允许取消生成！\");\r\n");
      out.write("\t\t\t\t    \t\treturn;\r\n");
      out.write("\t\t\t\t    \t} */\r\n");
      out.write("\t\t\t\t\t\tmini.confirm(\"确定取消生成？\",\"提示：\",function(data){if(\"ok\" == data){backGenerated();}});\r\n");
      out.write("\t\t\t\t\t   }else{\r\n");
      ...
      out.write("\t\t\t\t\t    \tif(0 == row.status){\r\n");
      out.write("\t\t\t\t\t    \t\tmini.alert(\"催款函状态为已打印,不允许重复打印！\");\r\n");
      out.write("\t\t\t\t\t    \t\treturn;\r\n");
      out.write("\t\t\t\t\t    \t}\r\n");
      out.write("\t\t\t\t\t    \tattachmentParams=\"contract_id=\"+row.contract_id;\r\n");
      out.write("\t\t\t\t\t    \tshowEbankInfo(row);\r\n");
      out.write("\t\t\t\t\t    \t\r\n");
      out.write("\t\t\t\t\t\t /*   var fileTeplate=new fileTemplateConfig({\r\n");
      out.write("\t\t\t\t\t\t\t\ttemplateno:'F-201412005',\r\n");
      out.write("\t\t\t\t\t\t\t\ttableid:'table_id1',\r\n");
      out.write("\t\t\t\t\t\t\t\tmodelname:'租金催收通知函',\r\n");
      out.write("\t\t\t\t\t\t\t\treturntype:'file',\r\n");
      out.write("\t\t\t\t\t\t\t\tparames:mini.encode({\"id\":row.id})\r\n");
      out.write("\t\t\t\t\t\t    });\r\n");
      out.write("\t\t\t\t\t\t    fileTeplate.createFile();\r\n");
      out.write("\t\t\t\t\t\t\tprintgeneratedData();*/\r\n");
      out.write("\t\t\t\t\t    }else{\r\n");
      out.write("\t\t\t\t\t    \tmini.alert(\"请至少选中一行！\");\r\n");
      out.write("\t\t\t\t\t    }\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}],\r\n");
      out.write("\t\t\txmlFileName:'/eleasing/jsp/fund/fund_reminder/print_reminder_letter_list.xml',\r\n");
      out.write("\t\t\tafterClickClearBtnCallBack: function(miniTable,queryAreaParams){\r\n");
      out.write("\t\t\t\tmini.get(\"table_id1_queryArea_status\").setText(\"已申请\");\r\n");
      out.write("\t\t\t\t$(\"input[name='table_id1_queryArea_status']\").val(\"1\");\r\n");
      out.write("\t\t\t\treturn true;\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tparams:{},\r\n");
      out.write("\t\t\tcolumns:[ \r\n");
      ...
      out.write("\t\t\t\t{field:'contract_id',header:'合同号',headerAlign:'center',width:100,allowSort:true,\r\n");
      ...
      out.write("\t\t\t\t\t          width:200}},\r\n");
      out.write("\t\t\t    {field:'rawValue_partdept',header:'催款员',headerAlign:'center',\r\n");
      out.write("\t\t\t\t        queryConfig:{\r\n");
      out.write("\t\t\t\t\t          width:200,colspan:3}},\r\n");
      out.write("\t\t\t    {field:'custname',header:'客户名',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t        queryConfig:{\r\n");
      out.write("\t\t\t\t\t        newLine:true,\r\n");
      out.write("\t\t\t\t\t          width:200}},\r\n");
      out.write("\t\t\t    {field:'phone',header:'电话',headerAlign:'center',width:100},\r\n");
      out.write("\t\t\t    {field:'address',header:'地址',headerAlign:'center',width:100},\r\n");
      out.write("\t\t\t    {field:'guaranteecustname',header:'担保人',headerAlign:'center',width:100,\r\n");
      out.write("\t\t\t\t         queryConfig:{\r\n");
      out.write("\t\t\t\t\t           width:200}},\r\n");
      out.write("\t\t\t    {field:'startdate',header:'起租日',headerAlign:'center',width:100,allowSort:true},\r\n");
      out.write("\t\t\t    {field:'overduenum',header:'逾期期数',headerAlign:'center',width:100,allowSort:true},\r\n");
      out.write("\t\t\t    {field:'overduerent',header:'逾期租金',headerAlign:'center',width:100,allowSort:true},\r\n");
      out.write("\t\t\t    {field:'penalty',header:'逾期罚息',headerAlign:'center',width:100,allowSort:true},\r\n");
      out.write("\t\t\t    {field:'',header:'合计欠款',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t            renderer:function(e){\r\n");
      out.write("\t\t\t\t\t\t\t\t var incrent = e.record.overduerent;\r\n");
      out.write("\t\t\t\t\t\t\t\t var penalty = e.record.penalty;\r\n");
      out.write("\t\t\t\t\t\t\t\t return parseFloat(incrent) + parseFloat(penalty);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}/* ,{field:'status',header:'状态',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t            renderer:function(e){\r\n");
      out.write("\t\t\t\t\t\t\t\t var status = e.record.status;\r\n");
      out.write("\t\t\t\t\t\t\t\t return status==\"1\"?\"已申请\":\"已打印\";\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tqueryConfig:{\r\n");
      out.write("\t\t\t           width:200,\r\n");
      ...
      out.write("\t\t\t\t\t   value:'1',\r\n");
      out.write("\t\t\t\t\t   text:'已申请',\r\n");
      out.write("\t\t   \t\t\t   data:[{text:'已打印',value:'0'},{text:'已申请',value:'1'},{text:'全部',value:''}]\r\n");
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t} */]\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<div id=\"return_fund_time\" class=\"mini-window\" title=\"选择还款日期\" style=\"width:300px;height:200px;\" showModal=\"true\" allowResize=\"true\" allowDrag=\"true\">\r\n");
      out.write("\t<div id=\"return_fund_time\" style=\"width:100%;text-align: center;margin-top: 20px;\">\r\n");
      out.write("\t\t<input id=\"return_fund_time.date\" name=\"return_fund_time.date\" class=\"mini-datepicker\" \r\n");
      out.write("\t\t\tallowInput=\"false\" required=\"true\" label=\"还款时间\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${requestScope['return_fund_time.changedate']}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\"/></br>\r\n");
      out.write("\t\t\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t<div id=\"return_fund_time\" style=\"width:100%;text-align: center;margin-top: 50px;\">\r\n");
      out.write("\t\t<a class=\"mini-button\" text-align: center onclick=\"print()\" style=\"width:80px\">确定</a>&nbsp;&nbsp;\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("</div>\r\n");
      ...
      out.write("</html>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tfunction backGenerated(e){\r\n");
      out.write("\t\tvar table_id1 = mini.get(\"table_id1\");\r\n");
      out.write("\t\tvar rows = table_id1.getSelecteds();\r\n");
      out.write("\t\tvar noticeids = \"\";\r\n");
      out.write("\t\tfor(var i=0;i<rows.length;i++){\r\n");
      out.write("\t\t\tnoticeids+=rows[i].id+\",\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t        url: getRootPath()+\"/acl/removeGeneratedReminderLetter.acl\",\r\n");
      out.write("\t        type: \"post\",\r\n");
      out.write("\t        cache: false, \r\n");
      out.write("\t        data:{\"noticeids\":noticeids},\r\n");
      out.write("\t        async:false,\r\n");
      out.write("\t        success: function (text) {\r\n");
      out.write("\t        \tmini.alert(\"取消成功！\");\r\n");
      out.write("\t        }\r\n");
      out.write("\t    });\r\n");
      out.write("\t\tmini.get(\"table_id1\").load();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction printgeneratedData(e){\r\n");
      out.write("\t\tvar table_id1 = mini.get(\"table_id1\");\r\n");
      out.write("\t\tvar row = table_id1.getSelected();\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t        url: getRootPath()+\"/acl/updateGeneratedReminderLetter.acl\",\r\n");
      out.write("\t        type: \"post\",\r\n");
      out.write("\t        cache: false, \r\n");
      out.write("\t        data:{\"id\":row.id,\"status\":1},\r\n");
      out.write("\t        async:false,\r\n");
      out.write("\t        success: function (text) {\r\n");
      out.write("\t        \tmini.alert(\"打印成功！\");\r\n");
      out.write("\t        }\r\n");
      out.write("\t    });\r\n");
      out.write("\t\tmini.get(\"table_id1\").load();\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t{\r\n");
      out.write("\t\tvar editWindow = mini.get(\"return_fund_time\");\r\n");
      ...
      out.write("\t{\r\n");
      out.write("\t\tvar editWindow = mini.get(\"return_fund_time\");\r\n");
      out.write("\t\t// mini.alert(attachmentParams+\">>>>>>>\"+mini.get(\"return_fund_time.date\").getText());\r\n");
      out.write("\t\tvar id=attachmentParams.split('=')[1];\r\n");
      out.write("\t\tvar date=mini.get(\"return_fund_time.date\").getText();\r\n");
      out.write("\t\tvar parames={};\r\n");
      out.write("\t\tparames['id']=id;  \r\n");
      out.write("\t\tparames['enddate']=date;  //这个值是你弹出框选中的值\r\n");
      out.write("\t\tparames['date_enddate']=date.substring(0,4)+\"年\"+date.substring(5,7)+\"月\"+date.substring(8)+\"日\";\r\n");
      out.write("\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(date==\"\"){\r\n");
      out.write("\t\t\tmini.alert(\"请选择日期\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\teditWindow.hide();\r\n");
      out.write("\t\t    var fileTeplate=new fileTemplateConfig({\r\n");
      out.write("\t\t\ttemplateno:'F-201701005',\r\n");
      out.write("\t\t\ttableid:'table_id1',\r\n");
      out.write("\t\t\tmodelname:'租金催收通知函',\r\n");
      out.write("\t\t\treturntype:'file',\r\n");
      out.write("\t\t\tparames:parames\r\n");
      out.write("\t\t\t//parames:mini.encode({\"id\":id},{\"date\":date})\r\n");
      out.write("\t    });\r\n");
      out.write("\t    fileTeplate.createFile();\r\n");
      out.write("\t\tprintgeneratedData();\r\n");
      out.write("\t\t}\r\n");
