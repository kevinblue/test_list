 ...
 * Generated at: 2017-06-01 06:23:06 UTC
...
public final class vat_005finvoice_005frecord_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tid: 'vat_invoice_info',\r\n");
      out.write("\t\trenderTo: 'id_table_container_vat_invoice_info',\r\n");
      out.write("\t\twidth: '100%',\r\n");
      out.write("\t\theight: '100%',\r\n");
      out.write("\t\tlazyLoad: false,\r\n");
      out.write("\t\tentityClassName : 'com.tenwa.leasing.entity.invoice.VatInvoiceInfo',\r\n");
      out.write("\t\ttitle: \"进项发票登记\",\r\n");
      ...
      out.write("\t\tparams:{invoicestatusname:\"0','3\"},\r\n");
      ...
      out.write("\t\t\t\tvar contractnum = checkedRowDatas[i].contractnum;\r\n");
      out.write("\t\t\t\tvar sumamt = checkedRowDatas[i].sumamt;\r\n");
      out.write("\t\t\t\tvar invoiceStatus = checkedRowDatas[i].invoicestatusname;\r\n");
      out.write("\t\t\t\tif(invoiceStatus != '未提交' && invoiceStatus!='已退回'){\r\n");
      out.write("\t\t\t\t\tmini.alert(\"请选择未提交或已退回的数据\");\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(parseInt(contractnum) > 0 || parseFloat(sumamt) > 0){\r\n");
      out.write("\t\t\t\t\tmini.alert(\"发票已关联到相关合同，删除之前请点击修改，删除发票下关联合同\");\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\treturn true;\r\n");
      ...
      out.write("\t\t\t\tvar url = getRootPath()+\"/leasing/invoice_manage/vat_invoice/vat_invoice_record_detail.bi?invoiceId=0&buttonFlag=\"+buttonFlag;\r\n");
      ...
      out.write("\t\t\t\thandler : function(miniTable, buttonText) {\r\n");
      out.write("\t\t\t\t\tvar checkedRowDatas = miniTable.getSelecteds();\r\n");
      out.write("\t\t\t\t\tif(checkedRowDatas.length>1 ){\r\n");
      out.write("\t\t\t\t\t\tmini.alert(\"只能选择单条数据进行修改操作！\");\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tvar invoiceStatus = checkedRowDatas[0].invoicestatusname;\r\n");
      out.write("\t\t\t\t\tif(invoiceStatus != '未提交' && invoiceStatus!='已退回'){\r\n");
      out.write("\t\t\t\t\t\tmini.alert(\"请选择未提交或已退回的数据\");\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t};\r\n");
      out.write("\t\t\t\t\tvar buttonFlag = 'edit';\r\n");
      out.write("\t\t\t\t\tvar row = miniTable.getSelected();\r\n");
      out.write("\t\t\t\t\tvar invoiceId = row.id;\r\n");
      out.write("\t\t\t\t\tvar url = getRootPath()+\"/leasing/invoice_manage/vat_invoice/vat_invoice_record_detail.bi?invoiceId=\"+invoiceId+\"&buttonFlag=\"+buttonFlag;\r\n");
      out.write("\t\t\t\t\tvar sheight = window.screen.availHeight - 30;\r\n");
      out.write("\t\t\t\t\tvar swidth = window.screen.availWidth - 10;\r\n");
      out.write("\t\t\t\t\tvar winoption = \"left=0px,top=0px,height=\" + sheight + \"px,width=\" + swidth + \"px,toolbar=yes,menubar=yes,location=yes,status=yes,scrollbars=yes,resizable=yes\";\r\n");
      out.write("\t\t\t\t\twindow.open(url, '_blank', winoption);\r\n");
      ...
      out.write("\t\t\t\tvar operAction = \"submitVatInvoice\";\r\n");
      ...
      out.write("\t\t\t\t\tvar invoiceStatus = checkedRowdata.invoicestatusname;\r\n");
      out.write("\t\t\t\t\tif(invoiceStatus != '未提交' && invoiceStatus!='已退回'){\r\n");
      out.write("\t\t\t\t\t\tmini.alert(\"请选择未提交或已退回的数据\");\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t};\r\n");
      out.write("\t\t\t\t\tif(checkedRowdata.contractinfo == ''||checkedRowdata.contractinfo==null){\r\n");
      out.write("\t\t\t\t\t\tmini.alert(\"发票号\"+checkedRowdata.invoiceno+\"未关联合同,请检查数据后在操作\");\r\n");
      out.write("\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\tmini.confirm(\"确定\"+operType+\"当前条记录么？\",\"提交\",\r\n");
      out.write("\t\t\t\t\tfunction(action){\r\n");
      out.write("\t\t\t\t\t\tif(\"ok\" == action){\r\n");
      ...
      out.write(" \t\t\t{field: 'invoiceno', header: '发票号',queryConfig : {},formEditorConfig : {required: true,width:180}},\r\n");
      out.write("\t\t\t{field: 'invoicemoney', header: '发票金额',align: 'right',dataType:'currency',queryConfig : {},\r\n");
      out.write("\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\trequired: true,\r\n");
      out.write("\t\t\t\twidth:180,\r\n");
      out.write("\t\t\t\tvtype: 'float'\r\n");
      out.write("\t\t\t}},\r\n");
      out.write("\t\t\t{field: 'sumamt',header: '已登记合同金额',align: 'right',dataType:'currency',formEditorConfig : {fieldVisible :false}},\r\n");
      out.write("\t\t\t{field: 'contractinfo',header: '发票信息',formEditorConfig : {fieldVisible :false}},\r\n");
      out.write("\t\t\t{field: 'contractno',header: '合同号',visible :false,queryConfig:{fieldVisible:true}},\r\n");
      out.write("\t\t\t{field: 'purchasenits', header: '购货单位',queryConfig:{newLine:true},formEditorConfig : {newLine: true}},\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t{field: 'suppliername', header: '供货商',queryConfig:{},formEditorConfig : {fieldVisible: false}},\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}},\r\n");
      out.write("\t\t\t{field: 'goodsname', header: '货物名称', queryConfig : {},formEditorConfig : {newLine:true,width:200}},\r\n");
      out.write("\t\t\t{field: 'recorddate', header: '登记日期',type:\"date\",format:\"yyyy-MM-dd\",queryConfig : {\r\n");
      out.write("\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\ttype: 'date',\r\n");
      ...
      out.write("\t\t\t}},\r\n");
      out.write("\r\n");
      out.write("\t\t\t{field: 'invoicestatusname', header: '发票状态',formEditorConfig : {fieldVisible :false,newLine : true},\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t{field: 'creatorname', header: '登记人',formEditorConfig:{fieldVisible :false}},\r\n");
      ...
      out.write("\tmini.get('vat_invoice_info').reload();\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\t\r\n");
      out.write("<body>\r\n");
      out.write("<div id=\"id_table_container_vat_invoice_info\" style=\"height: 100%;\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
      out.write("\r\n");
