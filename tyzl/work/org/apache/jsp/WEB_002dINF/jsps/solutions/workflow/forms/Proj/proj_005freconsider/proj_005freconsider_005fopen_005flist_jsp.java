 ...
 * Generated at: 2017-06-14 01:11:15 UTC
...
public final class proj_005freconsider_005fopen_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\txmlFileName : '/eleasing/workflow/proj/proj_reconsider/proj_reconsider_info_list.xml',\r\n");
      out.write("\t\t\t\ttools : [\r\n");
      out.write("\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\thtml : '项目复议',\r\n");
      ...
      out.write("\t\t\t\t\t\t\tif(row.id){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar attachmentParams = \"proj_id=\"+row.id;\r\n");
      out.write("\t\t\t\t        \t\tstartProcess(\"项目复议流程-1\",attachmentParams); \r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\tmini.alert('请你选择需要发起复议流程的项目！！！');\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}         \r\n");
      out.write("\t\t\t\t],\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t{field : 'projectname',header : '项目名称',queryConfig : {}},\r\n");
      out.write("\t\t\t\t\t\t   \t{field : 'custname',header : '承租人',queryConfig : {}},\r\n");
      out.write("\t\t\t\t\t\t   \t{field : 'dept',header : '出单部门'},\r\n");
      out.write("\t\t\t\t\t\t   \t{field : 'projsource',header : '内部行业'},\r\n");
      out.write("\t\t\t\t\t\t   \t{field : 'projmanager',header : '项目经理',queryConfig : {newLine: true}},\r\n");
      out.write("\t\t\t\t\t\t   \t{field : 'projdate',header : '立项时间',queryConfig : {type : 'date',range : true,format : 'yyyy-MM-dd'}},\r\n");
