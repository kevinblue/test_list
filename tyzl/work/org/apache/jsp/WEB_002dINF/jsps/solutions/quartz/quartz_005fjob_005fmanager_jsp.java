 ...
 * Generated at: 2017-03-02 08:51:47 UTC
...
public final class quartz_005fjob_005fmanager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tid:'id_jobsTable',\r\n");
      out.write("\t\t\ttitle:'调度任务',\r\n");
      out.write("\t\t\trenderTo:\"id_jobContainer\",\r\n");
      ...
      out.write("\t\t\t   {header:'任务描述',field:'description'},\r\n");
      out.write("\t\t\t   {header:'任务CLASS',field:'job_class_name'}],\r\n");
      out.write("\t\t\ttools:[{\r\n");
      out.write("\t\t\t\thtml:'新增',\r\n");
      ...
      out.write("\t\t\t\t\t\tmodifyJob(rowData);\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\tmini.alert(\"请先选择数据\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},{\r\n");
      out.write("\t\t\t\thtml:'删除',\r\n");
      out.write("\t\t\t\ticonCls:'icon-remove',\r\n");
      out.write("\t\t\t\tplain : false,//按钮是否有立体感\r\n");
      out.write("\t\t\t\thandler:function(miniTable, buttonText){\r\n");
      out.write("\t\t\t\t\tvar selectedRowDatas = miniTable.getSelecteds();//多选的数据，推荐使用，无选择时返回空数组对象[]\r\n");
      out.write("\t\t\t\t\tif(selectedRowDatas.length > 0){\r\n");
      out.write("\t\t\t\t\t\tvar rowData = selectedRowDatas[0];\r\n");
      out.write("\t\t\t\t\t\tremoveJob(rowData);\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\tmini.alert(\"请先选择数据\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t\t\tid:'combo_quartzJob',\r\n");
      out.write("\t\t\trenderTo:'id_quartzJobContainer',\r\n");
      out.write("\t\t\tloadModel:'ajax',\r\n");
      out.write("\t\t\tlazyLoad:true,\r\n");
      out.write("\t\t\tdropListHeight:200,\r\n");
      out.write("\t\t\twidth:197,\r\n");
      out.write("\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/quartz/getQuartzJobs.action',\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\tfunction resetJob(resetValue) {\r\n");
      out.write("\t\tvar comboQuartzJob = getTracywindyObject(\"combo_quartzJob\");\r\n");
      out.write("\t\tcomboQuartzJob.value = resetValue;\r\n");
      out.write("\t\tcomboQuartzJob.reload();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction addJob() {\r\n");
      out.write("\t\tmini.get(\"id_jobName\").setValue(\"\");\r\n");
      out.write("\t\tmini.get(\"id_description\").setValue(\"\");\r\n");
      out.write("\t\tresetJob(\"\");\r\n");
      out.write("\t\tmini.get(\"id_quartzJobDetailInfoForm\").show();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction modifyJob(rowData) {\r\n");
      out.write("\t\tmini.get(\"id_jobName\").setValue(rowData['job_name']);\r\n");
      out.write("\t\tmini.get(\"id_description\").setValue(rowData['description']);\r\n");
      out.write("\t\t//var comboQuartzJob = getTracywindyObject(\"combo_quartzJob\");\r\n");
      out.write("\t\tresetJob(rowData['job_class_name']);\r\n");
      out.write("\t\t//comboQuartzJob.setValue(rowData['job_class_name']);\r\n");
      out.write("\t\t//mini.get(\"#id_jobClassName\").setValue(rowData['job_class_name']); \r\n");
      out.write(" \t\tmini.get(\"id_quartzJobDetailInfoForm\").show();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction doQuartzJobOperationClose() {\r\n");
      out.write("\t\tmini.get(\"id_quartzJobDetailInfoForm\").hide();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction doQuartzJobOperation() {\r\n");
      out.write("\t\tvar jobName = mini.get(\"id_jobName\").getValue();\r\n");
      out.write("\t\tvar description = mini.get(\"id_description\").getValue();\r\n");
      out.write("\t\t//var jobClassName = mini.get(\"id_jobClassName\").getValue();\r\n");
      out.write("\t\tvar comboQuartzJob = getTracywindyObject(\"combo_quartzJob\");\r\n");
      out.write("\t\tjobClassName =  comboQuartzJob.getValue();\r\n");
      out.write("\t\t//if(!jobName){mini.alert(\"任务名称不能为空\");return;}\r\n");
      out.write("\t\tif(!description){mini.alert(\"任务描述不能为空\");return;}\r\n");
      out.write("\t\tif(!jobClassName){mini.alert(\"任务执行CLASS不能为空\");return;}\r\n");
      out.write("\r\n");
      out.write("\t\tvar params = {};\r\n");
      out.write("\t\tparams['jobName'] = jobName;\r\n");
      out.write("\t\tparams['description'] = description;\r\n");
      out.write("\t\tparams['jobClassName'] = jobClassName;\r\n");
      out.write("\r\n");
      out.write("\t\tmini.mask({\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction removeJob(rowDate) {\r\n");
      out.write("\t\tmini.mask({\r\n");
      out.write("            el: document.body,\r\n");
      out.write("            cls: 'mini-mask-loading',\r\n");
      out.write("            html: '操作进行中，请稍等...'\r\n");
      ...
      out.write("\t\t\turl:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/quartz/removeJob.action',\r\n");
      out.write("\t\t\tmethod:'POST',\r\n");
      out.write("\t\t\tsuccess:function(res){\r\n");
      out.write("\t\t\t\tmini.unmask(document.body);\r\n");
      out.write("\t\t\t\tmini.alert(\"操作成功\",'提示',function(){\r\n");
      ...
      out.write("\t\t\t\tmini.alert(\"操作失败\");\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tparams:rowDate\r\n");
      out.write("  \t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<div id=\"id_jobContainer\"></div>\r\n");
      out.write("\t\r\n");
      out.write("\t<div id=\"id_quartzJobDetailInfoForm\" title=\"调度任务\" class=\"mini-window\" style=\"display:none;width:350px;height:180px;\">\r\n");
      out.write("\t\t<input type=\"text\" id=\"id_jobName\" class=\"mini-hidden\"/>\r\n");
      out.write("\t\t<table align=\"center\" style=\"width:100%\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td style=\"width: 75px;\">任务CLASS:</td>\r\n");
      out.write("\t\t\t\t<td style=\"width: 205px;\"><div id=\"id_quartzJobContainer\"></div></td>\r\n");
      out.write("\t\t\t\t<td style=\"width: 70px;\"><span class=\"content-required\">*</span></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>任务描述:</td>\r\n");
      out.write("\t\t\t\t<td><textarea id=\"id_description\" class=\"mini-textarea\" style=\"width: 200px;\"></textarea></td>\r\n");
      out.write("\t\t\t\t<td><span class=\"content-required\">*</span></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"content-separator\">\r\n");
      out.write("\t\t\t\t<td colspan=\"3\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<a class=\"mini-button\" onclick='doQuartzJobOperation'><span>确定</span></a>\r\n");
      out.write("\t\t\t\t\t<a class=\"mini-button\" onclick='doQuartzJobOperationClose'><span>取消</span></a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
