 ...
 * Generated at: 2017-05-24 07:29:04 UTC
...
public final class rent_005fpayment_005fnotice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\txmlFileName : '/eleasing/workflow/rent/rent_payment_notice.xml',\r\n");
      out.write("\t\t\t\ttools : [{\r\n");
      out.write("\t\t\t\t\thtml : '导出租金支付通知书',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t }else if(row.length==1){\r\n");
      out.write("\t\t\t\t\t\t\t var rows=miniTable.getSelected();\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t/*params['label.custname'] = mini.get(\"cust_name\").getValue();\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['label.invoicecode'] = rows.invoicecode;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['label.factoringtype'] =mini.get(\"factoringtype\").getText();\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['label.contractnumber'] =mini.get(\"contract_number\").getValue();\r\n");
      out.write("\t\t\t\t\t\t\t\t*/\r\n");
      out.write("\t\t\t\t\t\t\t\tvar transferdate =rows.plan_date;\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar startdate =rows.start_date;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['date.iyear']=startdate.substring(0,4);//3.年\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['date.imonth']=startdate.substring(5,7);//4.月\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['date.iday']=startdate.substring(8);//5.日\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar nowdate=new Date().format(\"yyyy-mm-dd\"); \r\n");
      out.write("\t\t\t\t\t\t\t\tparams['date.tyear']=nowdate.substring(0,4);//3.年\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['date.tmonth']=parseInt((new Date).getMonth().toString()) + 1;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['date.tday']=nowdate.substring(8);//5.日\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['lebal.custname'] = rows.cust_name;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['lebal.number'] = rows.contract_number;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['lebal.rentlist'] = rows.rent_list;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['lebal.rent'] = rows.rent;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams['lebal.plandate'] = rows.plan_date;\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar fileTeplate=new fileTemplateConfig({\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttemplateno : 'F-201701006',\r\n");
      ...
      out.write("\t\t\t\t   \t{field : 'contractnumber',header : '业务合同号',queryConfig : {},width: 200,renderer:function(e){\r\n");
      out.write("\t\t\t\t\t\treturn \"<a href='javascript:void(0);' onclick='showContractDetail(\\\"\"+e.record.id+\"\\\")'>\" + e.record.contract_number + \"</a>\";\r\n");
      out.write("\t\t\t\t\t}},\r\n");
      out.write("\t\t\t\t   \t{field : 'cust_name',header : '客户名称',width: 130,queryConfig : {}},\r\n");
      out.write("\t\t\t\t   \t{field : 'rent_list',header : '期次',width: 70,align:'center'},\r\n");
      out.write("\t\t\t\t\t{field : 'start_date',header : '合同开始日期',width: 80,visible:false},\r\n");
      out.write("\t\t\t\t   \t{field : 'plan_date',header : '计划日期',width: 80,queryConfig:{type:'date',range:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'rent',header : '计划金额',width: 80,dataType: 'currency',summary:true},\r\n");
      out.write("\t\t\t\t   \t{field : 'proj_manage',header : '项目经理',width: 80,align:'center',queryConfig : {newLine: true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'proj_dept',header : '组别',width: 100,queryConfig:{}},\r\n");
      out.write("\t\t\t\t   \t{field : 'company_address',header : '经营地址',width: 160},\r\n");
      out.write("\t\t\t\t   \t{field : 'main_person',header : '主联系人',width: 100},\r\n");
      out.write("\t\t\t\t   \t{field : 'mobile_number',header : '手机号',width: 140},\r\n");
      out.write("\t\t\t\t   \t{field : 'export_state',header : '导出状态',width: 80,queryConfig:{\r\n");
      out.write("\t\t\t\t   \t\ttype:'combobox',\r\n");
      out.write("\t\t\t\t   \t\tshowNullItem: true,\r\n");
      out.write("\t\t\t\t   \t\tdata: '[{name:\"已导出\",value:\" RPNR.ID IS NOT NULL\"},{name:\"未导出\",value:\" RPNR.ID IS NULL\"}]',\r\n");
      out.write("\t\t\t\t   \t\ttextField:\"name\",\r\n");
      out.write("\t\t\t\t   \t\tvalueField:\"value\"\r\n");
      out.write("\t\t\t\t   \t}},\r\n");
      out.write("\t\t\t\t   \t{field : 'export_times',header : '导出次数',width: 80}\r\n");
      out.write("\t\t\t\t]\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
