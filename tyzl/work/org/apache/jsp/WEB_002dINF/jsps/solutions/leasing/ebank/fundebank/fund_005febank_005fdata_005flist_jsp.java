 ...
 * Generated at: 2017-06-01 06:23:10 UTC
...
public final class fund_005febank_005fdata_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\t //是否废弃\r\n");
      out.write("\t var localEnabled = [ {id:'',text:''},{id : '否',text : '否'}, {id : '是',text : '是'}];\r\n");
      out.write("\t var localMayMoney = [ {id:'',text:'全部'},{id : ' and e.fact_money-e.no_with_money-nvl(cf.fundmoney,0)- nvl(cr.rent,0)-nvl(pro.process_amount,0)>0',text : '大于零'}, {id : ' and  e.fact_money-e.no_with_money-nvl(cf.fundmoney,0)- nvl(cr.rent,0)-nvl(pro.process_amount,0)=0',text : '等于零'}];\r\n");
      ...
      out.write("\t\t\t\timportOrExPortCallBack:'checkFundEbankInfoImport',\r\n");
      ...
      out.write("\t\t\t\t    var invalid=getMiniEditFormField(\"table_id_index.invalid\").getText();\r\n");
      out.write("\t\t\t\t\tvar hadmoney=getMiniEditFormField(\"table_id_index.hadmoney\").getValue();\r\n");
      out.write("\t\t\t\t\tvar factmoney= getMiniEditFormField(\"table_id_index.factmoney\").getValue();\r\n");
      out.write("\t\t\t\t\tvar nowithmoney=getMiniEditFormField(\"table_id_index.nowithmoney\").getValue();\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\thadmoney=parseFloat(hadmoney).toFixed(2);\r\n");
      out.write("\t\t\t\t\tfactmoney=parseFloat(factmoney).toFixed(2);\r\n");
      out.write("\t\t\t\t\tnowithmoney=parseFloat(nowithmoney).toFixed(2);\r\n");
      out.write("\t\t\t\t\tvar sum=parseFloat(hadmoney)+parseFloat(nowithmoney);\r\n");
      out.write("\t\t\t\t\tsum=sum.toFixed(2);\r\n");
      out.write("\t\t\t\t\tif(parseFloat(hadmoney)>0){\r\n");
      out.write("                       if(invalid==\"是\"){mini.alert(\"已核销过的网银不能废弃\");return false;}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tif(parseFloat(sum)>parseFloat(factmoney)){mini.alert(\"非业务金额大于可核销金额\");return false;};\r\n");
      out.write("\t\t\t\t\treturn true;\r\n");
      out.write("\t\t\t    },\r\n");
      out.write("\t\t\t    params:{invalid:'否'},\r\n");
      out.write("\t\t\t\tcolumns:[ \r\n");
      out.write("\t\t\t\t    {type:'indexcolumn'},//有序列\r\n");
      out.write("\t\t\t\t   \t{type:'checkcolumn'},//单选行\r\n");
      out.write("\t\t\t\t   \t{field:'id',header:'id',visible:false},\r\n");
      out.write("\t\t\t\t   \t{field:'ebdataid',header:'网银编号',allowSort:true,\r\n");
      out.write("\t\t\t\t\t   \t           queryConfig:{\r\n");
      out.write("\t\t\t   \t                    lableWidth:100},\r\n");
      out.write("\t\t\t\t\t   \t      formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t   \t  readOnly:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t   \tlabelWidth:100}},\r\n");
      out.write("\t\t\t\t   \t{field:'sn',header:'流水号',allowSort:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t   queryConfig:{},\r\n");
      out.write("\t\t\t\t\t\t      formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\tlabelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t      readOnly:true}},\r\n");
      out.write("\t\t\t\t \t{field:'invalid',header:'是否废弃',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t           queryConfig:{ \r\n");
      out.write("\t\t\t   \t\t\t              readOnly:false,\r\n");
      out.write("\t\t\t   \t\t\t                  data:localEnabled,\r\n");
      ...
      out.write("\t\t\t\t   \t\t\t               type:'combobox',\r\n");
      out.write("\t\t\t\t   \t\t\t            colspan:3}},\r\n");
      out.write("\t\t\t\t   \t{field:'custidname',header:'承租人名称',visible:true,\r\n");
      out.write("\t\t\t\t   \t\t            queryConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t        newLine:true},\r\n");
      out.write("\t\t\t\t\t\t   \t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t       fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field:'custid',header:'承租人名称',allowSort:true,visible:false,\r\n");
      out.write("\t\t\t\t   \t\t               renderer:function(e){return e.record.custname;},\r\n");
      out.write("\t\t\t\t   \t\t       formEditorConfig:{\r\n");
      out.write("\t\t\t\t   \t\t\t            newLine:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t              width:300,\r\n");
      out.write("\t\t\t\t\t\t\t            colspan:3,\r\n");
      out.write("\t\t\t\t\t\t\t             params:{xmlFileName:'common/custInfo.xml',custtype:'cust_type.cust'}}},\r\n");
      out.write("\t\t\t\t   \t{field:'clientname',header:'付款人',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tqueryConfig:{},\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcolspan:3,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    newLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t\t{field:'factmoney',header:'到账金额',summary:true,dataType:\"currency\",headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tqueryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   type:\"double\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  range:true},\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  vtype:'double',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t\t{field:'factdate',header:'到账时间',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t    queryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   type:'date',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  range:true},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t           readOnly:true}},   \r\n");
      out.write("\t\t\t\t\t{field:'nowithmoney',header:'非业务金额',summary:true,dataType:\"currency\",headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnewLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'hadmoney',header:'已核销金额',summary:true,dataType:\"currency\",headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'mayopemoney',header:'可核销金额',summary:true,dataType:\"currency\",headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t\t{field:'uploaddate',header:'上传时间',dateFormat:\"yyyy-MM-dd HH:mm:ss\",headerAlign:'center',\r\n");
      out.write("                                    queryConfig:{\r\n");
      out.write("\t\t                                   type:'date',\r\n");
      out.write("\t\t                                  range:true},\r\n");
      out.write("\t\t                       formEditorConfig:{\r\n");
      ...
      out.write("\t\t\t\t   \t{field:'ownbank',header:'本方银行',headerAlign:'center',\r\n");
      out.write("\t\t\t\t   \t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t   \t    newLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t   \t   readOnly:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'clientbank',header:'对方银行',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tqueryConfig:{},\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'ownaccount',header:'本方账户',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t\t{field:'clientaccnumber',header:'对方账号',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tqueryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    newLine:true},\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'ownaccnumber',header:'本方账号',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t           formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t        newLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t       readOnly:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'clientaccount',header:'对方账户',headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t    queryConfig:{},\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   readOnly:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'ismaymoney',header:'可核销金额',visible:false,headerAlign:'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t    queryConfig:{ \r\n");
      out.write("\t\t\t   \t\t\t              readOnly:false,\r\n");
      ...
      out.write("\t\t\t   \t\t\t                 value:' and e.fact_money-e.no_with_money-nvl(cf.fundmoney,0)- nvl(cr.rent,0)-nvl(pro.process_amount,0)>0',\r\n");
      out.write("\t\t\t   \t\t\t                  text:'大于零'}},\r\n");
      out.write("\t\t\t\t   \t{field:'summary',header:'备注',headerAlign:'center',\r\n");
      out.write("\t\t\t   \t\t\t\t  formEditorConfig:{\r\n");
      out.write("\t\t\t\t   \t\t               newLine:true,\r\n");
      out.write("\t\t\t\t   \t\t                 width:350,\r\n");
      out.write("\t\t\t\t   \t\t               colspan:3,\r\n");
      ...
      out.write("  ['edit','-','importExcel','-'\r\n");
      out.write("          ,{\r\n");
      out.write("\t\t\t\thtml:'网银模板下载',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\t\turl:window.globalWebRoot + '/acl/delEbankInfo.acl',\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("  ];\r\n");
      out.write(" function ShowIsdiuse(e)\r\n");
      out.write(" {\r\n");
      out.write("\tvar id_isdiuse=mini.getbyName(\"isdiuse\").getValue();\r\n");
      out.write("\tvar id_procmoney= mini.getbyName(\"procmoney\").getValue();  \r\n");
      out.write("\tif (id_isdiuse ==\"0\" && id_procmoney >0 )\r\n");
      out.write("\t{\r\n");
      out.write("\t\tmini.alert(\"网银正在使用中... 不允许废弃!\");\r\n");
      out.write("\t\tmini.getbyName(\"isdiuse\").setValue(\"1\");\r\n");
      out.write("\t}\r\n");
      out.write(" }\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
