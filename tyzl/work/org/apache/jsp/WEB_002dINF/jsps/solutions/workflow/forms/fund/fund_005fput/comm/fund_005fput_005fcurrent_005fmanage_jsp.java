...
public final class fund_005fput_005fcurrent_005fmanage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t{field: 'factdate', header: '投放日期',formEditorConfig:{newLine:true,required: true,type:'date',colspan:3}},\r\n");
      ...
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar allput=0;\r\n");
      out.write("\tfor(var i=0;i<chargeData.length;i++){\r\n");
      out.write("\t\tallput=parseFloat(allput)+parseFloat(chargeData[i].factmoney);\r\n");
      out.write("\t}\r\n");
      out.write("\tvar putcurequipamt=mini.get(\"putcurequipamt\").getValue();\r\n");
      out.write("\tif(parseFloat(putcurequipamt)!=parseFloat(allput)){\r\n");
      out.write("\t\tmini.alert(\"投放金额与投放明细总金额不相等，不能提交！！！\");\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      ...
      out.write("                if(payData[i].fundfundchargeplan==fundData[j].fundfundchargeplan&&(parseFloat(payData[i].factmoney)!=parseFloat(fundData[j].factmoney))){\r\n");
      ...
      out.write("\t if(payData.length>0){\r\n");
      out.write("\t\t for(var i=0;i<payData.length;i++){\r\n");
      out.write("\t\t\t pay=payData[i].factobject||\"\";\r\n");
      out.write("\t\t\t clientbankname=payData[i].clientbankname||\"\";\r\n");
      out.write("\t\t\t paytype=payData[i].settlemethodname||\"\";\r\n");
      out.write("\t\t\t if(paytype==\"货扣\"){\r\n");
      out.write("\t\t\t\t if(pay==\"\"){\r\n");
      out.write("\t\t\t\t\t message.push(\"设备款[\"+payData[i].factmoney+\"]支付对象没有填<br>\");\r\n");
      out.write("\t\t\t\t }\r\n");
      out.write("\t\t\t }else{\r\n");
      out.write("\t\t\t if(pay==\"\"||clientbankname==\"\"){\r\n");
      out.write("\t\t\t\t message.push(\"设备款[\"+payData[i].factmoney+\"]支付对象或对方银行没有填<br>\");\r\n");
      out.write("\t\t\t }}\r\n");
      out.write("\t\t }\r\n");
      ...
      out.write("\t             <td class=\"td-content-title\" width=\"25%\">支付对象：</td>\r\n");
      out.write("\t             <td class=\"td-content\">\r\n");
      out.write("                      <input id=\"id_select_person\" name=\"selectperson\" label=\"支付对象\" class=\"mini-buttonedit mini-queryinput\" allowInput=\"false\" required=\"true\"/>\r\n");
      out.write("\t\t\t\t\t <font class=\"required-tag\">*</font>\r\n");
      out.write("                 </td>\r\n");
      out.write("\t          </tr  >\r\n");
      out.write("\t          <tr class=\"tr-project-info tr-even\" style=\"height:40px\">\r\n");
      out.write("\t          <td class=\"td-content-title\" width=\"25%\">对方银行：</td>\r\n");
      ...
      out.write("\t          </tr >\r\n");
      out.write("\t          <tr class=\"tr-project-info tr-even\" style=\"height:40px\">\r\n");
      out.write("\t          <td class=\"td-content-title\" width=\"25%\">对方账户：</td>\r\n");
      ...
      out.write("\t          </tr>\r\n");
      out.write("\t          <tr  class=\"tr-project-info tr-even\" style=\"height:40px\">\r\n");
      out.write("\t          <td class=\"td-content-title\" width=\"25%\">对方账号：</td>\r\n");
      ...
      out.write("\t\t\tid:'id_select_person',\r\n");
      out.write("\t\t\tlabel:'选择付款对象',\r\n");
      out.write("\t\t\ttextField: 'name',\r\n");
      out.write("\t\t\tvalueField: 'name',\r\n");
      out.write("\t\t\twindowWidth: 600,\r\n");
      out.write("\t\t\tonSelect: function($me, inputObj, rowData){\r\n");
      out.write("\t\t\t    mini.get(\"id_select_account\").setValue(\"\");\r\n");
      out.write("\t\t\t    mini.get(\"id_select_accnumber\").setValue(\"\");\r\n");
      out.write("\t            var clientbank= mini.get(\"id_select_bank\")\r\n");
      out.write("\t            fact=rowData.name;\r\n");
      out.write("\t            if(fact==\"\"){alert(\"请选择付款对象\");return false;}\r\n");
      out.write("\t            var param={};\r\n");
      out.write("\t            param[\"custname\"]=fact;\r\n");
      out.write("\t            param[\"xmlFileName\"]=\"common/custbankInfo.xml\";\r\n");
      ...
      out.write("\t\t\t\t\t\t\tmini.get(\"id_select_account\").setValue(selected.clientaccount);\r\n");
      out.write("\t\t\t\t\t\t\tmini.get(\"id_select_accnumber\").setValue(selected.clientaccnumber);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t });\r\n");
      out.write("\t      \t      }});    \t\r\n");
      out.write("\t\t\t},\r\n");
      ...
      out.write("\t var payobj=mini.get(\"id_select_person\").getValue();\r\n");
      ...
      out.write("\t\t\t var cm={\"factobject\":payobj,\"factobjectname\":payobj,\"clientbank\":paybank,\"clientbankname\":paybank,\"clientaccount\":payaccount,\"clientaccnumber\":payaccnumber}\r\n");
      out.write("\t\t\t if(selectData[i].settlemethodname==\"货扣\"){\r\n");
      out.write("\t\t\t\t cm={\"factobject\":payobj,\"factobjectname\":payobj}\r\n");
      out.write("\t\t\t }\r\n");
      ...
      out.write("\tvar curTable=mini.get(\"put_current\")\r\n");
      out.write("\tvar payData=curTable.getData();\r\n");
      out.write("\tvar cm={\"factobject\":\"\",\"factobjectname\":\"\",\"clientbank\":\"\",\"clientbankname\":\"\",\"clientaccount\":\"\",\"clientaccnumber\":\"\"}\r\n");
      out.write("\tvar selectData=curTable.getSelecteds();\r\n");
      out.write("\tif(selectData.length>0){\r\n");
      out.write("\t\t for(var i=0;i<selectData.length;i++){\r\n");
      out.write("\t\t\t curTable.updateRow(selectData[i],cm);\r\n");
  ...
  private boolean _jspx_meth_mini_005fparam_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/fund/fund_put/comm/fund_put_current_manage.jsp(7,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_mini_005fparam_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/fund/fund_put/comm/fund_put_current_manage.jsp(298,5) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
