 ...
 */
@Entity
@FieldName(name = "合同会计现金流明细表(临时)")
@Table(name="CONTRACT_FINA_CASH_DETAIL_TEMP")
@JsonIgnoreProperties(ignoreUnknown=true,value = { "hibernateLazyInitializer" , "creator" ,"modificator"})
public class ContractFinaCashDetailTemp implements CashDetail, Comparable<CashDetail> {
