 ...
 * 
 * @author 孙传良
 * @date 2013-3-6下午09:41:36
 * @info 合同会计租金计划(临时)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "合同会计租金计划(临时)")
@Table(name="CONTRACT_FINA_RENT_PLAN_TEMP")
@JsonIgnoreProperties(ignoreUnknown=true,value = { "hibernateLazyInitializer" , "creator" ,"modificator"})
public class ContractFinaRentPlanTemp implements RentPlan,Comparable<RentPlan>{
