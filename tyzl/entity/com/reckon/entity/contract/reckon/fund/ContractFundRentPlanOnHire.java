 ...
 * 
 * @author 孙传良
 * @date 2013-3-7下午03:20:09
 * @info 合同租金计划(多次起租)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "合同租金计划(多次起租)")
@Table(name="CONTRACT_FUND_RENT_PLAN_ONHIRE")
public class ContractFundRentPlanOnHire implements RentPlan,Comparable<RentPlan> {
