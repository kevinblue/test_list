 ...
 * 
 * @author 孙传良
 * @date 2013-3-7下午03:27:05
 * @info 项目租金计划(临时)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "项目租金计划(临时)")
@Table(name="PROJ_FUND_RENT_PLAN_TEMP")
public class ProjFundRentPlanTemp implements RentPlan,Comparable<RentPlan> {
