...
jQuery(function() {
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			new ApTable({
				...
				importDataIndex:'2',
				importHeaderIndex:'1',
				addRemoteOperUrl:getRootPath()+"/acl/addTaxFundHcInfo.acl",
				remoteOper:true,
				id : 'table_id1',
				...
				showPager:true,
				xmlFileName : '/eleasing/jsp/invoice_manage/fund_invoice/invoiceHC/fund_invoice_hc.xml',
				tools : ['add'],
				...
				columns : [ 
				    {type : 'indexcolumn'},
				   	...
				   	{field : 'outno',header : '编号',formEditorConfig : {fieldVisible:false}},
				   	{field : 'contractid',header : '合同号',queryConfig : {},formEditorConfig : {fieldVisible:false}},
				   	{field : 'contractnumber',header : '业务合同号',formEditorConfig : {fieldVisible:false},queryConfig : {},renderer:function(e){
						return "<a href='javascript:void(0);' onclick='showContractDetail(\""+e.record.cid+"\")'>" + e.record.contractnumber + "</a>";
					}},
				   	{field : 'custname',header : '客户名称',allowSort:true,queryConfig : {},formEditorConfig : {fieldVisible:false}},
				   	...
				   	{field : 'money',header : '收款金额',dataType:"currency",align:'right',summary: true,formEditorConfig : {fieldVisible:false}},
				   	
				   	{field : 'invoiceno',header : '发票号',
				   		formEditorConfig : {
							type : 'combobox',//表单域类型
							required : true,//是否必填
							...
							//width : 125,//该域总宽度
							params : {
								xmlFileName : 'eleasing/jsp/invoice_manage/fund_invoice/invoiceHC/invoice_no_hc.xml'
							}
						}
				   	},
				   	{field : 'oldinvoiceno',header : '原始发票号',formEditorConfig : {fieldVisible:false}},
				   	...
				   	{field : 'taxregcode',header : '纳税人识别号',formEditorConfig : {fieldVisible:false}},
				   	...
				   	{field : 'taxregadd',header : '开票地址',formEditorConfig : {fieldVisible:false}},
				   	{field : 'hcstatus',header : '状态',formEditorConfig : {fieldVisible:false}},
				   	{field: 'leaseform', header:'租赁形式',formEditorConfig : {fieldVisible:false},
						queryConfig:{
							type:'combobox',
							params : {
								pid:'leas_form',
