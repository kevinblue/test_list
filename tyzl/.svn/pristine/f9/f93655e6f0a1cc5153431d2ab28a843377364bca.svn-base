 ...
 * 
 * @author 孙传良
 * @date 2013-3-6下午09:39:43
 * @info 项目会计租金计划(临时)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "项目会计租金计划(临时)")
@Table(name="PROJ_FINA_RENT_PLAN_TEMP")
public class ProjFinaRentPlanTemp implements RentPlan,Comparable<RentPlan> {
