...
jQuery(function() {
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			new ApTable({
				...
				xmlFileName : '/eleasing/jsp/invoice_manage/fund_invoice/invoicePlan/fund_invoice_plan_confirm.xml',
				tools : [
					{
						html : '退回',
						plain : true,
					...
					},'-',
					{
						...
						handler : function(miniTable, buttonText) {
							...
							var fileTeplate=new fileTemplateConfig({
		                         ...
		                         parames:{
		                        	importorexportcallback:'exportFundInvoiceBefore',
