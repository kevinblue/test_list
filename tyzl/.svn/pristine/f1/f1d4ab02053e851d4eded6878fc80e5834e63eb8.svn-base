 ...
 * 
 * @author 孙传良
 * @date 2013-3-7下午03:24:43
 * @info 合同多次起租租金计划(临时)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "合同多次起租租金计划(临时)")
@Table(name="C_FUND_RENT_PLAN_ONHIRE_TEMP")
public class ContractFundRentPlanOnHireTemp implements RentPlan,Comparable<RentPlan> {
