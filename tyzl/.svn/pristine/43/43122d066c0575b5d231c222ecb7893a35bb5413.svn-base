...
jQuery(function(){
	...
	tenwa.createTable({
		...
		params : {
		    contract_id:"<mini:param  name="contract_info.id" />",
...
<input type="hidden" id="isseparaterentlist" name="isseparaterentlist" value="<mini:param  name="isseparaterentlist" defaultValue="false"/>"/>
