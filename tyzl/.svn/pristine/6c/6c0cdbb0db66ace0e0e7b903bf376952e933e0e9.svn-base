...
<!-- 高级查询部分 -->
    <div>
    	<div class="mini-panel" title="集团客户" showCollapseButton="false" style="width: 100%;">
    ...
    <div class="mini-fit" id="_fit">      
        <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" 
            url="${urlPrefix}/eleasing/jsp/cust_info/cust_clique/cust_clique_list.xml"  idField="id"
    ...
    <script type="text/javascript">
        ...
        function opencustdetail(id,name){
        	var params = "id="+id;
      		var url = getRootPath()+"/leasing/cust_info/cust_clique/cust_clique_detail.bi?"+params;
        ...
        var button = new miniuiExtButtons({
    		url:'/leasing/cust_info/cust_clique/input_cust_clique_list.bi',
    		title : '集团客户信息', 
    		width :  800, 
    		height : globalClientHeight - 50,  
    	    datagridId : "datagrid1",
    	    renderTo : "miniuiextbuttons",
    	    constantFlagTable : "CustClique",
    	    tools :['新增', '修改', {
    	    	html : '废弃',//自定义按钮的名字
				plain : true,//按钮是否有立体感
