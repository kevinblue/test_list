...
@WorkflowAction(name = "contractRentModifyEndAction", description = "租金修改结束动作", workflowName = "租金计划修改")
@Component(value = "contractRentModifyEndAction")
public class ContractRentModifyEndAction implements JbpmBaseAction {
