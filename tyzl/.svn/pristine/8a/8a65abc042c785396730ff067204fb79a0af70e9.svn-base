 ...
 *
 * @author Ben Alex
 * @version $Id: ConcurrentSessionFilter.java 3813 2009-08-10 14:18:18Z ltaylor $
 */
            ...
            if (info != null) {
                if (info.isExpired()) {
                    ...
                    if (targetUrl != null) {
                    	...
                    	String returnInfo = "该账户已被他人使用，<a href=\"javascript:void(0);\" onclick=\"window.top.location.href='"+request.getContextPath()+"/login.jsp';\">点击重新登录</a>";
