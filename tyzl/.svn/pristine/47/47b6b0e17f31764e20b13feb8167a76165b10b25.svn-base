...
//		sql=sql+"  where jh.HTASK_='"+userid+"' and tu.end_time_ is null ";
		String sql="select id_ id from t_jbpm_workflow_info b where b.jbpm4_hist_procinst_dbid_ = '"+userid+"'  ";
