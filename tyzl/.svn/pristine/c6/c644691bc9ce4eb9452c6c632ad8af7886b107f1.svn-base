...
<script type="text/javascript">
	...
	jQuery(function(){
		var table= new tracywindyOperationTable({
            ...
            height:pageHeight+7,
            title:'<font id="id_titleDictData">目录数据</font><input type="text" style="margin-right:4px;border:1px solid #DDD;" id="id_queryDictDataTableInput" value="<mini:param name='queryDictDataText'/>" />',
            isRank:true,
            rankSize:30,
            id:'id_table',
            checkOnly:true,
...
<body>
	<div id='menu_main_content' style="float:left;width:325px;overflow:hidden;border:1px solid #DDD;border:0px;">
	   <div class="panel-title" style="margin-top:0px;border-top:0px;">数据字典管理<input type="text" style="margin-left: 4px; margin-top: 5px;border:1px solid #DDD;" id="id_queryWorkflowsTableInput" value="<mini:param name='queryText'/>" /></div>
