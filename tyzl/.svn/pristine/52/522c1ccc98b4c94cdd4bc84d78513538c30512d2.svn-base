         ...
         function resizeOper(window)
		 {
	       ...
	       function recursionTreeMenu(topMenuItemDiv,menuJson,menuButtonItemDiv,isInit,pageUrl)
			...
			function showModifyPasswordWindow(isForceUpdatePassword)
			{
		        ...
		        jQuery("#id_userName").val("<mini:param name='login_username'/>");
		        jQuery("#id_realName").val("<mini:param name='login_realname'/>");
		        jQuery("#id_telephone").val("<mini:param name='login_usertelephone'/>");
		        jQuery("#id_email").val("<mini:param name='login_useremail'/>");
