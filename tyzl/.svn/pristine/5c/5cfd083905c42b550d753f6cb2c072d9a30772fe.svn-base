		...
		columns: [
			...
			{field:'leasform', header:'租赁形式', visible:false,
				  formEditorConfig:{
			            ...
			            valueField:'value',
			          fieldVisible:true,
              	 params:{pid: 'proj_type', xmlFileName:'combos/comboDict.xml'}}
			 },
			...
			{field:'taxregtype', header:'纳税人类别', visible:false,
			 ...
			 {field:'rentratename', header:'租金税率', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'rentrate'}},
			{field:'rentrate', header:'租金税率', visible:false,
				  formEditorConfig:{
			               newLine:true,
			                  type:'combobox',
			              required:false,
			...
			{field:'rentinvoicetypename', header:'租金开票类型', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'rateinvoicetype'}},
			{field:'rentinvoicetype', header:'租金开票类型', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			              required:false,
			             textField:'name',
			...
			{field:'corpusinvoicetype', header:'本金开票类型', visible:false,
			 ...
			 {field:'interestratename', header:'利息税率', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'interestrate'}},
			{field:'interestrate', header:'利息税率', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			                  newLine:true,
			              required:false,
			...
			{field:'interestinvoicetypename', header:'利息开票类型', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'interestinvoicetype'}},
			{field:'interestinvoicetype', header:'利息开票类型', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			              required:false,
			             textField:'name',
			...
			{field:'insurancelessorinvoicetype', header:'保险费开票类型', visible:false,
			 ...
			 {field:'assetsrationame', header:'资产管理费税率', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'assetsratio'}},
			{field:'assetsratio', header:'资产管理费税率', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			                  newLine:true,
			              required:false,
			...
			{field:'assetsmoneyname', header:'资产管理费发票类型', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'assetsmoney'}},
			{field:'assetsmoney', header:'资产管理费发票类型', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			              required:false,
			             textField:'name',
   		 ...
   		 params:{pid: 'invoicetype', xmlFileName:'combos/comboDict.xml'}}
			 ...
			 {field:'adviserrationame', header:'财务顾问税率', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'adviserratio'}},
			{field:'adviserratio', header:'财务顾问费税率', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			                  newLine:true,
			              required:false,
      	 ...
      	 params:{pid: 'invoice_rate', xmlFileName:'combos/comboDict.xml'}}
			...
			{field:'advisermoneyname', header:'财务顾问费发票类型', 
			      formEditorConfig:{
			          fieldVisible:false,
			     fillFromFieldName:'advisermoney'}},
			{field:'advisermoney', header:'财务顾问费发票类型', visible:false,
				  formEditorConfig:{
			                  type:'combobox',
			              required:false,
			             textField:'name',
