...
<script type="text/javascript">
	...
	{
		var cplandate=mini.get("proj_board_meeting_meetingdate").getValue()||"";
		if(cplandate==""){
		...
		<div class="mini-tabs" activeIndex="0"   style="width: 99%" id="tabDetailsBase"  onactivechanged="changTab">
		   ...
		   <div title="文件清单" name="proj_file_detail"   iconCls="icon-cut" >
		    ...
		    <div title="生成客户信审报告" name="credit_report"   iconCls="icon-cut" >
		    	 <jsp:include page="../proj_credit/common/proj_credit_reportxls.jsp" >
						<jsp:param value="true" name="isView"/>
				 </jsp:include>
		    </div>
		    <div title="评审会议记录" name="proj_file_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_meeting_record.jsp" ><jsp:param value="true" name="isView"/></jsp:include>
		    </div>
		    <div title="董事会会议记录" name="proj_board_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_meeting_board_record.jsp" ><jsp:param value="true" name="isView"/></jsp:include>
		    </div>
		    <div title="信审结论" name="proj_file_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_credit_info.jsp"><jsp:param value="true" name="isView"/></jsp:include>
		    </div>
	   </div>
	</div>
<script type="text/javascript">
	jQuery(function(){
	    ...
	    var plandate=mini.get("proj_board_meeting_meetingdate").getValue()||"";
	    if(plandate==""){
	    	var tabs=mini.get(tabDetailsBase);
	    	tabs.removeTab("proj_board_detail");
	    } 
	});
</script>	