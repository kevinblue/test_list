...
<html>
	<head>
	   <title>管理平台-V3.0</title>
	    <link rel="icon" href="${pageContext.request.contextPath}/images/companylog.png" type="image/x-icon" />
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/companylog.png" type="image/x-icon" />
	          ...
	          <div class="header" style="overflow:hidden;" >
			      ...
			      <div class="main_topbg" id='id_mainPage_header'>
						...
						<div class="main_time" style="display:none;">
								欢迎您：<font color="#FF9238"><mini:param name="login_realname"/></font>&nbsp;|
						  ...
						  <auth:authorize ifAnyGranted="ROLE_ADMIN">|
						    当前在线<a style="text-decoration:none;" href="javascript:void(0);" onClick="javascript:showOnlineUsersWindow();">&nbsp;<font color="#FF9238"><mini:param name='online_user_count'/></font>&nbsp;</a>个用户
						  </auth:authorize> 						    
					  </div>
				  </div>
				  <!--菜单栏-->	
