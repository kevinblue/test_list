...
<script type="text/javascript">
    var displayName = "<mini:param  name='display_name'/>";
    var type = "<mini:param  name='type'/>";
    var code = "<mini:param  name='code'/>";
    var position = "<mini:param  name='position'/>";
    var workflowName = "<mini:param  name='workflow_name'/>";
    var workflowVersion = "<mini:param  name='workflow_version'/>";
    var workflowDescription = "<mini:param  name='workflow_description'/>";
    var isDeployed = ("true" == "<mini:param  name='workflow_isDeployed'/>")? true:false;
    var processInstanceId  = "<mini:param  name='processInstanceId'/>";
    var jbpmWorkflowHistoryInfoUserId = "<mini:param  name='jbpmWorkflowHistoryInfoUserId'/>";
    var nodeDetailWindowId = "id_NodeDetailWindow";
    var maxDotX  = parseInt("<mini:param  name='maxDotX'/>"||"0");
    var maxDotY  = parseInt("<mini:param  name='maxDotY'/>"||"0");
    ...
    function globalWorkflowNodeClickCallBack(e,nodeType,nodeName,posX,posY,nodeWidth,nodeHeight)
    {
	   ...
	   ajaxRequest({
          ...
          params:{
              ...
              deployId:"<mini:param  name='deployId'/> ",
