...
function _b8(){
	var _b9=$(_a7).tree("find",$(_b6).attr("node-id"));
	if(false != _a8.onDrop.call(_a7,_b7,_b9,"append")){
		 _b9=$(_a7).tree("pop",_b6);
...
var _be = $(_a7).tree("find",$(_ba).attr("node-id"));
if(false != _a8.onDrop.call(_a7,_bb,_be,_bc)){
	_be=$(_a7).tree("pop",_ba);
	_bd.data=_be;
	$(_a7).tree("insert",_bd);
}
};
...
_1e1.window.css("z-index",Math.max($.fn.window.defaults.zIndex++,_1e1.options.zIndex||0));
...
_1eb=_1eb||{};
/*modify by tracywindy 20130622**/
var clientHeight = $(window).height();
var windowTop = (_1eb||{}).top||1;
this.show();
if((windowTop+this.height()+20) > clientHeight){
	this.css("overflow-y","auto");
	_1eb["height"] = clientHeight-windowTop-20;
}
return this.each(function(){
...
_205=_205||{};
/*modify by tracywindy 20130625**/
var _1eb = _205;
var clientHeight = $(window).height();
var windowTop = (_1eb||{}).top||1;
this.show();
if((windowTop+this.height()+50) > clientHeight){
	 this.css("overflow-y","auto");
	_1eb["height"] = clientHeight-windowTop-50;
}
return this.each(function(){
...
/*自定义window样式*/
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:true,resizable:false,shadow:true,modal:true,inline:false,title:"New Window",collapsible:false,minimizable:false,maximizable:false,closable:true,closed:false});
})(jQuery);
