	...
	var dataCallBack = function(treeTableId,index,inputName,savedDataValueArr,parentTreeObj,dataObj,contentDiv,readOnly,treeTableObj,treeTableTrObj,ri,treeTableTdObj_id,currentTitleCode){
		 ...
		 switch(flag){
		   case "documentColumnType_checkbox":
			  if(itemIsRequire == '1'){
				  html =  "<input onclick='scoreClick(\""+treeTableId+"\",\""+inputName+"\",\""+dictId+"\",\""+dataValue+"\","+readOnly+",\"checkbox\",\""+columnId+"\")' "+currentTitleCode+checked+" type='checkbox' value='"+dataValue+"' id='"+columnId+"' dictId='"+dictId+"' columnId='"+columnId+"'  name='"+inputName+"'/> <font style='color:red;'>*</font>"+dataDescription;
			  }else{
				  html =  "<input onclick='scoreClick(\""+treeTableId+"\",\""+inputName+"\",\""+dictId+"\",\""+dataValue+"\","+readOnly+",\"checkbox\",\""+columnId+"\")' "+currentTitleCode+checked+" type='checkbox' value='"+dataValue+"' id='"+columnId+"' dictId='"+dictId+"' columnId='"+columnId+"'  name='"+inputName+"'/>"+dataDescription;   
			  }
			  if(readOnly){
		   ...
		   case "documentColumnType_radio":{
			  if(itemIsRequire == '1'){
				  html =  "<input onclick='scoreClick(\""+treeTableId+"\",\""+inputName+"\",\""+dictId+"\",\""+dataValue+"\","+readOnly+",\"radio\",\""+columnId+"\")' "+checked+" type='radio' value='"+dataValue+"' id='"+columnId+"' dictId='"+dictId+"' columnId='"+columnId+"'  name='"+inputName+"'/> <font style='color:red;'>*</font>"+dataDescription;   
			  }else{
				  html =  "<input onclick='scoreClick(\""+treeTableId+"\",\""+inputName+"\",\""+dictId+"\",\""+dataValue+"\","+readOnly+",\"radio\",\""+columnId+"\")' "+checked+" type='radio' value='"+dataValue+"' id='"+columnId+"' dictId='"+dictId+"' columnId='"+columnId+"'  name='"+inputName+"'/> "+dataDescription;
			  }
			  if(readOnly){
