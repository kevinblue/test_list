...
<input  style="display:none;"	class="mini-textarea" id="id_json_rent_red_detail_str" name="json_rent_red_detail_str" value='<mini:param  name="json_rent_red_detail_str" defaultValue="[]"/>'></input>
