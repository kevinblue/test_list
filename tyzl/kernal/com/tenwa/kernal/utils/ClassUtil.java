...
public class ClassUtil {
	...
	public static String[] getPackageAllClassName(String classLocation, String packageName) throws Exception {
		...
		File packeageDir = new File(StrTools.fileNameCheck(realClassLocation));
	...
	public static String getPackageClassNames( String[] packageNames) throws Exception{
	...
	public static String getAllEnumsAndBase(String[] packageNames)throws Exception{
		Set<Class<?>> classes = new HashSet<Class<?>>();
		for(String packageName : packageNames){
			classes.addAll(FileUtil.getClasses(packageName)) ;
		}
