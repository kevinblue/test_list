...
public class ReflectionUtil {
	...
	private static Object handleValueType(Object obj, String propertyName,Object value) {
		...
		if (returnType == Boolean.class) {
			...
			try {
				value = DateUtil.getTimeByFormat(value.toString(), DateUtil.FULL_TIME_FORMAT);
						//SimpleDateFormatFactory.getInstance(DateUtil.FULL_TIME_FORMAT).parse(value.toString());
			} catch (Exception e) {
				LogUtil.error("类型转型Timpestap-->Date时，发生错误! " + e.getMessage()+ "(" + value.toString() + ")");
			}
	...
	public static void main(String[] args) throws Exception {
		...
		DateUtil.getTimeByFormat(ts.toString(), DateUtil.FULL_TIME_FORMAT);
		/*System.out.println(SimpleDateFormatFactory.getInstance(
				DateUtil.FULL_TIME_FORMAT).parse(ts.toString()));*/
