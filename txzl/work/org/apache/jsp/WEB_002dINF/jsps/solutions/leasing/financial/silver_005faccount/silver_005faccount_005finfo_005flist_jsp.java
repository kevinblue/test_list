 ...
 * Generated at: 2017-07-13 14:25:38 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.financial.silver_005faccount;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class silver_005faccount_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid : 'table_silver_account_info_id',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\timportTargetClass:'com.tenwa.leasing.entity.finacial.SilverAccount',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.finacial.SilverAccount',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenStartColumn : 0,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenEndColumn : 2,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/finacial/silver_account/silver_account_list.xml',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'drafitendorser',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '付款人（上手背书人）',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'ticketamount',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '票据金额',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'outdate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '出票日期',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'drawerbank',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '出票银行',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'draweraccount',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '出票人账号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'drawer',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '出票人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'endpaydisname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '背书转让、收款、贴现',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth:140,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tentityClassName:'com.tenwa.business.entity.DictionaryData',//对应实体类\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillProperty:'name',//显示endpaydis的name\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'endpaydis',//关联的列\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tentityHeaderFieldName:'name'//显示值是对应实体类的哪个字段\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t {         \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'endpaydis',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '背书转让、收款、贴现',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tpid : 'endpaydis',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/combos/comboDict.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'endpaydisdate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '背书转让、收款、贴现日期',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 150,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdateFormat : \"yyyy-MM-dd\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'endorsee',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '被背书人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'endorsepurpose',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '背书转让用途',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine:false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '所属项目',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {width:210},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'accessmethod',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '取得方式',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
