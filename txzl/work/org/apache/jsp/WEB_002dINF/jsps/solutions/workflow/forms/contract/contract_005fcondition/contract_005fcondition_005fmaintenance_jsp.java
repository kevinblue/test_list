 ...
 * Generated at: 2017-03-26 03:34:33 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.forms.contract.contract_005fcondition;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class contract_005fcondition_005fmaintenance_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \t\t\t\t\tshowToolbar: showTools,//是否显示表格按钮行\r\n");
      out.write("  \t\t\t\t\ttitle:'合同条件维护',//修改显示页面的标题\r\n");
      out.write("  \t\t\t\t\tqueryButtonColSpan:4,\r\n");
      out.write("  \t\t\t\t\tremoteOper:true,//是否每次操作都交给后台，为true 时必须定义  entityClassName\r\n");
      out.write("  \t\t\t\t\tentityClassName:'com.tenwa.leasing.entity.contract.ContractConditionMaintenance',\r\n");
      out.write("  \t\t\t\t\tpageSize:15,\r\n");
      out.write("  \t\t\t\t\tshowPager:true,\r\n");
      out.write("  \t\t\t\t\tlazyLoad:false, \t\r\n");
      out.write("  \t\t\t\t\txmlFileName:'/eleasing/workflow/contract/contract_condition/contract_condition_query.xml', \t\r\n");
      ...
      out.write("  \t\t\t\t\t\t{field:'conditionname',header:'条件名称',  \t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t     \r\n");
      out.write(" \t\t\t\t\t\t\t           }},  \t\r\n");
      out.write("  \t\t\t\t\t\t {field:'contracttype',header:'合同类型',\r\n");
      out.write("  \t\t\t\t\t\t\t      headerAlign:'center',\r\n");
      out.write("  \t\t\t\t\t\t\t      width:50,\r\n");
      out.write("  \t\t\t\t\t\t\t      allowSort:true,\r\n");
      out.write("  \t\t\t\t\t\t\t      queryConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t  data:[{id:'租赁合同',text:'租赁合同'},{id:'供货合同',text:'供货合同'}]\r\n");
      out.write(" \t\t\t\t\t\t\t           \r\n");
      out.write("  \t\t\t\t\t\t\t      },\r\n");
      out.write("  \t\t\t\t\t\t\t    formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t         type:'combobox',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t  data:[{id:'租赁合同',text:'租赁合同'},{id:'供货合同',text:'供货合同'}]\r\n");
      out.write(" \t\t\t\t\t\t\t           } }, \t  \t\t\t  \t\t\t\t\t\t  \t\t\t     \r\n");
      out.write("  \t\t\t  \t\t\t{field:'paymentcategory',header:'款项类别',\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    \theaderAlign:'center',\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    \twidth:150,\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    \tallowSort:true, \r\n");
      out.write("\t  \t\t\t  \t\t\t\t       queryConfig : {},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t     \t\twidth:200\r\n");
      out.write("\t  \t\t  \t\t\t\t\t\t\t           }},  \r\n");
      out.write("  \t\t\t  \t\t\t {field:'conditiontype',header:'条件类型',\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t headerAlign:'center',\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t width:50,\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t allowSort:true,\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t queryConfig : {\r\n");
      ...
      out.write("  \t\t\t\t\t\t\t\t\t    \t\t valueField:'id', \r\n");
      out.write("  \t\t\t\t\t\t\t\t         \t\ttextField:'text',\r\n");
      out.write("  \t\t\t\t\t\t\t\t\t\t\t\tdata:[{id:'前置',text:'前置'},{id:'后置',text:'后置'}]\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t\t \r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t },\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t    formEditorConfig:{\t\t\r\n");
      out.write("  \t\t\t\t\t\t\t\t\t         type:'combobox',\r\n");
      ...
      out.write("  \t\t});\r\n");
      out.write("\t</script>\r\n");
      out.write("<div id='content_table_id5' style=\"width:300px;height:200px;\" ></div>\r\n");
      out.write("\r\n");
      out.write("</head>\r\n");
      out.write("<body></body>\r\n");
      out.write("</html>");
