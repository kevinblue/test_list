...
public final class contract_005fequip_005fdetail_005ftmp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar buttons=[ 'add', '-', 'edit', '-','copy','-',\r\n");
      out.write("\t              {html:'删除',\r\n");
      ...
      out.write("\t\t\t\t\tif(row){\r\n");
      out.write("\t\t\t\t\t\tmarkDeletion1(row.id);\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\talert(\"未选中行\");\t\t\t \r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t         } \r\n");
      out.write("\t         },'-','exportExcel','-','importExcel'];\r\n");
      out.write("\tif('");
      ...
      out.write("\t\t\tentityClassName : \"com.tenwa.leasing.entity.contract.ContractEquipTmp\",    \r\n");
      ...
      out.write("'),\r\n");
      out.write("\t\t\t  xmlFileName : '/eleasing/workflow/contract/contract_change/contract_equip_tmp.xml', \r\n");
      out.write("\t\t\tcolumns: [\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t},\t\t  \r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t{field:'equipprice', header:'总价(RMB)',dataType:\"currency\",align:'right',summary:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdataType:\"currency\",\r\n");
      out.write("\t\t\t\t\t  formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t        \t  type:'text',\r\n");
      out.write("\t\t\t\t\t\t         vtype:'float',\r\n");
      ...
      out.write("});\r\n");
      out.write("//标记删除\r\n");
      out.write("function markDeletion1(id){\r\n");
      out.write("\tmini.confirm(\"确认删除吗？\", \"删除？\", function(action){\r\n");
      ...
      out.write("        data: {id:id,mark:\"1\"},\r\n");
      out.write("        success: function (data) {\r\n");
      out.write("        \tif(data==1){\r\n");
      out.write("        \t\tmini.get(\"contract_equip\").reload();\r\n");
      out.write("        \t\treturn;\r\n");
      out.write("        \t}else{\r\n");
      ...
      out.write("\tmini.getbyName(\"originaltotal\").setValue(decimal(temp,2));\r\n");
      out.write("}\r\n");
