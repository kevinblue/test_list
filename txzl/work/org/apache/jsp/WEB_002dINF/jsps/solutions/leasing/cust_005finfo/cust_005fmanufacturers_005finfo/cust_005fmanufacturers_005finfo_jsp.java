 ...
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.cust_005finfo.cust_005fmanufacturers_005finfo;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class cust_005fmanufacturers_005finfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\trenderTo:'content_table_id7',\r\n");
      ...
      out.write("\t\t\tentityClassName:'com.tenwa.leasing.entity.cust.other.CustManufacturersInfo',\r\n");
      out.write("\t\t\tpageSize:15,\r\n");
      out.write("\t\t\tshowPager:true,\r\n");
      out.write("\t\t\tlazyLoad:false,\t\t\r\n");
      out.write("\t\t\txmlFileName:'/eleasing/jsp/cust_info/cust_manufacturersInfo/cust_manufacturersInfo_list.xml',\r\n");
      ...
      out.write("\t\t\t\t\t\t/* getMiniEditFormField(\"contractid\").setText(mini.getbyName(\"connameidname\").getValue()); */\r\n");
      out.write("\t\t\t\t\t\tmini.getbyName(\"companynameid\").setText(mini.getbyName(\"companyname\").getValue());\r\n");
      out.write("\t\t\t\t\t\tmini.getbyName(\"companynameid\").setValue(mini.getbyName(\"companyname\").getValue());\r\n");
      out.write("\t\t\t\t\t\t//mini.alert(\"1\"+mini.getbyName(\"companynameid\").getValue());\r\n");
      out.write("\t\t\t\t\t\t//mini.alert(mini.getbyName(\"companynameid\").getText());\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t \t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'companyname',header:'公司名称',headerAlign:'center',width:100,visible:true,\r\n");
      out.write("\t\t\t\t           formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t     fillFromFieldName : 'companynameid',\r\n");
      out.write("\t\t\t\t\t           fieldVisible:false}},\r\n");
      out.write("\t\t\t\t{field:'companynameid',header:'公司名称',headerAlign:'center',width:100,visible:false,\r\n");
      out.write("\t\t           formEditorConfig:{\r\n");
      ...
      out.write("\t\t\t\t\t\t\tmini.getbyName(\"companyname\").setValue(rowData.name);\r\n");
      out.write("\t\t\t\t\t\t\tmini.getbyName(\"companynumber\").setValue(rowData.value);\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\txmlFileName : '/eleasing/jsp/cust_info/cust_manufacturersInfo/custcompany_query.xml'\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}},\r\n");
      out.write("\t\t             {field:'companynumber',header:'社会信用代码',headerAlign:'center',width:100,visible:true,\r\n");
      out.write("\t\t\t\t           formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t               readonly : true,\r\n");
      out.write("\t\t\t\t\t                newLine:false,\r\n");
      out.write("\t\t\t\t\t                   type:'text'}},\r\n");
      out.write("\t\t             {field:'companynumberid',header:'社会信用代码',headerAlign:'center',width:100,visible:false,\r\n");
      out.write("\t\t\t\t           formEditorConfig:{}},\r\n");
      out.write("\t\t\t\t\t/* {field:'projectname',header:'项目名称',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      ...
      out.write("\t\t\t\t\t{field:'monthavgmoney',header:'合同金额',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t            formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t                    type:'text',\r\n");
      out.write("\t\t\t\t\t            fieldVisible:true,\r\n");
      ...
      out.write("\t\t\t\t\t                   width:200,\r\n");
      out.write("\t\t\t\t\t              labelWidth:100}}, */\r\n");
      out.write("\t\t\t\t  //项目名称下拉框，辉哥说只需要文本，不用下拉\r\n");
      out.write("\t\t             /*  {field:'projectname',header:'项目名称',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t             formEditorConfig:{\r\n");
      out.write("\t\t\t\t            \t newLine:true,\r\n");
      out.write("\t\t\t\t\t                     type:'combobox',\r\n");
      out.write("\t\t\t\t\t                     params: {pid: custid,xmlFileName: '/eleasing/jsp/cust_info/cust_manufacturersInfo/cust_manufacturersInfo_project.xml'},\r\n");
      out.write("\t\t\t\t\t\t                 textField: 'name',\r\n");
      out.write("\t\t\t\t\t\t                valueField: 'value',\r\n");
      out.write("\t\t\t\t\t             fieldVisible:true,\r\n");
      out.write("\t\t\t\t\t                    width:200,\r\n");
      ...
      out.write("\t\t\t\t                    width:200,\r\n");
      out.write("\t\t\t\t               labelWidth:100}}, \r\n");
      out.write("\t\t\t\t\t {field:'paymentway',header:'付款方式',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t             formEditorConfig:{\r\n");
      out.write("\t\t\t\t            \t newLine:false,\r\n");
      out.write("\t\t\t\t\t                     type:'text',\r\n");
      out.write("\t\t\t\t\t             fieldVisible:true,\r\n");
      ...
      out.write("\t\t\t\t\t               labelWidth:100}},\r\n");
      out.write("\t               \r\n");
      out.write("\t\t\t\t\t  {field:'purchaseproject',header:'货物名称',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t             formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t                     type:'text',\r\n");
      out.write("\t\t\t\t\t                     newLine:true,\r\n");
      out.write("\t\t\t\t\t             fieldVisible:true,\r\n");
      out.write("\t\t\t\t\t                    width:200,\r\n");
      out.write("\t\t\t\t\t               labelWidth:100}},\r\n");
      out.write("\t\t\t\t\t   {field: 'qualityratename', header: '金风质量评级' ,\r\n");
      out.write("\t\t\t\t\t\t            \t formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t            \t\t fieldVisible: false, \r\n");
      out.write("\t\t\t\t\t\t            \t }},\t\t\t\t\t\t\t\t\t             \r\n");
      out.write("                       {field: 'qualityrate', header: '金风质量评级',headerAlign:'center',visible:false,width:100,allowSort:true,\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t   newLine:false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t             labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t                  width:200,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t           emptyText:\"\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           type:'combobox',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           params:{pid: 'cust_qualityrate',xmlFileName: '/combos/comboDict.xml'},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           textField:'name',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t           valueField:'value'}},\r\n");
      out.write("\t\t\t\t       \r\n");
      out.write("\t\t\t\t\t\t{field: 'creditratename', header: '天信客户信用评级' ,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            fieldVisible: false, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        }},\t\t\t\t\t\t\t\t\t             \r\n");
      out.write("\t\t\t             {field: 'creditrate', header: '天信客户信用评级',headerAlign:'center',visible:false,width:100,allowSort:true,\t \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\temptyText:\"\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    type:'combobox',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tparams:{pid: 'credit_rating',xmlFileName: '/combos/comboDict.xml'},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\ttextField:'name',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tvalueField:'value'}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("});\r\n");
      out.write("</script>\r\n");
      out.write("<div id='content_table_id7'></div>");
  ...
  private boolean _jspx_meth_permission_005faction_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_manufacturers_info/cust_manufacturers_info.jsp(6,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f0.setCode("cust_manufacturersInfo_add");
  ...
  private boolean _jspx_meth_permission_005faction_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_manufacturers_info/cust_manufacturers_info.jsp(9,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f1.setCode("cust_manufacturersInfo_edit");
  ...
  private boolean _jspx_meth_permission_005faction_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_manufacturers_info/cust_manufacturers_info.jsp(12,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f2.setCode("cust_manufacturersInfo_remove");
