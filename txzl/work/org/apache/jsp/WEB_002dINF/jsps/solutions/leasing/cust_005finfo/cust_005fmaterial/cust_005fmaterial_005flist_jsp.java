 ...
 * Generated at: 2017-06-15 01:05:05 UTC
...
public final class cust_005fmaterial_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\thiddenQueryArea : false,//是否将查询区域折叠起来，true为隐藏\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tshowToolbar : showTools,//是否显示表格按钮行\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttitle : '档案信息查询',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tqueryButtonColSpan : 4,//查询区的按钮占的列行数\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t$\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t.ajax({\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\turl : getRootPath()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"/acl/getRunningWater.acl\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype : \"post\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/cust_info/cust_material/get_cust_material.xml',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'archivestitle',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '档案标题',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tallowSort : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t//在配置中引用定义的数组\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'archivesnumber',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '档案编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tallowSort : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'archivestypename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '档案类型',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'archivesexplain',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '档案说明',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\treturn \"<a href='javascript:void(0);' onclick='showanduploadfile(\\\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ id\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"\\\",\\\"one\\\")'>查看/上传资料 </a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t} ]\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      ...
      out.write("';\r\n");
      out.write("\t\t if(custid==\"\"||custid.length<0){\r\n");
      out.write("\t\t mini.alert(\"没有获取到当前登录人,请重新登录系统\");\r\n");
      out.write("\t\t return false;  \r\n");
      out.write("\t\t } */\r\n");
      out.write("\r\n");
      out.write("\t\tvar urlFlag = getRootPath()\r\n");
      out.write("\t\t\t\t+ \"/leasing/cust_info/cust_material/cust_material_file_list.bi?id=\"\r\n");
      out.write("\t\t\t\t+ id + \"&type=\" + type;\r\n");
      out.write("\t\tmini.open({\r\n");
      out.write("\t\t\turl : urlFlag,\r\n");
      out.write("\t\t\ttitle : \"档案管理\",\r\n");
      out.write("\t\t\twidth : 800,\r\n");
      out.write("\t\t\theight : 455,\r\n");
  ...
  private boolean _jspx_meth_permission_005faction_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_material/cust_material_list.jsp(14,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_material/cust_material_list.jsp(17,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f1.setCode("archives");
  ...
  private boolean _jspx_meth_permission_005faction_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_material/cust_material_list.jsp(20,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f2.setCode("archives");
  ...
  private boolean _jspx_meth_permission_005faction_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_material/cust_material_list.jsp(23,1) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f3.setCode("archives");
    ...
    if (_jspx_eval_permission_005faction_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\thtml : '查看所有档案资料',//自定义按钮的名字\r\n");
        out.write("\t\tplain : true,//背景透明，按钮是否有立体感\r\n");
        out.write("\t\ticonCls : 'icon-search',//按钮图标类\r\n");
        out.write("\t\thandler : function(miniTable, buttonText) {//按钮点击的响应函数\r\n");
        out.write("\t\t\tshowanduploadfile(\"xx\", \"all\");\r\n");
        out.write("\t\t}\r\n");
        out.write("\t});\r\n");
        out.write("\t");
