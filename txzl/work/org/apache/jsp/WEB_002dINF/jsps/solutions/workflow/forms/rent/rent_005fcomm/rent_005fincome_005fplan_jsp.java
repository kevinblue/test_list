...
public final class rent_005fincome_005fplan_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\" onclick=\"saveCheckboxValue(this);\" name=\"aa\" class=\"mini-checkbox\" style=\"vertical-align: middle;\" text=\"允许隔期回笼\"></div>',\r\n");
      ...
      out.write("\t\t\t{field: 'corpus', header: '本金',type:'double',summary : true,dataType : \"currency\"},\r\n");
      out.write("\t\t\t{field: 'interest', header: '利息收入',type:'double',summary : true,dataType : \"currency\"},\r\n");
      out.write("\t\t\t{field: 'penalty', header: '应收罚息',type:'double',summary : true,dataType : \"currency\"},\r\n");
      out.write("\t\t\t{field: 'currentoverage', header: '计划余额',type:'double',summary : true,dataType : \"currency\"},\r\n");
      out.write("\t\t\t{field: 'curcorpusoverage', header: '本金余额',type:'double',summary : true,dataType : \"currency\"},\r\n");
      out.write("\t\t\t{field: 'curinterestoverage', header: '租息余额',type:'double',summary : true,dataType : \"currency\"},\r\n");
      ...
      out.write("\t//尹兽指导\r\n");
      out.write("\tvar aa=$(\"#isseparaterentlist\").val();\r\n");
      out.write("\tvar datas = miniTable.getSelecteds();\r\n");
      out.write("\t//console.info(selectedDatas);\r\n");
      out.write("\t//不允许隔期回笼时\r\n");
      out.write("\tvar temp=0;\r\n");
      out.write("\tvar tempAry=new Array();\r\n");
      out.write("\tif(aa==false||aa==\"false\"){\t\t\r\n");
      out.write("\t\tfor(var i=0;i<datas.length;i++){\r\n");
      out.write("\t\t\ttempAry[i]=Number(datas[i].rentlist);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\ttempAry.sort(function(a,b){\r\n");
      out.write("        return a-b});\r\n");
      out.write("\tfor(var i=0;i<tempAry.length-1;i++){\r\n");
      out.write("\t\tif(tempAry[i]!=(tempAry[i+1]-1)){\r\n");
      out.write("\t\t\tmini.alert(\"不允许隔期回笼\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
