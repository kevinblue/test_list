 ...
 * Generated at: 2017-05-10 02:01:05 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.forms.factoring.factoring_005ftransfer_005freceivables;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class transfer_005freceivables_005finvoice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t mini.alert('请先选择需要生成应收账款反转让选项！');\r\n");
      out.write("\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t }else if(row.length==1){ \r\n");
      out.write("\t\t\t\t\t\tvar rows=miniTable.getSelected();\r\n");
      out.write("\t\t\t\t\t\tvar equipstatusname=rows.equipstatusname;\r\n");
      out.write("\t\t\t\t\t\tif(equipstatusname=='已反转让'){\r\n");
      ...
      out.write("\t\t\t\t\t\tvar transfermattersname =rows.transfermattersname;\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\tvar b=\"未清偿应收账款\";\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t if(transfermattersname==b){\r\n");
      out.write("\t\t\t\t\t\t\tparams['label.transfermattersname']=\"1\";\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\tparams['label.transfermattersname']=\"2\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t params['buyer.purchasername'] =rows.purchasername;\r\n");
      out.write("\t\t\t\t\t params['buyer.purchasername1'] =rows.purchasername;\r\n");
      out.write("\t\t\t\t\t params['buyer.purchasername2'] =rows.purchasername;\r\n");
      out.write("\t\t\t\t\t//iyear,imonth,iday,tyear,tmonth,tday\r\n");
      out.write("\t\t\t\t\t    var transferdate=rows.transferdate;\r\n");
      out.write("\t\t\t\t\t    params['date.iyear']=transferdate.substring(0,4);//3.年\r\n");
      out.write("\t\t\t\t\t\tparams['date.imonth']=transferdate.substring(5,7);//4.月\r\n");
      out.write("\t\t\t\t\t\tparams['date.iday']=transferdate.substring(8);//5.日\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t    params['date.tyear']=transferdate.substring(0,4);//3.年\r\n");
      out.write("\t\t\t\t\t\tparams['date.tmonth']=transferdate.substring(5,7);//4.月\r\n");
      out.write("\t\t\t\t\t\tparams['date.tday']=transferdate.substring(8);//5.日\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tvar fileTeplate=new fileTemplateConfig({\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\ttemplateno : 'F-201611006',\r\n");
      ...
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\tmini.alert('请选择转让状态是已反转让的选项！');\r\n");
      out.write("\t\t\t\t\t      \r\n");
      out.write("\t\t\t\t\t\t}\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar name=row[0].purchasername;\r\n");
      out.write("\t\t\t\tvar transfermattersname = row[0].transfermattersname;\r\n");
      out.write("\t\t\t\tvar equipstatusname = '已反转让';\r\n");
      out.write("\t\t\t\tfor(var i=0;i<row.length;i++){\r\n");
      out.write("\t\t\t\t\t if(equipstatusname==row[i].equipstatusname){\r\n");
      out.write("\t\t\t\t\t\t equipstatusname=row[i].equipstatusname;\r\n");
      out.write("\t\t\t\t\t }else{\r\n");
      out.write("\t\t\t\t\t\t mini.alert(\"选择有已转让\");\r\n");
      out.write("\t\t\t\t\t\t return;\r\n");
      out.write("\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t\t if(name==row[i].purchasername&&transfermattersname==row[i].transfermattersname){\r\n");
      out.write("\t\t\t\t\t\t name=row[i].purchasername;\r\n");
      out.write("\t\t\t\t\t\t transfermattersname=row[i].transfermattersname;\r\n");
      out.write("\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t }else{\r\n");
      out.write("\t\t\t\t\t\t mini.alert(\"名称或事项有差异\");\r\n");
      out.write("\t\t\t\t\t\t return;\r\n");
      out.write("\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t} \r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\tparams['label.custname'] = mini.get(\"cust_name\").getValue();\r\n");
      out.write("\t\t\t\t //2两个日期\r\n");
      out.write("\t\t\t\t  var transferdate=row[0].transferdate;\r\n");
      out.write("\t\t\t\t\t    params['date.iyear']=transferdate.substring(0,4);//3.年\r\n");
      out.write("\t\t\t\t\t\tparams['date.imonth']=transferdate.substring(5,7);//4.月\r\n");
      out.write("\t\t\t\t\t\tparams['date.iday']=transferdate.substring(8);//5.日\r\n");
      out.write("\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\tparams['date.tday']=transferdate.substring(8);//5.日\r\n");
      out.write("               //发票号                 \r\n");
      out.write("\t\t\t\t        var invoicecodes=\"\";\r\n");
      out.write("\t\t\t\t\t\tfor(c=0;c<row.length-1;c++){\r\n");
      out.write("\t\t\t\t\t\t\tvar invoicecode=row[c].invoicecode;\r\n");
      out.write("\t\t\t\t\t\t\tinvoicecodes=invoicecodes +invoicecode+\",\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tvar last =row[length].invoicecode;\r\n");
      out.write("\t\t\t\t\t\tvar invoice= invoicecodes+last;\r\n");
      out.write("                  params['label.invoicecode'] = invoice;\r\n");
      out.write("\t\t\t    //\r\n");
      out.write("\t\t\t\t params['label.factoringtype'] =mini.get(\"factoringtype\").getText();\r\n");
      out.write("\t\t\t\t params['label.contractnumber'] =mini.get(\"contract_number\").getValue();\r\n");
      out.write("\t\t\t\t//反转让事项\r\n");
      ...
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t//3个买方\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\tparams['buyer.purchasername'] =row[0].purchasername;\r\n");
      out.write("\t\t\t\tparams['buyer.purchasername1'] =row[0].purchasername;\r\n");
      out.write("\t\t\t\tparams['buyer.purchasername2'] =row[0].purchasername;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar fileTeplate=new fileTemplateConfig({\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\ttemplateno : 'F-201611006',\r\n");
      out.write("\t\t\t\t\ttableid:miniTable.config.id,\r\n");
      ...
      out.write("              }\r\n");
      out.write("\t\t\t        ],\r\n");
      out.write("\t\t\txmlFileName:'/eleasing/workflow/proj/proj_account_rece/proj_transfer_receivables_invoice.xml',\r\n");
      out.write("\t\t\tcolumns: [   \r\n");
      ...
      out.write("\t\t\t\t\t\t       colspan: 3,\r\n");
      out.write("\t\t\t\t\t\t         width: '100%'}},\r\n");
      out.write("\t\t\t\t{field:'equipprice', header:'发票金额',align:'left',summary:true,\r\n");
      out.write("\t\t\t\t\t  formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t  readOnly : true,\r\n");
      out.write("\t\t\t\t\t        \t  type:'text',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t                newLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t            allowInput:false}},\r\n");
      out.write("\t\t\t  {field: 'transferdate', header:'转让日期',dateFormat:\"yyyy-MM-dd\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t                  type:'date',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t                 vtype:'date',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t            \r\n");
      out.write("\t\t\t  {field:'equipstatusname',header:'转让状态',visible: true, formEditorConfig : {fieldVisible : false}}\t,\t\t\t            \r\n");
      out.write("\t\t \t  {\r\n");
      out.write("\t\t\t\t   field: 'equipstatus', \r\n");
      out.write("\t\t\t\t   header:'转让状态',\r\n");
      out.write("\t\t\t\t   visible: false,\r\n");
      out.write("\t\t            formEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t        data : [{value:'2',name:'已转让'},{value:'3',name:'已反转让'}]\r\n");
      out.write("\t\t\t\t\t}\t            \r\n");
      out.write("\t\t\t \t\t            \r\n");
      out.write("\t\t\t \t} ,        \r\n");
      out.write("\t\t\t \t  \r\n");
      out.write("\t\t\t\t  {field:'transfermattersname',header:'反转让事项',visible: true, formEditorConfig : {fieldVisible : false}}\t,\t\t\t            \r\n");
      out.write("\t\t\t\t\t\t \t  {\r\n");
      out.write("\t\t\t\t\t\t\t\t  field: 'transfermatters', \r\n");
      out.write("\t\t\t\t\t\t\t\t  header:'反转让事项',\r\n");
      out.write("\t\t\t\t\t\t\t\t  visible: false,\r\n");
      out.write("\t\t\t\t\t\t          formEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype : 'combobox',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttextField : 'name',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tvalueField : 'value',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t        data : [{value:'1',name:'未清偿应收账款'},{value:'2',name:'买方提出争议'}]\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\t            \r\n");
      out.write("\t\t\t\t\t\t\t \t\t            \r\n");
      out.write("\t\t\t\t\t\t\t \t} ,  \r\n");
      out.write("\t\t\t  {field: 'hadtransferdate', header:'反转让日期',dateFormat:\"yyyy-MM-dd\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  \r\n");
      out.write("\t\t\t\t\t\t\t\t                  type:'date',\r\n");
      out.write("\t\t\t\t\t\t\t\t                 vtype:'date',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t            \r\n");
      out.write("\t\t\t\t\t\t\t \t},\r\n");
      out.write("\t\t\t \t{field:'transferreason',header:'转让原因',\r\n");
      out.write("\t\t\t\t\t  formEditorConfig:{\r\n");
      ...
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<div id=\"id_table_proj_invoice_detail\" style=\"height: 100%;\">\r\n");
      out.write("</div>\r\n");
