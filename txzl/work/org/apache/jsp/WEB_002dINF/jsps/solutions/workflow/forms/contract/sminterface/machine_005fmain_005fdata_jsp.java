 ...
 * Generated at: 2017-06-14 09:58:30 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.forms.contract.sminterface;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class machine_005fmain_005fdata_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\tmini.confirm(\"确认同步么？\",\"同步\", function(action){\r\n");
      out.write("\t\t\t\t\tmini.mask({\r\n");
      ...
      out.write("\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/acl/updateMachineMainData.acl',\r\n");
      out.write("\t\t\t\t\ttype: \"post\",\r\n");
      out.write("\t\t\t\t    cache: false, \r\n");
      out.write("\t\t\t\t    async : false,\r\n");
      out.write("\t\t\t\t\tsuccess:function(res){\r\n");
      out.write("\t\t\t\t\t\tif(res=='成功'){\r\n");
      out.write("\t\t\t\t\t\t\tmini.alert(\"同步成功！\");\r\n");
      out.write("\t\t\t\t\t\t\tmini.unmask(document.body);\r\n");
      out.write("\t\t\t\t\t\t\tminiTable.reload();\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\tmini.alert(\"刷新失败！\");\r\n");
      out.write("\t\t\t\t\t\t\tminiTable.reload();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t   },\r\n");
      ...
      out.write("\t\txmlFileName: '/eleasing/workflow/contract/SM_interface/machine_main_data.xml',\r\n");
      out.write("\t\tcolumns: [\r\n");
      out.write("\t\t\t{type: 'indexcolumn'},\r\n");
      out.write("\t\t\t{field: 'id', header: 'id', visible: false},\r\n");
      out.write("\t\t\t{field:'风场编号', header:'风场编号',width:170,queryConfig:{}},\t\r\n");
      out.write("\t\t\t{field:'proj_name', header:'项目名称',width:130,queryConfig:{}},\r\n");
      out.write("\t\t\t{field:'机组编号', header:'机组编号',width:150,queryConfig:{}},\t\r\n");
      out.write("\t\t\t{field:'风场名称', header:'风场名称',width:200,queryConfig:{}},\t\r\n");
      out.write("\t\t\t{field:'片区', header:'片区'},\t\r\n");
      out.write("\t\t\t{field:'项目部', header:'项目部',width:200},\t\r\n");
      out.write("\t\t\t{field:'项目经理', header:'项目经理'},\t\r\n");
      out.write("\t\t\t{field:'机组状态', header:'机组状态'},\t\r\n");
      out.write("\t\t\t{field:'运行机位号', header:'运行机位号'},\t\r\n");
      out.write("\t\t\t{field:'SCADA风机编号', header:'SCADA风机编号'},\t\r\n");
      out.write("\t\t\t{field:'SCADA风场编号', header:'SCADA风场编号'},\t\r\n");
      out.write("\t\t\t{field:'机组容量', header:'机组容量'},\t\r\n");
      out.write("\t\t\t{field:'机型', header:'机型'},\t\r\n");
      out.write("\t\t\t{field:'轮毂高度', header:'轮毂高度'},\t\r\n");
      out.write("\t\t\t{field:'IP地址', header:'IP地址'},\t\r\n");
      out.write("\t\t\t{field:'子网掩码', header:'子网掩码'},\t\r\n");
      out.write("\t\t\t{field:'基础开挖时间', header:'基础开挖时间'},\t\r\n");
      out.write("\t\t\t{field:'基础浇筑时间', header:'基础浇筑时间'},\t\r\n");
      out.write("\t\t\t{field:'箱变安装时间', header:'箱变安装时间'},\t\r\n");
      out.write("\t\t\t{field:'接货开始时间', header:'接货开始时间'},\t\r\n");
      out.write("\t\t\t{field:'接货结束时间', header:'接货结束时间'},\t\r\n");
      out.write("\t\t\t{field:'吊装开始时间', header:'吊装开始时间'},\t\r\n");
      out.write("\t\t\t{field:'吊装结束时间', header:'吊装结束时间'},\t\r\n");
      out.write("\t\t\t{field:'上电时间', header:'上电时间'},\t\r\n");
      out.write("\t\t\t{field:'静调开始时间', header:'静调开始时间'},\t\r\n");
      out.write("\t\t\t{field:'静调结束时间', header:'静调结束时间'},\t\r\n");
      out.write("\t\t\t{field:'动调开始时间', header:'动调开始时间'},\t\r\n");
      out.write("\t\t\t{field:'动调结束时间', header:'动调结束时间'},\t\r\n");
      out.write("\t\t\t{field:'试运行开始时间', header:'试运行开始时间'},\t\r\n");
      out.write("\t\t\t{field:'试运行结束时间', header:'试运行结束时间'},\t\r\n");
      out.write("\t\t\t{field:'预验收通过时间', header:'预验收通过时间'},\t\r\n");
      out.write("\t\t\t{field:'在建转质保时间', header:'在建转质保时间'},\t\r\n");
      out.write("\t\t\t{field:'主控程序版本号', header:'主控程序版本号'},\t\r\n");
      out.write("\t\t\t{field:'变流版本号', header:'变流版本号'},\t\r\n");
      out.write("\t\t\t{field:'变桨版本号', header:'变桨版本号'},\t\r\n");
      out.write("\t\t\t{field:'初始化文件版本号', header:'初始化文件版本号'},\t\r\n");
      out.write("\t\t\t{field:'变桨类型', header:'变桨类型'},\t\r\n");
      out.write("\t\t\t{field:'变流类型', header:'变流类型'},\t\r\n");
      out.write("\t\t\t{field:'冷却', header:'冷却'},\t\r\n");
      out.write("\t\t\t{field:'叶片', header:'叶片'},\t\r\n");
      out.write("\t\t\t{field:'总线类型', header:'总线类型'},\t\r\n");
      out.write("\t\t\t{field:'塔筒', header:'塔筒'},\t\r\n");
      out.write("\t\t\t{field:'基础形式', header:'基础形式'},\t\r\n");
      out.write("\t\t\t{field:'塔架连接方式', header:'塔架连接方式'},\t\r\n");
      out.write("\t\t\t{field:'塔架图号', header:'塔架图号'},\t\r\n");
      out.write("\t\t\t{field:'预计出质保时间', header:'预计出质保时间'},\t\r\n");
      out.write("\t\t\t{field:'最终交接结束时间', header:'最终交接结束时间'},\t\r\n");
      out.write("\t\t\t{field:'吊装过程验收开始时间', header:'吊装过程验收开始时间'},\t\r\n");
      out.write("\t\t\t{field:'吊装过程验收结束时间', header:'吊装过程验收结束时间'},\r\n");
      out.write("\t\t\t{field:'力矩验收开始时间', header:'力矩验收开始时间'},\t\r\n");
      out.write("\t\t\t{field:'力矩验收结束时间', header:'力矩验收结束时间'},\t\r\n");
      out.write("\t\t\t{field:'接线开始时间', header:'接线开始时间'},\t\r\n");
      out.write("\t\t\t{field:'接线结束时间', header:'接线结束时间'},\t\r\n");
      out.write("\t\t\t{field:'整体验收开始时间', header:'整体验收开始时间'},\t\r\n");
      out.write("\t\t\t{field:'整体验收结束时间', header:'整体验收结束时间'},\t\r\n");
      out.write("\t\t\t{field:'内部验收开始时间', header:'内部验收开始时间'},\t\r\n");
      out.write("\t\t\t{field:'内部验收结束时间', header:'内部验收结束时间'},\t\r\n");
      out.write("\t\t\t{field:'预验收开始时间', header:'预验收开始时间'},\t\r\n");
      out.write("\t\t\t{field:'最终交接开始时间', header:'最终交接开始时间'},\r\n");
      out.write("\t\t\t{field:'最终交接验收开始时间', header:'最终交接验收开始时间'},\r\n");
      out.write("\t\t\t{field:'最终交接验收结束时间', header:'最终交接验收结束时间'},\r\n");
      out.write("\t\t\t{field:'最终出质保时间', header:'最终出质保时间'},\r\n");
      out.write("\t\t\t{field:'系统创建时间', header:'系统创建时间'}\r\n");
      out.write("\t\t]\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<div id=\"id_table_container_contract_sign\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
