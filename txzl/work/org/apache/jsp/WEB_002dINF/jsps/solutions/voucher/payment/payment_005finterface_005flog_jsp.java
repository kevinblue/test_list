 ...
 * Generated at: 2017-06-12 08:03:16 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.voucher.payment;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class payment_005finterface_005flog_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\tparams:{},\r\n");
      out.write("\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.fund.ContractFundPaymentInterfaceLog',\r\n");
      out.write("\t\t\t\txmlFileName : '/eleasing/jsp/fund/fund_payment/payment_interface_log.xml',\r\n");
      ...
      out.write("  \t\t \t\t\t\t\t\tvar  logid=row.id;\r\n");
      out.write("  \t\t \t\t\t\t\t\tvar message='';\r\n");
      out.write("  \t\t \t\t\t\t\t\tif(row.paymentstatus==\"S\"){\r\n");
      out.write("  \t\t \t\t\t\t\t\t\tmini.alert(\"付款已成功，不允许再次发送！\");//sendPaymentDate.acl\r\n");
      out.write("  \t\t \t\t\t\t\t\t\treturn false;\r\n");
      out.write("  \t\t \t\t\t\t\t\t}\r\n");
      out.write("  \t\t \t\t\t\t\t\tif(row.paymentstatus==\"A\"){\r\n");
      out.write("  \t\t \t\t\t\t\t\t\tmini.alert(\"传输已成功，不允许再次发送！\");//sendPaymentDate.acl\r\n");
      out.write("  \t\t \t\t\t\t\t\t\treturn false;\r\n");
      out.write("  \t\t \t\t\t\t\t\t}\r\n");
      out.write("  \t\t \t\t\t\t\t\tif(row.paymentstatus==\"F\"){\r\n");
      out.write("  \t\t \t\t\t\t\t\t\tmini.alert(\"付款失败，不允许再次发送！请线下联系。\");//sendPaymentDate.acl\r\n");
      out.write("  \t\t \t\t\t\t\t\t\treturn false;\r\n");
      out.write("  \t\t \t\t\t\t\t\t}\r\n");
      out.write("  \t\t \t\t\t\t\t\tvar depositbanktype=getMiniEditFormField(\"table_paymentlog.depositbanktype\").getValue();\r\n");
      out.write("  \t\t \t\t\t\t\t   if(getLength(depositbanktype)>5){\r\n");
      out.write("  \t\t \t\t\t\t\t\t\t  mini.alert(\"银行简称不能超过5个字符或2个汉字\");\r\n");
      out.write("  \t\t \t\t\t\t\t \t return false;\r\n");
      out.write("  \t\t \t\t\t\t  \t\t} \r\n");
      out.write("  \t\t \t\t\t\t\t   var banknumber=getMiniEditFormField(\"table_paymentlog.banknumber\").getValue();\r\n");
      out.write("  \t\t \t\t\t\t       if(getLength(banknumber)>10){\r\n");
      out.write("\t \t\t\t\t\t\t\t  mini.alert(\"收款方银行号不能超过10个字符\");\r\n");
      out.write("\t \t\t\t\t\t \t     return false;\r\n");
      out.write("\t \t\t\t\t  \t\t   } \r\n");
      out.write("  \t\t \t\t\t\t\t\t\r\n");
      out.write("  \t\t \t\t\t\t     \r\n");
      out.write("  \t\t \t\t\t\t\t\t\r\n");
      out.write("  \t\t \t\t\t\t\t\t$.ajax({\r\n");
      out.write("  \t\t\t\t\t\t\t\t\turl : getRootPath()+ \"/eleasing/sendPaymentDate.acl\",\r\n");
      out.write("  \t\t\t\t\t\t\t\t\ttype : \"post\",\r\n");
      out.write("  \t\t\t\t\t\t\t\t\tcache : false,\r\n");
      out.write("  \t\t\t\t\t\t\t\t\tdata : {logid:logid},\r\n");
      ...
      out.write("  \t\t \t\t\t\t},'-',\r\n");
      out.write("  \t\t \t\t\t\t {\r\n");
      out.write("  \t  \t\t   \t\t\t\thtml:'更新付款状态',\r\n");
      out.write("  \t  \t\t \t\t\t\t\tplain : true,\r\n");
      out.write("  \t  \t\t \t\t\t\t\thandler : function(miniTable, buttonText) {\r\n");
      out.write("  \t  \t\t \t\t\t\t\tvar row = miniTable.getSelected();//updatePaymentStatus\r\n");
      out.write("  \t  \t\t \t\t\t\t\tvar message='';\r\n");
      out.write("  \t  \t\t \t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\t\t\turl : getRootPath()+ \"/eleasing/updatePaymentStatus.acl\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\tcache : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata : {},\r\n");
      out.write("\t\t\t\t\t\t\t\t\tasync : false,\r\n");
      ...
      out.write("\t\t\t\t   \t{field : 'erppaymentid',header : 'erppaymentid',visible:false},\r\n");
      out.write("\t\t\t\t   \t{field : 'projname',header : '项目名称',formEditorConfig:{readOnly:true},queryConfig:{}},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymentcontractid',header : '合同编号',formEditorConfig:{readOnly:true},queryConfig:{}},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymentprocessid',header : '流程编号',formEditorConfig:{readOnly:true,fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymentmethodtypeid',header : '结算方式',formEditorConfig:{readOnly:true,fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'amount',header : '交易金额',formEditorConfig:{readOnly:true,newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymenttypeid',header : '付款合同类型',visible:false},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymenttypeidname',header : '合同类型',formEditorConfig:{fieldVisible:false},\r\n");
      ...
      out.write("\t\t\t\t\t\tdata:[{id:'保理',text:'保理'},{id:'租赁',text:'租赁'}]\r\n");
      out.write("\t\t\t\t   \t}\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymentstatus',header : '付款状态标识符',visible:false,formEditorConfig:{readOnly:true,newLine:false,fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymentstatusname',header : '付款状态',formEditorConfig:{readOnly:true,newLine:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'errorreason',header : '错误原因',formEditorConfig:{readOnly:true,newLine:true}},\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t\t   \t{field : 'feetypename',header : '费用类型',formEditorConfig:{readOnly:true,newLine:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'paymentaccounts',header : '付款方银行账号',formEditorConfig:{newLine:true}},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t  \t{field : 'depositbankname',header : '收款方开户行',formEditorConfig:{newLine:false},queryConfig:{newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'depositaccountsname',header : '收款方银行账户名称',formEditorConfig:{newLine:true},queryConfig:{newLine:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'depositaccounts',header : '收款方银行账号',formEditorConfig:{newLine:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'depositbanktype',header : '收款方银行简称',formEditorConfig:{newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'depositprovince',header : '收款方开户行省',formEditorConfig:{newLine:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'depositcity',header : '收款方开户行市',formEditorConfig:{newLine:true}},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t  \t{field : 'priorityflag',header : '加急标识',formEditorConfig:{newLine:false},\r\n");
      out.write("\t\t\t\t\t\tqueryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\tshowNullItem:true,\r\n");
      out.write("\t\t\t\t\t\t\tvisible:true,\r\n");
      out.write("\t\t\t\t\t\t\ttype:'combobox',\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'banknumber',header : '收款方银行号',formEditorConfig:{newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'unionbanknumber',header : '收款方联行号',formEditorConfig:{newLine:false}},\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t   \t{field : 'creator',header : '发起人ID',visible:false},\r\n");
      out.write("\t\t\t\t   \t{field : 'creatorid',header : '付款发起人',formEditorConfig:{readOnly:true,newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'createdate',header : '发起时间',\r\n");
      ...
      out.write("\t\t\t\t\t\t}},\t\t\t\t\t\r\n");
      out.write("\t\t\t\t   \t{field : 'modificator',header : '修改人',visible:false},\r\n");
      out.write("\t\t\t\t   \t{field : 'modificatorid',header : '修改人',formEditorConfig:{readOnly:true,newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field : 'modifydate',header : '修改时间',\r\n");
      out.write("\t\t\t\t   \t\tdateFormat : \"yyyy-MM-dd HH:mm:ss\",\r\n");
      out.write("\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\tnewLine : false,\r\n");
      out.write("\t\t\t\t\t\t\treadOnly:true,\r\n");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/voucher/payment/payment_interface_log.jsp(7,7) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005fmessage_005f0.setCode("CustomerCodingMaintenance");
    // /WEB-INF/jsps/solutions/voucher/payment/payment_interface_log.jsp(7,7) name = text type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
