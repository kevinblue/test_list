 ...
 * Generated at: 2017-08-12 03:07:30 UTC
...
public final class financeReportTable_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t            type:'text'}},\r\n");
      out.write("\t\t\t\t\t    {field:'datatypename', header:'数据类型',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t      formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t          fieldVisible:false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t     fillFromFieldName:'datatype',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t          fillProperty:'value'}},\r\n");
      out.write("\t\t\t\t\t    {field:'datatype', header:'数据类型', visible:false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t  formEditorConfig:{\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tparams:{pid: 'reportdatatype', xmlFileName:'combos/comboDict.xml'}}},\t\t            \r\n");
