 ...
 * Generated at: 2017-05-09 06:05:31 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.cust_005finfo.cust_005fcontent;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class cust_005fcontent_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \t\t\t\t\ttitle:'其他合同档案',//修改显示页面的标题\r\n");
      out.write("  \t\t\t\t\tqueryButtonColSpan:4,  \t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\tremoteOper:true,//是否每次操作都交给后台，为true 时必须定义  entityClassName\r\n");
      out.write("  \t\t\t\t\tentityClassName:'com.tenwa.leasing.entity.cust.ContentMaterial',\r\n");
      out.write("  \t\t\t\t\tpageSize:15,\r\n");
      out.write("  \t\t\t\t\tshowPager:true,\r\n");
      out.write("  \t\t\t\t\tlazyLoad:false, \t\r\n");
      out.write("  \t\t\t\t\txmlFileName:'/eleasing/jsp/cust_info/cust_content/get_cust_content.xml',   \t\t\t\t\t \r\n");
      out.write("  \t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\t//tools数组用来画出新增、修改、删除、查询等按钮\r\n");
      out.write("  \t\t\t\t\ttools:[ 'add', '-', 'edit', '-', 'remove','-',\r\n");
      out.write("                              {\r\n");
      out.write("                               html:'查看所有档案资料',\r\n");
      ...
      out.write("  \t\t\t\t\t    {type:'indexcolumn',header:'序号',width:50},  \t\t\t\t\t    \r\n");
      ...
      out.write("\t\t\t\t\t\t               }},\r\n");
      out.write("  \t\t\t\t\t\t{field:'contractnumber',header:'合同编号',\r\n");
      out.write("  \t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t      width:150\r\n");
      out.write("  \t\t\t\t\t\t\t           }},  \t\r\n");
      out.write("  \t\t\t\t\t\t {field:'contractname',header:'合同名称',\r\n");
      out.write("  \t\t\t\t\t\t\t      headerAlign:'center',\r\n");
      out.write("  \t\t\t\t\t\t\t      width:100,\r\n");
      out.write("  \t\t\t\t\t\t\t      allowSort:true ,\t\r\n");
      ...
      out.write("  \t\t\t\t\t\t\t\t labelWidth:100,\r\n");
      out.write("  \t\t\t  \t\t\t\t\t\t width:150}}, \r\n");
      out.write("  \t\t\t  \t\t\t{field:'othername',header:'对方名称',\r\n");
      out.write("  \t\t\t  \t\t\t\t\t  headerAlign:'center',\r\n");
      out.write("  \t\t\t  \t\t\t\t\t  width:100,\r\n");
      out.write("  \t\t\t  \t\t\t\t\t  allowSort:true ,\r\n");
      out.write("  \t\t\t  \t\t\t\t\t  queryConfig : {},\t\t\t\t\r\n");
      ...
      out.write("\t  \t\t\t  \t\t\t   labelWidth:100,\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    width:150}}, \t  \t\t\t  \t\t\t\t\t\t  \t\t\t     \r\n");
      out.write("  \t\t\t  \t\t\t{field:'contractmoney',header:'合同金额',\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    \theaderAlign:'center',\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    \twidth:100,\r\n");
      out.write("\t  \t\t\t  \t\t\t\t    \tallowSort:true ,\t\t\t\t\t\r\n");
      out.write("  \t\t\t  \t\t\t    formEditorConfig:{\r\n");
      ...
      out.write("  \t\t\t  \t\t\t  \t  \t\tlabelWidth:100,\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t width:150}}, \r\n");
      out.write("  \t\t\t  \t\t\t {field:'othernumber',header:'对方编号',\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t headerAlign:'center',\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t width:100,\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t allowSort:true ,\t\r\n");
      out.write("  \t\t\t  \t\t\t  \t\t  \t\t\t queryConfig : {width:200,newLine:false},\t\t\t\t\r\n");
      out.write("\t  \t  \t\t\t  \t\t\t\tformEditorConfig:{\r\n");
      out.write("\t  \t  \t\t\t  \t\t\t\t\t  newLine:true,\r\n");
      out.write("\t  \t\t  \t\t\t  \t\t\t\t\t type:'text',\t\t\t\t\t\t\t\t\r\n");
      out.write("\t  \t\t  \t\t\t  \t\t\t   labelWidth:100,\r\n");
      out.write("\t  \t\t  \t\t\t  \t\t\t\t    width:150}},\r\n");
      out.write("\t  \t\t  \t\t\t {field:'contractexplain',header:'合同说明',\r\n");
      out.write("\t  \t\t  \t\t\t  \t\t\t\t    \theaderAlign:'center',\r\n");
      out.write("\t  \t\t  \t\t\t  \t\t\t\t    \twidth:100,\r\n");
      out.write("\t  \t\t  \t\t\t  \t\t\t\t    \tallowSort:true ,\t\t\t\t\t\r\n");
      out.write("\t  \t\t  \t  \t\t\t  \t\tformEditorConfig:{\t\r\n");
      ...
      out.write("  \t\t  \t\t  \t\t\t  \t\t\t\t    colspan:4\r\n");
      out.write("  \t\t  \t\t  \t\t\t  \t\t\t\t  }},\r\n");
      out.write("\t  \t\t  \t\t  \t {field:'signdate',header:'签订日期',\r\n");
      out.write("\t  \t\t  \t\t  \t\t\t  \t\t\t\t headerAlign:'center',\r\n");
      out.write("\t  \t\t  \t\t  \t\t\t  \t\t\t\t width:100,\r\n");
      out.write("\t  \t\t  \t\t  \t\t\t  \t\t\t\t allowSort:true ,\r\n");
      out.write("\t  \t\t  \t\t  \t\t\t  \t\t\tqueryConfig : {\r\n");
      ...
      out.write("\t  \t\t  \t\t\t\tdefaultValue:mini.formatDate(new Date(),\"yyyy-MM-dd\"),\r\n");
      out.write("\t  \t\t  \t\t\t\t\t\t\t\t   format:'yyyy-MM-dd'}}, \r\n");
      out.write("\t  \t\t  \t\t\t {field:'contractleader',header:'负责人',\r\n");
      out.write("\t  \t\t  \t\t\t\t  \t\t\t\theaderAlign:'center',\r\n");
      out.write("\t  \t\t  \t\t\t\t  \t\t\t\twidth:100,\r\n");
      out.write("\t  \t\t  \t\t\t\t  \t\t\t\tallowSort:true ,\r\n");
      out.write("\t  \t\t  \t\t\t\t  \t\t\tqueryConfig : {},\t\r\n");
      ...
      out.write("\t  \t\t  \t\t  \t\t  \t\t  \t\t\t width:150}},  \r\n");
      out.write("  \t\t\t\t\r\n");
      out.write("\t  \t\t\t\t\t{field:'archivesark',header:'档案柜号',\r\n");
      out.write("\t  \t\t  \t\t  \t\t  \t\t  \t\t\t\theaderAlign:'center',\r\n");
      out.write("\t  \t\t  \t\t  \t\t  \t\t  \t\t\t\twidth:100,\r\n");
      out.write("\t  \t\t  \t\t  \t\t  \t\t  \t\t\t\tallowSort:true ,\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tformEditorConfig:{\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t \t\t\t\t labelWidth:100,\r\n");
      out.write("\t  \t\t\t\t\t\t  \t\t\t\t      width:150}},\t\r\n");
      out.write("\t  \t\t\t\t\t{field: 'savedate',header:'归档时间',\t\r\n");
      out.write("\t  \t\t\t\t\t\t  \t\t\t\t headerAlign:'center',\r\n");
      out.write("\t  \t\t\t\t\t\t  \t\t\t\t width:100,\r\n");
      out.write("\t  \t\t\t\t\t\t  \t\t\t\t allowSort:true,\r\n");
      out.write("\t  \t\t\t\t\t\t  \t\t\t\tqueryConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t     \t\t\tformat:'yyyy-MM-dd'}},\t\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\t    {field: 'archivesnumber',header:'档案编号',\t\r\n");
      out.write("\t  \t\t\t\t\t  \t\t\t\t\t headerAlign:'center',\r\n");
      out.write("\t  \t\t\t\t\t  \t\t\t\t\t width:100,\r\n");
      out.write("\t  \t\t\t\t\t  \t\t\t\t\t allowSort:true,\r\n");
      out.write("\t  \t\t\t\t\t  \t\t\t\t \r\n");
      out.write("\t  \t\t\t\t\t  \t\t\t\t\t visible:true ,queryConfig : {newLine:true },\r\n");
      out.write("  \t\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t\t\t   type:'text',\r\n");
      ...
      out.write("  \t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t{field: 'archivesexplain',header:'档案说明',\t\r\n");
      out.write("  \t\t\t\t\t  \t\t\t\t\t\t  headerAlign:'center',\r\n");
      out.write("  \t\t\t\t\t  \t\t\t\t\t\t  width:100,\r\n");
      out.write(" \t  \t\t\t\t\t  \t\t\t\t\t allowSort:true, \r\n");
      ...
      out.write("  \t\t\t\t\treturn false;  \r\n");
      out.write("  \t\t\t  } */\r\n");
      out.write("  \t\t\tvar urlFlag = getRootPath()+\"/leasing/cust_info/cust_content/cust_content_file_list.bi?id=\"+id+\"&type=\"+type;\r\n");
      out.write("  \t\t\tmini.open({\r\n");
      out.write("  \t\t        url: urlFlag,\r\n");
      out.write("  \t\t        title: \"档案资料\", width: 800, height: 455,\r\n");
