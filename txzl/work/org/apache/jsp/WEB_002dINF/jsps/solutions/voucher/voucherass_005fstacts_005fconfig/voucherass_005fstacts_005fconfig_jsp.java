 ...
 * Generated at: 2017-05-09 06:06:02 UTC
...
public final class voucherass_005fstacts_005fconfig_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t   \t{field:'subjectsid', header:'科目编码ID',queryConfig:{},formEditorConfig:{required: true}},\r\n");
      out.write("\t\t\t\t   \t{field:'subjectsname', header:'科目名称',formEditorConfig:{required: true}},\t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'subjects_code_long', header:'科目代码',formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'subjectscode', header:'科目段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t\t{field:'subjects_onename', header:'科目段描述',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'company_code', header:'公司段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t\t{field:'company_name', header:'公司段名称',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t   \t{field:'sonsubject_code', header:'子科目段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'sonsubject_name', header:'子科目段名称',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t   \t{field:'respon_center', header:'责任中心段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'respon_center_name', header:'责任中心段名称',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t{field:'product', header:'产品段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t   \t{field:'product_name', header:'产品段名称',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t\t{field:'attribute', header:'属性段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t\t{field:'attribute_name', header:'属性段名称',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'intrabranch', header:'内部往来段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t\t{field:'intrabranch_name', header:'内部往来段名称',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t\t{field:'stanby', header:'备用段',visible:false,formEditorConfig:{fieldVisible: true,required: true,newLine:true}},\r\n");
      out.write("\t\t\t\t\t{field:'stanby_name', header:'备用段',visible:false,formEditorConfig:{fieldVisible: true,required: true}},\r\n");
      out.write("\t\t\t\t\t\r\n");
