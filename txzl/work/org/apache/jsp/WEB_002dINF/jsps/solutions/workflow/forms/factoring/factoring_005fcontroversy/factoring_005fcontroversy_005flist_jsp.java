 ...
 * Generated at: 2017-04-01 02:51:17 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.forms.factoring.factoring_005fcontroversy;
...
public final class factoring_005fcontroversy_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\tid:'table_factoring_controversy',\r\n");
      out.write("\t\t\t\trenderTo : \"id_table_factoring_controversy_list\",\r\n");
      ...
      out.write("\t\t\t\t\t//如果是新增就获取流水号 \r\n");
      out.write("\t\t\t\t\tif (editFormItemOperFlag == 'add') {\r\n");
      out.write("\t\t\t\t\t\tvar num=0;\r\n");
      out.write("\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\turl : getRootPath()+ \"/acl/getApplicationRunningWater.acl\",\r\n");
      out.write("\t\t\t\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\t\t\t\tcache : false,\r\n");
      out.write("\t\t\t\t\t\t\tdata : {},\r\n");
      out.write("\t\t\t\t\t\t\tasync : false,\r\n");
      out.write("\t\t\t\t\t\t\tsuccess : function(date) {\r\n");
      out.write("\t\t\t\t\t\t\t\tmini.getbyName(\"applicationnumber\").setValue(date);\r\n");
      out.write("\t\t\t\t\t\t\t\tnum++;\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\tif(num==1){\r\n");
      ...
      out.write("\t\t\t\t\t} \r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.factoring.FactoringControversy',\r\n");
      out.write("\t\t\t\txmlFileName:'/eleasing/workflow/factoring/factoring_controversy/factoring_controversy_list.xml',\r\n");
      out.write("\t\t\t\ttools: ['add', '-', 'edit', '-','remove','-','exportExcel','-',\r\n");
      out.write("\t\t\t\t       {\thtml : '生成保理争议通知单',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tparams['label.applicationnumber'] = row.applicationnumber;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tparams['label.purchasername'] = row.purchasername;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tparams['label.invoicecode'] = row.invoicecodename;\r\n");
      out.write("\t\t\t\t\t\t\t\t  \tvar fileTeplate=new fileTemplateConfig({\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttemplateno : 'F-201612007',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmini.alert('请选择需要生成保理争议的选项！！！');\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t  \t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t],\r\n");
      ...
      out.write("\t\t\t\t    },\r\n");
      out.write("\t\t\t\t    {\r\n");
      out.write("\t\t\t\t    \tfield:'applicationnumber',\r\n");
      out.write("\t\t\t\t    \theader:'争议申请编号',\r\n");
      ...
      out.write("\t\t\t\t    },\r\n");
      out.write("\t\t\t\t    {\r\n");
      out.write("\t\t\t\t    \t//contractidname在页面显示,对应着页面查询的XML\r\n");
      out.write("\t\t\t\t    \tfield:'contractidname',\r\n");
      ...
      out.write("\t\t\t\t    },\r\n");
      out.write("\t\t\t\t    {\r\n");
      out.write("\t\t\t\t    \t//contractid在页面不显示,对应着页面查询的XML\r\n");
      ...
      out.write("\t\t\t\t\t\t\trequired : true,\r\n");
      out.write("\t\t\t\t\t\t\t//弹出框显示值为contractid,实际存储为id值r\r\n");
      out.write("\t\t\t\t\t\t\ttextField : 'contractid',\r\n");
      out.write("\t\t\t\t\t\t\tvalueField : 'idvalue',\r\n");
      ...
      out.write("\t\t\t\t                var clientBankQueryInput = getMiniuiExtObject(\"table_factoring_controversy_editFormPopupWindow_form_invoicecode\");\r\n");
      out.write("\t\t\t\t                var conidparams=clientBankQueryInput.params ;\r\n");
      out.write("\t\t\t                    conidparams.contract_id= rowDatas;\r\n");
      out.write("\t\t\t                    mini.getbyName(\"invoicecode\").setText(\"\");\r\n");
      out.write("\t\t\t                    mini.getbyName(\"invoicecode\").setValue(\"\");\r\n");
      out.write("\t\t\t                    mini.getbyName(\"invoicecodename\").setValue(\"\");\r\n");
      out.write("\t\t\t                    mini.getbyName(\"purchasername\").setValue(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\txmlFileName : '/eleasing/workflow/factoring/factoring_controversy/factoring_controversy_contractId.xml'\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t    },\r\n");
      out.write("\t\t\t\t    {\r\n");
      ...
      out.write("\t\t\t\t    },\r\n");
      out.write("\t\t\t\t    {\r\n");
      out.write("\t\t\t\t    \tfield:'invoicecodename',\r\n");
      out.write("\t\t\t\t    \theader:'发票号',\r\n");
      out.write("\t\t\t\t    \theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t    \tallowSort:true,\r\n");
      out.write("\t\t\t\t    \tqueryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\twidth : 200\r\n");
      ...
      out.write("\t\t\t\t\t\t\ttype : 'queryinput',\r\n");
      out.write("\t\t\t\t\t\t\trequired : true,\r\n");
      out.write("\t\t\t\t\t\t\tonvaluechanged:'clearSonInputData',\r\n");
      out.write("\t\t\t\t\t\t\ttextField : 'invoicecode',\r\n");
      out.write("\t\t\t\t\t\t\tvalueField : '',\r\n");
      out.write("\t\t\t\t\t\t\tallowInput : false,\r\n");
      out.write("\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\tonSelect : function($me,queryInput,rowData) {\r\n");
      out.write("\t\t\t\t\t\t\t\tmini.getbyName(\"purchasername\").setValue(rowData.purchasername);\r\n");
      out.write("\t\t\t\t\t\t\t\tvar clientBankQueryInput = getMiniuiExtObject(\"table_factoring_controversy_editFormPopupWindow_form_invoicecode\");\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\txmlFileName : '/eleasing/workflow/factoring/factoring_controversy/factoring_controversy_invoicecode.xml',\r\n");
      out.write("\t\t\t\t\t\t\t\tcontract_id: 'xxx'\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t    }, \r\n");
      out.write("\t\t\t\t    {\r\n");
      out.write("\t\t\t\t    \tfield:'purchasername',\r\n");
      out.write("\t\t\t\t    \theader:'买方名称',\r\n");
      out.write("\t\t\t\t    \theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t    \tallowSort:true,\r\n");
      out.write("\t\t\t\t    \tqueryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\twidth : 200,\r\n");
      ...
      out.write("\t\t\t\t    },\r\n");
      out.write("\t\t\t\t    {\r\n");
      out.write("\t\t\t\t    \tfield:'explaination',\r\n");
      out.write("\t\t\t\t    \theader:'争议申请说明',\r\n");
      out.write("\t\t\t\t    \twidth:200,\r\n");
      out.write("\t\t\t\t    \theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t    \tallowSort:true,\r\n");
      out.write("\t\t\t\t    \tqueryConfig:{\r\n");
      ...
      out.write("\t\t<div id=\"id_table_factoring_controversy_list\"></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html> ");
