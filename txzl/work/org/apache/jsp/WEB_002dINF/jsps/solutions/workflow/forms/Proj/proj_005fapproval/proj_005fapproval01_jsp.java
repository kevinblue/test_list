...
public final class proj_005fapproval01_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        miniui_ext.saveIncludeData(\"tabApprovalDeatils\");\r\n");
      out.write("/*         \r\n");
      out.write("        if(mini.getbyName('rawValue_proj_info.leasform').getValue()==\"直租\"){\r\n");
      out.write("        \tvar data=mini.get('proj_equip').getData();\r\n");
      out.write("        \tif(mini.get('proj_equip').getData().length==0){\r\n");
      out.write("        \t\tmini.alert(\"直租时，租赁物明细不能为空！\");\r\n");
