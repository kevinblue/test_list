 ...
 * Generated at: 2017-08-12 03:10:57 UTC
...
public final class appVersion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar phonetype=[{id:'android'},{id:'ios'}];\r\n");
      out.write("\t\tvar isnew=[{id:'yes',name:'是'},{id:'no',name:'否'}];\r\n");
      out.write("\t\tvar isneed=[{id:'yes',name:'Y'},{id:'no',name:'N'}];\r\n");
      out.write("\t\tnew ApTable({\r\n");
      out.write("\t\t\tid : 'table_app_version',\r\n");
      out.write("\t\t\twidth : globalClientWidth,\r\n");
      out.write("\t\t\theight : globalClientHeight,\r\n");
      out.write("\t\t\ttitle : 'APP版本管理',\r\n");
      ...
      out.write("\t\t\tentityClassName : 'com.tenwa.business.entity.AppVersion',\r\n");
      out.write("\t\t\txmlFileName : '/eleasing/jsp/template_word/appversion_info.xml',\r\n");
      out.write("\t\t\ttools : [ 'add', '-', 'edit', '-', 'remove', '-',\r\n");
      out.write("                   {\r\n");
      out.write("\t\t\t\t     html : '上传安装包',plain : true,iconCls : 'icon-edit',\r\n");
      out.write("\t\t\t\t     handler : function(miniTable, buttonText) {\r\n");
      out.write("\t\t\t\t\t       var row = miniTable.getSelected();\r\n");
      out.write("\t\t\t\t\t       if(row){\r\n");
      out.write("\t\t\t\t\t    \t   uploadFile(row.id,row.versionid);\r\n");
      out.write("\t\t\t\t\t        }else{\r\n");
      out.write("\t\t\t\t\t         mini.alert('请选择版本！！！');\r\n");
      out.write("\t\t\t\t\t    }}\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t      ],\r\n");
      out.write("\t\t\tcolumns : [ \r\n");
      ...
      out.write("\t\t\t\t\t\t{field:'versionid',header:'版本号',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t{field:'versionname',header:'版本名称',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t{field:'versioncode',header:'版本下载码',\r\n");
      out.write("\t\t\t\t\t\t\tqueryConfig:{newLine: true},\r\n");
      out.write("\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\tnewLine: true,\r\n");
      out.write("\t\t\t\t\t\t\t\ttype : 'text',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t{field:'updates',header:'发布日期',\r\n");
      out.write("\t\t\t\t\t\t\tqueryConfig:{},\r\n");
      out.write("\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\ttype : 'date',\r\n");
      out.write("\t\t\t\t\t\t\t\tnewLine : true }\r\n");
      out.write("\t\t\t\t\t\t},\t\r\n");
      out.write("\t\t\t\t\t\t{field:'phonetype',header:'手机类型',\r\n");
      out.write("\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      ...
      out.write("\t\t\t\t              data:phonetype\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t{field:'isnew',header:'是否最新版本',\r\n");
      out.write("\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t   \t\t\t                 type:'combobox',\r\n");
      out.write("\t\t\t\t             required:false,\r\n");
      ...
      out.write("\t\t\t\t           showNullItem:\"true\" ,\r\n");
      out.write("\t\t\t\t                  data:isnew\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t{field:'mustupdate',header:'是否强制更新',\r\n");
      out.write("\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t   \t\t\t                 type:'combobox',\r\n");
      out.write("\t\t\t\t             required:false,\r\n");
      ...
      out.write("\t\t\t\t           valueField:'name',\r\n");
      out.write("\t\t\t\t           showNullItem:\"true\" ,\r\n");
      out.write("\t\t\t\t                  data:isneed\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t{field:'skipcelld',header:'安装包',formEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\tfieldVisible : false\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\trenderer : function(e){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar id = e.record.basefileid;\r\n");
      out.write("\t\t\t\t\t\t\t\t if(e.record.imagepath.length<2){\r\n");
      out.write("\t\t\t\t\t\t\t        \treturn \"无安装包\";\r\n");
      out.write("\t\t\t\t\t\t\t         }else{\r\n");
      out.write("\t\t\t\t\t\t\t        \t return \"<a href='javascript:void(0);' onclick='downloadFile(\\\"\" + id + \"\\\")'>下载 </a>\";\r\n");
      out.write("\t\t\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("   \t//上传模板\r\n");
      out.write("\tfunction uploadFile(id,versionid){\r\n");
      out.write("\t\tvar uploadutil=new uploadUtil({\r\n");
      out.write("\t\t\turl:'/leasing/file/uploadFile.action',modelname:'app_version',\r\n");
      out.write("\t\t\ttitle:'上传安装包',\r\n");
      out.write("\t        parames:{appId:id,versionid:versionid}}\r\n");
      out.write("\t\t);\r\n");
      ...
      out.write("\t\tvar uploadutil=new uploadUtil({url:'/leasing/template/downLoadAttachById.action',parames:{id:Id}});\r\n");
      out.write("\t\tuploadutil.createFormAndDown();\r\n");
      out.write("\t    mini.unmask(document.body);\r\n");
      out.write("\t}\t\r\n");
      out.write("\tfunction reloadTable(message){\r\n");
      out.write("\t\tmini.alert(message);\r\n");
      out.write("\t\tmini.get(\"table_app_version\").reload();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("</body>\r\n");
