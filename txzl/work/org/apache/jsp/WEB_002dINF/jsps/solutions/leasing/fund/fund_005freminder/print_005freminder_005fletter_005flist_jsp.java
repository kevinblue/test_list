 ...
 * Generated at: 2017-06-16 03:32:37 UTC
...
public final class print_005freminder_005fletter_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t    \t//客户名称\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.custname'] = row.custname;\r\n");
      out.write("\t\t\t\t\t    \tvar sdate = row.startdate;\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.startdate'] = sdate.substring(0,4)+\"年\"+sdate.substring(5,7)+\"月\"+sdate.substring(8)+\"日\";\r\n");
      out.write("\t\t\t\t\t    \t//合同号\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.contract_id'] = row.contract_id;\r\n");
      out.write("\t\t\t\t\t    \tvar pdate = row.plandate;\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.plandate'] = pdate.substring(0,4)+\"年\"+pdate.substring(5,7)+\"月\"+pdate.substring(8)+\"日\";\r\n");
      out.write("\t\t\t\t\t    \t//逾期期数\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.rentlist'] = row.overduenum;\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.overduerent'] = row.overduerent;\r\n");
      out.write("\t\t\t\t\t    \tvar sumoverduerent = parseFloat(row.overduerent)+parseFloat(row.penalty);\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.sumoverduerent'] = sumoverduerent;\r\n");
      out.write("\t\t\t\t\t    \tvar thisdate=mini.formatDate(new Date(),\"yyyy-MM-dd\");\r\n");
      out.write("\t\t\t\t\t    \tparams['overdue.systemdate']=thisdate.substring(0,4)+\"年\"+thisdate.substring(5,7)+\"月\"+thisdate.substring(8)+\"日\";\r\n");
      out.write("\t\t\t\t\t\t    var fileTeplate=new fileTemplateConfig({\r\n");
      out.write("\t\t\t\t\t\t\t\ttemplateno:'F-201612011',\r\n");
      ...
      out.write("\t\t\t\t{field:'contract_id',header:'合同编号',headerAlign:'center',width:100,allowSort:true},\r\n");
      ...
      out.write("\t\t\t\t\t          width:200}},\r\n");
      out.write("\t\t\t    {field:'startdate',header:'签约日期',headerAlign:'center',width:100,visible:false},\r\n");
      out.write("\t\t\t    {field:'plandate',header:'计划日期',headerAlign:'center',width:100,visible:false},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t return incrent>0||penalty>0?parseFloat(incrent) + parseFloat(penalty):0;\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t        type: \"post\",\r\n");
      out.write("\t        cache: false, \r\n");
      out.write("\t        data:{\"id\":row.id,\"status\":0},\r\n");
      out.write("\t        async:false,\r\n");
      out.write("\t        success: function (text) {\r\n");
