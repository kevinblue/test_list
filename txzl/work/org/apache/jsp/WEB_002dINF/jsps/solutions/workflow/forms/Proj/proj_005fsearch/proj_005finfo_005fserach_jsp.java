 ...
 * Generated at: 2017-06-15 08:29:45 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.forms.Proj.proj_005fsearch;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class proj_005finfo_005fserach_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\tvar statusnamedate = [ {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid : '项目立项',\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目立项'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid : '项目信审(审批通过)',\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目信审(审批通过)'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid : '项目复议',\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目复议'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项登记[草稿]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项登记[进行中]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项登记[已结束]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项变更[草稿]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项变更[进行中]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项变更[已结束]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目撤销[草稿]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目撤销[进行中]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '立项登记[已结束]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目审批[草稿]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目审批[进行中]'\r\n");
      out.write("\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttext : '项目审批[已结束]'\r\n");
      out.write("\t\t\t\t\t\t\t\t} ];\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\txmlFileName : \"/eleasing/workflow/proj/proj_search/proj_info_query.xml\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\treturn \"<a href='javascript:showcustinfo(\\\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ row.custid\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"\\\")'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ row.custname\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\treturn \"<a href='javascript:void(0);' onclick='viewProjSummary(\\\"\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ rowData[\"projid\"]\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"\\\")'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ rowData[\"proname\"]\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'cleanleasemoney',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tdataType : \"currency\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '融资金额',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'equipamt',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tdataType : \"currency\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvisible:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '合同金额',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tsummary:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\talign : \"right\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   \t\t\t\t\t   \t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'industrytypename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '内部行业（项目）',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'flowstatus',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '当前流程状态',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 115,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '最新步骤名称',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 170,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tallowSort : true\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'planusers',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '最新步骤处理人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tallowSort : true\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : 'eleasing/jsp/base/t_district.xml',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tPID : 'CHN'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projdate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '立项日期',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tallowSort : true\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projdeptname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '业务部'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'deptroute',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '业务子部门'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projimpotername',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '项目导入人'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projmanagename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '项目经理'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projassistname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '项目助理'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'seller',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\theader : '供应商(用\",\"分隔)',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 200,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trenderer : function(e) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar row = e.record;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\treturn \"<a href='javascript:showcustinfo(\\\"\"\r\n");
      ...
      out.write("\t\t\t\t\t+ \"/leasing/cust_info/cust_company/cust_company_detail.bi?\"\r\n");
      out.write("\t\t\t\t\t+ params;\r\n");
  ...
  private boolean _jspx_meth_permission_005faction_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(21,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(24,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(27,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(30,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(33,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(36,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_permission_005faction_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/workflow/forms/Proj/proj_search/proj_info_serach.jsp(40,2) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
