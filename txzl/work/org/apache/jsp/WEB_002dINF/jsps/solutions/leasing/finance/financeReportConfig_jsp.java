 ...
 * Generated at: 2017-03-20 11:03:23 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.finance;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class financeReportConfig_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String id=request.getParameter("id");
      ...
      out.write("\t\t\teditFormPopupWindowWidth:150,\r\n");
      out.write("\t\t\teditFormPopupWindowHeight:250,\t\t\r\n");
      out.write("\t\t\tshowPager:true,\r\n");
      out.write("\t\t\tremoteOper:true,\r\n");
      out.write("\t\t\tentityClassName:'com.tenwa.leasing.entity.finance.FinancialSubjects',\r\n");
      out.write("\t\t\tentityBeanCallBackClassName:'com.tenwa.leasing.serviceImpl.Finance.financeConfigCallBack',\r\n");
      out.write("\t\t\txmlFileName:'/eleasing/jsp/finance/financeConfig.xml',\r\n");
      out.write("\t\t\ttools:[ 'add', '-', 'edit', '-', 'remove'],\r\n");
      out.write("\t\t\tparams:{pid:\"");
      out.print(id);
      out.write("\"},\r\n");
      out.write("\t\t\tcolumns:[ \r\n");
      ...
      out.write("\t\t\t\t\t\t{field:'financialtable',header:'financialtable',visible:false,\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t           readOnly:true,\r\n");
      out.write("\t\t\t\t\t\t\t       fieldVisible:false,\r\n");
      out.write("\t\t\t\t\t\t\t              value:\"");
      out.print(id);
      out.write("\"}},\r\n");
      out.write("\t\t\t\t\t\t{field:'subjectname',header:'科目名称'},\r\n");
      out.write("\t\t\t\t\t\t{field:'subjectcode',header:'科目编号',\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t            newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t               type:'text'}},\r\n");
      out.write("\t\t\t\t\t\t{field:'subjectindex',header:'EXCEL行',\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t         newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t\t            type:'text'}},\r\n");
      out.write("\t\t\t\t\t\t{field:'subjectcell',header:'EXCEL列',\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     newLine:true,   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype:'text'}},\t\t\r\n");
      out.write("\t\t\t\t\t\t{field:'formula',header:'科目最小数值',\r\n");
      out.write("\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t       type:'text'}},\r\n");
      out.write("\t\t\t\t\t\t{field:'contrast',header:'年初所在的列',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t       type:'text'}},\r\n");
      out.write("\t\t\t\t\t\t{field:'gongshi',header:'大型对应列',\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype:'text'}},\r\n");
      out.write("\t\t\t\t\t\t{field:'gongshismall',header:'小型对应列',\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype:'text'}},\r\n");
      out.write("\t\t\t\t\t\t{field:'gongshisipp',header:'供应商对应列',\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t newLine:true, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype:'text'}},\r\n");
      out.write("\t\t\t\t\t\t]\r\n");
