 ...
 * Generated at: 2017-03-20 10:08:39 UTC
...
public final class financial_005fdata_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.custid}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\";\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<div style=\"width:100%;height:8%;line-height:40px;\" >\r\n");
      out.write("\t&nbsp;<span>请选择年份:</span>\r\n");
      out.write("\t<select id=\"selectedyear\" style=\"width: 160px;\" onchange=\"changeview()\">\r\n");
      out.write("\t\t");
      if (_jspx_meth_c_005fforEach_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t</select>\r\n");
      out.write("\t<a style=\"float:right;margin-top:6px;margin-right:20px\" class=\"mini-button\" iconCls=\"icon-save\" onclick=\"saveData()\" plain=\"true\">保存</a> \r\n");
      out.write("</div>\r\n");
      out.write("\t<div id=\"id_table_financial_data_edit\" class=\"mini-datagrid\" style=\"width:100%;height:92%;\" \r\n");
      out.write("        url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/table/getTableData.action?tracywindyRandom=1&decorate=none&xmlFileName=/eleasing/jsp/cust_info/cust_financial/select_project_year.xml&custid=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.custid}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\" idField=\"id\" \r\n");
      out.write("        allowResize=\"true\" pageSize=\"20\" dataField=\"datas\"\r\n");
      out.write("        allowCellEdit=\"true\" allowCellSelect=\"true\" multiSelect=\"true\" \r\n");
      out.write("        editNextOnEnterKey=\"true\"  editNextRowCell=\"true\"\r\n");
      out.write("    >\r\n");
      out.write("        <div property=\"columns\">\r\n");
      out.write("            <div type=\"indexcolumn\"></div>\r\n");
      out.write("            <div type=\"checkcolumn\"></div>\r\n");
      out.write("            <div name=\"subjectname\"  field=\"subjectname\" headerAlign=\"center\" allowSort=\"true\" width=\"150\" >资金类型\r\n");
      out.write("            </div>\r\n");
      out.write("            <div name=\"subjectdata\"  field=\"subjectdata\" headerAlign=\"center\" allowSort=\"true\" width=\"150\" >金额\r\n");
      out.write("                <input property=\"editor\" class=\"mini-textbox\" style=\"width:100%;\" />\r\n");
      out.write("            </div>\r\n");
      out.write("            <div name=\"projectyear\"  field=\"projectyear\" headerAlign=\"center\" allowSort=\"true\" width=\"150\" >年度\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("</body>\r\n");
      ...
      out.write("\tvar grid = mini.get(\"id_table_financial_data_edit\");\r\n");
      out.write("    function saveData() {\r\n");
      out.write("        var data = grid.getChanges();\r\n");
      out.write("        var json = mini.encode(data);\r\n");
      out.write("        grid.loading(\"保存中，请稍后......\");\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            url: getRootPath()+\"/leasing/modifyFinanceData.acl\",\r\n");
      out.write("            data: { data: json },\r\n");
      out.write("            type: \"post\",\r\n");
      ...
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("    grid.on(\"celleditenter\", function (e) {\r\n");
      out.write("        var index = grid.indexOf(e.record);\r\n");
      out.write("        if (index == grid.getData().length - 1) {\r\n");
      out.write("            var row = {};\r\n");
      out.write("            grid.addRow(row);\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("\tgrid.load();\r\n");
      out.write("\tfunction changeview(){\r\n");
      out.write("\t\tvar param={};\r\n");
      out.write("\t\tvar selectedyear = $(\"#selectedyear\").val();\r\n");
      out.write("\t\tgrid.load({financialdate:selectedyear});\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("</html>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_finance/financial_data_edit.jsp(17,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("yearsObject");
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_finance/financial_data_edit.jsp(17,2) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /WEB-INF/jsps/solutions/leasing/cust_info/cust_finance/financial_data_edit.jsp(17,2) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${yearsObject.financial_date}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${yearsObject.subject_data}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</option>\r\n");
          out.write("\t\t");
