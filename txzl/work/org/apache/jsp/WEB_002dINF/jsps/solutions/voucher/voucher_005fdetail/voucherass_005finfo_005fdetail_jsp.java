 ...
 * Generated at: 2017-03-08 12:17:26 UTC
...
public final class voucherass_005finfo_005fdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tif(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.rollback}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\" == 1 || \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.rollback}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\" == -1){\r\n");
      ...
      out.write("\t\t\t\tentityClassName:'com.tenwa.leasing.entity.voucher.InterV8Vouchers',\r\n");
      out.write("\t\t\t\tparams:{\r\n");
      out.write("\t\t\t\t\tevidence_number:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.evidence_number}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\",\r\n");
      out.write("\t\t\t\t\trollback : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.rollback}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\txmlFileName : '/voucher/voucher_info_list.xml',\r\n");
      out.write("\t\t\t\ttools : ['edit'],\r\n");
      out.write("\t\t\t\tcolumns : [ \r\n");
      out.write("\t\t\t\t    {type : 'indexcolumn'},\r\n");
      out.write("\t\t\t\t   \t{type : 'checkcolumn'},  \r\n");
      out.write("\t\t\t\t   \t{field : 'id',header : 'id',visible : false},\r\n");
      out.write("\t\t\t\t   \t/*\t{ field : 'evidencetype',header : '凭证基本类别',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'dept_id',header : '所属公司编号',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'dept_name',header : '所属公司名称',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'periodyear',header : '年份',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'f59',header : '序号',visible : false, formEditorConfig:{fieldVisible:false}}, */\r\n");
      out.write("\t\t\t\t   \t{field : 'happen_date',header : '记账日期'},\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t{field : 'recording_voucher',header : '凭证字',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'evidence_number',header : '凭证号', formEditorConfig:{fieldVisible:false}},\r\n");
      ...
      out.write("\t\t\t\t  \t \t,width:350\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'subjects_code',header : '科目编码', \r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t   \t\t\tnewLine:true\r\n");
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t\t,width:270\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'debit',header : '借方金额'},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t{field : 'credit',header : '贷方金额'},\r\n");
      out.write("\t\t\t\t   \t/* {field : 'f9',header : '数量',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'f10',header : '外币',visible : false, formEditorConfig:{fieldVisible:false}}, */\r\n");
      out.write("\t\t\t\t   \t{field : 'ebank_fact_date',header : '到账日期', formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   /* \t{field : 't_depts_uuid',header : '部门编码',visible : false, formEditorConfig:{fieldVisible:false}}, */\r\n");
      out.write("\t\t\t//\t   \t{field : 'f18',header : '客户编码', formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t\t{field : 'client_id',header : '客户编码', formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'vndr_id',header : '供应商编码',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'acc_set_number',header : '帐套',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'acc_year',header : '会计年度',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'acc_month',header : '会计月份', formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t{field : 'subjects_name',header : '科目名称', formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t/* {field : 'f63',header : '部门名称',visible : false, formEditorConfig:{fieldVisible:false}}, */\r\n");
      out.write("\t\t\t\t   /* \t{field : 'f66',header : '供应商名称',visible : false, formEditorConfig:{fieldVisible:false}}, */\r\n");
      out.write("\t\t\t\t   \t{field : 'inter_contract_id',header : '合同号', formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   /* \t{field : 'f68',header : '项目大类编码',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'f69',header : '项目大类名称',visible : false, formEditorConfig:{fieldVisible:false}}, */\r\n");
      out.write("\t\t\t\t   \t{field : 'voucher_status',header : '凭证状态',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'exp_flag',header : '导出状态',visible : false, formEditorConfig:{fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field:'rollback',header:'凭证状态',visible:true,formEditorConfig:{fieldVisible:false}}\r\n");
      out.write("\t\t\t\t]\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
