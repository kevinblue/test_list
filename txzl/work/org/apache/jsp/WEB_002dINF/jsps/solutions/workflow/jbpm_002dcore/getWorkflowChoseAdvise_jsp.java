...
public final class getWorkflowChoseAdvise_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_spring_005fmessage_005f0(_jspx_page_context))
        return;
      out.write("\" style=\"display:none;width:550px;\">\r\n");
      out.write("\t<div style=\"padding: 5px 0px;\">\r\n");
      out.write("\t\t<table style=\"width:530px\" style=\"padding:1px;\">\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"tr-even\" style=\"width:300px;\">\r\n");
      out.write("\t\t\t\t<td style=\"width:80px;text-align:right;\">审批结论：</td>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr class=\"tr-odd\">\r\n");
      out.write("\t\t\t\t<td style=\"width:80px;text-align:right;\">审批意见：</td>\r\n");
      out.write("\t\t\t\t<td style=\"text-align:left;\">\r\n");
      out.write("\t\t\t\t\t<textarea id=\"text_selectedAdvise\" style=\"width:400px;height:200px;border:1px solid #DDD;font-size: 12px;\"></textarea>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("</textarea>\r\n");
      out.write("<textarea id='id_processedResultTxt' style=\"display:none;\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${currentJBPMWorkflowHistoryInfoUser.processedResult.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("</textarea>\r\n");
      out.write("<textarea id='id_processedResultShowTxt' style=\"display:none;\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${currentJBPMWorkflowHistoryInfoUser.processedResult.name}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("</textarea>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tvar currentSavedAdvise = (jQuery(\"#id_processedAdviseTxt\").val()||jQuery(\"#id_assignedAdviseTxt\").val());\r\n");
      out.write("\tvar currentSavedResult = jQuery(\"#id_processedResultTxt\").val();\r\n");
      out.write("\tvar currentShowSavedResult = jQuery(\"#id_processedResultShowTxt\").val();\r\n");
      out.write("\t\r\n");
      out.write("\t// 加载意见列表意见\r\n");
      out.write("\tfunction addCommonAdivse(hidden_text_choseAdviseValue,hidden_choseResult,show_choseResult) {\r\n");
      ...
      out.write("\t\t$(\"#id_hidden_choseResult\").val(hidden_choseResult);\r\n");
      out.write("\t\t$(\"#id_show_choseResult\").val(show_choseResult);\r\n");
      ...
      out.write("\t\tinsertHtml +='\t<span style=\"width:300px;margin-left:5%;height:100%;padding-top:5px;font-size:12px;\">【审批结论】<font style=\"color:red;\">'+ show_choseResult+'</font></span>';\r\n");
      ...
      out.write("\t\tinsertHtml+='<div id=\"id_currentTaskFilledAdvise_2\" style=\"border:0px solid silver;border-top:0px solid #FFFFFF;border-bottom:0px;padding-left:20px;height:auto;line-height:25px;background-color:#FFFFFF;\">';\r\n");
      ...
      out.write("\t\tvar hidden_choseResult=$(\"#id_processedResultTxt\").val() ;\r\n");
      out.write("\t\tvar show_choseResult=$(\"#id_processedResultShowTxt\").val();\r\n");
      out.write("\t\tmini.get('id_selectAdvise_combo').setValue(hidden_choseResult);\r\n");
      out.write("\t\tmini.get('id_selectAdvise_combo').setText(show_choseResult);\r\n");
      ...
      out.write("\t\t$(\"#id_hidden_choseResult\").val(mini.get('id_selectAdvise_combo').getValue());\r\n");
      out.write("\t\t$(\"#id_show_choseResult\").val(mini.get('id_selectAdvise_combo').getText());\r\n");
      out.write("\t\t$(\"#id_processedResultTxt\").val(mini.get('id_selectAdvise_combo').getValue());\r\n");
      out.write("\t\t$(\"#id_processedResultShowTxt\").val(mini.get('id_selectAdvise_combo').getText());\r\n");
      out.write("\t\tvar workflowAdviseContainer = document.getElementById('id_workflowAdviseContainer');\r\n");
      ...
      out.write("\t\tinsertHtml +='<div id=\"id_currentTaskFilledAdvise_1\" style=\"border:0px solid silver;padding:5px;height:auto;line-height:25px;background-color:#EFEFEF;\">';\r\n");
      ...
      out.write("\t\tinsertHtml +='\t<span style=\"width:300px;margin-left:5%;height:100%;padding-top:5px;font-size:12px;\">【审批结论】<font style=\"color:red;\">'+ mini.get('id_selectAdvise_combo').getText()+'</font></span>';\r\n");
      out.write("\t\tinsertHtml +='\t<span style=\"width:150px;margin-left:20%;height:100%;padding-top:4px;font-size:12px;\">';\r\n");
      out.write("\t\tinsertHtml +='\t\t<a href=\"javascript:void(0);\" style=\"text-decoration:none;\" onclick=\"showModalCommonAdivseWindow();\"><img align=\"absmiddle\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/menuIcons/pencil.png\" border=\"0\"/>&nbsp;'+workFlowlocale['Edit']+'</a>';\r\n");
      ...
      out.write("\t\t$(\"#id_hidden_choseResult\").val(\"\");\r\n");
      out.write("\t\t$(\"#id_show_choseResult\").val(\"\");\r\n");
      out.write("\t\t$(\"#id_processedResultTxt\").val(\"\");\r\n");
      out.write("\t\t$(\"#id_processedResultShowTxt\").val(\"\");\r\n");
      out.write("\t}\r\n");
  ...
  private boolean _jspx_meth_mini_005fdict_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_mini_005fdict_005f0.setOtherproperties("width=\"200px\"");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    _jspx_th_spring_005fmessage_005f3.setCode("Cancel");
    ...
    _jspx_th_spring_005fmessage_005f3.setText("取消");
