 ...
 * Generated at: 2017-03-25 11:16:00 UTC
...
public final class five_005fcategory_005fapply_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar statusdata = [ {name : '',value : ''},{name : '未申请',value : '未申请'},{name : '审核中',value : \"审核中\"},{name : '审核通过',value : '审核通过'},{name : '已退回',value : '已退回'}];\r\n");
      out.write("\r\n");
      out.write("\tjQuery(function() {\r\n");
      out.write("\t\ttenwa\r\n");
      out.write("\t\t\t\t.createTable({\r\n");
      out.write("\t\t\t\t\tid : \"five_category_apply\",\r\n");
      out.write("\t\t\t\t\trenderTo : \"id_table_container_five_category_apply\",\r\n");
      out.write("\t\t\t\t\twidth : currentClientWidth,\r\n");
      out.write("\t\t\t\t\theight : currentClientHeight,\r\n");
      out.write("\t\t\t\t\tlazyLoad : false,\r\n");
      out.write("\t\t\t\t\ttitle : \"五级分类申请\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ \"/acl/showFiveCategoryApplication.acl?opertype=add\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar applystatus=rows[0].apply_status;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif (applystatus!='未审核') {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tmini.alert(\"该申请\" + rows[0].apply_status\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ \"无法修改！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tvar url = getRootPath()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ \"/acl/showFiveCategoryApplication.acl?opertype=edit&applyid=\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ rows[0].id;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar sheight = window.screen.availHeight - 30;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar swidth = window.screen.availWidth - 10;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar winoption = \"left=0px,top=0px,height=\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif (rows[0].apply_status != \"未审核\") {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tmini.alert(\"该申请\" + rows[0].apply_status\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ \"无法删除！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar url = getRootPath()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ \"/acl/deleteFiveCategoryApplication.acl\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar params = {};\r\n");
      out.write("\t\t\t\t\t\t\t\t\tparams[\"applyid\"] = rows[0].id;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\turl : url,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tmini.alert(\"请选择要操作的数据内容！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t};\r\n");
      out.write("\t\t\t\t\t\t\t\t\tif(rows.counts=='0'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tmini.alert(\"申请客户数为0，不允许提交审核！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t}; \r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar url = getRootPath()+ \"/acl/showFiveCategoryApplicationOk.acl\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar params = {};\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar nums =[];\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//debugger;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tnums.push(rows.apply_number);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar x = nums.join(\",\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\tparams[\"applynumbers\"] = x;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\turl : url,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata : params,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype : 'post',\r\n");
      ...
      out.write("\t\t\t\t\txmlFileName : '/eleasing/jsp/other/five_category_apply_detail_list.xml',\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tparams:{\r\n");
      out.write("\t\t\t\t\t\tusername:\"");
      ...
      out.write("\t\t\t\t\t\t\t{field : 'viewdetails',\r\n");
      out.write("\t\t\t\t\t\t\t\theader : '查看明细',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t+ \"查看明细\" + \"</a>\";}\r\n");
      out.write("\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{field : 'apply_number',\r\n");
      out.write("\t\t\t\t\t\t\t\theader : '申请编号',\r\n");
      out.write("\t\t\t\t\t\t\t\tqueryConfig:{}\r\n");
      out.write("\t\t\t\t\t\t\t\t}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{field : 'applyusername',header : '申请人',queryConfig:{}}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{field : 'counts',header : '申请客户数'}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{field : 'apply_date',header : '申请日期',queryConfig:{}}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{field : 'apply_memo',header : '备注'}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{field : 'apply_status',header : '申请状态',queryConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\tvar url = getRootPath()\r\n");
      out.write("\t\t\t\t+ \"/acl/showFiveCategoryApplication.acl?applyid=\"\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<div id=\"id_table_container_five_category_apply\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
