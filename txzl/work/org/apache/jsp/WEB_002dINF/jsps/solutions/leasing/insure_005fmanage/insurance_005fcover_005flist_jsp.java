 ...
 * Generated at: 2017-03-16 03:03:24 UTC
...
public final class insurance_005fcover_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \t\t\t\t\tid:'table_insurancecover_id',\r\n");
      ...
      out.write("  \t\t\t\t\tentityBeanCallBackClassName:'',//'com.tenwa.business.callback.InsuranceCoverCallBack',  \t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\tfrozenStartColumn:0,\r\n");
      out.write("  \t\t\t\t\tfrozenEndColumn:5,  \t \t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\tshowPager:true,\r\n");
      out.write("  \t\t\t\t\tpageSize:15,\r\n");
      out.write("  \t\t\t\t\txmlFileName:'/eleasing/jsp/insure_manage/insurance_cover_list.xml', \r\n");
      out.write("  \t\t\t\t\tcolumns:[ \r\n");
      ...
      out.write("  \t\t\t\t\t\t{field:'custname',header:'客户名',headerAlign:'center',visible:true,width:130,\r\n");
      out.write("\t  \t\t\t\t\t     formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t         type:'text',  \r\n");
      out.write("\t\t\t\t\t\t   \t\t     readOnly:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tvar custname = e.record.custname;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tvar contractid = e.record.contractid;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tvar contractnumber = e.record.contractnumber;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\treturn \"<a href='javascript:void(0);' onclick='opencustdetail(\\\"\" + contractid + \"\\\",\\\"\" + contractnumber + \"\\\")'>\" + custname + \"</a>\";},\r\n");
      out.write("\t\t\t\t\t\t\t      queryConfig:{\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200}} ,\t\r\n");
      out.write("  \t\t\t\t\t\t{field: 'contractid_',header:'合同编号',headerAlign:'center',visible:true,width:130,\r\n");
      out.write("  \t\t\t\t\t   \t\t formEditorConfig:{\r\n");
      out.write("  \t\t\t\t\t   \t\t\t         type:'text',  \r\n");
      out.write("  \t\t\t\t\t   \t\t\t     readOnly:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t fieldVisible:true ,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t      queryConfig:{\t\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200}},  \t\r\n");
      out.write("  \t\t\t\t\t\t{field:'contractnumber', header: '业务合同号', visible: true,width:130,\r\n");
      out.write("\t\t\t\t\t  \t\t\t  queryConfig:{  \r\n");
      out.write(" \t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t\t\t\t   \t\t\t            width:200},\r\n");
      out.write("  \t\t\t\t\t\t     formEditorConfig:{\r\n");
      out.write(" \t\t\t\t\t\t\t\t fieldVisible:false }},\r\n");
      out.write("\t\t\t\t\t   \t{field:'startdate',header:'租赁起始日',headerAlign:'center',visible:true,width:90, dateFormat:\"yyyy-MM-dd\",\r\n");
      out.write("  \t\t\t\t\t     \t formEditorConfig:{\r\n");
      out.write("  \t\t\t\t\t     \t\t         type:'date',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200}},\r\n");
      out.write("\t\t\t\t\t   \t{field:'enddate',header:'租赁截至日',headerAlign:'center',visible:true,width:90,dateFormat:\"yyyy-MM-dd \",\r\n");
      out.write("\t\t\t\t\t   \t \t formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t   \t\t\t         type:'date',  \r\n");
      out.write("\t\t\t\t\t   \t\t\t     readOnly:true,\r\n");
      out.write("\t\t\t\t\t\t   \t\t       format:'yyyy-MM-dd',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200}},\t\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t\t   \t{field:'insurerstartdate',header:'保险生效日',headerAlign:'center',visible:true,width:100, dateFormat:\"yyyy-MM-dd \",\r\n");
      out.write("\t\t\t\t\t   \t\t formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t   \t\t\t      newLine:true,\r\n");
      out.write("\t\t\t\t\t   \t\t\t         type:'date', \r\n");
      out.write("\t\t\t\t\t   \t\t\t     readOnly:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200}},\r\n");
      out.write("\t\t\t\t\t   \t{field:'insurerenddate',header:'保险截止日',headerAlign:'center',visible:true,width:100, dateFormat:\"yyyy-MM-dd \" ,\r\n");
      out.write("\t\t\t\t\t   \t\t formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t   \t\t\t         type:'date',  \r\n");
      out.write("\t\t\t\t\t   \t\t\t     readOnly:true,\r\n");
      out.write("\t\t\t\t\t\t   \t\t       format:'yyyy-MM-dd',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t   labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200 }},\r\n");
      out.write("\t\t\t\t\t   \t{field:'leaseterm',header:'融资期限(月)',headerAlign:'center',visible:true,width:100 ,\r\n");
      out.write("\t  \t\t\t\t\t   \t formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t         type:'text',  \r\n");
      out.write("\t\t\t\t\t\t   \t\t     readOnly:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t fieldVisible:true ,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t        width:200,\r\n");
      out.write("\t\t\t\t\t\t\t\t      newLine:true}},\r\n");
      out.write("\t\t\t\t\t    {field:'handledate',header:'最后处理日期',headerAlign:'center',visible:true,width:100,dateFormat:\"yyyy-MM-dd \" ,\r\n");
      out.write("  \t\t\t\t\t  \t\t formEditorConfig:{\r\n");
      out.write("  \t\t\t\t\t  \t\t\t         type:'date',  \r\n");
      out.write("\t\t\t\t\t   \t\t\t       format:'yyyy-MM-dd',  \t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t fieldVisible:true ,\r\n");
      ...
      out.write("  \t\t\t\r\n");
      out.write("  \t\t});\r\n");
      out.write("  \t\tfunction opencustdetail(contractid,contractnumber){\r\n");
      out.write("  \t\t\tvar params = \"contractid=\"+contractid+\"&contractnumber=\"+contractnumber;\r\n");
      out.write("  \t\t\tvar url = getRootPath()+\"/leasing/insure_manage/insurance_cover_details.bi?\"+params;\r\n");
