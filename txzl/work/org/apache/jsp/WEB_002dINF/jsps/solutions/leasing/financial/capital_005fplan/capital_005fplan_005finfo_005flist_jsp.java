 ...
 * Generated at: 2017-05-24 06:38:02 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.financial.capital_005fplan;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class capital_005fplan_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t//console.info(mini.decode(tabledate));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//mini.getbyName(\"balance\").setValue(\"123\");\r\n");
      out.write("\t\tmini.get(\"id_minitableimport\").hide();\r\n");
      out.write("\t\tmini.get(\"table_capital_plan_id\").reload();\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid : 'table_capital_plan_id',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\timportTargetClass : 'com.tenwa.leasing.entity.finacial.CapitalPlan',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\ttitle : '集团存款',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tremoteOper : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tpageSize : 10,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tshowPager : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tlazyLoad : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tloadMode : 'ajax',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tqueryButtonColSpan : 1,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tqueryButtonNewLine : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.finacial.CapitalPlan',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenStartColumn : 0,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenEndColumn : 2,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/finacial/capital_plan/capital_deposit_list.xml',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'depstirdate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '上存/下拨日期',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'interestrates',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '存款利率(%)',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '存款利息',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'right',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tdataType:\"currency\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
