 ...
 * Generated at: 2017-08-12 03:05:01 UTC
...
public final class pledge_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid : 'table_accountrecple_info_id',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\ttitle : '抵质押登记',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tremoteOper : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tpageSize : 15,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tshowPager : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tlazyLoad : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tloadMode : 'ajax',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.pledge.Pledge',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenStartColumn : 0,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenEndColumn : 2,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tqueryButtonColSpan : 8,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tqueryButtonNewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/pledge/pledge_info_list.xml',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t/* validateForm:function(miniTable, miniForm, editFormItemOperFlag, addIndex){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar pledge=miniTable.getSelected();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvar num=Number(pledge.pledgevalue).toFixed(2);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tgetMiniEditFormField(\"table_accountrecple_info_id.pledgevalue\").setValue(Number(num));\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\treturn  true;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, */\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t//mini.getbyName(\"contractid\").setValue(mini.getbyName(\"connameidname\").getValue());\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tmini.getbyName(\"projid\").setText(mini.getbyName(\"projectname\").getValue());\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t//mini.getbyName(\"contractid\").setReadOnly(false);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t/* $($(\".mini-buttonedit-button\")[1]).hide();*/\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tgetMiniEditFormField(\"table_accountrecple_info_id.contractid\").disable();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\treturn true;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttools : [\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ id\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t+ \"\\\",\\\"one\\\")'>查看所上传资料 </a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t/* \t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'connameidname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '业务合同号',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/pledge/pledge_contractid.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'regisnum',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '登记证明编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'projid'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tlabelWidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 200\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype : 'queryinput',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttextField : 'projname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalueField : 'projid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tonSelect : function(\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t$me,queryInput,rowData) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmini.getbyName(\"connameidname\").setValue(rowData.name);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmini.getbyName(\"contractid\").setValue(rowData.value);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/pledge/pledge_contractid.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      ...
      out.write(" \t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'registypename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '登记类型',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'registypeid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillProperty : 'name'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'registypeid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '登记类型',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tpid : 'regis_type',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/combos/comboDict.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteeid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '担保合同编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t/*  {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projectname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '抵质押登记合同编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 150,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'projnameid'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projnameid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '抵质押登记合同编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine : false,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/guarantee_manage/guarantee_manage_proj.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},  */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'pledgestatus',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '登记状态',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 150,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'regisunit',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '登记单位',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 150,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'assurorname',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '担保人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/pledge/pledge_open_list.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'pledgeownner',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '抵质押物所在企业/自然人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 200,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'assurorunion',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '联合担保人',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '被担保债权总额/主合同金额(元)',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 200,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tformat : 'yyyy-MM-dd',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\totherAttributes:'onvaluechanged=\"copydate\"'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      ...
      out.write("\t\tvar start=mini.getbyName(\"debtstart\").getValue();\r\n");
      out.write("\t\tmini.getbyName(\"debtend\").setMinDate(start);  \t\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction copydate(){\r\n");
      out.write("\t\tvar dizhiStart=mini.getbyName(\"pledgestart\").getValue();\r\n");
      out.write("\t\tmini.getbyName(\"debtstart\").setValue(dizhiStart);\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction showanduploadfile(id, type) {\r\n");
      out.write("\t\tvar urlFlag = getRootPath()\r\n");
      out.write("\t\t\t\t+ \"/workflow/forms/law_mng/pledge/pledge_file_list.bi?id=\" + id\r\n");
      out.write("\t\t\t\t+ \"&type=\" + type;\r\n");
      out.write("\t\tmini.open({\r\n");
      out.write("\t\t\turl : urlFlag,\r\n");
      out.write("\t\t\ttitle : \"设备信息\",\r\n");
      out.write("\t\t\twidth : 800,\r\n");
