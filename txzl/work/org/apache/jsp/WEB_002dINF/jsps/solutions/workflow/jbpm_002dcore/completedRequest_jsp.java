 ...
 * Generated at: 2017-03-07 16:16:20 UTC
...
public final class completedRequest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t{field: 'workflowdisplayname', header: '流程名称'},\r\n");
      out.write("\t\t\t\t\t{field:'processinstancetype',header:'已办类型',visible:false, /* ,\r\n");
      out.write("\t\t\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t\t\t\t\tvar rowData = e.record;\r\n");
      out.write("\t\t\t\t\t\treturn getTaskTypeChineseName(rowData.processinstancetype);\r\n");
      out.write("\t\t\t\t\t} */ },\r\n");
      out.write("\t\t\t\t\t{field:'processinstancetypename',header:'已办类型' ,\r\n");
      out.write("\t\t\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t\t\t\t\tvar rowData = e.record;\r\n");
      out.write("\t\t\t\t\t\treturn getTaskTypeChineseName(rowData.processinstancetype);\r\n");
      out.write("\t\t\t\t\t} },\r\n");
      out.write("\t\t\t\t\t{field:'taskname',header:'已办任务',\r\n");
      out.write("\t\t\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t\t\t\t\tvar rowData = e.record; \r\n");
      out.write("\t\t\t\t\t\treturn rowData[\"taskname\"].substring(rowData[\"taskid\"].length,rowData[\"taskname\"].length);\r\n");
      out.write("\t\t\t\t    }},\r\n");
      out.write("\t\t\t\t\t{field: 'processstart', header: '开始时间',allowSort : true,dateFormat : 'yyyy-MM-dd HH:mm:ss'},\r\n");
      out.write("\t\t\t\t\t{field: 'processend', header: '结束时间',allowSort : true,dateFormat : 'yyyy-MM-dd HH:mm:ss',\r\n");
      out.write("\t\t\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t\t\t\t\tvar rowData = e.record;\r\n");
      ...
      out.write("\t\t\t\t    }},\r\n");
      out.write("\t\t\t\t\t{header:'操作',field:'oper',align:\"left\",\r\n");
      out.write("\t\t\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t\t\t\t\t\tvar rowData = e.record;\r\n");
      out.write("\t\t\t\t\t\t\tvar deploy = \"\";\r\n");
      out.write("\t\t\t\t\t\t\tif(rowData.deployid) {\r\n");
      out.write("\t\t\t\t\t\t\t\tdeploy += '<a href=\"javascript:void(0);\" onclick=\"toProcessActivePicture(\\''+rowData.deployid+'\\',\\''+rowData.processinstanceid+'\\',\\''+rowData.actorid+'\\')\">显示流程图</a>'\r\n");
      out.write("\t\t\t\t\t\t\t\t+'&nbsp;&nbsp;&nbsp;&nbsp;'+\r\n");
