 ...
 * Generated at: 2017-08-12 08:42:14 UTC
...
public final class holidayclassify_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("var holiday_number=null;\r\n");
      out.write("jQuery(function(){\r\n");
      out.write("\t$.ajax({//自动生成节假日编号\r\n");
      out.write("\t    url: getRootPath()+\"/acl/createHolidayNumber.acl\",\r\n");
      out.write("\t    type: \"post\",\r\n");
      out.write("\t    cache: false, \r\n");
      out.write("\t    async : false,\r\n");
      out.write("\t    success: function (data) {\r\n");
      out.write("\t    \tholiday_number=data;\r\n");
      out.write("\t    }\r\n");
      out.write("\t});\r\n");
      out.write("}); \r\n");
      out.write("var whether=[{id:'是',text:'是'},{id:'否',text:'否'}];\r\n");
      out.write("jQuery(function(){\r\n");
      out.write("\ttenwa.createTable({\r\n");
      out.write("\t\tid: \"holiday_calssify\",\r\n");
      out.write("\t\trenderTo: \"id_table_holiday_calssify\",\r\n");
      out.write("\t\twidth: '100%',\r\n");
      out.write("\t\theight: '100%',\r\n");
      out.write("\t\tlazyLoad: false,\r\n");
      out.write("\t\tentityClassName : 'com.tenwa.leasing.entity.base.HolidayClassify',\r\n");
      out.write("\t\ttitle: \"节假日信息维护\",\r\n");
      ...
      out.write("\t\txmlFileName: '/eleasing/jsp/sysmgr/sysdatamgr/holidayclassify.xml',\r\n");
      out.write("\t\tbeforeShowWindowCallBack:function(miniTable,miniForm, operType){\r\n");
      out.write("\t\t\tif(\"add\"==operType){\r\n");
      out.write("\t\t\t\tif(Number(holiday_number)<10){\r\n");
      out.write("\t\t\t\t\tvar holidaynum=parseInt(holiday_number)+parseInt(\"1\");\r\n");
      out.write("\t\t\t\t\tmini.getbyName(\"holidaynumber\").setValue(\"CAL00\"+holidaynum);\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tvar holidaynum=parseInt(holiday_number)+parseInt(\"1\");\r\n");
      out.write("\t\t\t\t\tmini.getbyName(\"holidaynumber\").setValue(\"CAL0\"+holidaynum);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\treturn true;\r\n");
      out.write("\t\t},\r\n");
      ...
      out.write("\t\t\tvar state=mini.getbyName(\"state\").getValue();\r\n");
      out.write("\t\t\tvar id=getMiniEditFormField(\"holiday_calssify.id\").getValue();\r\n");
      out.write("\t\t\tvar flag=0;\r\n");
      out.write("\t\t\tif(editFormItemOperFlag=='add'||editFormItemOperFlag=='edit'){\r\n");
      out.write("\t\t\t\tif(state=='是'){\r\n");
      out.write("\t\t\t\t\tvar stats=miniTable.getData()\r\n");
      out.write("\t\t\t\t\tfor(var i = 0;i<stats.length;i++){\r\n");
      out.write("\t\t\t\t\t\tvar stat = stats[i];\r\n");
      out.write("\t\t\t\t\t\tif(state==stat.state&&id!=stat.id){\r\n");
      out.write("\t\t\t\t\t\t\tflag+=1;\r\n");
      out.write("\t\t\t\t\t\t}\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(flag>0){\r\n");
      out.write("\t\t\t\tmini.alert(\"只能有一个首选节日方案！\");\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\treturn true;\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t{field: 'holidaynumber', header: '方案编号',align:'center',\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t{field: 'holidaytype', header: '节假日方案',align:'center',\r\n");
      out.write("\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\trequired:true\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t{field: 'holidayyear', header: '年份',align:'center',\r\n");
      out.write("\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\trequired:true,\r\n");
      out.write("\t\t\t\t\tvtype : 'int'\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t{field: 'state', header: '是否首选',align:'center',\r\n");
      out.write("\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\trequired:true,\r\n");
      out.write("\t\t\t\t\ttype: 'combobox',\r\n");
      out.write("\t\t\t\t\tdata: whether,\r\n");
      out.write("\t\t\t\t\tvalue : '否'\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t{field: 'coun', header: '节假日数量',align:'center',\r\n");
      out.write("\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\tfieldVisible:false\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t{field : '查看详情',header : '查看详情',align:'center',\r\n");
      out.write("\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\tfieldVisible:false\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t\t\t\t id = e.record.id;\r\n");
      out.write("\t\t\t\t\t type=e.record.holidaytype;\r\n");
      out.write("\t\t\t\t\t year=e.record.holidayyear;\r\n");
      out.write("\t\t\t\t\treturn \"<a style='text-decoration:underline;color:blue;' onclick='opencustdetail(\\\"\" + id +\"\\\",\\\"\"+type+ \"\\\",\\\"\"+year+ \"\\\")'> 查看明细 </a>\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t]\r\n");
      out.write("\t\t\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("function opencustdetail(id,type,year){\r\n");
      out.write("    var url=getRootPath()+\"/leasing/sysmgr/sysdatamgr/holidayinfo.bi?id=\"+id+\"&type=\"+escape(encodeURIComponent(type))+\"&year=\"+year;\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<div id=\"id_table_holiday_calssify\" style=\"height: 100%;\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
