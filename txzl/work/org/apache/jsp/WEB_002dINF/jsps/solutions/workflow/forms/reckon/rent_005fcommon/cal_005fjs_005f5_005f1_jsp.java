...
public final class cal_005fjs_005f5_005f1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("    \r\n");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "cal_js_5_1_common.jsp", out, false);
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("var changeEventArray = [\r\n");
      out.write("\t{'id':'equipamt',\r\n");
      out.write("\t  'onkeyup':changeequipamtvalue,\r\n");
      out.write("\t}, \r\n");
      out.write("\t{\r\n");
      ...
      out.write("\t}, \r\n");
      out.write("\t{\r\n");
      out.write("\t\t'id':'firstpayment',\r\n");
      out.write("\t\t'onkeyup':changefirstpaymentratio,\r\n");
      out.write("\t\t'onvaluechanged':changefirstpaymentratio\r\n");
      out.write("\t},\r\n");
      out.write("\t{\r\n");
      out.write("\t\t'id':'handhz',\r\n");
      out.write("\t\t'onvaluechanged':changeHandhz\r\n");
      out.write("\t},\r\n");
      out.write("\t{\r\n");
      ...
      out.write("\t},\r\n");
      out.write("\t{\r\n");
      out.write("\t\t'id':'insureratio',\r\n");
      out.write("\t\t'onvaluechanged':insureratiovaluechange\r\n");
      out.write("\t},\r\n");
      out.write("\t{\r\n");
      ...
      out.write("\tif(settlemethod == 'excel_import'){\r\n");
      ...
      out.write("\tvar ratefloatamtbefore = getNumber(\"graceadjust\"); //利率调整值\r\n");
      out.write("\tvar baserate = getNumber(\"baserate\");//基准利率\r\n");
      out.write("\tif(\"proportion\" == ratefloattypevalue){\r\n");
      out.write("\t\t$mini(\"gracerate\").setValue(decimal((ratefloatamtbefore+1) * baserate,6));\r\n");
      out.write("\t}else if(\"add\" == ratefloattypevalue){\r\n");
      out.write("\t\t$mini(\"gracerate\").setValue(decimal((ratefloatamtbefore + baserate),6));\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("/*\r\n");
      out.write("\t利率计算方式：\r\n");
      ...
      out.write("\t\t$mini(\"graceadjust\").disable();//利率调整值\r\n");
      out.write("\t\t$mini(\"baserate\").disable();//基准利率\r\n");
      out.write("\t\t$mini(\"ratefloatamt\").setRequired(false);\r\n");
      out.write("\t\t$mini(\"graceadjust\").setRequired(false);\r\n");
      out.write("\t\tmini.get(\"gracerate\").setReadOnly(false);\r\n");
      out.write("\t\t$miniEnable(\"rentorratevalue\");\r\n");
      out.write("\t\tif(typeof(e) != 'string'){\r\n");
      out.write("\t\t\t$mini(\"graceadjust\").setValue(\"0\");\r\n");
      out.write("\t\t\t$mini(\"baserate\").setValue(\"0\");\r\n");
      out.write("\t\t\tif($('#testrate').is(':visible')){\r\n");
      out.write("\t\t\t\t$mini(\"gracerate\").setValue($mini(\"graceadjust\").getValue());\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$mini(\"yearrate\").setValue('0');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}else if(\"proportion\" == ratefloattypevalue){//换央行浮动比率\r\n");
      out.write("\t\t$miniEnable(\"graceadjust\");\r\n");
      out.write("\t\t$miniEnable(\"baserate\");\r\n");
      out.write("\t\t$mini(\"graceadjust\").setRequired(true);\r\n");
      out.write("\t\t$mini(\"baserate\").setRequired(true);\r\n");
      out.write("\t\t$mini(\"rentorratevalue\").disable();\r\n");
      out.write("\t\tmini.get(\"gracerate\").setReadOnly(true);\r\n");
      out.write("\t\tif(typeof(e) != 'string'){\r\n");
      out.write("\t\t\t$mini(\"gracerate\").setValue(decimal((ratefloatamtbefore+1) * baserate,6));\r\n");
      ...
      out.write("\t\tif(typeof(e) != 'string'){\r\n");
      out.write("\t\t\t$mini(\"rentorratevalue\").setValue(\"0\");\r\n");
      out.write("\t\t\t$mini(\"gracerate\").setValue(ratefloatamtbefore + baserate);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$miniEnable(\"adjuststyle\");\r\n");
      out.write("\t}else{//说明为空\r\n");
      out.write("\t\t$mini(\"graceadjust\").disable();//利率调整值\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function insureratiovaluechange(e){\r\n");
      out.write("\t//保险费 设备款*保险费率*租赁期限/12\r\n");
      out.write("\tif(typeof(e)==\"undefined\"){\r\n");
      out.write("\t\tvar insureratio =  mini.get(\"insureratio\").getValue();\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tvar insureratio =  e.sender.value;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar insuremoneytype = mini.get(\"insuremoneytype\").getValue();\r\n");
      out.write("\tvar leaseterm = ('0'==mini.get(\"leaseterm\").getValue())?'12':mini.get(\"leaseterm\").getValue();;\r\n");
      out.write("\tif(\"insure_type1\" == insuremoneytype || \"insure_type2\" == insuremoneytype){\r\n");
      out.write("\t\tvar insurancelessor = decimal(getNumber('equipamt') * Number(insureratio)*Number(leaseterm)/12/10000,2);\r\n");
      out.write("\t\tvar insurancelessee = getNumber('insurancelessee_show');\r\n");
      out.write("\t\t$miniDisableSetValue('insurancelessor',insurancelessor);\r\n");
      out.write("\t\t//$mini(\"insuremoney\").setValue(insurancelessor + insurancelessee);//保险费\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("/*\r\n");
      ...
      out.write("\t\t\t\tvar insurancelessor = decimal(getNumber('equipamt') * Number(mini.get('insureratio').getValue())\r\n");
      out.write("\t\t\t\t\t\t*Number(mini.get(\"leaseterm\").getValue())/12/100,2);\r\n");
      out.write("\t\t\t\t$miniDisableSetValue('insurancelessor',insurancelessor);\r\n");
      out.write("\t\t\t\t//$mini(\"insuremoney\").setValue(insurancelessor);//保险费\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tif(getNumber('insurancelessor_show') == 0 ){\r\n");
      out.write("\t\t\t\t\tvar insurancelessor = decimal(getNumber('equipamt') * Number(mini.get('insureratio').getValue())\r\n");
      out.write("\t\t\t\t\t\t\t*Number(mini.get(\"leaseterm\").getValue())/12/100,2);\r\n");
      out.write("\t\t\t\t\t$miniDisableSetValue('insurancelessor',insurancelessor);\r\n");
      out.write("\t\t\t\t\tvar insurancelessee = getNumber('insurancelessee_show');\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t//代收代付\r\n");
      out.write("\t\t}else if(\"insure_type2\" == sender.value){\r\n");
      out.write("\t\t\t$miniEnable('insurancelessor_show');// 保险费(我司)\r\n");
      ...
      out.write("\tinsureratiovaluechange();\r\n");
      out.write("}\r\n");
      ...
      out.write("\tif(\"rate\" == rentorratevalue || \"handle_method\"==rentorratevalue || \"r_special_regular\"==rentorratevalue){\r\n");
      ...
      out.write("\t\t\t\t$miniDisable(\"rentorratevalue\");\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$miniEnable(\"rentorratevalue\");\r\n");
      out.write("\t\t\t\tmini.get('rentorratevalue').setReadOnly(false);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}else{\r\n");
      ...
      out.write("\t\t\t\t$miniEnable(\"graceadjust\");//利率调整值\r\n");
      out.write("\t\t\t\t$miniEnable(\"baserate\") ;//基准利率\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$miniDisable(\"ratefloatamt\");//利率调整值\r\n");
      out.write("\t\t\t\t$miniDisable(\"graceadjust\");//利率调整值\r\n");
      ...
      out.write("\t\t if(settlemethod != 'excel_import'){\r\n");
      out.write("\t\t\t$(\"#calculateButton\").show();\r\n");
      out.write("\t\t\ttempColume.tools =nomalTool ;\r\n");
      out.write("\t\t\ttempColume.columns = columnsNomal;\r\n");
      out.write("\t\t\t$miniSetCombValue(\"rentorrate\",\"r_special_regular\",\"分段推算\");\r\n");
      out.write("\t\t\t$miniSetCombValue(\"settlemethod\",\"special_regular\",\"规则测算\");\r\n");
      out.write("\t\t\t//$miniDisable(\"grace\");\r\n");
      out.write("\t\t\tmini.get(\"segment_config\").show();\r\n");
      out.write("\t\t\t$miniSetCombValue('ratefloattype','fixed','固定利率');\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tmini.get(\"segment_config\").hide();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t }\r\n");
      out.write("\t//动态改变租金计算方式\r\n");
      out.write("\tif(rentorratevalue != \"knowing_rent\"){\r\n");
      out.write("\t\tif($minigetvalue('settlemethod') == \"irregular_rent\"){\r\n");
      out.write("\t\t}else if(rentorratevalue == \"handle_method\"){\r\n");
      out.write("\t\t\t$miniSetCombValue(\"settlemethod\",\"excel_import\",\"不规则导入\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}else{\r\n");
      ...
      out.write("\t\t\t$mini(\"rentorratevalue\").setValue(\"0\");\r\n");
      out.write("\t\t\t$mini(\"rentorratevalue\").setReadOnly(true);\r\n");
      ...
      out.write("\t\telse{\r\n");
      out.write("\t\t\t$mini(\"rentorratevalue\").setValue(\"0\");\r\n");
      out.write("\t\t\t$mini(\"rentorratevalue\").setReadOnly(false);\r\n");
      out.write("\t\t\t$('#testrent').hide();\r\n");
      out.write("\t\t\t$('#testrate').show();\r\n");
      ...
      out.write("\t// \tincome_12\tincome_12\tincome_number_year\t年  付\r\n");
      out.write("\t// \tincome_2\tincome_2\tincome_number_year\t双月付\r\n");
      out.write("\tchangeDate();//租金支付日改变调用此方法\r\n");
      ...
      out.write("\tvar incomenumberyear = $minigetvalue(\"incomenumberyear\");//租金支付类型\r\n");
      out.write("\tif(typeof(e) == 'string' || (\"\" == startdate && \"\" == firstplandate  && \"\" == lastplandate)){\r\n");
      ...
      out.write("\tformatSpecialConfig();\r\n");
      out.write("\tvar fund_put_config=mini.get(\"fund_put_config\").getData();\r\n");
      out.write("\t//如果是是特殊规则\r\n");
      out.write("\tvar special_regular=\"\";\r\n");
      out.write("\tif(mini.get(\"settlemethod\").getValue()=='special_regular'){\r\n");
      out.write("\t\tspecial_regular=mini.get(\"special_regular\").getData();\r\n");
      out.write("\t\tif(special_regular.length==0){\r\n");
      out.write("\t\t\tmini.alert('请先填写特殊规则！');\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}else{\r\n");
      ...
      out.write("\t\t\t\tmonth=parseInt(month)+(parseInt(special_regular[i].endlist)-parseInt(special_regular[i].startlist)+1)*parseInt(special_regular[i].regularmonths);\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t//设备款和投放计划校验\r\n");
      out.write("\t\tif(!fund_put_config){\r\n");
      out.write("\t\t\tmini.alert('请先填写投放计划！');\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tvar equipMoney=mini.get(\"equipamt\").getValue().replace(/,/g,'');\r\n");
      out.write("\t\t\tvar fundputmoney=mini.get(\"fund_put_config\").getSummaryCellEl(\"planmoney\").innerHTML.replace(/,/g,'');\r\n");
      out.write("\t\t\tif(parseFloat(equipMoney)!=parseFloat(fundputmoney)){\r\n");
      out.write("\t\t\t\tmini.alert(\"投放计划的投放总金额和设备款不一致！\");\r\n");
      out.write("\t\t\t\treturn ;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar leaseterm=mini.get(\"leaseterm\").getValue();\r\n");
      out.write("\tif(!leaseterm||Number(leaseterm)<=0){\r\n");
      out.write("\t\tmini.alert(\"租赁期限(月)必须大于0！\");\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\t//判断租金支付类型，规则测算不能为不等期\r\n");
      ...
      out.write("\tif(incomenumberyear == 'income_0' && '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.process}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("' != 'onhire'){\r\n");
      out.write("\t\tmini.alert('请选择规则的租金支付类型！！！！')\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar numRegex  = /^[-\\+]?\\d+$/;\r\n");
      out.write("\tif(!numRegex.test(incomenumber)){\r\n");
      out.write("\t\tmini.alert('请你输入正确格式的还租次数！')\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tif(Number(incomenumber) <= 0 ){\r\n");
      out.write("\t\t\tmini.alert('还租次数需大于0！');\r\n");
      out.write("\t\t\treturn ;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\treturn; \r\n");
      out.write("\t}\r\n");
      out.write("\t//如果手续费收取间隔是随还租频率收取，并且手续费计算基数是剩余本金，则起租日和第一期租金支付日的日期保持一致\r\n");
      out.write("\tvar handhz=$minigetvalue(\"handhz\");//手续费收取间隔\r\n");
      out.write("\tvar handmoney=$minigetvalue(\"handmoney\");//手续费计算基数\r\n");
      out.write("\tvar leaseamtday=leaseamtdate.getDate();//付款日\r\n");
      out.write("\tvar firstplanday = firstplandate.getDate();//第一期租金支付日\r\n");
      out.write("\tif(handhz==\"hand_hz.01\"&&(handmoney==\"hand_ratio.02\"||handmoney==\"hand_ratio.03\")){\r\n");
      out.write("\t\tif(leaseamtday!=firstplanday){\r\n");
      out.write("\t\t\tmini.alert('手续费收取间隔为规则收取时，第一期租金支付日期【'+firstplanday+'】要和付款日期【'+leaseamtday+'】保持一致');\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\tmini.mask({\r\n");
      ...
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    $('#id_json_fund_put_config_str').val(mini.encode(fund_put_config));\r\n");
      out.write("    o.json_fund_rent_plan_str  = $('#id_json_fund_rent_plan_str').val();\r\n");
      out.write("    o.json_fund_cash_flow_str  = $('#id_json_fund_cash_flow_str').val();\r\n");
      out.write("    o.json_fund_fund_charge_str  = $('#id_json_fund_fund_charge_str').val();\r\n");
      out.write("    o.json_knowing_rent_plan_str  = $('#id_json_knowing_rent_plan_str').val();\r\n");
      out.write("    o.json_knowing_corpus_plan_st  = $('#id_json_knowing_corpus_plan_str').val();\r\n");
      out.write("    o.json_fund_put_config_str=$('#id_json_fund_put_config_str').val();\r\n");
      ...
      out.write("        \t\t$mini(\"xirr\").setValue(result.xirr);//内部收益率\r\n");
      out.write("        \t\t$('#irr').val(result.irr);\r\n");
      out.write("            \t$mini(\"enddate\").setValue(result.enddate);//内部收益率\r\n");
      out.write("            \t$mini(\"grace\").setValue(result.grace);//宽限期期数\r\n");
      ...
      out.write("            \tvar graceplan =result.graceplan ;\r\n");
      out.write("            \tvar finacashdetail =result.cashdetaillist ;\r\n");
      out.write("            \tvar fundchargeplan =  result.fundchargeplan;\r\n");
      out.write("            \tvar fundfundplan =  result.fundputplan;\r\n");
      out.write("            \t//写的什么鸡巴玩意儿\r\n");
      out.write("                if(mini.get(\"approval_distingguish\") && mini.get(\"approval_distingguish\").getValue()==\"show_fund_cash\"){\r\n");
      ...
      out.write("            \t}else if(mini.get(\"approval_distingguish\") && mini.get(\"approval_distingguish\").getValue()==\"show_rent_cash\"){\r\n");
      ...
      out.write("                \tmini.get(\"fund_cash_plan_frame\").setData(finacashdetail);\r\n");
      out.write("                   \tmini.get(\"fund_fund_plan\").setData(fundchargeplan);\r\n");
      out.write("                   \tmini.get(\"fund_put_config\").setData(fundfundplan);\r\n");
      out.write("                   \tmini.get(\"grace_plan\").setData(graceplan);\r\n");
      out.write("                   \t$(\"#id_json_fund_cash_flow_str\").val(mini.encode(finacashdetail));\r\n");
      out.write("                   \t$(\"#id_json_fund_fund_charge_str\").val(mini.encode(fundchargeplan));\r\n");
      out.write("                   \t$(\"#id_json_fund_rent_plan_str\").val(mini.encode(fundrentplan));\r\n");
      out.write("                   \t$(\"#id_json_fund_put_config_str\").val(mini.encode(fundfundplan));\r\n");
      out.write("                   \t$(\"#id_json_grace_plan_str\").val(mini.encode(graceplan));\r\n");
      out.write("            \t} \r\n");
      out.write("            \t//alert(mini.get(\"approval_distingguish\").getValue());\r\n");
      ...
      out.write("            \tupdateInputThousand();\r\n");
      out.write("        \t}\r\n");
      out.write("        \t//测算完成之后，页面计算租前息的数据，并添加到资金收付计划页签中\r\n");
      out.write("\t\t\tcalculatebeforeinterest_new();\r\n");
      out.write("        },\r\n");
      ...
      out.write("    });\r\n");
      out.write("}\r\n");
      out.write("//测算前格式化分段规则 初始化还款间隔 计算分段年利率\r\n");
      out.write("function formatSpecialConfig(){\r\n");
      out.write("\tvar special_regular=mini.get(\"special_regular\").getData();\r\n");
      out.write("\tvar incomenumberyear = $minigetvalue(\"incomenumberyear\");\r\n");
      out.write("\tvar tempValue = parseInt(incomenumberyear.replace(\"income_\",\"\"));//还款间隔\r\n");
      out.write("\tvar ratefloattypevalue = $minigetvalue(\"ratefloattype\");\r\n");
      out.write("\tvar baserate = getNumber(\"baserate\");//基准利率\r\n");
      out.write("\tvar temprate=0;\r\n");
      out.write("\tfor(var i=0;i<special_regular.length;i++){\r\n");
      out.write("\t\tif(\"proportion\" == ratefloattypevalue){\r\n");
      out.write("\t\t\ttemprate=decimal((parseFloat(special_regular[i].ratefloatamt)+1) * baserate,6);\r\n");
      out.write("\t\t\tspecial_regular[i].yearrate=temprate;\r\n");
      out.write("\t\t}else if(\"add\" == ratefloattypevalue){\r\n");
      out.write("\t\t\ttemprate=decimal((parseFloat(special_regular[i].ratefloatamt) + baserate),6);\r\n");
      out.write("\t\t\tspecial_regular[i].yearrate=temprate;\r\n");
      out.write("\t\t} \r\n");
      out.write("\t\tspecial_regular[i].regularmonths=tempValue;\r\n");
      out.write("\t}\r\n");
      out.write("\tmini.get(\"special_regular\").setData(special_regular);\r\n");
      out.write("    $('#id_json_special_regular_str').val(mini.encode(special_regular));\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//测算利率改变事件\r\n");
      ...
      out.write("\r\n");
      out.write("//计算风险敞口 \r\n");
      out.write("function cleancreditmoney(){\r\n");
      out.write("\t//净授信额 = 设备款－首付款－保证金-厂商保证金-利息补贴-返点收入-其他收入-期初第1期租金-厂商返利-手续费 - 咨询费+其他支出+保险费\r\n");
      out.write("\tvar equipamt = $minigetinputtext(\"equipamt\");//设备款\r\n");
      out.write("\tvar firstpayment = $minigetinputtext(\"firstpayment\");//首付款\r\n");
      out.write("\tvar cautionmoney = $minigetinputtext(\"cautionmoney\");//保证金 \r\n");
      out.write("\tvar faccautionmoney = $minigetinputtext(\"faccautionmoney\");//厂商保证金 \r\n");
      out.write("\tvar interestsupport = $minigetinputtext(\"interestsupport\");//利息补贴\r\n");
      out.write("\tvar returnpointincome = $minigetinputtext(\"returnpointincome\");//返点收入\r\n");
      out.write("\tvar otherincome = $minigetinputtext(\"otherincome\");//其他收入 \r\n");
      out.write("\tvar firstRent=0;\r\n");
      out.write("\tif($mini(\"fund_rent_plan_frame\").getData().lenght>0){\r\n");
      out.write("\t\tfirstRent=$mini(\"fund_rent_plan_frame\").getData()[0].rent;//期初第1期租金\r\n");
      out.write("\t}\r\n");
      out.write("\tvar returnamt = $minigetinputtext(\"returnamt\");//厂商返利\r\n");
      out.write("\tvar handlingchargemoney = $minigetinputtext(\"handlingchargemoney\");//手续费\r\n");
      out.write("\tvar managementmoney = $minigetinputtext(\"managementmoney\");//咨询费\r\n");
      ...
      out.write("\t$mini(\"cleancreditmoney\").setValue(equipamt - firstpayment - cautionmoney - faccautionmoney - interestsupport - returnpointincome-\r\n");
      out.write("\t\t\totherincome-firstRent-returnamt-handlingchargemoney-managementmoney+otherexpenditure+insuremoney);\r\n");
      ...
      out.write("' == '41093'){//代表是伙伴计划信审流程，手续费取值按照融资额\r\n");
      out.write("\t\tequipamt = getNumber(\"cleanleasemoney\");//融资额\r\n");
      out.write("\t}\r\n");
      out.write("\tsetformatvalue($mini(\"handlingchargemoney\"));\r\n");
      out.write("\tvar handlingchargemoney = mini.get(\"handlingchargemoney\").getInputText().replace(/,/g,\"\");//手续费\r\n");
      out.write("\tvar handlingchargemoneyratio = mini.get(\"handlingchargemoneyratio\");//手续费比例\r\n");
      out.write("\tvar handlingchargemoneyratiovalue =!equipamt || Number(equipamt)<=0 ?  0 : decimal(handlingchargemoney/equipamt*100, 6);\r\n");
      out.write("\thandlingchargemoneyratio.setValue(handlingchargemoneyratiovalue);\r\n");
      out.write("}\r\n");
      out.write("//计算管理费比例\r\n");
      out.write("function changemanagementmoneyratio(e){\r\n");
      out.write("\tsetformatvalue($mini(\"managementmoney\"));\r\n");
      out.write("\tvar equipamt = getNumber(\"equipamt\");//设备款\r\n");
      out.write("\tvar managementmoney = mini.get(\"managementmoney\").getInputText().replace(/,/g,\"\");//管理费\r\n");
      out.write("\tvar managementmoneyratio = mini.get(\"managementmoneyratio\");//管理费比例\r\n");
      out.write("\t\r\n");
      out.write("\tvar managementmoneyratiovalue = !equipamt || Number(equipamt)<=0 ?  0 : decimal(managementmoney/equipamt*100, 6);\r\n");
      out.write("\tmanagementmoneyratio.setValue(managementmoneyratiovalue);\r\n");
      out.write("}\r\n");
      out.write("//计算保证金比例\r\n");
      ...
      out.write("\tif((typeof(e) != 'string' && e.sender.id != 'cautionmoney') || e == 'fac'){\r\n");
      ...
      out.write("\tvar equipamt = getNumber(\"equipamt\");//设备款\r\n");
      out.write("\tvar cautionmoney = mini.get(cautionmoney).getInputText().replace(/,/g,\"\");//保证金\r\n");
      out.write("\tvar cautiondeductionratio = mini.get(cautiondeductionratio);//保证金比例\r\n");
      out.write("\tvar cautiondeductionratiovalue =!equipamt || Number(equipamt)<=0 ?  0 : decimal(cautionmoney/equipamt*100, 6);\r\n");
      out.write("\tcautiondeductionratio.setValue(cautiondeductionratiovalue);\r\n");
      out.write("\t//如果保证金发生改变的话，默认是将保证金抵扣金额赋值为和保证金金额相等\r\n");
      out.write("\tmini.get(cautiondeductionmoney).setValue(!cautionmoney ? 0 : cautionmoney);\r\n");
      ...
      out.write("\tsetformatvalue(e.sender);\r\n");
      out.write("\tchangefirstpaymentratio();//计算首付比例\r\n");
      ...
      out.write("\t//cleancreditmoney();//净融资额\r\n");
      out.write("\tcleanleasemoney();//融资额\r\n");
      out.write("\tchangecleancreditratio();//计算净授信比例 \r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//计算首付比例\r\n");
      out.write("function changefirstpaymentratio(e){\r\n");
      out.write("\tsetformatvalue($mini(\"firstpayment\"));\r\n");
      out.write("\tvar equipamt = getNumber(\"equipamt\");//设备款\r\n");
      out.write("\tvar firstpayment = $minigetinputtext(\"firstpayment\");//首付款\r\n");
      out.write("\tvar firstpaymentratio = mini.get(\"firstpaymentratio\");//首付比例\r\n");
      out.write("\tvar firstpaymentratiovalue = !equipamt || Number(equipamt)<=0 ?  0 : decimal(firstpayment/equipamt*100, 6);\r\n");
      out.write("\tfirstpaymentratio.setValue(firstpaymentratiovalue);\r\n");
      out.write("\tcleanleasemoney();//融资额\r\n");
      out.write("}\r\n");
      out.write("//计算净授信比例 \r\n");
      ...
      out.write("}\r\n");
      out.write("function changeEvencorpusRateType(settlemethod){\r\n");
      out.write("\t/* var settlemethod = settlemethod == '' ? \"special_regular\" : settlemethod ;\r\n");
      out.write("\tif(settlemethod == 'even_corpus'){\r\n");
      out.write("\t\tif(!mini.get('evencorpusratetype').getValue()){\r\n");
      out.write("\t\t\t$miniSetCombValue(\"evencorpusratetype\",\"issue\",'按期');\r\n");
      out.write("\t\t}\t\t\r\n");
      out.write("\t\t$miniEnable(\"evencorpusratetype\");\r\n");
      out.write("\t\t//将计息方式只读\r\n");
      out.write("\t\t$miniSetCombValue(\"rateadjusttype\",\"by_issue\",'按期');\r\n");
      out.write("\t\t$miniDisable(\"rateadjusttype\");\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\t//$miniSetCombValue(\"adjuststyle\",\"\",'');\r\n");
      out.write("\t\t$miniSetCombValue(\"evencorpusratetype\",\"\",'');\r\n");
      out.write("\t\t//$miniDisable(\"evencorpusratetype\");\r\n");
      out.write("\t\tif(settlemethod == 'even_interest'){\r\n");
      out.write("\t\t\t$miniSetCombValue(\"rateadjusttype\",\"by_issue\",'按期');\r\n");
      out.write("\t\t\t$miniDisable(\"rateadjusttype\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$miniSetCombValue(\"adjuststyle\",\"next_year\",'年调');\r\n");
      out.write("\t\t\t$miniEnable(\"adjuststyle\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t} */\r\n");
      out.write("}\r\n");
      ...
      out.write("\tvar settlemethod = mini.get('settlemethod').getValue();\r\n");
      out.write("\tchangeEvencorpusRateType(settlemethod);\r\n");
      out.write("\tvar conditionDeatils = mini.get(\"conditionDeatils\");\r\n");
      out.write("\tif(settlemethod == 'irregular_rent'){\r\n");
      out.write("\t\t$('#calculateButton').show();\r\n");
      out.write("\t\ttempColume.tools =nomalTool ;\r\n");
      out.write("\t\ttempColume.columns = columnsIrr;\r\n");
      out.write("\t\t$miniSetCombValue(\"rentorrate\",\"knowing_rent\",\"已知租金规则测算\");\r\n");
      out.write("\t\tmini.get('rentorratevalue').disable();\r\n");
      out.write("\t\t$miniSetCombValue('ratefloattype','fixed','固定利率');\r\n");
      out.write("\t\t$miniSetCombValue(\"incomenumberyear\",\"\",\"\");\r\n");
      out.write("\t\t$miniDisable('incomenumberyear');\r\n");
      out.write("\t\t$miniDisable(\"ratefloattype\");\r\n");
      out.write("\t\t$miniDisable(\"ratefloatamt\");\r\n");
      out.write("\t\t$miniDisable(\"graceadjust\");\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t}else if(settlemethod == 'special_regular'){\r\n");
      out.write("\t\t$(\"#calculateButton\").show();\r\n");
      out.write("\t\ttempColume.tools =nomalTool ;\r\n");
      out.write("\t\ttempColume.columns = columnsNomal;\r\n");
      out.write("\t\t$miniSetCombValue(\"rentorrate\",\"r_special_regular\",\"分段推算\");\r\n");
      out.write("\t\t$miniSetCombValue(\"incomenumberyear\",\"income_1\",\"月  付\");\r\n");
      out.write("\t\t$miniEnable('incomenumberyear');\r\n");
      out.write("\t\t$mini(\"incomenumber\").setValue(\"0\");\r\n");
      out.write("\t\t$mini(\"leaseterm\").setValue(\"0\");\r\n");
      out.write("\t\t$miniDisable(\"grace\");\r\n");
      out.write("\t\tmini.get(\"segment_config\").show();\r\n");
      out.write("\t\tmini.get('rentorratevalue').enable();\r\n");
      out.write("\t\t$miniEnable(\"ratefloattype\");\r\n");
      out.write("\t}else if(settlemethod == 'excel_import'){\r\n");
      out.write("\t\t$('#calculateButton').hide();\r\n");
      out.write("\t\ttempColume.tools =impExcelTool ;\r\n");
      out.write("\t\ttempColume.columns = columnsIrr;\r\n");
      out.write("\t\t$miniSetCombValue(\"rentorrate\",\"handle_method\",\"手工EXCEL\");\r\n");
      out.write("\t\t$miniSetCombValue('ratefloattype','fixed','固定利率');\r\n");
      out.write("\t\t$miniSetCombValue(\"incomenumberyear\",\"\",\"\");\r\n");
      out.write("\t\t$miniDisable('incomenumberyear');\r\n");
      out.write("\t\t$mini(\"rentorratevalue\").setReadOnly(false);\r\n");
      out.write("\t\t$miniDisable(\"incomenumber\");\r\n");
      out.write("\t\t$miniDisable(\"leaseterm\");\r\n");
      out.write("\t\t$miniDisable(\"ratefloattype\");\r\n");
      out.write("\t\t$miniDisable(\"ratefloatamt\");\r\n");
      out.write("\t\t$miniDisable(\"graceadjust\");\r\n");
      out.write("\t\t$miniDisable(\"baserate\");\r\n");
      ...
      out.write("\t\t$miniEnable('rentorratevalue');\r\n");
      out.write("\t\tmini.get('rentorratevalue').setReadOnly(false);\r\n");
      out.write("\t\t//$('input[name=\"rentorratevalue\"]').removeAttr(\"readonly\");\r\n");
      out.write("\t\tif(mini.get('rentorrate').getValue() == 'knowing_rent'){\r\n");
      out.write("\t\t\tmini.get('yearrate').setValue('0');\r\n");
      out.write("\t\t\tmini.get('rentorratevalue').setValue('0');\r\n");
      out.write("\t\t\t$miniEnable(\"rentorratevalue\");\r\n");
      out.write("\t\t\t$miniSetCombValue('rentorrate','rate','按年利率计算租金');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t/* if(settlemethod == 'even_corpus' && (mini.get('rentorrate').getValue() != 'rate' || mini.get('rentorrate').getValue() == 'knowing_corpus')){\r\n");
      out.write("\t\t\t$miniSetCombValue('rentorrate','rate','按年利率计算租金');\r\n");
      out.write("\t\t} */\r\n");
      out.write("\t\tif(mini.get('settlemethod').getValue() == 'even_interest'){\r\n");
      out.write("\t\t\t$miniSetCombValue('rentorrate','rate','按年利率计算租金');\r\n");
      out.write("\t\t}else if(mini.get('settlemethod').getValue() == 'even_corpus'){\r\n");
      out.write("\t\t\tif(mini.get('rentorrate').getValue() == 'knowing_rent' || mini.get('rentorrate').getValue() == 'rent'){\r\n");
      out.write("\t\t\t\t$miniSetCombValue('rentorrate','rate','按年利率计算租金');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//再去判断是否是按租金推算年租息率\r\n");
      out.write("\t\tif(mini.get('rentorrate').getValue() == 'rent'){\r\n");
      out.write("\t\t\t$miniSetCombValue('ratefloattype','add','按央行利率加点');\r\n");
      out.write("\t\t\t$miniEnable(\"ratefloattype\");\r\n");
      ...
      out.write("    try {\r\n");
      out.write("    \tvalue=mini.get(id).getValue();\r\n");
      ...
      out.write("\tmini.get('incomenumber').setReadOnly(true);\r\n");
      out.write("\tmini.get('leaseterm').setReadOnly(true);\r\n");
      out.write("}\r\n");
      ...
      out.write("}\r\n");
      out.write("//测算完成之后，页面计算租前息的数据，并添加到资金收付计划页签中\r\n");
      out.write("function calculatebeforeinterest_new(){\r\n");
      out.write("\tvar special_regular=mini.get(\"special_regular\");\r\n");
      out.write("\tvar datas=special_regular.data;\r\n");
      out.write("\tfor(var i=0;i<datas.length;i++){\r\n");
      out.write("\t\tif(datas[i].regularsettlemethod==\"special_regular.beforeinterest\"){\r\n");
      out.write("\t\t\tvar startlist=datas[i].startlist;//开始期次\r\n");
      out.write("\t\t\tvar endlist=datas[i].endlist;//结束期次\r\n");
      out.write("\t\t\tvar yearrate=datas[i].yearrate;//租前息年利率\r\n");
      out.write("\t\t\tvar regularmonths=datas[i].regularmonths;//还款间隔\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("};\r\n");
      out.write("function changeHandhz(e){\r\n");
      out.write("\t//hand_hz.01\t随还租频率收取\r\n");
      out.write("\t//hand_hz.02\t不规则收取\r\n");
      out.write("\t\r\n");
      out.write("\t//hand_ratio.01\t融资总额\r\n");
      out.write("\t//hand_ratio.02\t上期剩余本金\r\n");
      out.write("\t//hand_ratio.03\t当期剩余本金\r\n");
      out.write("\t\r\n");
      out.write("\t//period_type_1\t期初\r\n");
      out.write("\t//period_type_0\t期末\r\n");
      out.write("\tif(e.sender.value=='hand_hz.01'){\r\n");
      out.write("\t\tmini.get(\"handmoney\").enable();\r\n");
      out.write("\t}else if(e.sender.value=='hand_hz.02'){\r\n");
      out.write("\t\tmini.get(\"handmoney\").disable();\r\n");
      out.write("\t\t$miniSetCombValue(\"handmoney\",\"hand_ratio.01\",\"融资总额\");\r\n");
      out.write("\t}\r\n");
      out.write("\tif(e.sender.value==\"\"){\r\n");
      out.write("\t\tmini.get(\"handtype\").setRequired(false);\r\n");
      out.write("\t\tmini.get(\"handmoney\").setRequired(false);\r\n");
      out.write("\t\tmini.get(\"handratio\").setRequired(false);\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tmini.get(\"handtype\").setRequired(true);\r\n");
      out.write("\t\tmini.get(\"handmoney\").setRequired(true);\r\n");
      out.write("\t\tmini.get(\"handratio\").setRequired(true);\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("</script>");
