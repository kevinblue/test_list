 ...
 * Generated at: 2017-03-16 08:54:20 UTC
...
public final class rent_005finvoice_005fhc_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\txmlFileName : '/eleasing/jsp/invoice_manage/rent_invoice/invoiceHC/rent_invoice_hc.xml',\r\n");
      out.write("\t\t\t\ttools : ['add'],\r\n");
      out.write("\t\t\t\tcolumns : [ \r\n");
      out.write("\t\t\t\t    {type : 'indexcolumn'},\r\n");
      out.write("\t\t\t\t   \t{type : 'checkcolumn'},  \r\n");
      out.write("\t\t\t\t   \t{field : 'id',header : 'id',visible : false},\r\n");
      out.write("\t\t\t\t   \t{field : 'outno',header : '编号',width : 120,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'contractid',header : '合同号',width : 120,queryConfig : {},formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'contractnumber',header : '业务合同号',width : 120,queryConfig : {},formEditorConfig : {fieldVisible:false},renderer:function(e){\r\n");
      out.write("\t\t\t\t\t\treturn \"<a href='javascript:void(0);' onclick='showContractDetail(\\\"\"+e.record.cid+\"\\\")'>\" + e.record.contractnumber + \"</a>\";\r\n");
      out.write("\t\t\t\t\t}},\r\n");
      out.write("\t\t\t\t   \t{field : 'custname',header : '客户名称',width : 120,allowSort:true,queryConfig : {},formEditorConfig : {fieldVisible:false}},\r\n");
      ...
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'money',header : '收款金额',width : 120,dataType:\"currency\",align:'right',summary: true,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t{field : 'invoiceno',header : '发票号',width : 120,\r\n");
      ...
      out.write("\t\t\t\t\t\t\ttextField : 'invoiceno',//combox显示值\r\n");
      out.write("\t\t\t\t\t\t\tlabelWidth : 100,//该域标签宽度\r\n");
      out.write("\t\t\t\t\t\t\t//width : 125,//该域总宽度\r\n");
      out.write("\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\txmlFileName : 'eleasing/jsp/invoice_manage/rent_invoice/invoiceHC/rent_invoice_no_hc.xml'\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'oldinvoiceno',header : '原始发票号',width : 120,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'invoicemoney',header : '开票金额',width : 120,dataType:\"currency\",align:'right',summary: true,\r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t   \t\t\tfillFromFieldName : 'invoiceno',\r\n");
      out.write("\t\t\t\t\t\t\tfillProperty : 'invoicemoney',\r\n");
      out.write("\t\t\t\t   \t\t\treadonly:true,\r\n");
      out.write("\t\t\t\t   \t\t\tnewLine:true\r\n");
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'invoicedate',header : '开票时间',formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxmoney',header : '销项税金',summary: true,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxrate',header : '税率',formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t   \t{field : 'feetype',header : '费用类型',\r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t   \t\t\tfillFromFieldName : 'invoiceno',\r\n");
      out.write("\t\t\t\t\t\t\tfillProperty : 'feetype',\r\n");
      out.write("\t\t\t\t   \t\t\treadonly:true,\r\n");
      out.write("\t\t\t\t   \t\t\tnewLine:true\r\n");
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'hcnumber',header : '红冲通知单号',visible : false,\r\n");
      out.write("\t\t\t\t   \t\tformEditorConfig : \r\n");
      out.write("\t\t\t\t   \t\t{\r\n");
      out.write("\t\t\t\t   \t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t   \t\t\trequired : true,//是否必填\r\n");
      ...
      out.write("\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'hcinvoicedate',header : '红冲时间',visible : false,\r\n");
      out.write("\t\t\t\t\t   \tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\tnewLine : true,//新起一行来画该表单域，用于修改页面的表单域换行\r\n");
      out.write("\t\t\t\t\t\t\tfieldVisible:true,\r\n");
      out.write("\t\t\t\t\t\t\ttype : 'date',\r\n");
      out.write("\t\t\t\t\t\t\trequired : true,//是否必填\r\n");
      out.write("\t\t\t\t\t\t\twidth : 200,\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxlevel',header : '发票类型',formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxregcode',header : '纳税人识别号',width : 120,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxbank',header : '开户行',width : 120,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxacc',header : '开户账号',width : 120,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxphone',header : '开票电话',formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'taxregadd',header : '开票地址',width : 120,formEditorConfig : {fieldVisible:false}},\r\n");
      out.write("\t\t\t\t   \t{field : 'hcstatus',header : '状态',formEditorConfig : {fieldVisible:false}},\r\n");
