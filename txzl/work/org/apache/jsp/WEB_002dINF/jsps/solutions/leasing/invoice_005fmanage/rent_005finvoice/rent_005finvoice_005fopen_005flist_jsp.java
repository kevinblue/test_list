 ...
 * Generated at: 2017-08-12 06:42:27 UTC
...
public final class rent_005finvoice_005fopen_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\tvar tsdxml=mini.get(\"fund_invoice_queryArea_trendsxml\").getValue();\r\n");
      out.write("\t\t\t\t\t\t\tvar params =[];\r\n");
      out.write("\t\t\t\t\t\t\tif(rows.length>0){\r\n");
      out.write("\t\t\t\t\t\t\t\tvar ids=\"\";\r\n");
      out.write("\t\t\t\t\t\t\t\tvar cid=\"\";\r\n");
      out.write("\t\t\t\t\t\t\t\t for(var i=0;i<rows.length;i++){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t var checkedRowdata = rows[i];\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   if(checkedRowdata.planmoney<=0){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   mini.alert(\"计划金额小于0的不允许开票!!!\" );\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t   return false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t   if(\"增值税专用发票\"==checkedRowdata.rentinvoicetype){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tif(checkedRowdata.taxregcode==null || checkedRowdata.taxregcode==''){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tmini.alert(\"请维护纳税人信息后再生成开票清单!!!\" );\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  if(\"已申请\"==checkedRowdata.status){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tmini.alert(\"合同号：\"+checkedRowdata.contractid+\"已申请,不能再生成!!!\" );\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t  var data={};\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t\t\tvar datas=mini.encode(params);//租金实收的参数封装\r\n");
      out.write("\t\t\t\t\t\t\t\tvar attachmentParams = \"id=\"+ids+\"&tsdxml=\"+tsdxml+\"&datas=\"+datas+\"&cid=\"+cid;\r\n");
      out.write("\t\t\t\t        \t    startProcess(\"租金开票流程-1\",attachmentParams); \r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\tmini.alert('请你选择需要发起租金开票流程！！！');\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}         \r\n");
      out.write("\t\t\t\t],\r\n");
      ...
      out.write("\t\t\t\t\t\t\t  }\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t{field : 'incomemoney',header : '实收金额',align:'right',summary: true},\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}},\r\n");
      out.write("\t\t\t\t\t\t\t{field : 'trendsxml',visible:false,header : '提前/实收开票',\r\n");
      out.write("\t\t\t\t\t\t\t\tqueryConfig : \r\n");
      out.write("\t\t\t\t\t\t   \t    {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tvalueField : 'value',\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttextField : 'name',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue:'rentshishou',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tallowInput : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata : trendsxml\r\n");
      out.write("\t\t\t\t\t\t\t   }\t\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t})\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<div id=\"id_fund_invoice\" style=\"height: 100%\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
