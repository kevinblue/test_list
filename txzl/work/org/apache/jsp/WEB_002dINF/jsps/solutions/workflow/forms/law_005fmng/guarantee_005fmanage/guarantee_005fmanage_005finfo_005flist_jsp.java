 ...
 * Generated at: 2017-06-16 05:01:08 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.forms.law_005fmng.guarantee_005fmanage;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class guarantee_005fmanage_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tqueryButtonNewLine : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.guaranteemanagement.GuaranteeInfo',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenStartColumn : 0,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenEndColumn : 2,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/guarantee_manage/guarantee_manage_info_list.xml',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'projnameidname',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t                var clientBankQueryInput = getMiniuiExtObject(\"table_guarantee_info_id_editFormPopupWindow_form_cnsid\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t                var conidparams=clientBankQueryInput.params ;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t                    conidparams.projid= rowDatas;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteestate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函状态',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'guaranteestateid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillProperty : 'name'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteestateid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函状态',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'cnsid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '采购合同名编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible:false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig:{width:200},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tlabelWidth : 120,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype : 'queryinput',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttextField:'contractnumber',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalueField:'cnsid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tonSelect : function($me,queryInput,rowData) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmini.getbyName(\"contractidname\").setValue(rowData.contractnumber); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tloadContractNameAjax($me,queryInput,rowData);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvar clientBankQueryInput = getMiniuiExtObject(\"table_guarantee_info_id_editFormPopupWindow_form_cnsid\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tprojid : 'xxx',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName:'/eleasing/jsp/guarantee_manage/guarantee_contract_number.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tallowInput:false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'applyrefund',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '是否申请退还',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函名称',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine : true\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'guaranteenameid',\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillProperty : 'name'\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteenameid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函名称',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine : false,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteetype',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函类型',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {},\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'openbank',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函开立银行',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'relatedequipment',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '相关设备',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'effectivedate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '生效日期',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdateFormat : \"yyyy-MM-dd\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'expirydate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '失效日期',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdateFormat : \"yyyy-MM-dd\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'money',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '金额（元）',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'relevantcontract',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '相关合同',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'guaranteeposition',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保函位置',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t//发送ajax获取合同名\r\n");
      out.write("\tfunction loadContractNameAjax($me,queryInput,rowData){\r\n");
      out.write("\t\tvar conid = queryInput.value;  \r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\tcache : false,\r\n");
      out.write("\t\t\tasync : false,\r\n");
      out.write("\t        type: \"post\",\r\n");
      out.write("\t        url : getRootPath()+ \"/acl/loadContractName.acl\",\r\n");
      out.write("\t        data: {conid:conid},\r\n");
      out.write("\t        success: function (data){\r\n");
      out.write("\t        \t//debugger;\r\n");
      out.write("\t        \tmini.getbyName(\"contractname\").setValue(data);\r\n");
      out.write("\t        }\r\n");
      out.write("\t    })\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
