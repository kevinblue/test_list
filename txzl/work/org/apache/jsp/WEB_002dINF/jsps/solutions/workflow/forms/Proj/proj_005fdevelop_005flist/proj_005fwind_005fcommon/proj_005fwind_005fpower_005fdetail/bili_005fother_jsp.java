...
public final class bili_005fother_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid : 'bili_other',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\twidth : globalClientWidth - 20,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\theight : 420,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\texportTitle : '各项时间占比',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ticonCls : 'icon-node',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\trenderTo : 'main_bili_other',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/workflow/proj/proj_wind/bili_other.xml',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'typename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '所占比例',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tallowSort : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      ...
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("<div id='main_bili_other'></div>");
