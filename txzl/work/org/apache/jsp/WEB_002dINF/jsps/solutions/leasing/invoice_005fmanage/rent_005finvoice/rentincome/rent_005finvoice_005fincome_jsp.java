 ...
 * Generated at: 2017-03-16 08:54:18 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.invoice_005fmanage.rent_005finvoice.rentincome;
...
public final class rent_005finvoice_005fincome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("//状态下拉查询\r\n");
      out.write("var statusdata = [ {name : '未申请',value : '未申请'},{name : '已退回',value : '已退回'},{name : '已申请',value : \"已申请\"},{name : '全部',value : ''},{name : '不开票',value : '不开票'}];\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\tparams:{\r\n");
      out.write("\t\t\t\t\tstatus:\"未申请','已退回\"\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tisRemoteStatistic: true,\r\n");
      out.write("\t\t\t\txmlFileName : '/eleasing/jsp/invoice_manage/rent_invoice/invoiceIncome/rent_invoice_income.xml',\r\n");
      out.write("\t\t\t\ttools : [\r\n");
      out.write("\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\thtml : '生成开票清单',\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar operTitle = \"租金实收开票\";\r\n");
      out.write("\t\t\t\t\t\t\tvar operAction = \"submitRentIncomeInvoice\";\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tif(\"已申请\"==checkedRowdata.status){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"合同号：\"+checkedRowdata.contractid+\"已申请,不能再生成!!!\" );\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tvar id = checkedRowdata.id;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar data={};\r\n");
      out.write("\t\t\t\t\t\t\t\tdata.id=id;\r\n");
      out.write("\t\t\t\t\t\t\t\tdata.pid=checkedRowdata.pid;\r\n");
      out.write("\t\t\t\t\t\t\t\tdata.planmoney=checkedRowdata.planmoney;\r\n");
      out.write("\t\t\t\t\t\t\t\tdata.type=checkedRowdata.plantypeid;\r\n");
      out.write("\t\t\t\t\t\t\t\tdata.incomemoney=checkedRowdata.incomemoney;\r\n");
      out.write("\t\t\t\t\t\t\t\tparams.push(data);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata : {datas:mini.encode(params)},\r\n");
      ...
      out.write("\t\t\t\t\t},'-',\r\n");
      out.write("\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\thtml : '删除开票清单',\r\n");
      out.write("\t\t\t\t\t\tplain : true,\r\n");
      out.write("\t\t\t\t\t\ticonCls : 'icon-addfolder',\r\n");
      out.write("\t\t\t\t\t\thandler : function(miniTable, buttonText) {\r\n");
      out.write("\t\t\t\t\t\t\tvar checkedRowDatas = miniTable.getSelecteds();\r\n");
      out.write("\t\t\t\t\t\t\tdebugger;\r\n");
      out.write("\t\t\t\t\t\t\tvar operType = \"删除\";\r\n");
      out.write("\t\t\t\t\t\t\tvar operTitle = \"租金开票清单\";\r\n");
      out.write("\t\t\t\t\t\t\tvar operAction = \"deleteRentInvoiceOrReceipt\";\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tif(0 == checkedRowDatas.length){\r\n");
      out.write("\t\t\t\t\t\t\t\talert(\"请选择要\"+operType+\"的记录！！\");\r\n");
      out.write("\t\t\t\t\t\t\t\treturn;\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar checkedRowdata = checkedRowDatas[i];\r\n");
      out.write("\t\t\t\t\t\t\t\tif(\"已申请\"==checkedRowdata.status){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"合同号：\"+checkedRowdata.contractid+\"已申请,不能删除!!!\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tif(checkedRowdata.rentinvoicid){\r\n");
      out.write("\t\t\t\t\t\t\t\t  var id = checkedRowdata.rentinvoicid;\r\n");
      out.write("\t\t\t\t\t\t\t\t  tempIdArr.push(id);\r\n");
      out.write("\t\t\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"没有记录，不需要删除！！！\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\tdebugger;\r\n");
      out.write("\t\t\t\t\t\t\tvar operType = \"生成\";\r\n");
      out.write("\t\t\t\t\t\t\tvar operTitle = \"租金不开票\";\r\n");
      out.write("\t\t\t\t\t\t\tvar operAction = \"submitRentIncomeNoInvoice\";\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tif(0 == checkedRowDatas.length){\r\n");
      out.write("\t\t\t\t\t\t\t\talert(\"请选择要\"+operType+\"的记录！！\");\r\n");
      out.write("\t\t\t\t\t\t\t\treturn;\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar checkedRowdata = checkedRowDatas[i];\r\n");
      out.write("\t\t\t\t\t\t\t\tif(\"已申请\"==checkedRowdata.status){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"合同号：\"+checkedRowdata.contractid+\"已申请,不能提交不开票!!!\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tif(\"不开票\"==checkedRowdata.status){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"合同号：\"+checkedRowdata.contractid+\"已经是不开票状态,不能提交不开票!!!\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\tvar id = checkedRowdata.id;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar data={};\r\n");
      ...
      out.write("\t\t\t\t\t{field : 'rentlist',header : '期数'},\r\n");
      out.write("\t\t\t\t\t{field : 'plandate',header : '计划日期'},\r\n");
      out.write("\t\t\t\t\t{field : 'planmoney',header : '计划金额',dataType:\"currency\",align:'right',summary: true},\r\n");
      out.write("\t\t\t\t\t{field : 'incomedate',header : '实收日期',\r\n");
      ...
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t{field : 'incomemoney',header : '实收金额',width : 120,dataType:\"currency\",align:'right',summary: true},\r\n");
