...
public final class cust_005frelatedperson_005flist01_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsps/solutions/leasing/fund/fund_overdue/cust_comn.jsp", Long.valueOf(1486185627247L));
...
String projid=request.getParameter("projid");
      ...
      out.write("\t\t\tid:'table_id1x',\r\n");
      out.write("\t\t\twidth:globalClientWidth,\r\n");
      out.write("\t\t\theight:300,\r\n");
      out.write("\t\t\ticonCls:'icon-node',\r\n");
      out.write("\t\t\trenderTo:'content_table_id1x',\r\n");
      out.write("\t\t\ttitle:'联系人信息',\r\n");
      ...
      out.write("\t\t\t\tmini.get(\"table_id1x\").deselectAll(false);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\txmlFileName:'/eleasing/jsp/cust_info/cust_relatedperson/cust_relatedperson_list.xml',\r\n");
      out.write("\t\t\toperValidate:function(miniTable,rowData,oper){\r\n");
      out.write("\t\t\t\tvar deptobj = \"");
      out.print(session.getAttribute("userDeptListStr"));
      out.write("\";\r\n");
      out.write("\t\t\t\t/* if(\"edit\"==oper||\"remove\"==oper){\r\n");
      out.write("\t\t\t\t\tvar checkRowDatas = miniTable.getSelecteds();\r\n");
      out.write("\t\t\t\t\tif(checkRowDatas && checkRowDatas.length > 0){\r\n");
      out.write("\t\t\t\t\t\tvar rowData = checkRowDatas[0];\r\n");
      out.write("\t\t\t\t\t\t//4028805e5261d9e001526206b4630066资产管理部\r\n");
      out.write("\t\t\t\t\t\tif(rowData.onhirenum > '0' && deptobj.indexOf('4028805e5261d9e001526206b4630066')<0){\r\n");
      out.write("\t\t\t\t\t\t\tmini.alert(\"该承租人有在起租的合同，请联系资产管理部进行修改\");\r\n");
      out.write("\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t} */\r\n");
      ...
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\tvar multiform = new mini.Form(\"overduedunningcored\");\r\n");
      ...
      out.write("\t\t\t\t\t\tmini.get(\"custname\").setValue(row.personname);\r\n");
      out.write("\t\t\t\t\t\tmini.get(\"custid\").setValue(row.id);\r\n");
      out.write("\t\t\t\t\t\tmini.get(\"planid\").setValue(planid);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},'-','add', '-', 'edit','-',{\r\n");
      out.write("\t\t\t\thtml:'项目总表',\r\n");
      out.write("\t\t\t\tplain : true,\r\n");
      out.write("\t\t\t\thandler : function(miniTable, buttonText){\r\n");
      out.write("\t\t\t          if(projid!=null||projid!=\"\"||projid.length>0){\r\n");
      out.write("\t\t\t        \t\t var URL = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/jbpm/getProjSummaryHistoryInfos.action?keyOne=\"+projid;\r\n");
      out.write("\t\t\t\t\t\t\t    openFullScreenWindow(URL);  \r\n");
      out.write("\t\t\t          }else{\r\n");
      out.write("\t\t\t        \t  \r\n");
      out.write("\t\t\t        \t  mini.alert(\"该合同没有总表信息！\");\r\n");
      out.write("\t\t\t          }\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}],\r\n");
      ...
      out.write("\t\t\t\t\t  {field:'duties',header:'职务',headerAlign:'center',width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     width:200,\r\n");
      ...
      out.write("\t\t\t\t     /*  {field:'sendperson',header:'是否寄件人',visible:true,headerAlign:'center',width:100,allowSort:true,visible:false,\r\n");
      out.write("\t\t\t\t\t\t\t     formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t            newLine:true,\r\n");
      out.write("\t\t\t\t\t            \t  \trequired:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t        width:200,\r\n");
      ...
      out.write("\t\t\t\t\t                     /*\r\n");
      out.write("\t\t\t         {field: 'rawValue_unitposition', header: '职务', visible:false,\r\n");
      out.write("\t\t\t\t              formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t              fieldVisible: false,\r\n");
      ...
      out.write("\t\t\t\t\t                labelWidth:100,\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t                     width:200 }},\r\n");
      out.write("\t\t\t        {field: 'modificatorname',header:'修改人',\theaderAlign:'center' ,width:100,visible:true,allowSort:true,\r\n");
      out.write("\t\t\t\t              formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t                   newLine:true,\r\n");
      out.write("\t\t\t\t\t                      type:'text',\r\n");
      out.write("\t\t\t\t\t                  readOnly:true,\r\n");
      ...
      out.write("\t\t\t\t\t                labelWidth:100,\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t                     width:200}},\r\n");
      out.write("\t\t\t       {field: 'modifydate',header:'修改时间',\theaderAlign:'center', visible:true,dateFormat:\"yyyy-MM-dd \",width:100,allowSort:true,\r\n");
      out.write("\t\t\t\t              formEditorConfig:{\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t                      type:'text',\r\n");
      out.write("\t\t\t\t\t                  readOnly:true,\r\n");
      out.write("\t\t\t\t\t              fieldVisible:true,\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\tif(sId!=\"\"){\r\n");
      out.write("\tmini.get(\"table_id1x_editFormPopupWindow_form_birthdate\").setValue(idcardStr.brithdate);\r\n");
      out.write("\tmini.get(\"table_id1x_editFormPopupWindow_form_sex\").setValue(idcardStr.sex);\r\n");
      out.write("\t}\r\n");
      out.write("\treturn true;\r\n");
      out.write("}\r\n");
      out.write("function checkIsPersonMain(){\r\n");
      out.write("\tvar mainpersonflagvalue = getMiniEditFormField(\"table_id1x.mainpersonflag\").getValue();//mini.getbyName(\"mainpersonflag\").getValue();\r\n");
      out.write("\tif(\"\" == mainpersonflagvalue || \"否\" == mainpersonflagvalue)return \"\";\r\n");
      out.write("\tvar idvalue = getMiniEditFormField(\"table_id1x.id\").getValue();\r\n");
      out.write("\tvar str = \"\";\r\n");
      out.write("\t$.ajax({\r\n");
      ...
      out.write("\tvar cardNo = getMiniEditFormField(\"table_id1x.idcardno\").getValue();//mini.getbyName(\"mainpersonflag\").getValue();\r\n");
      ...
      out.write("\tvar planid=mini.get(\"planid\").getValue();\r\n");
      out.write("\tvar cuid=mini.get(\"custid\").getValue();\r\n");
      out.write("\tvar contactway=mini.get(\"contactWay\").getValue();\r\n");
      out.write("\tvar commitmentinfo=mini.get(\"commitmentInfo\").getValue();\r\n");
      out.write("\tif(contactway == \"\"){\r\n");
      out.write("\t\tmini.alert(\"请选择联系方式！\");\r\n");
      out.write("\t\treturn ;\r\n");
      out.write("\t}\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t       url: getRootPath()+\"/acl/addsOverdueDunningRecord.acl\",\r\n");
      out.write("\t       type: \"post\",\r\n");
      out.write("\t       cache: false, \r\n");
      out.write("\t       data :{ \"custid\":cuid ,\"planid\":planid,\"contactway\":contactway,\"commitmentinfo\":commitmentinfo},\r\n");
      out.write("\t       async:false,\r\n");
      out.write("\t       success: function (text) {\r\n");
      ...
      out.write("\t       }\r\n");
      out.write("\t   });\r\n");
      out.write("\tmini.get(\"editWindow\").hide();\r\n");
      out.write("\tmini.get(\"table_id1\").reload();\t\t\r\n");
      out.write("\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("<div id='content_table_id1x'></div>\r\n");
      out.write("<div id=\"editWindow\" class=\"mini-window\" title=\"催收登记\" style=\"width:300px;height:200px;\" showModal=\"true\" allowResize=\"true\" allowDrag=\"true\">\r\n");
      out.write("\t<div id=\"overduedunningcored\">\r\n");
      out.write("\t\t<table>\r\n");
      out.write("\t\t\t<tr style=\"display:none\">\r\n");
      out.write("\t\t\t\t<td style=\"width:100px;\">租金计划id：</td>\r\n");
      out.write("                <td >\r\n");
      out.write("                    <input name=\"planid\" id=\"planid\" class=\"mini-textbox\" readOnly/>\r\n");
      out.write("                </td>\r\n");
      out.write("             </tr>\r\n");
      out.write("\t\t\t<tr style=\"display:none\">\r\n");
      out.write("\t\t\t\t<td style=\"width:100px;\">联系人id：</td>\r\n");
      out.write("                <td >\r\n");
      out.write("                    <input name=\"custid\" id=\"custid\" class=\"mini-textbox\" readOnly/>\r\n");
      out.write("                </td>\r\n");
      out.write("             </tr>\r\n");
      out.write("             <tr>\r\n");
      out.write("\t\t\t\t<td style=\"width:100px;\">联系人姓名：</td>\r\n");
      out.write("                <td >\r\n");
      out.write("                    <input name=\"custname\" id=\"custname\" class=\"mini-textbox\" readOnly/>\r\n");
      out.write("                </td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td style=\"width:100px;\">联系方式：</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input id=\"contactWay\" name=\"contactWay\" \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tshowNullItem=\"true\"\r\n");
      out.write("\t\t\t\t\t\t\t   allowInput=\"false\" \r\n");
      out.write("\t\t\t\t\t\t\t   data-options=\"{_params:{pid:'visit_mode',_xmlFileName:'combos/comboDict.xml'}}\" \r\n");
      out.write("\t\t\t\t\t\t\t   onbeforeshowpopup=\"miniextonbeforeshowpopup\"\r\n");
      out.write("\t                    onEnter=\"search\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td style=\"width:100px;\">联系情况：</td>\r\n");
      out.write("\t\t\t\t<td><input name=\"commitmentInfo\" id=\"commitmentInfo\" class=\"mini-textarea  asLabel\" width=\"95%\"/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t \t<td colspan=\"2\" style=\"border-bottom: 1px solid #99CCFF;\" align=\"center\" >\r\n");
      out.write("\t\t\t   <a class=\"mini-button\" iconCls=\"icon-edit\" onclick=\"add\">保存</a>\r\n");
      out.write("\t\t    </td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
