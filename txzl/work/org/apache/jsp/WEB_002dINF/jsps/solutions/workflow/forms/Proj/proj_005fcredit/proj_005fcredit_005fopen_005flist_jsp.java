 ...
 * Generated at: 2017-12-14 10:28:37 UTC
...
public final class proj_005fcredit_005fopen_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("'},\r\n");
      out.write("\t\t\t\txmlFileName:'/eleasing/workflow/proj/proj_credit/proj_credit_info_list.xml',\r\n");
      out.write("\t\t\t\ttools:[\r\n");
      out.write("\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\thtml:'项目信审',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t//if(!creditValidate(row)){\r\n");
      out.write("\t\t\t\t\t\t\t\t//\treturn ;\r\n");
      out.write("\t\t\t\t\t\t\t\t//}\r\n");
      out.write("\t\t\t\t\t\t\t\t/* if(\"是\"==mini.decode(row).draft){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tmini.alert('该项目承租人仍为潜在客户状态，请在客户信息中修改为非潜在客户状态后再发起流程！');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\t\t\t} */\r\n");
      out.write("\t\t\t\t\t\t\t\tvar attachmentParams = \"proj_id=\"+row.id;\r\n");
      out.write("\t\t\t\t        \t\tstartProcess(\"项目信审流程-1\",attachmentParams); \r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t\tmini.alert('请你选择需要发起信审流程的项目！！！');\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}         \r\n");
      out.write("\t\t\t\t],\r\n");
      ...
      out.write("\t\t\t\t\t{field:'custname',header:'客户名称',width : 100,queryConfig:{}},\r\n");
      ...
      out.write("\t\t\t\t\t{field:'projdate',header:'立项时间',queryConfig:{type:'date',newLine:false,range:true,format:'yyyy-MM-dd'}},\t\t\t\t\t\r\n");
