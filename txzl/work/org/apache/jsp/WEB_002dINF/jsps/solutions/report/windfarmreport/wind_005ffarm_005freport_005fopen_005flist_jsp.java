 ...
 * Generated at: 2017-06-16 03:37:47 UTC
...
public final class wind_005ffarm_005freport_005fopen_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("'},\r\n");
      out.write("\t\t\t\txmlFileName:'/eleasing/workflow/proj/proj_credit/wind_farm_report_list.xml',\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\ttools:[\r\n");
      out.write("\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\thtml:'年度风电场报告流程',\r\n");
      out.write("\t\t\t\t\t\tplain:true,\r\n");
      out.write("\t\t\t\t\t\ticonCls:'icon-addfolder',\r\n");
      out.write("\t\t\t\t\t\thandler:function(miniTable, buttonText) {\r\n");
      out.write("\t  \t\t\t\t\t\t\t    var multiform = new mini.Form(\"multiform2\");\r\n");
      out.write("\t  \t\t\t\t\t\t\t\tvar multieditWindow = mini.get(\"multieditWindow2\");\r\n");
      out.write("\t  \t\t\t\t\t\t\t\tmultiform.clear();\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttenwa.createQueryInput({\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid:'id_windfarmreportYear_list',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tlabel:'年度风电场报告',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\twindowWidth: 450,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\twindowHeight: 700,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttextField: 'name',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalueField: 'value',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tparams: {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    xmlFileName:'/eleasing/workflow/proj/proj_credit/wind_farm_report_year.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t  \t\t\t\t\t\t\t\tmultieditWindow.show();\r\n");
      out.write("\t\t\t\t\t\t\t\t//mini.alert('请你选择需要发起的项目！！！');\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t/* mini.confirm(\"确定发起本年度风场报表?\",'删除？',function(action){\r\n");
      out.write("\t\t\t\t\t\t\t\tif(action == 'ok'){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar attachmentParams = \"proj_id=风电场年报\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstartProcess(\"风电场报告-1\",attachmentParams); \r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t} );*/\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}, \"-\",{\r\n");
      out.write("\t\t\t\t\t\thtml:'月度风电场报告流程',\r\n");
      out.write("\t\t\t\t\t\tplain:true,\r\n");
      out.write("\t\t\t\t\t\ticonCls:'icon-addfolder',\r\n");
      out.write("\t\t\t\t\t\thandler:function(miniTable, buttonText) {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tmini.get(\"projid\").setValue(row.projid);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tmini.get(\"projectname\").setValue(row.projectname);\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttenwa.createQueryInput({\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid:'id_windfarmreportMonth_list',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tlabel:'月度风电场报告',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\twindowWidth: 450,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\twindowHeight: 700,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttextField: 'name',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalueField: 'value',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tparams: {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tselectedprojid:selectedprojid,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t    xmlFileName:'/eleasing/workflow/proj/proj_credit/wind_farm_report_month.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t  \t\t\t\t\t\t\t\tmultieditWindow.show();\r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
      ...
      out.write("\t\t\t\t\t{field:'globalcontractmessageid',header:'globalcontractmessageid',visible:false},\r\n");
      out.write("\t\t\t\t\t{field:'projid',header:'项目编号',queryConfig:{}},\r\n");
      out.write("\t\t\t\t\t{field:'custname',header:'客户名称',width : 100,queryConfig:{newLine:false,colspan:3}},\r\n");
      out.write("\t\t\t\t\t{field:'projectname',header:'项目名称',width : 100,queryConfig:{}},\r\n");
      out.write("\t\t\t\t\t{\r\n");
      ...
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t{field:'projsource',header:'内部行业'},\r\n");
      out.write("\t\t\t\t\t{field:'projdate',header:'立项时间'},\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'projmanager',header:'项目经理',queryConfig:{}},\r\n");
      out.write("\t\t\t\t\t{field:'dept',header:'出单部门'},\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t{field:'projstatus',header:'项目状态',headerAlign:'center',align:'center'},\r\n");
      out.write("\t\t\t\t\t{field:'draft',header:'是否草稿',visible:false,headerAlign:'center',align:'center'}\r\n");
      out.write("\t\t\t\t\t,{field:'companyid',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'person_idcard',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'maila_ddress',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'tax_reg_type',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'tax_reg_code',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'tax_bank',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'tax_acc',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'invoice_add',header:'',visible:false}\r\n");
      out.write("\t\t\t\t\t,{field:'invoice_phone',header:'',visible:false}\r\n");
      out.write("\t\t\t\t]\t\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      ...
      out.write("\t<div id=\"multieditWindow\" class=\"mini-window\" title=\"风场月报\" style=\"width:550px;height:150px;\" showModal=\"true\" allowResize=\"true\" allowDrag=\"true\">\r\n");
      ...
      out.write("\t            </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td style=\"width:80px;\">报表月份：</td>\r\n");
      out.write("                    <td >\r\n");
      out.write("                        <input id=\"id_windfarmreportMonth_list\" name=\"dunninginfo\" class=\"mini-buttonedit mini-queryinput\" allowInput = \"false\" />\r\n");
      out.write("                    </td>\r\n");
      out.write("                </tr>   \r\n");
      out.write("                <tr >\r\n");
      out.write("                    <td >\r\n");
      ...
      out.write("        </div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"id_table_id2\" style=\"height: 100%\"></div>\r\n");
      out.write("\t<div id=\"multieditWindow2\" class=\"mini-window\" title=\"风场年报\" style=\"width:450px;height:100px;\" showModal=\"true\" allowResize=\"true\" allowDrag=\"true\">\r\n");
      out.write("        <div id=\"multiform2\">\r\n");
      out.write("            <table>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td style=\"width:80px;\">报表年份：</td>\r\n");
      out.write("                    <td >\r\n");
      out.write("                        <input id=\"id_windfarmreportYear_list\" name=\"dunninginfo\" class=\"mini-buttonedit mini-queryinput\" allowInput = \"false\" />\r\n");
      out.write("                    </td>\r\n");
      out.write("                </tr>   \r\n");
      out.write("                <tr >\r\n");
      out.write("                    <td >\r\n");
      out.write("                        <a class=\"mini-button\" onclick=\"submitMultiDataWindReport2\">&nbsp;&nbsp;确定&nbsp;&nbsp;</a>\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td >\r\n");
      out.write("                        <a class=\"mini-button\" onclick='__userOperationClose2'>&nbsp;&nbsp;取消&nbsp;&nbsp;</a>\r\n");
      out.write("                    </td>\r\n");
      out.write("                </tr>   \r\n");
      out.write("            </table>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("\tvar windfarmreportmonth = mini.get(\"id_windfarmreportMonth_list\").getValue();\r\n");
      out.write("\tif(\"\" == windfarmreportmonth){mini.alert(\"请选择报表月份！\");return false;}\r\n");
      out.write("\tvar tablevalue = mini.get(\"table_id1\");\r\n");
      out.write("\tvar row = tablevalue.getSelected();\r\n");
      out.write("\tvar rowid = row.id;\r\n");
      out.write("\tvar globalcontractmessageid = row.globalcontractmessageid;\r\n");
      out.write("\tvar attachmentParams = \"proj_id=\"+rowid+\";\"+windfarmreportmonth+\";风电场月报\"+\";\"+globalcontractmessageid;\r\n");
      out.write("\tstartProcess(\"风电场报告-1\",attachmentParams); \r\n");
      out.write("\t\r\n");
      out.write("};\r\n");
      out.write("function submitMultiDataWindReport2(e){\r\n");
      out.write("\tvar windfarmreportyear = mini.get(\"id_windfarmreportYear_list\").getValue();\r\n");
      out.write("\tif(\"\" == windfarmreportyear){mini.alert(\"请选择报表年份！\");return false;}\r\n");
      out.write("\tvar attachmentParams = \"proj_id=风电场年报;\"+windfarmreportyear;\r\n");
      out.write("\tstartProcess(\"风电场报告-1\",attachmentParams); \r\n");
      out.write("\t\r\n");
      out.write("};\r\n");
      ...
      out.write("}\r\n");
      out.write("function __userOperationClose2(){\r\n");
      out.write("\tmini.get(multieditWindow2).hide();\r\n");
      out.write("}\n");
      out.write("function creditValidate(row){\r\n");
      out.write("\tif(!row.companyid){\r\n");
      out.write("\t\treturn true;\r\n");
      out.write("\t} \r\n");
      out.write("\tvar msg=\"请检查该客户以下字段是否填写: </br>\";\r\n");
      out.write("\tvar flag = true;\r\n");
      out.write("\t/* if(!row.person_idcard){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>证件号码</font></br>\";\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t} */\r\n");
      out.write("\tif(!row.maila_ddress){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>邮寄地址</br>\";\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(row.tax_reg_type == 'tax_level_name.1' && !row.tax_reg_code){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>纳税人识别号</br>\"\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(row.tax_reg_type == 'tax_level_name.1' && !row.tax_bank){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>开户行</br>\";\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(row.tax_reg_type == 'tax_level_name.1' && !row.tax_acc){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>开户账号</br>\";\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(row.tax_reg_type == 'tax_level_name.1' && !row.invoice_add){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>开票地址</br>\";\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(row.tax_reg_type == 'tax_level_name.1' && !row.invoice_phone){\r\n");
      out.write("\t\tmsg += \"<font color='#FF0000'>开票电话</br>\";\r\n");
      out.write("\t\tflag=false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(!flag){\r\n");
      out.write("\t\tmini.alert(msg);\r\n");
      out.write("\t}\r\n");
