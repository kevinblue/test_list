 ...
 * Generated at: 2017-05-23 03:35:36 UTC
...
public final class insurance_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \t\t\t\t  var userEnabled = [{id:'是',text:'是'}, {id:'否',text:'否'}];\r\n");
      out.write("  \t\t\t\t  var ispayment = [{id:'是',text:'是'}, {id:'否',text:'否'}];\r\n");
      out.write("  \t\t\t\t  var getUserEnabled = function(e) {\r\n");
      out.write("  \t\t\t\t\t    var code = e.record.ispaymentpremium;\r\n");
      out.write("                        for (var i = 0; i < ispayment.length; i++) {  \t\t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\t\t   if (ispayment[i]['id'] == code) {\r\n");
      out.write("  \t\t\t\t\t\t\t  return ispayment[i]['text'];\r\n");
      out.write("  \t\t\t\t\t\t }\r\n");
      out.write("  \t\t\t\t\t }\r\n");
      out.write("  \t\t\t\t\t return '';};\r\n");
      out.write("  \t\t\t\t\tvar getIsPayment = function(e) {\r\n");
      ...
      out.write("\t  \t\t\t\t\tid:'table_insuranceinfo_id',\r\n");
      ...
      out.write("\t  \t\t\t\t\ttitle:'保险清单' ,\r\n");
      out.write("\t  \t\t\t\t\tremoteOper:true,\r\n");
      out.write("\t  \t\t\t\t\tpageSize:15,\r\n");
      out.write("\t  \t\t\t\t\tshowPager:true,\r\n");
      out.write("\t  \t\t\t\t\tlazyLoad:false,\r\n");
      out.write("\t  \t\t\t\t\tloadMode:'ajax',\r\n");
      out.write("\t  \t\t\t\t\tentityClassName:'com.tenwa.leasing.entity.insurance.InsuranceInfo',\r\n");
      out.write("\t  \t\t\t\t\tentityBeanCallBackClassName : 'com.tenwa.business.callback.InsuranceInfoBeanCallBack',\r\n");
      ...
      out.write("\t  \t\t\t\t\tcolumns:[ \r\n");
      out.write("\t  \t\t\t\t\t    {type:'indexcolumn',width:40},\r\n");
      out.write("\t  \t\t\t\t\t   \t{type:'checkcolumn',width:40}, \r\n");
      ...
      out.write("\t  \t\t\t\t\t\t{field: 'contractidname_', header: '合同编号', visible: true,width:120,\r\n");
      out.write("\t  \t\t\t\t\t\t\t     formEditorConfig:{\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t     fieldVisible:false}},\r\n");
      out.write("\t  \t\t\t\t\t   \t{field: 'contractnumbername', header: '业务合同号',visible: false,formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t  \t\t\t\t\t\t{field: 'contractnumber', header: '业务合同号', visible: true,width:120,\r\n");
      ...
      out.write("  \t\t\t\t\t\t\t                   mini.getbyName(\"projname\").setValue(rowData.projname);\r\n");
      out.write("  \t\t\t\t\t\t\t                   mini.getbyName(\"contractid\").setValue(rowData.contractid);\r\n");
      out.write("  \t\t\t\t\t\t\t                   mini.getbyName(\"insurancemoney\").setValue(rowData.equipamt);},\r\n");
      out.write("  \t\t\t\t\t\t               params: {xmlFileName: '/eleasing/jsp/insure_manage/insurance_contractId.xml'}\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t }},\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t\t          queryConfig:{  \t\r\n");
      out.write("\t\t\t\t\t\t   \t\t\t            width:200}},\r\n");
      out.write("\t  \t\t\t\t\t    {field:'custname',header:'客户名称',headerAlign:'center',visible: true,width:120, \r\n");
      out.write("\t  \t\t\t\t\t   \t\t     formEditorConfig:{\t\r\n");
      out.write("\t  \t\t\t\t\t   \t\t                 type:'text',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            width:200,\r\n");
      ...
      out.write("\t  \t\t\t\t\t   \t\t          queryConfig:{  \t\r\n");
      out.write("\t  \t\t\t\t\t   \t\t\t            width:200}},  \t\r\n");
      out.write("\t  \t\t\t\t\t  \t{field:'projname',header:'项目名称',width:120, \r\n");
      out.write("\t  \t\t\t\t  \t\t\t\tformEditorConfig:{\r\n");
      out.write("\t  \t\t\t\t  \t\t\t\t\t   \t\ttype:'text',\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t\t\t\tlabelWidth:100,\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t\t\t    width:200,\r\n");
      ...
      out.write("\t  \t\t\t\t  \t\t\t\t\t   \t\twidth:200}\r\n");
      out.write("\t  \t\t\t\t\t\t},  \r\n");
      out.write("\t\t\t\t\t\t   \t{field:'isinsure',header:'是否我司投保',headerAlign:'center',visible: true,width:100, \t\t\t\t    \t\r\n");
      out.write("\t  \t\t\t\t\t    \t     formEditorConfig:{\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t            width:200,\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t         required:true,\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t       defaultValue:'否',\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t\t\tshowNullItem : false,\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t             type:'combobox',\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t             data:userEnabled}},\r\n");
      out.write("\t  \t\t\t\t\t\t{field:'ispaymentpremium',header:'是否已支付保费',headerAlign:'center',visible: true,width:100,\t    \t\r\n");
      out.write("\t  \t\t\t\t  \t\t\t\tformEditorConfig:{\r\n");
      out.write("\t  \t\t\t\t  \t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t  \t\t\t\t  \t\t\t\t\t\tlabelWidth:100,\r\n");
      out.write("\t  \t\t\t\t  \t\t\t\t\t\t\t width:200,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t        \t  newLine:true,\r\n");
      out.write("                                              width:200}},\r\n");
      out.write("                            {field: 'isurancetypename', header:'险种', visible: true,\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t   formEditorConfig:{\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t\t\tfieldVisible: false,\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'isurancetype',\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t\t\tfillProperty : 'name'\t\t\t\t\t\t\t\t \r\n");
      out.write("           \t\t\t\t\t}},\r\n");
      out.write("           \t\t\t\t\t{field : 'isurancetype',header : '险种',visible: false,\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t  formEditorConfig : {\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t\t    newLine:true,\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t\t\ttype : 'combobox',\r\n");
      ...
      out.write("           \t\t\t\t\t\t\t\t\t\t\tfieldVisible: true,\r\n");
      out.write("           \t\t\t\t\t\t\t\t\t\t\tparams:{pid: 'insurancetype',xmlFileName: '/combos/comboDict.xml'}\t\t\t                 \r\n");
      out.write("           \t\t\t\t\t}},\r\n");
      ...
      out.write("\t \t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t \t\t\t\t\t\t\t\t            width:200 }},\r\n");
      out.write("\t \t\t\t\t\t\t{field:'insurancemoney',header:'保额(设备款)',headerAlign:'center',visible: true,width:100,dataType:\"currency\",\t\t\t\t\t   \t\t\r\n");
      out.write("\t \t\t\t\t\t\t\t\t\t   \t\t     formEditorConfig:{\t\r\n");
      out.write("\t \t\t\t\t  \t\t\t\t\t   \t\t                 type:'text',\r\n");
      out.write("\t \t\t\t\t\t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t \t\t\t\t\t\t\t\t\t\t\t\t            width:200,\t\r\n");
      out.write("\t \t\t\t\t\t\t\t\t\t\t\t\t         readonly:true\r\n");
      out.write("\t \t\t\t\t\t\t}},\t\r\n");
      out.write("\t\t\t\t\t\t    {field:'insurancepremium',header:'保费',headerAlign:'center',visible: true,width:100,dataType:\"currency\",\r\n");
      out.write("\t\t  \t\t\t\t\t\t     formEditorConfig:{\r\n");
      out.write("\t\t  \t\t\t\t\t\t          \t newLine:true,\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t         required:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            width:200,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t         otherAttributes:\"onvaluechanged='insurancepremiumchanged(e)'\"}},\t\t\t\t\t   \r\n");
      out.write("\t\t\t\t\t\t    {field:'insurancepremiumrate',header:'保险费率(万分之)',headerAlign:'center',visible: true,width:100,\t\t\t\t\t    \t\r\n");
      out.write("\t\t\t\t\t\t    \t     formEditorConfig:{\r\n");
      out.write("\t  \t\t\t\t\t\t\t\t             type:'text',\r\n");
      out.write("\t \t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t \t\t\t\t\t\t\t\t            width:200,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            width:200}},\r\n");
      out.write("\t\t\t\t\t\t    {field:'surrendermoney',header:'退保金额',headerAlign:'center',visible: true,width:100,dataType:\"currency\",\r\n");
      out.write("\t\t\t\t\t\t    \t     formEditorConfig:{\r\n");
      out.write("\t\t\t  \t\t\t\t\t\t          newLine:true,\r\n");
      out.write("\t\t\t  \t\t\t\t\t\t             type:'text',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       labelWidth:100,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t             width:\"100%\",\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t              type:'textarea'}},\r\n");
      out.write("\t\t\t\t\t\t    {field:'memo',header:'备注',headerAlign:'center',visible: true,width:100,formEditorConfig:{\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t           newLine:true,\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t           colspan: 3,\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t             width:\"100%\",\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t              type:'textarea'}}\t,\r\n");
      out.write("\t\t  \t\t\t\t  \t{field:'',header:'保单',\r\n");
      out.write("\t\t  \t\t\t\t  \t\t\tformEditorConfig:{\r\n");
      out.write("\t\t  \t\t\t\t                fieldVisible:false},\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t\trenderer:function(e){\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t\tvar id = e.record.id;\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t\treturn \"<a href='javascript:void(0);' onclick='showanduploadfile(\\\"\" + id + \"\\\",\\\"one\\\")'>上传/下载 </a>\";\r\n");
      out.write("\t\t  \t\t\t\t\t\t\t\t\t\t               }}\t\t  \t\t\r\n");
      out.write("\t\t\t\t\t\t    ]\r\n");
      out.write("\t  \t\t\t\t});\r\n");
      out.write("\t  \t\t\t});\r\n");
      ...
      out.write("  \t\t\tvar urlFlag = getRootPath()+\"/leasing/cust_info/cust_contact/cust_contact_file_list.bi?id=\"+id+\"&type=\"+type;\r\n");
      out.write("  \t\t\tmini.open({\r\n");
      out.write("  \t\t        url: urlFlag,\r\n");
      out.write("  \t\t        id:'id_table_render_table1',\r\n");
      out.write("  \t\t        title: \"保单上传下载\", width: 800, height: 455,\r\n");
      ...
      out.write("  \t\t\tvar start=mini.getbyName(\"insurerstartdate\").getValue();\r\n");
      out.write("  \t\t\tmini.getbyName(\"insurerenddate\").setMinDate(start);  \t\t\t\r\n");
      out.write("  \t\t}\r\n");
      out.write("  \t\t \r\n");
      out.write("  \t\tfunction insurancepremiumchanged(e){\r\n");
      out.write("  \t\t\tvar data=e.sender;\r\n");
      out.write("  \t\t\t//console.info(data);\r\n");
      out.write("  \t\t\t//alert(data.value);\r\n");
      out.write("  \t\t\t//alert(data.value);\r\n");
      out.write("  \t\t\t//var insurancepremium=getMiniEditFormField(\"table_insuranceinfo_id.insurancepremium\").getValue();\r\n");
      out.write("  \t  \t\t//var insurancepremium = mini.getbyName(\"insurancepremium\").getValue();//保费\r\n");
      out.write("  \t  \t\tvar insurancemoney = mini.getbyName(\"insurancemoney\").getValue();//保额(设备款)\r\n");
      out.write("  \t  \t\tvar insurancepremiumrate = (Number(data.value,2)*10000/Number(insurancemoney,2)).toFixed(2);\r\n");
      out.write("  \t  \t\tmini.getbyName(\"insurancepremiumrate\").setValue(insurancepremiumrate);       \r\n");
      out.write("  \t  \t\t\r\n");
      out.write("  \t  \t} \r\n");
      out.write("  \t\t</script>\r\n");
      out.write("\t</head>\r\n");
  ...
  private boolean _jspx_meth_permission_005faction_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/insure_manage/insurance_info_list.jsp(17,5) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f0.setCode("insurance_add");
  ...
  private boolean _jspx_meth_permission_005faction_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/insure_manage/insurance_info_list.jsp(20,5) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f1.setCode("insurance_edit");
  ...
  private boolean _jspx_meth_permission_005faction_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/insure_manage/insurance_info_list.jsp(23,5) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f2.setCode("insurance_remove");
  ...
  private boolean _jspx_meth_permission_005faction_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsps/solutions/leasing/insure_manage/insurance_info_list.jsp(27,5) name = code type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_permission_005faction_005f3.setCode("insurance_exportexcel");
    ...
    if (_jspx_eval_permission_005faction_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("  \t\t\ttools.length>0?tools.push('-','exportExcel'):tool.push('exportExcel');\r\n");
        out.write("  \t\t\t");
