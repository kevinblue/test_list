 ...
 * Generated at: 2017-06-12 08:01:52 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.leasing.wind_005fproject_005fapproval;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class wind_005fproject_005fapproval_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>风电项目核准计划</title>\r\n");
      out.write('\r');
      out.write('\n');
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid : 'table_wind_project_approval_info_id',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\timportTargetClass : 'com.tenwa.leasing.entity.windprojectapproval.WindProjectApproval',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/wind_project_approval/wind_project_approval_list.xml',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttools : [ 'add', '-', 'edit', '-','remove', '-', 'importExcel','-', 'exportExcel' ],\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.windprojectapproval.WindProjectApproval',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'scale',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '规模（万千瓦）',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'prounit',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '项目单位',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\twidth:300,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tqueryConfig:{width:200},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'proadd',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '项目地址',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tqueryConfig:{width:200,newLine:true},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tnewLine : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'planappdate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '计划核准时间',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'planproddate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '计划投产时间',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t//\tdateFormat : \"yyyy-MM-dd\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tfield : 'approvalbatch',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\theader : '核准批次',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tqueryConfig:{width:200,newLine:false},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
