 ...
 * Generated at: 2017-08-12 06:44:46 UTC
...
public final class loan_005faccount_005finfo_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid : 'table_loan_account_info_id',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tentityClassName : 'com.tenwa.leasing.entity.finacial.LoanAccount',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenStartColumn : 0,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfrozenEndColumn : 2,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/finacial/loan_account/loan_account_list.xml',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttools : [ 'add', '-', 'edit', '-','remove','-',{html:'查看计提信息',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tmini.getbyName(\"contractid\").setText(mini.getbyName(\"projectname\").getValue());\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tcolumns : [\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   field:'oper',header:'借款详情',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   allowSort: false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   readOnly : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   renderer:function(e){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   \t      var row=e.record;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   \t\treturn \"<a href='javascript:showloaninfo(\\\"\"+row.id+\"\\\",\\\"\"+row.loancontractid+\"\\\")'>借款详情</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t   },\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field:'',header:'操作',width:200,\r\n");
      out.write("\t\t\t\t\t\t  \t\t\t\t\t  \t\t   formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t                                   fieldVisible:false},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t               renderer:function(e){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t                   var id = e.record.id;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t                       return \"<a href='javascript:void(0);' onclick='showanduploadfile(\\\"\" + id + \"\\\",\\\"one\\\")'>查看/上传资料 /附件个数：\"+e.record.attachmentnum+\"</a>\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t               }},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t {field : 'attachmentnum',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t    header : '附件个数',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'loanunit',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '借款单位',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'loancontractid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '借款合同编号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth:120,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'corpus',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '借款本金(元)',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'loanterm',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '借款期限',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'yearrate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '合同利率%',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvtype : 'float',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'nowrate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '当前执行利率%',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvtype : 'float',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t/* {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'cautionmoney',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '保证金(元)',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdataType:\"currency\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvtype : 'float',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, */\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'paymenttypename',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '还款方式',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillFromFieldName : 'paymenttype',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfillProperty : 'name'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{         \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'paymenttype',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '还款方式',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tfieldVisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tpid : 'paymenttype',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/combos/comboDict.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'loandate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '借款日',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\totherAttributes:'onvaluechanged=\"loandatejudge\"',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired : true\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'expiredate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '到期日',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdateFormat : \"yyyy-MM-dd\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'paydate',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '付息日',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theaderAlign : 'center',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdateFormat : \"yyyy-MM-dd\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t}, \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field: 'projectname', header: '借款项目', width:160,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tqueryConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine:true,},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  formEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          fieldVisible: false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t     fillFromFieldName:'contractid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          fillProperty:'name',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t       entityClassName:'com.tenwa.leasing.entity.contract.ContractInfo',\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t entityHeaderFieldName:'projectName'}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'contractid',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '借款项目',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : false,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth : 200,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t         fieldVisible:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tparams : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\txmlFileName : '/eleasing/jsp/finacial/loan_account/loan_contract.xml'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'atmmoney',header : '已提款金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'surplusatmmoney',width:160,header : '剩余可提款金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'alreadycorpus',header : '已还本金(元)',dataType:\"currency\",visible : true,formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'alreadyinterest',header : '已付利息(元)',dataType:\"currency\",visible : true,formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'surpluscorpus',header : '未还本金(元)',queryConfig : {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tnewLine:false,colspan:3},dataType:\"currency\",summary:true,visible : true,formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'surplusinterest',header : '未付利息(元)',dataType:\"currency\",visible : true,formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'alreadycaution',width:160, header : '保证金已付金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'surpluscaution',width:160,header : '保证金未付金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'alreadyhandling',width:160,header : '手续费已付金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'surplushandling',width:160,header : '手续费未付金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'alreadyother',width:160,header : '其他资金已付金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{field : 'surplusother',width:160,header : '其他资金未付金额(元)',visible : true,dataType:\"currency\",formEditorConfig:{fieldVisible: false}},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfield : 'mortgagedetail',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\theader : '担保抵押情况',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tvisible : true,\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tformEditorConfig : {\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\tfunction showloaninfo(id,loancontractid)\r\n");
      out.write("\t{\r\n");
      out.write("\t\tvar params = \"id=\"+id+\"&loancontractid=\"+loancontractid+\"&isView=true\";\r\n");
      out.write("\t\tvar url = getRootPath()+\"/leasing/financial/loan_account/loan_account_info_detail.bi?\"+params;\r\n");
      ...
      out.write(" \t\t\tvar urlFlag = getRootPath()+\"/leasing/financial/loan_account/loan_information_file_list.bi?id=\"+id+\"&type=\"+type;\r\n");
      out.write(" \t\t\tmini.open({\r\n");
      out.write(" \t\t        url: urlFlag,\r\n");
      out.write(" \t\t        title: \"借款资料\", width: 800, height: 455,\r\n");
      out.write(" \t\t        onload: function () {\r\n");
      out.write(" \t\t         mini.get(\"table_loan_account_info_id\").reload();\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("<div id=\"multieditWindow\" class=\"mini-window\" title=\"请选择\" style=\"width:30%;height:200px;\" showModal=\"true\" allowResize=\"true\" allowDrag=\"true\">\r\n");
      out.write("\t<div id=\"multiform\" title=\"计提信息\">\r\n");
      out.write("\t\t<table class=\"fillTable\" cellspacing=\"0\" cellpadding=\"10px\" style=\"width:100%;\" >\r\n");
      out.write("\t\t\t\t<tr class=\"tr-even\">\r\n");
      out.write("\t\t\t\t<td class=\"td-content-title\" style=\"width:80px;\">起息日：</td>\r\n");
      out.write("\t\t\t\t<td class=\"td-content\">\r\n");
      out.write("\t\t\t\t\t<input id=\"start_date\" name=\"start_date\" class=\"mini-datepicker\"  onvaluechanged=\"judgedate\" label=\"起息日\"  required=\"true\" allowInput=\"false\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr class=\"tr-even\">\r\n");
      out.write("\t\t\t\t<td class=\"td-content-title\" style=\"width:80px;\">止息日：</td>\r\n");
      out.write("\t\t\t\t<td class=\"td-content\">\r\n");
      out.write("\t\t\t\t\t<input id=\"end_date\" name=\"end_date\" class=\"mini-datepicker\"  label=\"止息日\"  required=\"true\" allowInput=\"false\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"center\" colspan=\"2\">\r\n");
      out.write("\t\t\t\t\t<a class=\"mini-button \" iconCls=\"icon-save\"  onclick=\"selectAccrued\">&nbsp;&nbsp;确定&nbsp;&nbsp;</a>\r\n");
      ...
      out.write("</body>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("function loandatejudge(e){ \r\n");
      out.write("\tvar start=mini.getbyName(\"loandate\").getValue();\r\n");
      out.write("\tmini.getbyName(\"expiredate\").setMinDate(start);  \r\n");
      out.write("\tmini.getbyName(\"paydate\").setMinDate(start); \r\n");
      out.write("\tvar end =mini.getbyName(\"expiredate\").getValue();\r\n");
      out.write("\tvar yearstart=start.getFullYear();\r\n");
      out.write("\tvar yearend=end.getFullYear();\r\n");
      out.write("\tvar monthstart=start.getMonth();\r\n");
      out.write("\tvar monthend=end.getMonth();\r\n");
      out.write("\tif(yearend==yearstart){\r\n");
      out.write("\t\tmini.getbyName(\"loantermnew\").setValue(monthend-monthstart+\"月\"); \r\n");
      out.write("\t}else{\r\n");
      out.write("\t\tif(monthstart==monthend){\r\n");
      out.write("\t\t\tmini.getbyName(\"loantermnew\").setValue(yearend-yearstart+\"年\"); \r\n");
      out.write("\t\t}else\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\tmini.getbyName(\"loantermnew\").setValue(yearend-yearstart+\"年\"+(monthend-monthstart)+\"月\"); \r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\tvar start=mini.getbyName(\"start_date\").getValue();\r\n");
      out.write("\tmini.getbyName(\"end_date\").setMinDate(start);  \t\t\t\r\n");
      out.write("}\r\n");
      out.write("function cancel(){\r\n");
      out.write("\tmini.get(\"multieditWindow\").hide();\r\n");
      out.write("}\r\n");
      out.write("function selectAccrued(){\r\n");
      out.write("\tif (miniui_ext.submitFormValidation([\"multiform\"]) == false) return false;\r\n");
      out.write("\tvar startdate=mini.get(\"start_date\").getValue();\r\n");
      out.write("\tvar enddate=mini.get(\"end_date\").getValue();\r\n");
      out.write("\tstartdate=mini.formatDate (startdate,\"yyyy-MM-dd\");\r\n");
      out.write("\tenddate=mini.formatDate (enddate,\"yyyy-MM-dd\");\r\n");
      out.write("\tvar params = \"startdate=\"+startdate+\"&enddate=\"+enddate;\r\n");
      out.write("\tvar url = getRootPath()+\"/leasing/financial/loan_account/loan_accrued_interest_list.bi?\"+params;\r\n");
      out.write("\tvar sheight = window.screen.availHeight - 30;\r\n");
      out.write("\tvar swidth = window.screen.availWidth - 10;\r\n");
      out.write("\tvar winoption = \"left=0px,top=0px,height=\" + sheight + \"px,width=\" + swidth + \"px,toolbar=yes,menubar=yes,location=yes,status=yes,scrollbars=yes,resizable=yes\";\r\n");
      out.write("\twindow.open(url, '_blank', winoption);\r\n");
