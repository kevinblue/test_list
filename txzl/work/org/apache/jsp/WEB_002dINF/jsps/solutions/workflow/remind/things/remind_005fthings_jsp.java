 ...
 * Generated at: 2017-08-12 03:03:37 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsps.solutions.workflow.remind.things;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class remind_005fthings_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>法务日志信息维护</title>\r\n");
      out.write('\r');
      out.write('\n');
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\ttitle:'推送任务管理',\r\n");
      out.write("\t\t\t\ticonCls:'icon-node',\r\n");
      out.write("\t\t\t\tmultiSelect:false,\t//是否可以多选\r\n");
      out.write("\t\t\t\thiddenQueryArea:false,//是否将查询区域折叠起来\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tqueryButtonColSpan:2,\t//查询区的按钮占的列数\r\n");
      out.write("\t\t\t\tqueryButtonNewLine:false,\r\n");
      out.write("\t\t\t\teditFormPopupWindowHeight:380,\r\n");
      out.write("\t\t\t\tqueryButtonNewLine:false,\t//查询区的按钮是不是换行显示\r\n");
      out.write("\t\t\t\tshowPager:true,\t\t\t//分页显示\r\n");
      out.write("\t\t\t\tremoteOper:true,\t\t//是否每次操作都提交都提交后台\r\n");
      out.write("\t\t\t\taddRemoteOperUrl:getRootPath()+\"/acl/addRemindTaskInfo.acl\",\r\n");
      out.write("\t\t\t\teditRemoteOperUrl:getRootPath()+\"/acl/updateRemindTaskInfo.acl\",\r\n");
      out.write("\t\t\t\tentityClassName:'com.tenwa.business.entity.RemindTask',\r\n");
      out.write("\t\t\t\txmlFileName: '/eleasing/jsp/law_mng/remind_things.xml',\r\n");
      out.write("\t\t\t\ttools:[\"add\",'-','edit','-','remove'],\r\n");
      out.write("\t\t\t\tcolumns:[\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t         \t{type:'indexcolumn',width:50},\r\n");
      out.write("\t\t\t\t\t\t   \t{type:'checkcolumn',width:50},  \r\n");
      out.write("\t\t\t\t\t\t   \t{field:'id',header:'id',visible:false},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'deployproppdid',header:'流程发起参数1'}, \r\n");
      out.write("\t\t\t\t\t\t   \t{field:'workflowparams',header:'流程发起参数2'},\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'reminduser',header:'发起人',\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t\t\tparams:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t\t\txmlFileName: '/eleasing/jsp/law_mng/remind_users.xml'\r\n");
      out.write("\t\t\t\t\t\t   \t\t\t},\r\n");
      out.write("\t\t\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'contractid',header:'合同编号',\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t   \t\t\ttype:'combobox',\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t\t\tparams:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t\t\txmlFileName: '/eleasing/jsp/law_mng/remind_contract_info.xml'\r\n");
      out.write("\t\t\t\t\t\t   \t\t\t},\r\n");
      out.write("\t\t\t\t\t\t   \t\t\t width: '100%'\r\n");
      out.write("\t\t\t\t\t\t   \t\t},queryConfig:{}\r\n");
      out.write("\t\t\t\t\t\t   \t\t},\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t{field:'docid',header:'流程实例ID',\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t   \t\t width: '100%'\r\n");
      out.write("\t\t\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'startdate',header:'开始执行日期',\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t   \t\t type:'date',\r\n");
      ...
      out.write("\t\t\t\t\t\t   \t{field:'statu',header:'状态',\r\n");
      out.write("\t\t\t\t\t\t\t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype:'combobox',\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdefaultValue:'待发起',\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\tdata:[{id:\"待发起\",text:\"待发起\"},{id:\"已发起\",text:\"已发起\"}],\r\n");
      out.write("\t\t\t\t\t\t\t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'keyone',header:'备用主键1',\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t width: '100%'\r\n");
      out.write("\t\t\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'keytwo',header:'备用主键2',\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t\tnewLine:true,\r\n");
      out.write("\t\t\t\t\t\t   \t\t width: '100%'\r\n");
      out.write("\t\t\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t\t\t   \t},\r\n");
      out.write("\t\t\t\t\t\t   \t{field:'keythree',header:'备用主键3'},\r\n");
      out.write("\t\t\t\t\t\t\t{field:'cid',header:'合同id',visible:false,\r\n");
      out.write("\t\t\t\t\t\t   \t\tformEditorConfig:{\r\n");
      out.write("\t\t\t\t\t\t   \t\t\tfillFromFieldName :'contractid',\r\n");
      out.write("\t\t\t\t\t\t   \t\t\tfillProperty :'cid'\r\n");
      out.write("\t\t\t\t\t\t   \t\t}\r\n");
      out.write("\t\t\t\t\t\t   \t}\r\n");
      out.write("\t\t\t\t\t\t   \t\r\n");
      out.write("\t\t\t\t]\r\n");
