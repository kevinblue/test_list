...
public class ExcelSwitchHtmlUtil {
	...
	/*public static void main(String[] args) {
		String path = "E:/bbbb.xlsx";
		String newpath=ExcelSwitchHtmlUtil.getExcelHtml(path);
		System.out.println(newpath);
	}*/
    public static String getExcelHtml(String path) {
       // String retpathHtml="";
        //String path = "E:/bbbb.xlsx";
        InputStream is = null;
        ...
        try {
            ...
            if (wb instanceof XSSFWorkbook) {
                ...
                htmlExcel = ExcelSwitchHtmlUtil.getExcelInfo(xWb,true);
            }else if(wb instanceof HSSFWorkbook){
                HSSFWorkbook hWb = (HSSFWorkbook) wb;
                htmlExcel = ExcelSwitchHtmlUtil.getExcelInfo(hWb,true);
            }
  ...
  /*          System.out.println(htmlExcel);
    		...
    		FileUtils.writeStringToFile(new File(savaPath, fileName), htmlExcel, "GBK");
    	     retpathHtml=savaPath+fileName;*/
    ...
    public String readExcelToHtml(String filePath , boolean isWithStyle){
        ...
        try {
            ...
            if (wb instanceof XSSFWorkbook) {
                XSSFWorkbook xWb = (XSSFWorkbook) wb;
                htmlExcel = ExcelSwitchHtmlUtil.getExcelInfo(xWb,isWithStyle);
            }else if(wb instanceof HSSFWorkbook){
                HSSFWorkbook hWb = (HSSFWorkbook) wb;
                htmlExcel = ExcelSwitchHtmlUtil.getExcelInfo(hWb,isWithStyle);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }finally{
