...
public abstract interface FundCommMethod {
	 ...
	 * @throws Exception
	 */
	public void initFundEquipDetail(String fieldIput,Map<String, String> variablesMap,Map<String,String>  queryMainObjectMap) throws Exception; 
