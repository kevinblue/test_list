...
public interface FileExcelService {
	...
	* 类说明卡扣数据上传初始化
	...
	public String exportFundRentInvoiceBefore(FileTemplateService fi,Map<String, String> pageMap,BaseFileTemplate ft,String modename) throws Exception;
...
//	public String exportRentInvoiceBefore(FileTemplateService fi,Map<String, String> pageMap,BaseFileTemplate ft,String modename) throws Exception;
	...
	public Object SetprojDevelop(ProjWindResource projresource,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	public Object SetDevelopProgress(ProjectProgress projectprogress,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	...
	public Object SetloanId(LoanFeePlan loanFeePlan,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	public Object SetloanIdIncome(LoanFeeIncome loanFeeIncome,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	public Object SetRentloanId(LoanRentPlan loanRentPlan,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	
	public Object SetIncomeloanId(LoanRentIncome loanRentIncome,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	public Object SetPIloanId(LoanRentPlanToInterest loanRentPlanToInterest,
			Map<String, String> model,Integer rowIndex) throws Exception ;
	public Object SetIIloanId(LoanRentIncomeToInterest loanRentIncomeToInterest,
			Map<String, String> model,Integer rowIndex) throws Exception ;
