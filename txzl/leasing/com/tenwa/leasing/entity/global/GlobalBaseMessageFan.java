 ...
 */
@Entity
@FieldName(name = "基本信息表")
@Table(name="T_GLOBAL_BASE_MESSAGEF_FAN")
public class GlobalBaseMessageFan {
	...
	@FieldName(name="风场风机ID")
	@Column(name="WFWT_ID",length=64)
	private String   wfwtId;
	...
	@FieldName(name="风机编号")
	@Column(name="FAN_NUMBER",length=200)
	private String   fanNumber;
	
	@FieldName(name="机型")
	@Column(name="FAN_TYPE",length=200)
	...
	public String getWfwtId() {
		return wfwtId;
	}

	public void setWfwtId(String wfwtId) {
		this.wfwtId = wfwtId;
	}
