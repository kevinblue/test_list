package com.tenwa.leasing.entity.cust.quot;
 ...
 */
@Entity
@FieldName(name = "客户初始商务条件")
@Table(name = "CUST_CONDITION")
//implements Condition 
public class CustCondition {
	@Id
	...
	@Column(name = "CUST_CAUTION_MONEY_RATIO", precision = 22, scale = Scale.GENERAL_RATE)
	private BigDecimal custCautionMoneyRatio;

	@FieldName(name = "承租人保证金")
	@Column(name = "CUST_CAUTION_MONEY", precision = 22, scale = Scale.DEFAULT)
	private BigDecimal custCautionMoney;

	@FieldName(name = "供应商保证金比例")
	@Column(name = "SUPPLIER_CAUTION_MONEY_RATIO", precision = 22, scale = Scale.GENERAL_RATE)
	private BigDecimal supplierCautionMoneyRatio;

	@FieldName(name = "供应商保证金")
	@Column(name = "SUPPLIER_CAUTION_MONEY", precision = 22, scale = Scale.DEFAULT)
	...
	public void setHandlingChargeMoneyRatio(BigDecimal handlingChargeRatio) {
		this.handlingChargeMoneyRatio = handlingChargeRatio;
	}
