...
@Entity
@FieldName(name = "销货厂商")
@Table(name = "CUST_SALES_MANUFACTURERS")
public class CustSalesManufacturers {
	...
	@FieldName(name="收款条件")
	@Column(name="PAYMENT_CONDITIONS" ,length=300)
	private String paymentConditions;
	
	@FieldName(name="占营收比率(%) ")
	@Column(name="REVENUE_RATIO", length=50)
	private String revenueRatio;

	@FieldName(name="进货项目")
	@Column(name="SALES_PROJECT", length=2000)
