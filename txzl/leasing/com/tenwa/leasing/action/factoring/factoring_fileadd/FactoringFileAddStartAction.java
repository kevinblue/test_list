...
@WorkflowAction(name = "factoringFileAddStartAction", description = "流程开始动作", workflowName = "保理资料补充")
@Component(value = "factoringFileAddStartAction")
public class  FactoringFileAddStartAction implements JbpmBaseAction {
