...
@WorkflowAction(name = "RiskReportStartAction", description = "流程开始动作", workflowName = "风险报送")
@Component(value = "RiskReportStartAction")
public class RiskReportStartAction implements JbpmBaseAction {
