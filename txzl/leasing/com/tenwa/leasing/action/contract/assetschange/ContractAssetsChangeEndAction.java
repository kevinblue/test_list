 ...
 * @info
 */
@WorkflowAction(name = "contractAssetsChangeEndAction", description = "流程结束动作", workflowName = "资产变更")
@Component(value = "contractAssetsChangeEndAction")
public class ContractAssetsChangeEndAction implements JbpmBaseAction {
	...
	public void end(HttpServletRequest request, Map<String, String> variablesMap, JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		this.onhireContractChangeService.saveAssetsContractChangeinfo(variablesMap);
		
		//this.contractAssetsChangeVoucherService.createVoucherReceiveContract(variablesMap);
