...
public class ContractSignEndAction implements JbpmBaseAction {
	...
	public void end(HttpServletRequest request, Map<String, String> variablesMap, JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		//保存签约信息
		Integer contractstatus = Integer.valueOf(variablesMap.get("contract_status"));
		ContractInfo contract=contractCommService.saveContractInfo(variablesMap, contractstatus);
