...
@WorkflowAction(name = "contractBackStartAction", description = "流程开始动作", workflowName = "合同归还")
@Component(value = "contractBackStartAction")
public class ContractBackStartAction implements JbpmBaseAction {
	...
	public void start(HttpServletRequest request, Map<String, String> variablesMap, JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		String json_contract_back_str=this.tableService.getJsonArrayData("contract_back/contract_back_present.xml", queryMainObjectMap).toString();
		variablesMap.put("json_contract_back_str",json_contract_back_str);
		/*//放款资料清单借阅
