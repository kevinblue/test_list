package com.tenwa.leasing.action.rent.regulatingBreathingBefore;
...
@WorkflowAction(name = "regulatingBreathingBeforeStartAction", description = "流程开始动作", workflowName = "起租前调息")
@Component(value = "regulatingBreathingBeforeStartAction")
public class regulatingBreathingBeforeStartAction implements JbpmBaseAction{
	
	private static final Logger log = LoggerFactory.getLogger(regulatingBreathingBeforeStartAction.class);
	...
	public void start(HttpServletRequest request,Map<String, String> variablesMap,JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		String interestid = variablesMap.get("interestid");
		//查询最新的央行调息记录
...
//		FundStandardInterest fajc=this.baseService.findEntityByProperties(FundStandardInterest.class, propertiesMap).get(0);
		FundStandardInterest fajc=this.baseService.findEntityByID(FundStandardInterest.class,interestid );
		...
		variablesMap.put("adjusttype", "before");//调息类型为起租前调息
