...
public class TaxFundInvoiceController {
	...
	@ResponseBody
	public JsonReturnResult submitFundChargeNoInvoice(HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		JsonReturnResult returnResult = new JsonReturnResult(JsonReturnResultTypeEnum.SUCCESS,"");
		try {
			Map<String,String> model =QueryUtil.getRequestParameterMapByAjax(request);
	...
	@ResponseBody
	public JsonReturnResult deleteFundInvoiceOrReceipt(HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		JsonReturnResult returnResult = new JsonReturnResult(JsonReturnResultTypeEnum.SUCCESS,"");
		try {
			Map<String,String> model =QueryUtil.getRequestParameterMapByAjax(request);
	...
	@RequestMapping(value = "/exportRentIncomeInvoiceBeforeTwo.acl")
	@ResponseBody
	public JsonReturnResult exportRentIncomeInvoiceBeforeTwo(HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		JsonReturnResult returnResult = new JsonReturnResult(JsonReturnResultTypeEnum.SUCCESS,"");
		try {
			Map<String,String> model =QueryUtil.getRequestParameterMapByAjax(request);
			this.taxFundService.exportRentAndIncomeInvoice(model);
			if(logger.isInfoEnabled()){
				logger.info("提交成功!");
			}
		} catch (Exception e) {
