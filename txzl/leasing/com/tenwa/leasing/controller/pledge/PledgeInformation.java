...
public class PledgeInformation {
	...
	public String showAccountReceivable(HttpServletRequest request,
		...
		Map<String, String> variablesMap = new HashMap<String, String>();
			...
			variablesMap.put("rawValue_contract_info.custname", contractinfo.getCustId().getCustName());//客户名称
		...
		if ("view".equals(opertype)) {
			return "solutions/workflow/forms/law_mng/pledge/pledge_cancle_manager03.jsp?contract_id="+contractid;
