...
public class LoanInterestPaymentServiceImpl implements LoanInterestPaymentService {
	...
	public String addInteretPaymentToIncome(HttpServletRequest request, Map<String, String> model) throws Exception {
		...
		for(int i=0;i<interestplans.length();i++){
			...
			loanRentIncomeToInterest.setSjinterest(loanRentPlanToInterest.getInterest().toString());
			loanRentIncomeToInterest.setSjbalance(loanRentPlanToInterest.getBalance());
			loanRentIncomeToInterest.setSjdateofinterest(loanRentPlanToInterest.getPlanDate());
			loanRentIncomeToInterest.setSjceasedate(loanRentPlanToInterest.getYpaydate());
			loanRentIncomeToInterest.setSjinterestrate(loanRentPlanToInterest.getInterestrate());
