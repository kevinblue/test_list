...
public class TableController extends BaseController {
	...
	public String getTableData(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    if(model.containsKey("trendsxml")){
	    	String trendsxml=model.get("trendsxml");
	    	   if("plantiqian".equals(trendsxml)){//资金提前开票xml
	    		   xmlFileNameOrPath="/eleasing/jsp/invoice_manage/fund_invoice/invoicePlan/fund_invoice_plan.xml";
	    	   }else if("planshishou".equals(trendsxml)){//资金实收开票xml
	    		   xmlFileNameOrPath="/eleasing/jsp/invoice_manage/fund_invoice/invoiceCharge/fund_invoice_charge.xml";
	    	   }else if("renttiqian".equals(trendsxml)){//租金提前xml
	    		   xmlFileNameOrPath="/eleasing/jsp/invoice_manage/rent_invoice/invoicePlan/rent_invoice_plan.xml";
	    	   }else{//租金实收xml
	    		   xmlFileNameOrPath="/eleasing/jsp/invoice_manage/rent_invoice/invoiceIncome/rent_invoice_income.xml";
	    	   }
	    }
	...
	@RequestMapping(value = "/getBusinessDeptTreeData.action")
	public String getBusinessDeptTreeData(HttpServletRequest request, HttpServletResponse response) throws Exception {
		Map<String, String> model = QueryUtil.getRequestParameterMapByAjax(request);
		String pid ="";
		if("0".equals(model.get("pid"))){
			pid="402811814a22c45f014a2353d45d0032";
