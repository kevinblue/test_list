 ...
 * @version 1.0.0
 **/
@QuartzJob(description = "保证金抵扣待办提醒")
public class QuartzJobFundOffset implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		// 使用spring的事物
		RemindTaskService remindTask = (RemindTaskService) WebUtil.getApplicationContext().getBean("remindTaskServcie");
		// 使用springAOP事物管理的service做一些事情
		System.out.println(">>>当前时间:" + DateUtil.getSystemDateTime());
		remindTask.saveFundOffRemindTask();
	}
}
