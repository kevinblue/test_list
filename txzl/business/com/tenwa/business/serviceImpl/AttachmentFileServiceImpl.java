...
public class AttachmentFileServiceImpl implements AttachmentFileService {
	...
	private final String[] identifierItems = new String[] { "One"/*
																 * ,"Two","Three"
																 * ,
																 * "Four","Five"
																 * ,
	...
	public String getAttachmentFileDetailsJsonString(
		...
		String attachmentFileUnionKeyFieldMapping = modelData
				.get("attachmentFileUnionKeyFieldMapping");
		...
		// identifiersMap);
		String attachmentFileDictListImplBeanName = StringUtil.empty2Other(
				modelData.get("attachmentFileDictListImplBeanName"),
				"commonAttachmentFileDictList");
		// attachmentFileDictList =
		// this.attachmentFileDao.getAttachmentFileDictListByAttachmentType(attachmentType);
		AbstractAttachmentFileList attachmentFileList = (AbstractAttachmentFileList) WebUtil
				.getApplicationContext().getBean(
						attachmentFileDictListImplBeanName);
		List<DictionaryData> attachmentFileDictList = attachmentFileList
				.getAttachmentFileDictList(attachmentType, identifiersMap,
						modelData);
		List<AttachmentFileUploadInfo> attachmentFileInfosList = attachmentFileList
				.getHaveUploadedAttachmentFileUploadInfoList(attachmentType,
						identifiersMap, modelData);
		for (DictionaryData attachmentFileDict : attachmentFileDictList) {
			...
			rowData.put("attachmentFileDictFileName",
					attachmentFileDictFileName);
			rowData.put("isAttachmentChecked", (null == attachmentFileDict
					.getIsMust()) ? false : attachmentFileDict.getIsMust());
			...
			if (null != attachmentFileUnionKeyFieldMapping) {
				rowData.put(attachmentFileUnionKeyFieldMapping,
						StringUtil.nullToString(attachmentFileUnionKey));
			}
			...
			StringBuffer attachmentFileUploadInfoDetailUploadActivities = new StringBuffer();
			String attachmentFileUploadInfoId = "";
			for (AttachmentFileUploadInfo attachmentFileUploadInfo : attachmentFileInfosList) {
				String attachmentFileDictId_inner = attachmentFileUploadInfo
						.getAttachmentFileDict().getId();
				String attachmentFileUnionKey_inner = attachmentFileUploadInfo
						.getUnionKey();
				// String attachmentFileDictId_inner =
				// attachmentFileInfos[0].toString();
				if (attachmentFileDictId.equals(attachmentFileDictId_inner)) {
					if ((null != attachmentFileUnionKey)
							&& (!attachmentFileUnionKey
									.equals(attachmentFileUnionKey_inner))) {
						continue;
					}

					// AttachmentFileUploadInfo attachmentFileUploadInfo =
					// (AttachmentFileUploadInfo)attachmentFileInfos[1];
					attachmentFileUploadInfoId = attachmentFileUploadInfo
							.getId();
					Set<AttachmentFileUploadInfoDetail> attachmentFileUploadInfoDetails = attachmentFileUploadInfo
							.getAttachmentFileUploadInfoDetails();
					int index = 0;
					for (AttachmentFileUploadInfoDetail attachmentFileUploadInfoDetail : attachmentFileUploadInfoDetails) {
						if (0 < index++) {
							...
							attachmentFileUploadInfoDetailUploadActivities
									.append(splitStr);
							attachmentFileUploadInfoDetailIds.append(splitStr);
							attachmentFileUploadInfoDetailActivityDetailIds
									.append(splitStr);
							attachmentFileUploadInfoDetailChineseFileNames
									.append(splitStr);
							attachmentFileUploadInfoDetailEncodeFileNames
									.append(splitStr);
							attachmentFileUploadInfoDetailFileTypes
									.append(splitStr);
							attachmentFileUploadInfoDetailFileSizes
									.append(splitStr);
							attachmentFileUploadInfoDetailUploadTimes
									.append(splitStr);
							attachmentFileUploadInfoDetailUploadUsers
									.append(splitStr);
							attachmentFileUploadInfoDetailRemarks
									.append(splitStr);
						}
						String attachmentFileUploadInfoDetailId = attachmentFileUploadInfoDetail
								.getId();
						String attachmentFileUploadInfoDetailUploadActivity = "";
						String attachmentFileUploadInfoActivityDetailId = "";
						ActivityDetail ad = attachmentFileUploadInfoDetail
								.getActivityDetail();
						if (null != ad) {
							attachmentFileUploadInfoActivityDetailId = ad
									.getId();
							attachmentFileUploadInfoDetailUploadActivity = attachmentFileUploadInfoDetail
									.getActivityDetail().getActivityName();
						}
						String attachmentFileUploadInfoDetailChineseFileName = attachmentFileUploadInfoDetail
								.getChineseFileName();
						String attachmentFileUploadInfoDetailEncodeFileName = attachmentFileUploadInfoDetail
								.getEncodeFileName();
						String attachmentFileUploadInfoDetailFileType = attachmentFileUploadInfoDetail
								.getFileType();
						long attachmentFileUploadInfoDetailFileSize = attachmentFileUploadInfoDetail
								.getFileSize();
						String attachmentFileUploadInfoDetailUploadTime = attachmentFileUploadInfoDetail
								.getUploadTime();
						String attachmentFileUploadInfoDetailRealName = attachmentFileUploadInfoDetail
								.getUploadUser().getRealname();
						String attachmentFileUploadInfoDetailRemark = StringUtil
								.getJsonString(attachmentFileUploadInfoDetail
										.getRemark());

						attachmentFileUploadInfoDetailIds
								.append(attachmentFileUploadInfoDetailId);
						attachmentFileUploadInfoDetailActivityDetailIds
								.append(attachmentFileUploadInfoActivityDetailId);
						attachmentFileUploadInfoDetailChineseFileNames
								.append(attachmentFileUploadInfoDetailChineseFileName);
						attachmentFileUploadInfoDetailEncodeFileNames
								.append(attachmentFileUploadInfoDetailEncodeFileName);
						attachmentFileUploadInfoDetailFileTypes
								.append(attachmentFileUploadInfoDetailFileType);
						attachmentFileUploadInfoDetailFileSizes
								.append(attachmentFileUploadInfoDetailFileSize);
						attachmentFileUploadInfoDetailUploadTimes
								.append(attachmentFileUploadInfoDetailUploadTime);
						attachmentFileUploadInfoDetailUploadUsers
								.append(attachmentFileUploadInfoDetailRealName);
						attachmentFileUploadInfoDetailRemarks
								.append(attachmentFileUploadInfoDetailRemark);
						attachmentFileUploadInfoDetailUploadActivities
								.append(attachmentFileUploadInfoDetailUploadActivity);
					}
					break;
				}
			}
			Map<String, String> attachmentFileDictOtherAttributes = attachmentFileDict
					.getAttributes();
			...
			rowData.put("attachmentFileUploadInfoId",
					attachmentFileUploadInfoId);
			rowData.put("attachmentFileUploadInfoDetailIds",
					attachmentFileUploadInfoDetailIds);
			rowData.put("attachmentFileUploadInfoDetailActivityDetailIds",
					attachmentFileUploadInfoDetailActivityDetailIds);
			rowData.put("attachmentFileUploadInfoDetailChineseFileNames",
					attachmentFileUploadInfoDetailChineseFileNames);
			rowData.put("attachmentFileUploadInfoDetailEncodeFileNames",
					attachmentFileUploadInfoDetailEncodeFileNames);
			rowData.put("attachmentFileUploadInfoDetailFileTypes",
					attachmentFileUploadInfoDetailFileTypes);
			rowData.put("attachmentFileUploadInfoDetailFileSizes",
					attachmentFileUploadInfoDetailFileSizes);
			rowData.put("attachmentFileUploadInfoDetailUploadTimes",
					attachmentFileUploadInfoDetailUploadTimes);
			rowData.put("attachmentFileUploadInfoDetailUploadUsers",
					attachmentFileUploadInfoDetailUploadUsers);
			rowData.put("attachmentFileUploadInfoDetailUploadActivities",
					attachmentFileUploadInfoDetailUploadActivities);
			rowData.put("attachmentFileUploadInfoDetailRemarks",
					attachmentFileUploadInfoDetailRemarks);
		}
	...
	@Override
	public String uploadAttachmentFile(HttpServletRequest request,
			MultipartFile multipartFile, Map<String, String> modelData)
			throws Exception {
		...
		String attachmentFileUploadInfoId = StringUtil.nullToString(modelData
				.get("attachmentFileUploadInfoId"));
		...
		String jbpmWorkflowHistoryInfoId = modelData
				.get("jbpmWorkflowHistoryInfoId");
		...
		DictionaryData attachmentFileDict = (DictionaryData) this.attachmentFileDao
				.getEntityObjectById(DictionaryData.class, attachmentFileDictId);
		if ((null != multipartFile)
				&& (!StringUtil.nullToString(filename).isEmpty())) {
			// 限制上传大小为2M
			/*
			 * long maxSize = 2 * 1024 *1024; if(multipartFile.getSize() >
			 * maxSize){ throw new BusinessException("文件大小请控制到2M以内！！！！"); }
			 */
			...
			if (!attachmentFileUploadInfoId.isEmpty()) {
				attachmentFileUploadInfo = (AttachmentFileUploadInfo) this.attachmentFileDao
						.getEntityObjectById(AttachmentFileUploadInfo.class,
								attachmentFileUploadInfoId);
			} else {
				...
				attachmentFileUploadInfo
						.setAttachmentFileDict(attachmentFileDict);
				attachmentFileUploadInfo.setModule(module);
				attachmentFileUploadInfo.setUnionKey(attachmentFileUnionKey);

				attachmentFileUploadInfoId = this.attachmentFileDao
						.saveEntityObject(attachmentFileUploadInfo);
			}
			...
			attachmentFileUploadInfoDetail
					.setAttachmentFileUploadInfo(attachmentFileUploadInfo);
			attachmentFileUploadInfoDetail.setChineseFileName(filename);
			attachmentFileUploadInfoDetail
					.setEncodeFileName(encodeFileNameNoExtentName + extentName);
			...
			if (null != jbpmWorkflowHistoryInfoId) {
				// 建立与流程关联
				JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo = (JBPMWorkflowHistoryInfo) this.attachmentFileDao
						.getEntityObjectById(JBPMWorkflowHistoryInfo.class,
								jbpmWorkflowHistoryInfoId);
				attachmentFileUploadInfoDetail
						.setJbpmWorkflowHistoryInfo(jbpmWorkflowHistoryInfo);
				HistoryProcessInstanceImpl historyProcessInstanceImpl = jbpmWorkflowHistoryInfo
						.getHistoryProcessInstanceImpl();
				attachmentFileUploadInfoDetail
						.setHistoryProcessInstanceImpl(historyProcessInstanceImpl);
				JbpmWorkflowDesigner jbpmWorkflowDesigner = jbpmWorkflowHistoryInfo
						.getDeploymentImpl().getJbpmWorkflowDesigner();
				attachmentFileUploadInfoDetail
						.setJbpmWorkflowDesigner(jbpmWorkflowDesigner);
				attachmentFileUploadInfoDetail
						.setActivityDetail(jbpmWorkflowHistoryInfo
								.getActivityDetail());
			}
			this.attachmentFileDao
					.saveEntityObject(attachmentFileUploadInfoDetail);
			// /将attachmentFileUploadInfoDetail的id回显示给map
			modelData.put("currentCttachmentFileUploadInfoDetailId",
					attachmentFileUploadInfoDetail.getId());
			String uploadDirPath = FileUtil.getFilePathString(ResourceUtil
					.getFileUploadDataPath())
					+ "/"
					+ module
					+ "/"
					+ FileUtil.getYearMonthDayPathByString(currentDate,
							"yyyy-MM-dd");
			/*
			 * +identifierOne;
			 ...
			 */
			String uploadedFileFullPath = uploadDirPath + "/"
					+ encodeFileNameNoExtentName + extentName;
			HttpSession session = request.getSession();
			FileProcess fileProcess = (FileProcess) session
					.getAttribute("attachmentFileProcessKey");
			InputStream in = multipartFile.getInputStream();
			ResourceUtil.getFileUploadOperation().uploadFile(
					uploadedFileFullPath, in, fileProcess);
			return "文件上传成功!";
		} else {
			return "上传文件不能为空!";
		}
	...
	@Override
	public String uploadAttachmentFiles(HttpServletRequest request,
			HttpServletResponse response, Map<String, String> modelData)
			throws Exception {
		...
		if (multipartResolver.isMultipart(request)) {
			...
			while (iter.hasNext()) {
				...
				MultipartFile multipartFile = multiRequest
						.getFile(filenameTemp);
				if (multipartFile != null) {
					String myFileName = multipartFile.getOriginalFilename();
					String fileType = myFileName.substring(
							myFileName.indexOf('.') + 1).toLowerCase();
					String tFileImagesId = "";
					if (fileType.matches("jpg|jpeg|png|bmp|gif")) {
						AppImageService appImage = (AppImageService) WebUtil
								.getApplicationContext().getBean(
										"appImageService");
					...
					String module = modelData.get("module");
					String attachmentFileDictId = modelData
							.get("attachmentFileDictId");
					attachmentFileUploadInfoId = ""
							.equals(attachmentFileUploadInfoId) ? StringUtil
							.nullToString(modelData
									.get("attachmentFileUploadInfoId"))
							: attachmentFileUploadInfoId;
					String identifierOne = modelData.get("identifierOne");
					String identifierTwo = modelData.get("identifierTwo");
					...
					String jbpmWorkflowHistoryInfoId = modelData
							.get("jbpmWorkflowHistoryInfoId");
					String attachmentFileUnionKey = modelData
							.get("attachmentFileUnionKey");
					// AttachmentFileDict attachmentFileDict =
					// (AttachmentFileDict)this.attachmentFileDao.getEntityObjectById(AttachmentFileDict.class,attachmentFileDictId);
					DictionaryData attachmentFileDict = (DictionaryData) this.attachmentFileDao
							.getEntityObjectById(DictionaryData.class,
									attachmentFileDictId);
					if ((null != multipartFile)
							&& (!StringUtil.nullToString(filename).isEmpty())) {
						// 限制上传大小为2M
						/*
						 * long maxSize = 2 * 1024 *1024;
						 * if(multipartFile.getSize() > maxSize){ throw new
						 * BusinessException("文件大小请控制到2M以内！！！！"); }
						 */
						AttachmentFileUploadInfo attachmentFileUploadInfo = null;
						String extentName = filename.substring(
								filename.lastIndexOf("."), filename.length());
						if (!attachmentFileUploadInfoId.isEmpty()) {
							attachmentFileUploadInfo = (AttachmentFileUploadInfo) this.attachmentFileDao
									.getEntityObjectById(
											AttachmentFileUploadInfo.class,
											attachmentFileUploadInfoId);
						} else {
							attachmentFileUploadInfo = new AttachmentFileUploadInfo();
							attachmentFileUploadInfo.setModule(module);
							attachmentFileUploadInfo
									.setIdentifierOne(identifierOne);
							attachmentFileUploadInfo
									.setIdentifierTwo(identifierTwo);
							attachmentFileUploadInfo
									.setIdentifierThree(identifierThree);
							attachmentFileUploadInfo
									.setIdentifierFour(identifierFour);
							attachmentFileUploadInfo
									.setIdentifierFive(identifierFive);
							attachmentFileUploadInfo
									.setIdentifierSix(identifierSix);
							attachmentFileUploadInfo
									.setIdentifierSeven(identifierSeven);
							attachmentFileUploadInfo
									.setIdentifierEight(identifierEight);
							attachmentFileUploadInfo
									.setIdentifierNine(identifierNine);
							attachmentFileUploadInfo
									.setIdentifierTen(identifierTen);
							attachmentFileUploadInfo
									.setAttachmentFileDict(attachmentFileDict);
							attachmentFileUploadInfo.setModule(module);
							attachmentFileUploadInfo
									.setUnionKey(attachmentFileUnionKey);
						...
						attachmentFileUploadInfoDetail
								.setAttachmentFileUploadInfo(attachmentFileUploadInfo);
						attachmentFileUploadInfoDetail
								.setChineseFileName(filename);
						attachmentFileUploadInfoDetail
								.setEncodeFileName(encodeFileNameNoExtentName
										+ extentName);
						attachmentFileUploadInfoDetail
								.setFileSize(multipartFile.getSize());
						attachmentFileUploadInfoDetail.setRemark(remark);
						attachmentFileUploadInfoDetail
								.setFileImagesId(tFileImagesId);
						attachmentFileUploadInfoDetail.setUploadUser(user);
						attachmentFileUploadInfoDetail
						...
						// /将attachmentFileUploadInfoDetail的id回显示给map
						modelData.put(
								"currentCttachmentFileUploadInfoDetailId",
								attachmentFileUploadInfoDetail.getId());
						String uploadDirPath = FileUtil
								.getFilePathString(ResourceUtil
										.getFileUploadDataPath())
								+ "/"
								+ module
								+ "/"
								+ FileUtil.getYearMonthDayPathByString(
	...
	public String removeAttachmentFile(String uploadAttachmentFileDetailId)
			throws Exception {
		AttachmentFileUploadInfoDetail attachmentFileUploadInfoDetail = (AttachmentFileUploadInfoDetail) this.attachmentFileDao
				.getEntityObjectById(AttachmentFileUploadInfoDetail.class,
						uploadAttachmentFileDetailId);
		if(attachmentFileUploadInfoDetail==null){
			return "删除成功！";
		}
		// 取消与流程关联
		...
		AttachmentFileUploadInfo attachmentFileUploadInfo = attachmentFileUploadInfoDetail
				.getAttachmentFileUploadInfo();
		...
		for (AttachmentFileUploadInfoDetailDownload attachmentFileUploadInfoDetailDownload : attachmentFileUploadInfoDetail
				.getAttachmentFileUploadInfoDetailDownloads()) {
			this.attachmentFileDao
					.removeEntityObject(attachmentFileUploadInfoDetailDownload);
		}
		...
		this.attachmentFileDao
				.removeEntityObject(attachmentFileUploadInfoDetail);

		if (1 == attachmentFileUploadInfo.getAttachmentFileUploadInfoDetails()
				.size()) {
		...
		String uploadDirPath = FileUtil.getFilePathString(ResourceUtil
				...
				+ "/"
				+ FileUtil
						.getYearMonthDayPathByString(uploadDate, "yyyy-MM-dd");
		/*
		 ...
		 * "/"+identifierTen);}
		 */
		String encodeFileName = attachmentFileUploadInfoDetail
				.getEncodeFileName();
		String uploadedFileFullPath = uploadDirPath + "/" + encodeFileName;
		try {
			ResourceUtil.getFileUploadOperation().removeFile(
					uploadedFileFullPath);
			 HashMap<String, Object> propertiesMap = new HashMap<String, Object>();
			 propertiesMap.clear();
	    	 propertiesMap.put("attachmentid", uploadAttachmentFileDetailId);
	    	 //级联删除页签中存在的数据
	         List<BaseFile_AttachmentInfo> baList = this.tableService.findEntityByProperties(BaseFile_AttachmentInfo.class, propertiesMap); 		  
	   	    if(baList.size()>0){
			  BaseFile_AttachmentInfo bainfo=baList.get(0);
			  BaseFile bafile=this.tableService.findEntityByID(BaseFile.class, bainfo.getUploadid());
			  bafile.setInvalid("否");
			      this.tableService.saveEntity(bafile);
		      this.tableService.removeEntity(bainfo);
		  }
		} catch (Exception e) {
	...
	public void downloadAttachmentFile(HttpServletResponse response,
			String uploadAttachmentFileDetailId, String browserType)
			throws Exception {
		AttachmentFileUploadInfoDetail attachmentFileUploadInfoDetail = (AttachmentFileUploadInfoDetail) this.attachmentFileDao
				.getEntityObjectById(AttachmentFileUploadInfoDetail.class,
						uploadAttachmentFileDetailId);
		String fileTitleName = attachmentFileUploadInfoDetail
				.getChineseFileName();
		if ("firefox".equals(browserType)) {
			fileTitleName = new String(fileTitleName.getBytes("GB2312"),
					"ISO-8859-1");
		} else if ("chrome".equals(browserType)) {
			fileTitleName = URLEncoder.encode(fileTitleName, "UTF-8");
		} else if ("safari".equals(browserType)) {
			fileTitleName = new String(fileTitleName.getBytes("UTF-8"),
					"ISO-8859-1");
		} else {
			fileTitleName = URLEncoder.encode(fileTitleName, "UTF-8");
		}
		...
		String encodeFileName = attachmentFileUploadInfoDetail
				.getEncodeFileName();
		String downloadedFileFullPath = FileUtil
				.getFilePathString(uploadDirPath + "/" + encodeFileName);
		...
		ResourceUtil.getFileUploadOperation().downloadFile(
				downloadedFileFullPath, out, null);
		// 当前用户信息
		...
		attachmentFileUploadInfoDetailDownload
				.setAttachmentFileUploadInfoDetail(attachmentFileUploadInfoDetail);
		attachmentFileUploadInfoDetailDownload.setDownloadUser(downloadUser);
		attachmentFileUploadInfoDetailDownload.setDownloadTime(DateUtil
				.getSystemDateTime());
		this.attachmentFileDao
				.saveEntityObject(attachmentFileUploadInfoDetailDownload);
	}
	...
	@Override
	public void downloadBatchAttachmentFiles(HttpServletResponse response,
			String fileTitleName, String attchmentDetailBatchDownloadIdStr,
			String browserType) throws Exception {
		if (null == fileTitleName) {
			fileTitleName = "批量下载"
					+ DateUtil.getSystemTimeByFormat("yyyy-MM-dd:HH:mm:ss");
		}
		fileTitleName += ".zip";
		if ("firefox".equals(browserType)) {
			fileTitleName = new String(fileTitleName.getBytes("GB2312"),
		...
		String baseDir = new File(ResourceUtil.getFileUploadDataPath())
				.getAbsolutePath();
		...
		try {
			...
			Collection<String> attchmentDetails = StringUtil
					.getCollectionByString("list",
							attchmentDetailBatchDownloadIdStr, ",");
			// AttachmentFileUploadInfoDetail
			...
			List<AttachmentFileUploadInfoDetail> fileDetails = this.attachmentFileDao
					.findEntityByIDArray(AttachmentFileUploadInfoDetail.class,
							detailIds);
			int fileIndex = 0;
			...
			for (Object obj : fileDetails) {
				...
				String uploadTime = attachmentFileUploadInfoDetail
						.getUploadTime();
				String uploadDate = uploadTime.substring(0, 10);
				AttachmentFileUploadInfo attachmentFileUploadInfo = attachmentFileUploadInfoDetail
						.getAttachmentFileUploadInfo();
				...
				String uploadDirPath = FileUtil.getFilePathString(ResourceUtil
						...
						+ module
						+ "/"
						+ FileUtil.getYearMonthDayPathByString(uploadDate,
								"yyyy-MM-dd");
				int lastIndexOfChineseName = attachmentFileUploadInfoDetail
						.getChineseFileName().lastIndexOf(".");
				String chineseName = attachmentFileUploadInfoDetail
						.getChineseFileName().substring(0,
								lastIndexOfChineseName)
						+ "（"
						+ (++fileIndex)
						+ "）"
						+ attachmentFileUploadInfoDetail.getChineseFileName()
								.substring(lastIndexOfChineseName);
				String encodeFileName = attachmentFileUploadInfoDetail
						.getEncodeFileName();
				String inputFileFullPath = FileUtil
						.getFilePathString(uploadDirPath + "/" + encodeFileName);
				// 下载文件
				...
				// "")+"/"+chineseName));
				out.putNextEntry(new ZipEntry(currentDateTime + "/"
						+ chineseName));
				ResourceUtil.getFileUploadOperation()
						.readInputStreamToOutputStream(inputFileFullPath, out);
				// 当前用户信息
				User downloadUser = (User) SecurityUtil.getPrincipal();
				AttachmentFileUploadInfoDetailDownload attachmentFileUploadInfoDetailDownload = new AttachmentFileUploadInfoDetailDownload();
				attachmentFileUploadInfoDetailDownload
	...
	@Override
	public String updateOnlineAttachmentFile(MultipartFile multipartFile,
			Map<String, String> modelData) throws Exception {
		String filename = multipartFile.getOriginalFilename();
		String uploadOnlineDirPath = WebUtil.getWebContextRealPath();
		String fullPath = FileUtil.getFilePathString(uploadOnlineDirPath
				+ filename);
	...
	/*
	 * (non-Javadoc) 批量下载生成文件
	 * 
	 * @see com.tenwa.business.service.AttachmentFileService#
	 * downloadBatchAttachmentFilesByIds(javax.servlet.http.HttpServletResponse,
	 * java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public void downloadBatchAttachmentFilesByIds(HttpServletResponse response,
			String fileTitleName, String attchmentDetailBatchDownloadIdStr,
			String browserType) throws Exception {
		if (null == fileTitleName) {
			fileTitleName = "批量下载"
		...
		ZipOutputStream out = null;
		String charSetName = "GB2312";
		String baseDir = FileUtil.getFilePathString(ResourceUtil
				.getFileUploadDataPath())
				+ ResourceUtil.getWordFilesRelativeStorePath() + "/";
		;
		...
		try {
			...
			String[] detailIds = new String[attchmentDetails.size()];
			detailIds = attchmentDetails.toArray(detailIds);
			List<BaseFile> fileDetails = this.attachmentFileDao
					.findEntityByIDArray(BaseFile.class, detailIds);
			String currentDateTime = DateUtil.getSystemDateTime();
			for (Object obj : fileDetails) {
				BaseFile baseFile = (BaseFile) obj;
				String inputFileFullPath = baseDir + baseFile.getFileAddress();
				String chineseName = baseFile.getFileName();
				out.putNextEntry(new ZipEntry(currentDateTime + "/"
						+ chineseName));
				ResourceUtil.getFileUploadOperation()
						.readInputStreamToOutputStream(inputFileFullPath, out);
				// 当前用户信息
				User downloadUser = (User) SecurityUtil.getPrincipal();
				BaseFileRecorder record = new BaseFileRecorder();
				record.setOperatorType(DateUtil.getSystemDateTime());
				record.setCreateDate(DateUtil.getSystemDateTime());
				record.setOperatorType("批量下载");
				record.setCreator(downloadUser);
				record.setBaseFile(baseFile);
				this.tableService.saveEntity(record);
			}
		} finally {
			if (null != out) {
				out.closeEntry();
	...
	public String uploadAttachmentFiles(HttpServletRequest request,
			HttpServletResponse response, Map<String, String> modelData,
			List<BaseFile> bsfiles) throws Exception {
		String message = "";
		String uploadid="";
		AttachmentFileUploadInfo attachmentFileUploadInfo  = new AttachmentFileUploadInfo();
		for(BaseFile bsfile : bsfiles){
			String filePath = ResourceUtil.getFileUploadDataPath() + ResourceUtil.getWordFilesRelativeStorePath()+"/"+bsfile.getFileAddress();
			uploadid=bsfile.getId();
			File file = null;
			try{
			...
			// String filename = multipartFile.getOriginalFilename();
			String filename = bsfile.getFileName();
			String encodeFileNameNoExtentName = UUIDUtil.getUUID();
			String currentTime = DateUtil.getSystemDateTime();
			String currentDate = currentTime.substring(0, 10);
			...
			DictionaryData attachmentFileDict = (DictionaryData) this.attachmentFileDao
					.getEntityObjectById(DictionaryData.class, attachmentFileDictId);
			if ((null != bsfile) && (!StringUtil.nullToString(filename).isEmpty())) {
				// 限制上传大小为2M
				/*
				 * long maxSize = 2 * 1024 *1024; if(multipartFile.getSize() >
				 * maxSize){ throw new BusinessException("文件大小请控制到2M以内！！！！"); }
				...
				attachmentFileUploadInfoDetail
				.setEncodeFileName(encodeFileNameNoExtentName + extentName);
				attachmentFileUploadInfoDetail.setFileSize(100);
				attachmentFileUploadInfoDetail.setRemark(remark);
				attachmentFileUploadInfoDetail.setFileImagesId(tFileImagesId);
				attachmentFileUploadInfoDetail.setUploadUser(user);
				attachmentFileUploadInfoDetail.setUploadTime(currentTime);
				...
				ResourceUtil.getFileUploadOperation().uploadFile(
						uploadedFileFullPath, in, fileProcess);
				//插入中间表T_BASEFILE_ATTACHMENTINFO
				String attachmentid=attachmentFileUploadInfoDetail.getId();
				...
				this.attachmentFileDao.saveEntity(bainfo);
