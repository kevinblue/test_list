...
public class ContractModifyServiceImpl implements  ContractModifyService {
	...
	public void startContractModify(Map<String, String> variablesMap)
		...
		this.rentConditionData.updateContractConditionDataAndSaveDatatoHis(ci, variablesMap, variablesMap.get("docId"), "his_plan_mod",  "framework_condition", "json_fund_rent_plan_new_str","json_fund_cash_flow_new_str","", "","json_fund_fund_charge_new_str");
	}
}
