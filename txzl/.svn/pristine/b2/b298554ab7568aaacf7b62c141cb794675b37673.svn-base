...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/tracywindy/tracywindyUtils.js"></script>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/tracywindy/tracywindyAjax.js"></script>
  		...
  		var tools=['add','-','edit','-','remove','-','exportExcel'
  		   		/* {
  		   			html:'导入联系人',
  		 			plain : true,
  				  ...
  				  new ApTable({
	  					...
	  					columns:[ 
	  					 ...
	  					 {field: 'contractid', header: '业务合同编号',headerAlign:'center', visible: false,
	  						...
	  						{field:'projdept',header:'项目出单部门',headerAlign:'center',visible:true,
						          formEditorConfig:{
						        	  newLine:true,
						        	    allowInput: false,
	 					  				visible:true
	  					  ...
	  					  {field:'delivernumber',header:'快递单号',headerAlign:'center',visible:true,queryConfig:{width:212,newLine:true},formEditorConfig:{
								required:true,
				          newLine:false}},
