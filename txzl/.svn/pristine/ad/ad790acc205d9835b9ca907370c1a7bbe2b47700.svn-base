...
jQuery(function(){
    ...
    seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
    	title:'租前息对比',
    	renderTo:'id_table_leasing_interest_compare_temp_list',
    	width:globalClientWidth-5,
    	height:600,
    	id:'id_table_leasing_interest_current_regulating_of_breathing_container',
    	xmlFileName:'/eleasing/workflow/rent/regulating_breathing/interestComparetmpBeforeInterest.xml',
    ...
    columns:[
		...
		{header:'期项',field:'paymentid1',width:35,align:'center'},
		{header:'费用类型',field:'feetype1',width:40,align:'center'},
		{header:'计划日期',field:'plandate1',width:40,align:'center'},
		{header:'金额',field:'planmoney1',dataType : "currency",summary : true,align:'center'},
		{header:'分隔',field:'flag',width:40,align:'center'},
		{header:'期项',field:'paymentid2',width:35,align:'center'},
		{header:'费用类型',field:'feetype2',width:40,align:'center'},
		{header:'计划日期',field:'plandate2',width:40,align:'center'},
		{header:'金额',field:'planmoney2',dataType : "currency",summary : true,align:'center'},
		]
		 });
    });
});
 ...
 <div   style="width:100%" id="id_table_leasing_interest_compare_temp_list"  style="overflow:auto"></div>