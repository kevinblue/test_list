...
jQuery(function(){
	...
	tenwa.createTable({
		...
		columns: [
			...
			{field: 'rent', header: '债权总额',type:'double',summary : true,dataType : "currency"},
			{field: 'corpus', header: '应收账款',type:'double',summary : true,dataType : "currency"},
			{field: 'interest', header: '保理收入',type:'double',summary : true,dataType : "currency"},
			{field: 'penalty', header: '应收罚息',type:'double',summary : true,dataType : "currency"},
			{field: 'currentoverage', header: '债权余额',type:'double',summary : true,dataType : "currency"},
			{field: 'curcorpusoverage', header: '应收账款余额',type:'double',summary : true,dataType : "currency"},
			{field: 'curinterestoverage', header: '保理收入余额',type:'double',summary : true,dataType : "currency"},
