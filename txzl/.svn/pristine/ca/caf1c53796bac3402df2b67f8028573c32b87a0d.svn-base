	...
	<table cellspacing="0" cellpadding="0" style="width:100%;border: 1px solid #99CCFF;" class="fillTable">
		<tr class="tr-odd">
				...
				<td class="td-content-title"  width="130px">保全日期：</td>
	             <td class="td-content">
			             <input name="law_approval.preservedate" class="mini-datepicker" label="保全日期"   
		...
		<tr class="tr-odd">
				<td class="td-content-title" >保全到期日：</td>
	             <td class="td-content">
			             <input name="law_approval.maturitydate" class="mini-datepicker"  value="${requestScope['law_approval.maturitydate'] }"  label="法务编号"   />
			      </td>
				<td class="td-content-title" >解除保全日：</td>
	             <td class="td-content">
			             <input name="law_approval.reliefpreservation" class="mini-datepicker" label="解除保全日"   
