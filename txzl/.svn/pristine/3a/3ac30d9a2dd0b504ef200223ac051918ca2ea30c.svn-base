...
var json_str="${requestScope['json_str'] }";
...
<body style="overflow: auto;">
	...
	<div id="five_classfy_apply_audit_detail">
		<div id="mini-panel" title="申请基本信息" showCollapseButton="true" style="width: 100%;">
			...
			<table class="fillTable" cellspacing="0" cellpadding="0"
				style="width: 100%;">
			<input name="json_str" id="json_str" type="text" style="display:none" value="${requestScope['json_str'] }"/>
				...
				<tr class="tr-odd">
					...
					<input width="55%" name="fivecategoryapply.applyuser"  id="fivecategoryapply.applyuser" class="mini-textbox" readonly value="${requestScope['fivecategoryapply.applyuser']}" /></td>				
					 <input width="55%" name="fivecategoryapply.docid"  style="display:none" class="mini-textbox" readonly value="${requestScope['fivecategoryapply.docid']}"/>
				...
				<tr class="tr-odd" style="height: 40px">
					...
					<td class="td-content" colspan="3"><textarea
							style="width: 81%; height: 90%" name="fivecategoryapply.applymemo"  id="fivecategoryapply.applymemo"
	...
	<div id="tabDeatils" class="mini-tabs" activeIndex="0"
		...
		<div title="资产分类信息" name="applicationcust">
