...
jQuery(function(){
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			showPager:true,
			xmlFileName:'eleasing/workflow/factoring/factoring_common/factoring_fund_fund_plan_all_list.xml',
			tools:toolsArray,
			remoteOper:false,
			...
			columns:[ 
				...
				{field:'projectname',header:'项目名称',headerAlign:'center',queryConfig:{colspan:1},formEditorConfig:{newLine:true }},
				...
				{field:'custid',header:'客户名称id',headerAlign:'center',visible:false},
				{field:'custname',header:'客户名称',headerAlign:'center',queryConfig:{newLine:true},formEditorConfig:{ }},
...
var toolsArray =
	...
	tenwa.createTable({
		...
		tools:[{
			...
			handler:function(miniTable, buttonText){
				...
				if(ebankRowData){
					...
					startProcess("保理卖方收款流程-1",attachmentParams); 
				}else{
		...
		columns:[
			...
			{field:'custidname',header:'承租人名称',visible:false},
			...
			{field:'clientaccount', header:'对方账户',visible:false},
