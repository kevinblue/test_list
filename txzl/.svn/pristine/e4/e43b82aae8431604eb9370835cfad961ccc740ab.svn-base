...
jQuery(function() {
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			afterShowWindowCallBack: function(miniTable,miniForm,operFlag){
				if("add" == operFlag){
					if(overdueProjectData){
						...
						$.ajax({
					        url: urlPrefix+"eleasing/workflow/factoring/fund_overdue/factoring_get_contract_list_byid.xml",
					        type: "post",
					        cache: false, 
					        async:false,
			...
			xmlFileName:'/eleasing/workflow/factoring/fund_overdue/factoring_overdue_project.xml',
				...
				{field:'custname',header:'承租人',headerAlign:'center',width:100,allowSort:true,
				           formEditorConfig:{
					           ...
					           fieldVisible:true,
					                  width:200,
                                 labelWidth:100}},
                 {field:'cleanleasemoney',header:'起租金额',visible:false,headerAlign:'center',width:100,allowSort:true,
				           formEditorConfig:{
					                newLine:true,
					               readOnly:true,
					                   type:'text',
			    ...
			    {field:'department',header:'出单部门',headerAlign:'center',width:100,allowSort:true,
				           formEditorConfig:{
					           ...
					           fieldVisible:true,
					                  width:200,
					             labelWidth:100}},
				 {field:'realname',header:'租后经办',headerAlign:'center',visible:false,width:100,allowSort:true,
				           formEditorConfig:{
					               readOnly:true,
					                   type:'text',
					           fieldVisible:false,
