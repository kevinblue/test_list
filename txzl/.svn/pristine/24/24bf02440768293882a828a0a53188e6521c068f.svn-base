...
@WorkflowAction(name = "contractAncillaryStartAction", description = "流程开始动作", workflowName = "附属合同审批流程")
@Component(value = "contractAncillaryStartAction")
public class ContractAncillaryStartAction implements JbpmBaseAction {
