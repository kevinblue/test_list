package com.reckon.entity.contract.reckon.fina;
 ...
 * 
 * @author 孙传良
 * @date 2013-3-6下午05:49:12
 * @info 合同会计租金计划(历史)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "合同会计租金计划(历史)")
@Table(name="CONTRACT_FINA_RENT_PLAN_HIS")
public class ContractFinaRentPlanHis {
	...
	@FieldName(name="修改操作流程ID")
	@Column(name="PROCESSID")	
	private String processId;
	
	@FieldName(name="修改时间")
	@Column(name="MOD_DATE", length=20)	
	private String modDate;
	
	@FieldName(name="修改人")
	@JoinColumn(name="MOD_STUFF")
	@ManyToOne
	private User modStuff;
	...
	public User getModStuff() {
		return modStuff;
	}

	public void setModStuff(User modStuff) {
		this.modStuff = modStuff;
	}
