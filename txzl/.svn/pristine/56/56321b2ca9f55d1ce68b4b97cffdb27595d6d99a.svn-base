<%@ page language="java" contentType="text/html; charset=UTF-8"	pageEncoding="UTF-8"%>
    <input name="contract_info.projectname" id="contract_info.projectname" type="hidden"  value="${requestScope['contract_info.projectname'] }"/>
 <div  id="contract_invoice_form"  title="租金开票审批"> 
    <div   class="mini-panel" title="租金开票审批" showCollapseButton="true" style="width: 100%;">
