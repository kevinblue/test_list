	...
	tenwa.createTable({
		...
		/* tools: ['add', '-', 'edit', '-', 'remove'], */
		 params:{
			...
			{field:'equipname', header:'抵质押物一名称', visible: true,
				     formEditorConfig:{
				    	 labelWidth:110,
				    	 required:true,
					     fieldVisible: true}
			...
			{field:'guarantyvalue', header:'原抵质押物价值（万元）',dataType:"currency",summary:true,formEditorConfig:{
			...
			{field:'mortgage_proportion1', header:'抵质押率',formEditorConfig:{
				newLine:true,required:true,
				labelWidth:110,
		    	 required:true,
			     fieldVisible: false}
			},
			{field:'whetherinsurance', header:'抵质押物一是否保险',visible: false,formEditorConfig:{
				newLine:true,required:true,
				labelWidth:110,
		    	 required:true,
			     fieldVisible: true}
			...
			,
			{field:'mortgage_currentstatus1', header:'抵质押物目前状态',formEditorConfig:{
				newLine:true,required:true,
				labelWidth:110,
		    	 required:true,
			     fieldVisible: true}
