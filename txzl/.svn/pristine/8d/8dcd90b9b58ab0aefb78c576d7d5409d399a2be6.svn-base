...
<input  style="display:none;"	class="mini-textarea" id="id_json_drawal_cost_detail_str" name="json_drawal_cost_detail_str" value='${empty json_drawal_cost_detail_str ? "[]" : json_drawal_cost_detail_str }'></input>
<div id="contract_finish_form">
	...
	<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;">
	 	<div title="撤诉情况" name="drawal_cost_detail" iconCls="icon-node">
		 	 <jsp:include page="drawal_cost_detail.jsp"><jsp:param value="true" name="isView" /></jsp:include>  
		</div>
	 	<div title="法务申请信息" name="law_approve_detail" iconCls="icon-node">
			 <jsp:include page="drawal_approval_detail.jsp"><jsp:param value="true" name="isView" /></jsp:include>  
		</div>  
