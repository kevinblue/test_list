				...
				<table id="id_workflowSynchronizedContainer">
					...
					<tr>
						...
						<td style="text-align: left;">
							<a class="mini-button" href="javascript:void(0);" onclick="__workflowSynchronized_true">同步选中流程</a>
							<a class="mini-button" href="javascript:void(0);" onclick="__workflowSynchronized_false">同步全部流程</a>
						</td>
					</tr>
				</table>
			</fieldset>
