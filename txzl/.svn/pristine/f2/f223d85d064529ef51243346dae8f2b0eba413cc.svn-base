	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		 new ApTable({
			...
			columns: [
					 ...
					 formEditorConfig:{
						   ...
						   labelWidth:100,
						    maxLength:120,
						      colspan:3,
						        width:506}},
				{field:'equipnum', header:'数量',dataType :"int",align:'right',summary :true,
					 formEditorConfig:{
					          newLine:true,
					         required:true,
					         readOnly:true,
				...
				{field:'price', header:'单价',dataType :"currency",align:'right',summary :true,
					 formEditorConfig:{
					       labelWidth:90,
					       readOnly:true,
					             type:'text',
				...
				{field:'equipprice', header:'交易价格',dataType :"currency",align:'right',summary :true,
					 formEditorConfig:{
						 newLine:true,
							 ...
							 readOnly:true}},
				{field:'originaltotal', header:'设备原值',dataType :"currency",align:'right',summary :true,
				     formEditorConfig:{
				    	 readOnly:true,
							    vtype:'float'}},
