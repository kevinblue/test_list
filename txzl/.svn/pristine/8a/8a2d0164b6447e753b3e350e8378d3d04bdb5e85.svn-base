...
//是否保存   
	...
	{
		 if (miniui_ext.submitFormValidation(["proj_cancel_stop_forml"]) == false) return;
...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;">
	<div title="中止说明" name="cancel_stop_detail" iconCls="icon-cut">
		 <jsp:include page="proj_cancel_stop_detail.jsp" ></jsp:include>
	</div>
	...
	<div title="抵质押物信息" name="proj_guaranty_detail" iconCls="icon-cut" >
		 ...
		 <div title="合同信息" name="proj_contract_detail" iconCls="icon-cut" >
	     <jsp:include page="proj_contract_detail.jsp" >
	       <jsp:param value="true" name="isView"/>
	     </jsp:include>
	</div>
</div>
