...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <div id="businessconditionFormModify">
	   <jsp:include page="../rent_common/condition_content_5_1_framework_modify.jsp"></jsp:include>
	</div>   
<script type="text/javascript">
var businessForm = new mini.Form("businessconditionFormModify");
jQuery(function(){
	var form = new mini.Form("businessconditionFormModify");
