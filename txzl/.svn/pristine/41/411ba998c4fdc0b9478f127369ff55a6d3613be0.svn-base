...
{
	 if (miniui_ext.submitFormValidation(["proj_base_info_form","proj_change_form"]) == false) return;
...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width:100%;">
	<div title="变更说明" name="change_detail" iconCls="icon-cut">
		<jsp:include page="proj_change_detail.jsp" ><jsp:param value="true" name="isView"/></jsp:include>
	</div>
	...
	<div title="项目报价方案" name="quotation_scheme" iconCls="icon-node" >
			<jsp:include page="../proj_common/proj_quotation_scheme.jsp" >
				<jsp:param value="true" name="isView"/>
			</jsp:include>
	</div> 
</div>
