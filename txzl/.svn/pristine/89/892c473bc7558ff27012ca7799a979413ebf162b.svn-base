...
<script type="text/javascript">
	...
	{
		if (miniui_ext.submitFormValidation(["contract_lawclose_info_form"]) == false) return false;
		return true;
	}
	jQuery(function(){
...
<div id="contract_finish_form">
	...
	<div id="tabDetails" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;">
		...
		<div title="法务处理详情" name="fund_payment_plan_info" iconCls="icon-node">
			<jsp:include page="law_close_detail.jsp"><jsp:param value="false" name="isView" /></jsp:include>
		</div>
