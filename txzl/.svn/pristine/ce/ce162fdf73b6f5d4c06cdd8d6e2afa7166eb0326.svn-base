	...
	<div class="mini-panel" title="合同基本信息" showCollapseButton="true" style="width:100%;">
		<table class="fillTable" cellspacing="0" cellpadding="0" style="width:100%" id="contract_base_info">
			...
			<tr class="tr-odd">
				...
				<td class="td-content" colspan="3" >
					<input style="width: 60%" id="cust_name" name="contract_info.custname" class="mini-textbox" readOnly require="true" label="承租单位" type="text"
			...
			<tr class="tr-odd" style="display:none">
				...
				<td class="td-content">
					<input name="contract_info.onhiretype" class="mini-combobox" textField="name" required="true" label="起租方式 " valueField="value" dataField="datas" allowInput="false"
			...
			<tr class="tr-even">
	             <td class="td-content-title" style="display:none">设备来源：</td>
