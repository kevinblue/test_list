...
<input name="contract_info.custid1" id="contract_info.custid1" style="display:none" value="${requestScope['contract_info.custid'] }">
...
<div id="contract_base_info_form" title="合同基本信息">
	<div class="mini-panel" title="合同基本信息" showCollapseButton="true" style="width:100%;">
		<table class="fillTable" cellspacing="0" cellpadding="0" style="width:100%" id="contract_base_info">
			...
			<tr class="tr-even" >
				<td class="td-content-title" style="display:none">客户编号：</td>
				<td class="td-content" style="display:none"><input name="contract_info.custnumber" class="mini-textbox" label="客户编号 " readOnly type="text" value="${requestScope['contract_info.custnumber'] }" /></td>				
				...
				<td class="td-content-title" >项目金额：</td>
				<td class="td-content" >      
					<input  vtype="double" id="contract_info.contractmoney"  name="contract_info.contractmoney" allowInput="false" class="mini-textbox" required label="项目金额" value="${requestScope['equipamt']}"/>
				</td>
			</tr>
			<tr class="tr-odd">
				<td class="td-content-title" >省份：</td>
				<td class="td-content" ><input id="cust_info.provice" name="cust_info.provice" class="mini-textbox" label="省份 " readOnly type="text" value="${requestScope['cust_info.provice'] }" /></td>				
				<td class="td-content-title" >城市：</td>
				<td class="td-content" ><input id="cust_info.city" name="cust_info.city" class="mini-textbox" label="城市 " readOnly type="text" value="${requestScope['cust_info.city'] }" /></td>				
			</tr>
			<tr class="tr-odd" style="display:none">
			...
			<tr class="tr-even" id="id_tr_factoring" style="display:none">
			...
			<td class="td-content"><input name="contract_info.contracttype" id ="contracttype"  class="mini-combobox" label="合同文本类型" 
				textField="text" valueField="text" data="[{text:'标准'},{text:'非标准'}]" value="${requestScope['contract_info.contracttype'] }" required="true"></td>
			</tr>
			<tr class="tr-even">
				...
				<td class="td-content-title">业务部：</td>
				<td class="td-content">
			...
			<tr class="tr-odd">
				...
				<td class="td-content-title" style="display: none">项目协办：</td>
			...
			<tr class="tr-even" style="display: none">
	            ...
	            <%--  <td class="td-content-title">商务复核：</td><td class="td-content">
		             <input id="contract_info.projcommisionerb" name="contract_info.projcommisionerb" label="商务复核" class="mini-buttonedit mini-textbox" allowInput="false" readOnly
							text="${ requestScope['rawValue_contract_info.projcommisionerb']}"
							value="${ requestScope['contract_info.projcommisionerb']}"
							/>
					 <input id="rawValue_contract_info.projcommisionerb" name="rawValue_contract_info.projcommisionerb" value="${ requestScope['rawValue_contract_info.projcommisionerb']}" class="mini-textbox" style="display:none"/>
	             </td>  --%> 
			</tr>
	       <tr class="tr-odd" style="display:none">
