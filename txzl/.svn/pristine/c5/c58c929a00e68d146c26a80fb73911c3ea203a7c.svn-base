...
import com.tenwa.webservice.service.RemoteWorkFlowService;

@Service
@WebService(serviceName = "remoteWorkFlowService",endpointInterface="com.tenwa.webservice.service.RemoteWorkFlowService")
