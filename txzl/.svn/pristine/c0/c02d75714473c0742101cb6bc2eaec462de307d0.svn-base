...
if (browser=="IE"){
	...
	document.write('codebase="'+getRootPath()+'/ntko/officecontrol/ofctnewclsid.cab#version=5,0,2,2" ForOnSaveToURL="OnComplete2" width="100%" height="100%">   ');
	...
	document.write('</object>');
		...
		document.write('<object id="TANGER_OCX" type="application/ntko-plug"  codebase="'+getRootPath()+'/ntko/officecontrol/ofctnewclsid.cab#version=5,0,2,2" width="100%" height="100%" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3"');
        ...
        document.write('_ProductCaption="融资租赁测试系统" ');
        document.write('_ProductKey="EB2E35586DF64D6706C8A49271EF07783D8C9901"');
		document.write('codebase="'+getRootPath()+'/ntko/officecontrol/ofctnewclsid.cab#version=5,0,2,2" width="100%" height="100%" type="application/ntko-plug" ');
		document.write('_IsUseUTF8URL="-1"   ');
		document.write('_IsUseUTF8Data="-1"   ');
		document.write('_BorderStyle="1"   ');
		document.write('_BorderColor="14402205"   ');
