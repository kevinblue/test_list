...
@WorkflowAction(name = "RepaymentPlanStartAction", description = "还款计划开始动作", workflowName = "还款计划变更")
@Component(value = "RepaymentPlanStartAction")
public class RepaymentPlanStartAction implements JbpmBaseAction{
