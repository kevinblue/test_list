...
@WorkflowAction(name = "drawalCostStartAction", description = "流程开始动作", workflowName = "撤销诉讼")
@Component(value = "drawalCostStartAction")
public class DrawalCostStartAction implements JbpmBaseAction {
...
//		this.fundOverCommService.loadLawInfoDetail(variablesMap);
		...
		mainMap.put("id", variablesMap.get("filingid"));
