...
<input id="rawValue_proj_invoice_type.taxregtype" name="rawValue_proj_invoice_type.taxregtype" value="${requestScope['rawValue_proj_invoice_type.taxregtype']}" class="mini-textbox" style="display:none"/>
 ...
 <div id="proj_proj_invoice_type_form" title="租金发票类型">
	<table cellspacing="0" cellpadding="0" style="width:100%;border: 1px solid #99CCFF;" class="fillTable">
			...
			<td class="td-content" colspan="3">
				<input id="proj_invoice_type.receivedinvoicetype" name="proj_invoice_type.receivedinvoicetype" class="mini-combobox" label="收到票据类型"
					...
					onvaluechanged="receivedInvoies" required="true"
				>
			</td>
			</tr> --%>
			<tr class="tr-odd">
		...
		<tr class="tr-even">
			...
			<td class="td-content">
				<input id="proj_invoice_type.taxregtype" name="proj_invoice_type.taxregtype" class="mini-combobox" textField="name"  label="纳税人类别" 
							   ...
							   onvaluechanged="comboboxChanged2" 
				 />	 
			</td>
...
/* function checktaxregtype(e){
	var sender = mini.get("proj_invoice_type.taxregtype");
...
function checktaxregtype(e){
	var sender = mini.get("proj_invoice_type.taxregtype");
	var str1 ="proj_invoice_type.taxregcode";
	var str2 ="proj_invoice_type.taxbank";
	var str3="proj_invoice_type.taxacc";
	var str4="proj_invoice_type.invoiceadd";
	var str5="proj_invoice_type.invoicephone";
	var str6="proj_invoice_type.corpusinvoiceratio";
	var str7="proj_invoice_type.interestinvoiceratio";
	var str8="proj_invoice_type.handlingchargeinvoiceratio";
	var str9="proj_invoice_type.managementinvoiceratio";
	if("一般纳税人" == sender.text){
		miniui_ext.setFieldsRequired(str1,true);
		miniui_ext.setFieldsRequired(str2,true);
		miniui_ext.setFieldsRequired(str3,true);
		miniui_ext.setFieldsRequired(str4,true);
		miniui_ext.setFieldsRequired(str5,true);
		miniui_ext.setFieldsRequired(str6,true);
		miniui_ext.setFieldsRequired(str7,true);
		miniui_ext.setFieldsRequired(str8,true);
		miniui_ext.setFieldsRequired(str9,true); 
	}else{
		miniui_ext.setFieldsRequired(str1,false);
		miniui_ext.setFieldsRequired(str2,false);
		miniui_ext.setFieldsRequired(str3,false);
		miniui_ext.setFieldsRequired(str4,false);
		miniui_ext.setFieldsRequired(str5,false);
		miniui_ext.setFieldsRequired(str6,false);
		miniui_ext.setFieldsRequired(str7,false);
		miniui_ext.setFieldsRequired(str8,false);
		miniui_ext.setFieldsRequired(str9,false);
	}
}
<%-- function assignment(invoicetype,rentinvoicetype){
	$.ajax({
