		...
		<table class="fillTable" cellspacing="0" cellpadding="0" style="width:100%;" id="tab_apply">   
		    ...
		    <tr class="tr-odd">
		        ...
		        <td class="td-content" width="38%">
 		        	 <input width="55%" name="applyusername" class="mini-textbox " readonly type='text' required="true" readonly="readonly" value="${requestScope['applyusername']}"/>
		        </td>
		        <td class="td-content-title" width="12%" >申请年月：</td>
		        <td class="td-content" width="38%">
					<input width="55%" name="applydate" class="mini-datepicker" readonly type="date" format="yyyy-MM" required="true" allowinput="false" value="${requestScope['applydate']}" onvaluechanged="changeDate(e)"/>
		        </td>
		    </tr>
		    <tr class="tr-even">
		        <td class="td-content-title" width="12%">申请状态：</td>
		        <td class="td-content" width="38%"> 
		            <input width="55%" name="applystatus" class="mini-textbox" readonly required="true" readonly="readonly" value="${empty requestScope['applystatus']?'未审核': requestScope['applystatus']}"/>
		        </td>
		        <td class="td-content-title" width="12%">申请编号：</td>
		        <td class="td-content" width="38%">
		            <input width="55%" name="applynumber" class="mini-textbox" readonly required="true" readonly="readonly" value="${requestScope['applynumber']}"/>
		        </td>
		    </tr>
		     <tr class="tr-odd" style="height:40px">
		        <td class="td-content-title" width="12%" height="70px">备注：</td>
		        <td class="td-content" colspan="3">
					<textarea style="width: 81%;height: 90%" name="applymemo" readonly  class="mini-textarea" value="${requestScope['applymemo']}"></textarea>
		        </td>
		    </tr>
		    <tr class="tr-even">
		        <td class="td-content-title" width="12%">创建人：</td>
		        <td class="td-content" width="38%">
					<input width="55%" name="creatorname" class="mini-textbox" readonly value="${requestScope['creatorname']}"/>
		        </td>
...
<div id="tabDeatils" class="mini-tabs" activeIndex="0" style="width: 100%;" bodyStyle="padding:0;border:0;">
	    <div title="申请详细信息" name="applicationcust" >
	    	<jsp:include page="asset_mng_detail.jsp" ><jsp:param value="true" name="isView"/></jsp:include>
	    </div>	 
</div>
<script type="text/javascript">
//初始化
