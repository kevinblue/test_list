...
public interface QuartzPublishService {
	...
	public void saveOrUpdateJobAndTrigger(Map<String,String> params) throws Exception;
	...
	public void updateTrigger(String cronexpression, String triggername) throws Exception;
