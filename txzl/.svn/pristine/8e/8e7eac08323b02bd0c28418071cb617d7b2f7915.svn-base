	...
	<table class="fillTable" cellspacing="0" cellpadding="0" style="border: 1px solid #99CCFF;">
		<tr class="tr-odd">
			...
			<td class="td-content" width="35%">
				<input id="contract_fund.caution_money" name="contract_fund.caution_money" class="mini-textbox" style="width: 165px;" allowInput="false" value="${requestScope['contract_fund.caution_money']}"/>
			</td>
			<td class="td-content-title" width="15%">已还保证金：</td>
			<td class="td-content" width="35%">
				<input id="contract_fund.caution_money_out" name="contract_fund.caution_money_out" class="mini-textbox" style="width: 165px;" allowInput="false" value="${requestScope['contract_fund.caution_money_out']}"/>
			</td>
		</tr>
		<tr class="tr-even">
			<td class="td-content-title">剩余保证金：</td>
			<td class="td-content">
				<input id="contract_fund.caution_money_remain" name="contract_fund.caution_money_remain" class="mini-textbox" style="width: 165px;" allowInput="false" value="${requestScope['contract_fund.caution_money_remain']}"/>
			</td>
			<td class="td-content-title">可抵扣保证金：</td>
			<td class="td-content">
				<input id="contract_fund.caution_money_available" name="contract_fund.caution_money_available" class="mini-textbox" style="width: 165px;" allowInput="true" required="true" value="${requestScope['contract_fund.caution_money_available']}"/>
			</td>
		</tr>
		<tr class="tr-odd">
