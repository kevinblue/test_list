										...
										columns : [
												...
												},	
												{
													...
													formEditorConfig : {
														...
														onSelect : function($me,queryInput,rowData) {
											                ...
											                var clientBankQueryInput = getMiniuiExtObject("table_guarantee_info_id_editFormPopupWindow_form_contractid");
												...
												}, 
												{
													...
													formEditorConfig:{
														...
														valueField:'value',
														onSelect : function($me,queryInput,rowData) {
															getMiniEditFormField("table_guarantee_info_id.contractidname").setValue(rowData.name);
															getMiniEditFormField("table_guarantee_info_id.contractname").setValue(rowData.contractname);
															getMiniEditFormField("table_guarantee_info_id.contractid").setText(rowData.name);
															getMiniEditFormField("table_guarantee_info_id.contractid").setValue(rowData.value);
