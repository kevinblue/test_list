		...
		new ApTable({
			...
			tools : [ 'add','-','edit','-','remove','-',{
				...
				handler : function(miniTable, buttonText) {
					...
					o.taxratio=mini.get('taxratio').getValue();
			...
			addOperCallBack:function(miniTable){
			...
			columns: [
				...
				{field: 'feetypename', header: '款项名称',formEditorConfig:{
					readOnly:true,
					fieldVisible:false,
					allowInput:false,
				...
				{field: 'paytypename', header: '收付方向',formEditorConfig:{
					readOnly:true,
					fieldVisible:false,
					allowInput:false,
				...
				{field: 'paytype', header: '收付方向', visible: false,
					formEditorConfig:
					{
						...
						fieldVisible:true,
						required: true,
						params:{pid: 'pay_type', xmlFileName:'combos/comboDict.xml'}
					}
				},
