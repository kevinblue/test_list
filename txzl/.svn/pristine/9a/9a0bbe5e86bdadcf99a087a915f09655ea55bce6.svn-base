...
<script type="text/javascript">
	...
	function __showImageById(id){
		if(id){
			...
			if(appImage){
				...
				$image.attr("src",'${pageContext.request.contextPath}/acl/getAppImage.acl?url=' + appImage.imagepath);
				$image.attr("title", appImage.title);
				$image.attr("thumbUrl",'${pageContext.request.contextPath}/acl/getAppImage.acl?url=' + appImage.thumbimagepath);
				box.html('');
				box.append($image);
	...
	function createAttachmentImageDiv(appImage){
		...
		if(appImage){
			...
			$image.attr("id", appImage.id);
			$image.attr("realUrl",'${pageContext.request.contextPath}/acl/getAppImage.acl?url='+ appImage.imagepath);
			$image.attr("title", appImage.title);
			$image.attr("src", '${pageContext.request.contextPath}/acl/getAppImage.acl?url='+appImage.thumbimagepath);
			$image.appendTo($div);
