...
@WorkflowAction(name = "regulatingBreathingBeforeEndAction", description = "流程结束动作", workflowName = "起租前调息")
@Component(value = "regulatingBreathingBeforeEndAction")
public class regulatingBreathingBeforeEndAction implements JbpmBaseAction{
	 ...
	 * log4j日志 
	 */
	private static final Logger log = LoggerFactory.getLogger(regulatingBreathingBeforeEndAction.class);
