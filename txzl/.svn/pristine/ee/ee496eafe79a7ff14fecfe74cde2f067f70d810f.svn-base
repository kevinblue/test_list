...
@WorkflowAction(name = "contractRentModifyIrregularStartAction", description = "不规则调息开始动作", workflowName = "不规则调息")
@Component(value = "contractRentModifyIrregularStartAction")
public class ContractRentModifyIrregularStartAction implements JbpmBaseAction{
