...
public interface ContractCommService {
  ...
  public void  loadContractFiveCategoryInfo(ContractInfo contracinfo,Map<String, String> variablesMap) throws Exception;
  ...
  void loadContractPremiseInfoByProj(ProjInfo projInfo, Map<String, String> variablesMap) throws Exception;
	...
	public void saveContractPlanInvoice(Map<String, String> variablesMap)throws Exception;
    
	//租金开票方法
	public void saveOrUpdateTiqianRentInvoiceInfo(Map<String, String> variablesMap)throws Exception;
	public void saveOrUpdateShishouRentInvoiceInfo(Map<String, String> variablesMap)throws Exception;
	public void saveContractRentInvoice(Map<String, String> variablesMap)throws Exception;
	
    public void saveContractNumberSettingInfo(ContractInfo contract,Map<String, String> variablesMap) throws Exception;
    
    
    public void loadContractNumberSetting(ContractInfo contractInfo,Map<String, String> variablesMap)throws Exception;
}
