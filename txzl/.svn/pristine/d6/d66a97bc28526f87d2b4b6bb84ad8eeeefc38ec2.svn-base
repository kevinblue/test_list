	...
	<table cellspacing="0" cellpadding="0" style="width:100%;border: 1px solid #99CCFF;" class="fillTable">
		...
		<tr class="tr-odd">
				<td class="td-content-title" >代表人电话：</td>
	             <td class="td-content">
			             <input name="law_approval.dbphone" class="mini-textbox"  value="${requestScope['law_approval.dbphone'] }"  label="代表人电话"   />
						 <font class="required-tag">*</font>
			      </td>
				<td class="td-content-title">移交时间：</td>
	             <td class="td-content">
			             <input name="law_approval.transfer" class="mini-datepicker" label="移交时间" textField="name"  
