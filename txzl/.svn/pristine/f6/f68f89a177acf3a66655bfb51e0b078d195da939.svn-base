...
<script type="text/javascript">
	...
	jQuery(function() {		
		tenwa.createTable({
					...
					xmlFileName : '/eleasing/jsp/other/get_team_department_build_detail_list.xml',
					...
					columns : [
							...
							/* {type : 'checkcolumn'},	 */	
								...
								{field : 'content',header : '内容',align:'center',
									formEditorConfig:{
										type: 'combobox',
										data: userEnable2,
										required:true,
								...
								onupdate:function(){
									...
									var len = data.length;
									$("#id_table_work_week_report8").height(150+len*20);									
