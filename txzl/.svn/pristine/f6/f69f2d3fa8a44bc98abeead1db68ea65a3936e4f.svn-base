...
var localMayMoney = [ {id:'',text:'全部'},{id :'and  cp.overmoney>0',text :'大于零'}, {id :' and cp.overmoney<0',text :'小于零'}];
jQuery(function(){
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			columns:[ 
				...
				{field:'planmoney',header:'应收资金合计',summary:true,dataType:"currency",headerAlign:'center',width:110,
					      formEditorConfig:{newLine:true }},
				{field:'plandate',header:'收款时间',dataType:"yyyy-MM-dd",headerAlign:'center',width:110,
					      formEditorConfig:{},
					           queryConfig:{
					                  type:'date',
					                 range:true,
				...
				{field:'factmoney',header:'已收资金合计',summary:true,dataType:"currency",headerAlign:'center',width:110,formEditorConfig:{ }},
				{field:'feeadjust',header:'调整资金合计',summary:true,dataType:"currency",headerAlign:'center',width:110,formEditorConfig:{ }},
				{field:'overmoney',header:'未收资金合计',summary:true,dataType:"currency",headerAlign:'center',width:110,formEditorConfig:{newLine:true }},
				{field:'collectstatus',header:'收款状态',headerAlign:'center',width:60,formEditorConfig:{newLine:true },
					             renderer:function(e){ return setfundIncomeState(e.record);}},
				{field:'projmanagename',header:'项目开发经理',headerAlign:'center',queryConfig:{},formEditorConfig:{newLine:true }},
...
var toolsArray =
	...
	tenwa.createTable({
		...
		params:{invalid:'否',ismaymoney:'and e.fact_money-nvl(e.no_with_money,0)-nvl(cf.fundmoney,0)- nvl(cr.rent,0)-nvl(pro.process_amount,0)>0'},
		...
		columns:[
			...
			{field:'custidname',header:'承租人名称'},
			{field:'clientname', header:'付款人',width:210,queryConfig:{}},
			//{field:'feetypename',header:'款项类别',queryConfig:{newLine:true}},
			{field:'factmoney', header:'到账金额',summary:true,width:110,dataType:"currency",queryConfig:{type:'float',vtype:'float',range:true,colspan:4,newLine:false}},
			{field:'nowithmoney', header:'非业务金额',summary:true,width:110,dataType:"currency"},
			{field:'hadmoney',header:'已核销金额',summary:true,width:110,dataType:"currency",headerAlign:'center'},
			{field:'mayopemoney', header:'可核销金额',summary:true,width:110,dataType:"currency"},
			{field:'sn', header:'流水号',width:170,queryConfig:{newLine:true}},
			{field:'ownbank', header:'本方银行',width:130},
			{field:'ownaccnumber', header:'本方账号',width:150},
			{field:'ownaccount', header:'本方账户',width:150},
			{field:'clientbank', header:'对方银行',width:130,queryConfig:{}},
			{field:'clientaccnumber', header:'对方账号',width:150,queryConfig:{}},
