...
jQuery(function() {
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			new ApTable({
				...
				loadMode:'ajax',
				params:{},				
				xmlFileName : '/eleasing/jsp/global/annual_operation.xml',
				columns : [ 
				    {type : 'indexcolumn'},
				   	{field : 'id',header : 'id',visible:false},
				   	{field : 'openid',header : '数据抓取ID',visible:false},
				 	...
				 	{field : 'custname',header : '客户名称'},
				   	{field : 'reportdate',header : '编号',visible:false},
