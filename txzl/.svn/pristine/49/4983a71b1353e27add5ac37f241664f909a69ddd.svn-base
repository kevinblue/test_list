...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			id: "oneyear_regulating_of_breathing",
			renderTo: "id_oneyear_regulating_of_breathing",
			...
			showToolbar: false,
			title:'一年内央行调息记录',
			xmlFileName:'/eleasing/workflow/rent/regulating_breathing/oneyear_regulating_breathing_list.xml',
...
<div id="id_oneyear_regulating_of_breathing"></div>