...
@WorkflowAction(name = "interestRateBeforeEditAction", description = "流程编辑动作", workflowName = "起租前调息")
@Component(value = "interestRateBeforeEditAction")
public class regulatingBreathingBeforeEditAction implements JbpmBaseAction {
