...
<title>自然人客户管理</title><%@include file="/base/mini.jsp"%>
<script>
var custid ="<%=id %>";
</script>
...
<body>
	<div style="width: 100%; height: 100%; overflow: auto;">
			...
			<table id="id_table_cust_detail" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td colspan="6" style="border-bottom: 1px solid #99CCFF;"><a
						class="mini-button" iconCls="icon-edit" onclick="upd">编辑</a>&nbsp;&nbsp;<a
						class="mini-button" iconCls="icon-close" onclick="onCancel">关闭</a>
					</td>
				</tr>
				<tr>
					<td width="12%">客户名称：</td>
					<td width="90%" colspan="4"><input name="custid"
						class="mini-textbox" style="display: none;" /> <input
						name="personid" class="mini-textbox" style="display: none;" /> <input
						name="custname" class="mini-textbox  asLabel"
						requiredErrorText="客户名称不能为空" /></td>
					<td></td>
				</tr>
				<tr>
					<td>性别：</td>
					<td><input name="sex" class="mini-combobox asLabel" /></td>
					<td></td>
					<td>身份证号码：</td>
				...
				<tr>
					<td>邮寄地址：</td>
					<td colspan="4"><input name="mailadd"
				...
				<tr>
					...
					<td></td>
					<td>手机：</td>
					<td><input name="mobilenumber" class="mini-textbox asLabel" />
					</td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>户口所在地：</td>
					<td colspan="4"><input name="domicileplace"
						class="mini-textbox asLabel" width="100%" /></td>
					<td></td>
				</tr>
				<tr>
					<td>常住地址：</td>
					<td colspan="4"><input name="oftenaddr"
						class="mini-textbox  asLabel" width="100%" /></td>
					<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td>工作单位：</td>
					<td colspan="4"><input name="unitname"
						class="mini-textbox asLabel" /></td>
					<td></td>
				</tr>
				<tr>
					<td>客户概况：</td>
					<td colspan="4"><input name="ceimemo"
				...
				<tr>
					...
					<td></td>
					<td>登记时间：</td>
					<td><input name="createdate" class="mini-datepicker asLabel"
						value="new Date()" /></td>
					<td></td>
				</tr>
				<tr>
					...
					<td></td>
					<!-- <td>归属人</td>
					<td><input name="belongingpeoplename"
						class="mini-textbox asLabel" /></td>
					<td></td> -->
					<td></td>
					<td></td>
		...
		<div id="tabDeatils" class="mini-tabs" activeIndex="0"
			...
			<div title="项目跟踪进度" iconCls="icon-cut">
			...
			<div
				...
				<jsp:include page="../cust_comm/cust_attachmentinfo.jsp">
					<jsp:param value="cust_person_attachment_file"
						name="attachmentType" />
				</jsp:include>
			</div>
		</div>
...
$.ajax({
    url: "<%=request.getContextPath() %>/table/getTableData.action?tracywindyRandom=1&decorate=none&xmlFileName=/eleasing/jsp/cust_info/cust_person/get_custinfoperson_byid.xml&id=<%=id %>",
    cache: false,
...
function upd(){
	var urlFlag = getRootPath()+"/leasing/cust_info/cust_person/input_cust_person_list.bi?id=<%=id%>";
