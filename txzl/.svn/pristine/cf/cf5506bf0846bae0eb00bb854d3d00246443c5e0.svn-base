...
<script type="text/javascript">
  ...
  var currentTaskActivityDetailId      = '${currentTaskActivityDetailId}';
  var isViewHistoryTask  = ( "true" == "${isViewHistoryTask}" ) || ("${currentRequestTaskType}" == "read")|| ("${currentRequestTaskType}" == "signature") ;
