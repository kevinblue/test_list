...
@WorkflowAction(name = "contractInsuranceStartAction", description = "流程开始动作", workflowName = "保险用印申请")
@Component(value = "contractInsuranceStartAction")
public class ContractInsuranceStartAction implements JbpmBaseAction {
