...
<script type="text/javascript">
	...
	function workflowNextRouteCallBack(buttonText,requestNextRoute){
		if(buttonText == "Submit"){
			...
			var info2 = "300W以下";
			var info3 = "否";
			var nextValue=mini.get('rawValue_proj_info.creditisapproval').getValue();
			if(nextValue == 'credit_type_@103'){
				requestNextRoute.value = info3;
			}else{
				var leaseMoney =  Number(mini.get('equipamt').getValue());
				if(leaseMoney < 3000000){
					requestNextRoute.value = info2;
				}else{
					requestNextRoute.value = info1;
				}
			}
	...
	<div id="contract_approval_form">
		<div class="fillTableContainer">
			<table class="fillTable" cellspacing="0" cellpadding="0">
					...
					<tr>
						<!-- 插入项目信审信息 -->
						<td colspan=4> <jsp:include page="../proj_credit/common/proj_credit_info.jsp"></jsp:include></td>
					</tr>
			</table>
		</div>
		<div class="mini-tabs" activeIndex="0"   style="width: 100%" id="tabDetailsBase"  onactivechanged="changTab">
			...
			<div title="信审评分" name="proj_guaranty_detail" iconCls="icon-cut">
				<span class="print-tabs-title-content">信审评分表</span>
				      <jsp:include page="../proj_credit/common/credit_grade.jsp"></jsp:include>
			</div>
			 <c:choose>
