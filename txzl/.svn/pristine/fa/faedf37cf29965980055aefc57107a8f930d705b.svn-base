...
<input  style="display:none;"	class="mini-textarea" id="id_json_terminate_protocol_str" name="json_terminate_protocol_str" value='${empty json_terminate_protocol_str ? "[]" : json_terminate_protocol_str }'></input>
<div id="contract_finish_form">
	...
	<div id="tabDetails" class="mini-tabs" activeIndex="0" style="width: 100%;"  onactivechanged="changTab"  bodyStyle="border:0px;">
		...
		<div title="提前终止变更项" name="business_condition" iconCls="icon-node">
			<jsp:include page="comm/contract_terminate_changeitem.jsp" ></jsp:include>
		</div>
		 <div title="(现)商务条件" name="fund_rent_plan_new" iconCls="icon-cut">
			<jsp:include page="../../reckon/rent_compare/main_5_1_2.jsp"></jsp:include>
		</div> 
		<div title="终止说明" name="contract_equip" iconCls="icon-node">
			<jsp:include page="../contract_comm/contract_change_info2.jsp"></jsp:include>
		</div>
		<div title="提前还款申请书" name="terminate_protocol" iconCls="icon-node">
