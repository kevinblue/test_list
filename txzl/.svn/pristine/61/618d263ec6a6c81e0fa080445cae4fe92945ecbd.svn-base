...
jQuery(function(){
	...
	tenwa.createTable({
		...
		columns: [
				...
				{field: 'rent', header: '回笼债权总额',summary : true,dataType : "currency"},
				{field: 'corpus', header: '回笼应收账款',summary : true,dataType : "currency"},
				{field: 'interest', header: '回笼保理收入',summary : true,dataType : "currency"},
				{field: 'penalty', header: '回笼罚息',summary : true,dataType : "currency"},
				{field: 'rentadjust', header: '债权调整',summary : true,dataType : "currency"},
				{field: 'corpusadjust', header: '应收账款调整',summary : true,visible:false,dataType : "currency"},
				{field: 'interestadjust', header: '保理收入调整',summary : true,dataType : "currency"},
