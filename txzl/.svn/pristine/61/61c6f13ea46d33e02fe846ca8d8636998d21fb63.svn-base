...
<script type="text/javascript">
	...
	{
    /* 	var id1=document.getElementById("proj_info.projstatus");
        var id2=document.getElementById("proj_info.approvedate");
        var id3=document.getElementById("proj_info.approveconclusion");
    	 */
	...
	function workflowSubmitCallBack(buttonText)
	{
	   ...
	   if (miniui_ext.submitFormValidation(["proj_factoring_base_info_form"]) == false||miniui_ext.submitFormValidation(["credit_result_form"])==false) return;
	   miniui_ext.saveIncludeData("tabApprovalDeatils");
	 //保存投票信息
