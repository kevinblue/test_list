...
<div id="rent_red_form">
	<!-- 插入合同基本信息 -->	<!-- 插入合同基本信息 --><jsp:include page="../factoring_comm/contract_factoring_base_info.jsp"></jsp:include>
	<div id="tabDetails" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;height:500px;">
		<div title="保理债权回笼历史" name="rent_income_his" iconCls="icon-node">
			<jsp:include page="factoring_income_his.jsp" ></jsp:include>
		</div>
		<div title="本次保理债权红冲明细" name="rent_red_detail" iconCls="icon-node">
			<jsp:include page="factoring_red_detail.jsp" ></jsp:include>
		</div>
	</div>
</div>
<script>
