	...
	<div style="width: 100%; height: 100%; overflow: auto;">
		...
		<div id="tabDeatils" class="mini-tabs" activeIndex="0"
			style="width: 100%;" bodyStyle="padding:0;border:0;">
				...
				<div title="项目批复文件" name="projApprovalDoc" iconCls="icon-cut">
					<jsp:include
				...
				<%-- <div title="机组选型报告相关附件" name="selection_accessories_report_list" iconCls="icon-cut">
					<jsp:include
						page="proj_wind_common/selection_accessories_report_list.jsp"></jsp:include>
				</div> --%>
				<div title="SM接口数据" name="projProgressSM" iconCls="icon-cut">
					<jsp:include
						page="../proj_develop_list/proj_wind_common/proj_progressSM.jsp"></jsp:include>
				</div>
				...
				<div title="其他文件" name="proj_accessories_report_list"
					iconCls="icon-cut">
					<jsp:include
						page="proj_wind_common/proj_accessories_report_list.jsp"></jsp:include>
				</div>
				<div title="风电供应商" name="table_supplier_information"
					iconCls="icon-cut">
					<jsp:include page="proj_wind_common/supplier_information.jsp"></jsp:include>
				</div>
				
				
				<div title="电价记录" name="table_tariff_record"
					iconCls="icon-cut">
					<jsp:include page="proj_wind_common/tariff_record.jsp"></jsp:include>
				</div>
				
				<div title="项目投资明细" name="wind_power_investment_details"
					iconCls="icon-cut">
					<jsp:include page="proj_wind_common/wind_power_investment_details.jsp"></jsp:include>
				</div>
				 <div title="接货主数据" name="pickup_wind_details"
					iconCls="icon-cut">
					<jsp:include page="proj_wind_common/pickup_wind_details.jsp"></jsp:include>
				</div> 
		</div>
	</div>
