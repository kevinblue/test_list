...
/* var startdatenew =mini.get("fivecategoryapply.startdate").getValue();
var enddatenew =mini.get("fivecategoryapply.enddate").getValue(); */
 /* var startdatenew='${param.startdate}';
var enddatenew='${param.enddate}'; */
...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			tools: ['remove','-',
			        {
						...
						handler : function(miniTable, buttonText) {							
							...
							tenwa.createQueryInput({
								...
								valueField: 'value',
								params: {
									    xmlFileName:'/eleasing/jsp/finance/guarateeasset.xml'
								}
							});
			...
			xmlFileName : '/eleasing/workflow/proj/proj_credit/five_classfy_credit_report_list.xml',
		 	params : {
				json_str:json_str,  				          				
				modelname : '资产分类认定表' 
			},
			...
			columns: [
				...
				{field: 'flow_unid', header: '流程id',visible: false},
...
function getParams(){
	...
	//1.3租赁合同编号
	params['label.contractid'] = mini.getbyName("contract_info.contractid").getValue();
	//获取融资金额的参数
        ...
        <div id="generatedform">
            <table class="miniext-form-table">
                <tr>
                    ...
                    <td >
                        <input id="financedate" name="financedate" class="mini-datepicker miniext-form-fit" allowInput="false"/>
                    </td>
                </tr>
                <tr>
