...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;" bodyStyle="border:0px;">
	<div title="议案基本信息" name="conference_decision_info" iconCls="icon-node" >
			<jsp:include page="conference_decision_detail.jsp" >
			<jsp:param value="true" name="isView"/>
			</jsp:include>
	</div>
	<div title="审批文件" name="conference_decision_file" iconCls="icon-node" >
			<jsp:include page="conference_decision_file.jsp"></jsp:include>
	</div> 
</div>