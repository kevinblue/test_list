			...
			columns:[ 
						...
						{field:'titleindex',header:'排序位置',
								formEditorConfig:{
								         newLine:true, 
								            type:'text'}},
					    {field:'datatypename', header:'数据类型',
											      formEditorConfig:{
											          fieldVisible:false,
											     fillFromFieldName:'datatype',
											          fillProperty:'value'}},
					    {field:'datatype', header:'数据类型', visible:false,
												  formEditorConfig:{
											                  type:'combobox',
											              required:true,
											             textField:'name',
											            valueField:'value',
											          fieldVisible:true,
									params:{pid: 'reportdatatype', xmlFileName:'combos/comboDict.xml'}}},		            
