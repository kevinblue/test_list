...
<!-- 页签 -->	
	 <div class="mini-panel" title="一、项目管理" id="lastone" name="lastone" style="width: 100%;" iconCls="icon-cut" >	     
	     <jsp:include page="first_sale_week_detail.jsp" ></jsp:include>
	     <jsp:include page="second_sale_week_detail.jsp" ></jsp:include>
	     <jsp:include page="third_sale_week_detail.jsp" ></jsp:include> 
	     <jsp:include page="fourth_sale_week_detail.jsp" ></jsp:include>
	     <jsp:include page="five_sale_week_detail.jsp" ></jsp:include>
	     <jsp:include page="six_sale_week_detail.jsp" ></jsp:include>  
	     <jsp:include page="channel_administration_detail.jsp" ></jsp:include>	   
	     <jsp:include page="problem_advice_detail.jsp" ></jsp:include>
	     <jsp:include page="department_build_detail.jsp" ></jsp:include> 
	 </div>
</div>
</body>
</html>