...
<script type="text/javascript">
	...
	{
	   if (miniui_ext.submitFormValidation(["proj_base_info_form","div_projregistrar"]) == false) return false;
	...
	<div id="contract_approval_form">
		<div class="fillTableContainer">
			<table class="fillTable" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td colspan=4> 
							<jsp:include page="common/proj_limit_choose.jsp">
								<jsp:param value="true" name="isView"/>
							</jsp:include>
						</td>
					</tr>
					<tr>
						<td colspan=4> <jsp:include page="common/proj_choose_fkjb.jsp"></jsp:include></td>
					</tr>
			</table>
		</div>
