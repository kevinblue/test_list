...
<input  style="display:none;"	class="mini-textarea" id="id_json_fund_put_rent_income_his_str" name="json_fund_put_rent_income_his_str" value='${empty json_fund_put_rent_income_his_str ? "[]" : json_fund_put_rent_income_his_str }'></input>
...
<%-- 		<div title="租赁物明细" name="contract_equip" iconCls="icon-node">
	...
	<div title="本次付款明细" name="put_current" iconCls="icon-expand">
	     <jsp:include page="fund_put_current_info.jsp" >
	     <jsp:param value="true" name="isView"/>
	     </jsp:include>
	</div>
	<div title="付款计划明细" name="put_plan" iconCls="icon-expand">
	     <jsp:include page="../../fund/fund_comm/fund_put_plan_info.jsp" >
	     <jsp:param value="true" name="isView"/>
	     </jsp:include>
	</div>
	<div title="已付款明细" name="put_his" iconCls="icon-expand">
	     <jsp:include page="../../fund/fund_comm/fund_put_his_info.jsp" >
	     <jsp:param value="true" name="isView"/>
	     </jsp:include>
	</div>
	...
	<%-- 	<div title="特别付款前提" name="contract_premise" iconCls="icon-node">
			<jsp:include page="../../contract/contract_approval/contract_premise_info.jsp" ></jsp:include>
		</div> --%>
	<div title="租金回笼历史" name="fund_put_rent_income_his" iconCls="icon-node">
		<jsp:include page="fund_put_rent_income_his.jsp" ></jsp:include>
	</div> 
	...
	<div title="付款流程报告" name="premise_report" iconCls="icon-node">
		<jsp:include page="../../fund/fund_comm/premise_report.jsp" >
...
<%-- 	<div title="租金开票类型" name="rentInvoiceType" iconCls="icon-node">
	...
	<%-- <div title="签约方" name="contract_supplier" iconCls="icon-node">
			<jsp:include page="../../contract/contract_comm/contract_signatory.jsp" ></jsp:include>
	</div> --%>
</div>
