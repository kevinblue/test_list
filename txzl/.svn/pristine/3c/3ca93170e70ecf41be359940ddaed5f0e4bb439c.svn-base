...
public class HistoryProcessInstanceImpl implements HistoryProcessInstance, Serializable {
 ...
 //@OneToMany(mappedBy="historyProcessInstanceImpl",fetch=FetchType.LAZY)
  private Set<AttachmentFileUploadInfoDetail> attachmentFileUploadInfoDetails = new HashSet<AttachmentFileUploadInfoDetail>();
  private Set<JBPMWorkflowHistoryInfo> jbpmWorkflowHistoryInfos = new HashSet<JBPMWorkflowHistoryInfo>();
...
public void setJbpmWorkflowHistoryInfos(Set<JBPMWorkflowHistoryInfo> jbpmWorkflowHistoryInfos) {
	this.jbpmWorkflowHistoryInfos = jbpmWorkflowHistoryInfos;
}

public Set<JBPMWorkflowHistoryInfo> getJbpmWorkflowHistoryInfos() {
	return jbpmWorkflowHistoryInfos;
}
}
