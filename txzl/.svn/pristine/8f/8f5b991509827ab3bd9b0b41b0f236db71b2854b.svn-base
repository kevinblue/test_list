   ...
   function reloadcustcontactfile(message){
    ...
    handler:function(miniTable, buttonText) {
       	  var uploadutil=new uploadUtil({
 			  url:'/leasing/file/uploadFile.action',modelname:'项目批复文件',
 			  title:'项目批复文件',
	...
	var custcontactData;
  		jQuery(function() {	
  			seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) { 				
  				...
  				var vxmlFileName="";
  				if(type=="one"){
  					 vxmlFileName="/eleasing/jsp/cust_info/cust_content/cust_content_file_list.xml";
  	  			}else{
  	  			     showTools=false;
  	  			     vxmlFileName="/eleasing/jsp/cust_info/cust_content/cust_content_file_all_list.xml";
  	  	  		}
  				new ApTable({  					
  					id:'table_id4',  					
  					...
  					params:{filekey:id,modelname:'项目批复文件'},
  					tools:tools1,
