		          ...
		          <tr class="tr-project-info tr-even">
		              ...
		              <td class="td-content">
		              	   <input id="framework_condition.settlemethod" name="framework_condition.settlemethod" class="mini-combobox" textField="name" 
							   ...
							   value="${requestScope['framework_condition.settlemethod'] }" 
							   text="${requestScope['rawValue_framework_condition.settlemethod'] }"
		              ...
		              <td class="td-content-title"><span id="testrent">测算租金:</span><span id="testrate">测算利率：</span></td>
		...
		<div class="mini-panel" title="资金信息" showCollapseButton="true" style="width: 100%;">
		    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info" >
		          ...
		          <tr class="tr-project-info tr-odd">
		              ...
		              <td class="td-content">
		              	  <input id="framework_condition.insuremoneytype" name="framework_condition.insuremoneytype" class="mini-combobox" textField="name" style="width:350px;"
			                  	   valueField="value"     
								   dataField="datas"
								   allowInput="false" 
