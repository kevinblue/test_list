	    ...
	    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info" >
	          ...
	          <tr class="tr-project-info tr-odd">
		            ...
		            <td class="td-content" colspan="3">
		            	<input style="width:60%" name="badassets_info.treatmentschema" id ="treatment_schema"  class="mini-textarea" label="资产处理方案"  type="text" required="required" value="${requestScope['badassets_info.treatmentschema']}">
		            </td>
	          </tr>
	</table>
</div>
