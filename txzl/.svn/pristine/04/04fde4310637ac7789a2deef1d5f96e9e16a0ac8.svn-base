	 		 ...
	 		 <div class="mini-panel" title="测算条件" showCollapseButton="true" style="width: 100%;">
			    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info0" >
			    	 <tr class="tr-project-info tr-even">
			             ...
			             <td class="td-content">
			              	<input name="leaseamtdate" required id ="leaseamtdate"   class="mini-datepicker" allowInput="false" value="${requestScope['leaseamtdate']}"></td>
			             </td>
			             <td class="td-content-title"  >期限(天)：</td>
			             <td class="td-content">
			              	<input name="leasetermday" required id ="leasetermday" vtype="int" class="mini-textbox"  value="${empty requestScope['leasetermday'] ? 0 : requestScope['leasetermday'] }"   >
			             </td>
			         <%-- </tr>
			         <tr class="tr-project-info tr-even">
			          <td class="td-content-title">基准利率</td>
			             ...
			             <td class="td-content-title">利率浮动比率</td>   
			              <td class="td-content"><input name="ratefloat" vtype="rate" id ="ratefloat"  class="mini-textbox" value="${empty requestScope['ratefloat'] ? 0 : requestScope['ratefloat'] }"><font class="required-tag">%</font></td>
			              <td class="td-content-title">合同利率(年)：</td>
			              <td class="td-content"><input name="factoringflatrateyear1" vtype="rate" id ="factoringflatrateyear1"  class="mini-textbox" value="${empty requestScope['factoringflatrateyear1'] ? 0 : requestScope['factoringflatrateyear1'] }" readonly><font class="required-tag">%</font></td>	          	  
			    	 </tr>
			 	</table>
			</div>   
		    <div class="mini-panel" title="授信条件" showCollapseButton="true" style="width: 100%;">
			    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info1" >
			          <tr class="tr-project-info tr-even">
			              ...
			              <td class="td-content">
							  ...
							  <!-- 下面是关于测算的关键值 -->
								...
								<input name="json_grace_plan_str" 				id="id_json_grace_plan_str" 			type="hidden" value='${empty json_grace_plan_str ? "[]" : json_grace_plan_str }'/><%-- 宽限期计划 --%>
								...
								<input name="json_special_regular_str" 			id="id_json_special_regular_str"  		type="hidden" value='${empty json_special_regular_str ? "[]" : json_special_regular_str }'/><!-- 分段配置列表 -->	
			             	    <input name="equipamt" id ="equipamt" required vtype="double" label ="应收账款金额" vtype="double"  class="mini-textbox"   value="${empty requestScope['equipamt'] ? 0 : requestScope['equipamt'] }"></td>
			              ...
			              <td class="td-content"><input name="cautionmoney" datachangefield vtype="double" label="保证金" id ="cautionmoney"  class="mini-textbox"  value="${empty requestScope['cautionmoney'] ? 0 : requestScope['cautionmoney'] }" ></td>
			          ...
			          <tr class="tr-project-info tr-odd">
			              ...
			              <td class="td-content"><input name="factoringpayout" readonly datachangefield vtype="double"  id ="factoringpayout" class="mini-textbox" value="${empty requestScope['factoringpayout'] ? 0 : requestScope['factoringpayout'] }" ></td>
			              ...
			              <td class="td-content"><input name="counselingmoney" datachangefield vtype="double"  id ="counselingmoney" class="mini-textbox" value="${empty requestScope['counselingmoney'] ? 0 : requestScope['counselingmoney'] }" ></td>
			           ...
			           <tr class="tr-project-info tr-even">
			              ...
			              <td class="td-content"><input name="factoringincome" readonly datachangefield vtype="double"  id ="factoringincome" class="mini-textbox" value="${empty requestScope['factoringincome'] ? 0 : requestScope['factoringincome'] }" ></td>
			              ...
			              <td class="td-content"><input name="handlingchargemoney" datachangefield vtype="double"  id ="handlingchargemoney" class="mini-textbox" value="${empty requestScope['handlingchargemoney'] ? 0 : requestScope['handlingchargemoney'] }" ></td>
			           ...
			           <tr class="tr-project-info tr-odd">
			              ...
			              <td class="td-content"><input name="insuremoney" vtype="double" datachangefield id ="insuremoney" class="mini-textbox" value="${empty requestScope['insuremoney'] ? 0 : requestScope['insuremoney'] }" ></td>
			              ...
			              <td class="td-content"><input name="otherfeerec" vtype="double" datachangefield  id ="otherfeerec" class="mini-textbox" value="${empty requestScope['otherfeerec'] ? 0 : requestScope['otherfeerec'] }" ></td>
			           ...
			           <tr class="tr-project-info tr-even">
			              ...
			              <td class="td-content"><input name="factoringguaranteefee" datachangefield vtype="double"  id ="factoringguaranteefee" class="mini-textbox" value="${empty requestScope['factoringguaranteefee'] ? 0 : requestScope['factoringguaranteefee'] }" ></td>
			              ...
			              <td class="td-content"><input name="otherfee" vtype="double" datachangefield  id ="otherfee" class="mini-textbox" value="${empty requestScope['otherfee'] ? 0 : requestScope['otherfee'] }" ></td>
			           ...
			           <tr class="tr-project-info tr-odd">
			              ...
			              <td class="td-content"><input name="factoringregisterfee" datachangefield vtype="double"  id ="factoringregisterfee" class="mini-textbox" value="${empty requestScope['factoringregisterfee'] ? 0 : requestScope['factoringregisterfee'] }" ></td>
			              ...
			              <td class="td-content"><input name="actualfund" readonly vtype="double" datachangefield  id ="actualfund" class="mini-textbox" value="${empty requestScope['actualfund'] ? 0 : requestScope['actualfund'] }" ></td>
			           ...
			           <tr class="tr-project-info tr-odd" hidden="hidden">
			              ...
			              <td class="td-content"><input name="salesvolume" readonly vtype="double" datachangefield id ="salesvolume" class="mini-textbox" value="${empty requestScope['salesvolume'] ? 0 : requestScope['salesvolume'] }" ></td>
			...
			<div class="mini-panel" title="保理收益" showCollapseButton="true" style="width: 100%;">
			    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info2" >
			          <tr class="tr-project-info tr-even" style="display: none;">
			              ...
			              <td class="td-content" ><input name="factoringirrmonth" vtype="rate" id ="factoringirrmonth"  class="mini-textbox" value="${empty requestScope['factoringirrmonth'] ? 0 : requestScope['factoringirrmonth'] }" readonly><font class="required-tag">%</font></td>
			              <td class="td-content-title">XIRR(月)：</td>
			           ...
			           <tr class="tr-project-info tr-odd">
			              <td class="td-content-title">合同利率：</td>
			              ...
			              <td class="td-content-title">资金成本：</td>
			              ...
			              <td class="td-content"><input name="factoringirryear" vtype="rate"  id ="factoringirryear" class="mini-textbox" value="${empty requestScope['factoringirryear'] ? 0 : requestScope['factoringirryear'] }" readonly><font class="required-tag">%</font></td>
			          ...
			          <tr class="tr-project-info tr-even" hidden="hidden">
			              ...
			              <td class="td-content"><input name="factoringspreadmonth" id="factoringspreadmonth" vtype="rate"   class="mini-textbox" value="${empty requestScope['factoringspreadmonth'] ? 0 : requestScope['factoringspreadmonth'] }" readonly><font class="required-tag">%</font></td>
			              <td class="td-content-title">Spread(年)：</td>
			              <td class="td-content"><input name="factoringspreadyear" id="factoringspreadyear" vtype="rate"   class="mini-textbox" value="${empty requestScope['factoringspreadyear'] ? 0 : requestScope['factoringspreadyear'] }" readonly><font class="required-tag">%</font></td>
