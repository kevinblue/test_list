...
public class Conn {
	 ...
	 * @throws Exception
	 */
	public List<Map<String, String>> executeQuery(String sql, String... mesage) throws Exception {
		String temp = "";
	 ...
	 * @throws Exception
	 */
	public int executeUpdate(String sql, String... mesage) throws Exception {
		String temp = "";
		for (int i = 0; i < mesage.length; i++) {
			temp += mesage[i] + " ";
		}
