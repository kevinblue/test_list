...
public class User implements Serializable,Comparable<User>,UserDetails
{
	...
	@Column(name="lastLoginRegId",length=100)
	private String lastLoginRegId;
...
//	}
	...
	public String getLastLoginRegId() {
		return lastLoginRegId;
	}
	public void setLastLoginRegId(String lastLoginRegId) {
		this.lastLoginRegId = lastLoginRegId;
	}
