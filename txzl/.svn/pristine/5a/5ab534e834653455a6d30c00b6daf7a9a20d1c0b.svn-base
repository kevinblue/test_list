...
@WorkflowAction(name = "lawCostStartAction", description = "流程开始动作", workflowName = "法务费用申请流程")
@Component(value = "lawCostStartAction")
public class LawCostStartAction implements JbpmBaseAction {
	...
	public void start(HttpServletRequest request, Map<String, String> variablesMap,JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		String json_law_cost_his_detail_str = this.tableService.getJsonArrayData("eleasing/jsp/law_mng/law_cost_his_detail_list.xml", mainMap).toString();
		variablesMap.put("json_law_cost_his_detail_str", json_law_cost_his_detail_str);
