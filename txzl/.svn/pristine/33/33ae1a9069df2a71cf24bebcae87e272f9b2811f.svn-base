...
@WorkflowAction(name = "factoringReconsiderEndAction", description = "流程结束动作", workflowName = "保理复议流程")
@Component(value = "factoringReconsiderEndAction")
public class FactoringReconsiderEndAction implements JbpmBaseAction {
	...
	public void end(HttpServletRequest request,Map<String, String> variablesMap,	JBPMWorkflowHistoryInfo jbpmWorkflowHistoryInfo) throws Exception {
		...
		projCreditService.updateFactoringReconsiderInfo(variablesMap,projStatusCode);
	}
