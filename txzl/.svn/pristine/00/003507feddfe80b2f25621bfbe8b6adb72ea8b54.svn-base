...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
		...
		%>
		<title>供应链项目开发详情</title> <%@include file="/base/mini.jsp"%>
	...
	<div style="width: 100%; height: 100%; overflow: auto;">
		<div id="form1" style="padding: 5px;">
			<table id="id_table_proj_detail" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td>金风质量等级：</td>
					<td><input name="custcreditratingname" class="mini-textbox  asLabel" /></td>
					<td></td>
					<td width="12%">与金风的年订单金额：</td>
					<td width="38%"><input name="annualorderamountname" class="mini-textbox  asLabel" /></td>
				</tr>
				<tr>
					<td>金风采购量占比(%)：</td>
					<td><input name="purchasesaccounted" class="mini-textbox  asLabel" /></td>
					<td></td>
					<td>供应商类别：</td>
					<td><input name="supcategoryname" class="mini-textbox  asLabel" /></td>
				</tr>
				<tr>
					<td>间接供应商：</td>
					<td><input name="indirectsup" class="mini-textbox  asLabel" /></td>
					<td></td>
					<td>天信客户信用等级：</td>
					<td><input name="txcreditratingname" class="mini-textbox  asLabel" /></td>
				</tr>
				<tr>
					<td>项目补充信息：</td>
