...
<!--多行控件  -->
<input style="display:none;"	class="mini-textarea" id="id_json_contract_patrol_plan_form_str" name="json_contract_patrol_plan_form_str" value='${empty json_contract_patrol_plan_form_str ? "[]" : json_contract_patrol_plan_form_str }'></input>
