 ...
 * 
 * @author 孙传良
 * @date 2013-3-7下午03:14:41
 * @info 合同租金计划(起租前)
 * @Copyright 
 * Tenwa
 */
@Entity
@FieldName(name = "合同租金计划(起租前)")
@Table(name="CONTRACT_FUND_RENT_PLAN_BEFORE")
@Deprecated		//标记为停用
public class ContractFundRentPlanBefore implements RentPlan,Comparable<RentPlan> {
