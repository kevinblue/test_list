...
<div id="proxy_content_form" title="代理人信息">
	<table cellspacing="0" cellpadding="0" style="width:100%;border: 1px solid #99CCFF;" class="fillTable">
		...
		<tr class="tr-even">
			...
			<td style="padding-top: 4px;padding-bottom: 4px;" colspan="3"><input maxLength="1000" emptyText="请输入备注" label="备注" style="width:75%;height: 80px;" id="proxymemo" name="law_approval.proxymemo" class="mini-textarea" allowInput="true" required="true" label="备注" value="${requestScope['law_approval.proxymemo']}"/></td>
		</tr>
	</table>
</div>
