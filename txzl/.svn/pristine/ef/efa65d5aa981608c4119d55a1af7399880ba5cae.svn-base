...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			showPager: true,
			multiSelect: true,
			xmlFileName:'/eleasing/workflow/rent/regulating_breathing/already_regulating_breathing_list_new.xml',
		    ...
		    columns:[
				    ...
				    {header:'操作',align:'center',width:120,
								renderer:function(e){
								var  table = e.record;
				                return "<a href='#' onclick='previewtmp("+JsonUtil.encode(table)+")'>对比</a>";}}
	        ]
		});});});	
