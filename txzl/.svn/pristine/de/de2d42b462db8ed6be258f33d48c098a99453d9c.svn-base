...
public class SajtIssueInvoiceServiceLocator extends org.apache.axis.client.Service implements sajt.webservice.ws.service.SajtIssueInvoiceService {
    ...
    private java.lang.String SajtIssueInvoiceServiceHttpSoap11Endpoint_address = "http://10.51.1.16:8080/axis2/services/SajtIssueInvoiceService.SajtIssueInvoiceServiceHttpSoap11Endpoint/";
    ...
    public sajt.webservice.ws.service.SajtIssueInvoiceServicePortType getSajtIssueInvoiceServiceHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public sajt.webservice.ws.service.SajtIssueInvoiceServicePortType getSajtIssueInvoiceServiceHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            sajt.webservice.ws.service.SajtIssueInvoiceServiceSoap11BindingStub _stub = new sajt.webservice.ws.service.SajtIssueInvoiceServiceSoap11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (sajt.webservice.ws.service.SajtIssueInvoiceServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                sajt.webservice.ws.service.SajtIssueInvoiceServiceSoap11BindingStub _stub = new sajt.webservice.ws.service.SajtIssueInvoiceServiceSoap11BindingStub(new java.net.URL(SajtIssueInvoiceServiceHttpSoap11Endpoint_address), this);
                _stub.setPortName(getSajtIssueInvoiceServiceHttpSoap11EndpointWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.ws.webservice.sajt", "SajtIssueInvoiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.ws.webservice.sajt", "SajtIssueInvoiceServiceHttpSoap11Endpoint"));
        }
