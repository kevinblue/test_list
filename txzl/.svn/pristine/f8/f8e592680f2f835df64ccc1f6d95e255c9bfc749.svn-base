 ...
 * Tenwa
 */
@WorkflowAction(name = "projCancelStopStartAction", description = "流程开始动作", workflowName = "项目执行中止流程")
@Component(value = "projCancelStopStartAction")
public class ProjCancelStopStartAction implements JbpmBaseAction {
