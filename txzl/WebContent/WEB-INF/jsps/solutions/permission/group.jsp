...
<script type="text/javascript">
	...
	jQuery(function(){
   	 var table = new tracywindyOperationTable({
   		 tableComment:'群组',
   		 constantFlagTable:'Group',
         renderTo:'id_tableContainer',
         title:'群组信息列表',
         otherOper:function(value,tableObj,columnName,columnIndex,rowData){
         	return "<a href='javascript:void(0);' onclick='viewUsers("+rowData.rowIndex+")'>已分配用户</a>";
         },
         isNeedEnabled:true,
         width:pageWidth,
         height:pageHeight,
         ...
         columns:[
		            ...
		            {header:'群组名称',name:'name',renderer:function(value,tableObj,columnName,columnIndex,rowData){
		             	return "<a title='已分配用户' href='javascript:void(0);' onclick='viewUsers("+rowData.rowIndex+")'>"+value+"</a>";
		            }},
   ...
   function viewUsers(rowIndex){
		   ...
		   ajaxRequest({
	            url:"${pageContext.request.contextPath}/acl/queryGroupUsers.acl?id="+rowData['id'],
	            timeout:30*1000,
	            success:function(res){
	                if(res.responseText){
	                	jQuery("#id_detailInfoUsersContainer").html(res.responseText);
	                }else{
	                	jQuery("#id_detailInfoUsersContainer").html("<font color='red'>该群组尚未分配用户</font>");
	                }
...
<body>
	...
	<div id="id_detailInfoWindowContainer"  closed="true" modal="true" title="群组信息管理" style="display:none;width:500px;padding-top:20px;">
	        <center>
		        <form id="id_detailInfoForm">
			        <table style="width:100%">
			            <tr style="display:none"><td><input name="id" type="hidden" value=""/></td></tr>
			            <tr><td class="input_label_desc">群组名称:  </td>  <td class="input_value"><input name="name" require="true" label="群组名称"   type="text" /><span class="content-required">*</span></td></tr>
			            <tr><td class="input_label_desc">群组编号:</td>  <td class="input_value"><input name="code" require="true" label="群组编号"   type="text" /><span class="content-required">*</span></td></tr>
			            <tr><td class="input_label_desc">群组描述:     </td><td  class="input_value"><textarea name="description"></textarea><span class="content-required">&nbsp;&nbsp;</span></td></tr>
	...
	<div id="id_detailInfoUsersWindowContainer"  closed="true" modal="true"  style="display:none;width:500px;height:300px;padding:0px;overflow:auto;">
	        <center>
