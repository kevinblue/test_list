	...
	jQuery(function(){
   	 var table = new tracywindyOperationTable({
         ...
         columns:[
		            ...
		            {header:'AD域登录密码',name:'adminpassword'},
	        ...
	        <center>
		        <form id="id_detailInfoForm">
			        <table style="width:90%">
			            ...
			            <tr><td class="input_label_desc">AD域登录密码:</td>  <td class="input_value"><input name="adminpassword" require="true" label="AD域登录密码"   type="text" /><span class="content-required">*</span></td></tr>
