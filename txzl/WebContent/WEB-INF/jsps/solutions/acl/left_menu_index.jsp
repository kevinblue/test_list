	...
	<body>
		<div>
			...
			<div class="frame-right" >
						...
						<span id="id_goPage" >用户主页</span>
							<span class="main_time" style="line-height:100%;margin-top:0px;font-size:12px;">
								...
								<auth:authorize ifAnyGranted="ROLE_ADMIN">
									&nbsp;&nbsp;在线用户数：<a style="text-decoration:none;" href="javascript:void(0);" onclick="javascript:showOnlineUsersWindow();"><font>${online_user_count}&nbsp;</font></a>，
								</auth:authorize>  
								欢迎您：<font color="#961433">${sessionScope.login_realname}</font>&nbsp;&nbsp;
				...
				<div>
					<iframe frameborder="0" name="name_rightFrame" id="id_frameRight" src="${pageContext.request.contextPath}/loadingIndex.html"></iframe>
				</div>
			</div>
		</div>
