...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/tenwa/tenwa.js"></script>
  		...
  		var tools = [];
			/* tools.push('add'); */
			<permission:action code="insurance_claim_add">
			tools.push('add');
			</permission:action>
			<permission:action code="insurance_claim_edit">
			tools.length>0?tools.push('-','edit'):tools.push('edit');
			</permission:action>
			<permission:action code="insurance_claim_remove">
  					...
  					columns : [ 
  						...
  						{field:'id',header:'id',headerAlign:'center',allowSort:true,visible:false, width:100,
  							    formEditorConfig:{
  								        readOnly:true,
  								    fieldVisible:false }},
  						{field:'contractidname', header:'合同编号', visible:true,width:120,
  							    formEditorConfig:{
  								    fieldVisible:false}},
  						{field:'contractnumber', header:'业务合同号', visible:true,width:120,
  							    formEditorConfig:{
  					   		         ...
  					   		         queryConfig:{  	
  					   		          labelWidth:100,
  					   			           width:200}},
  						{field:'custname',header:'客户名称',headerAlign:'center',visible:true,width:130,
  							    formEditorConfig:{
								        readOnly:true,
								      labelWidth:100,
								           width:200,								
						...
						{field:'claimstime',header:'赔偿日期',dateFormat:"yyyy-MM-dd ",headerAlign:'center',visible:true,width:100,
							     formEditorConfig:{
								       ...
								       labelWidth:100,
	 							            width:200}},
						{field:'claimsmoney',header:'赔款金额(元)',headerAlign:'center',visible:true,dataType:"currency",width:100,
							     formEditorConfig:{								
								             type:'text',
 								       labelWidth:100,
 								            width:200}},
						...
						{field:'claimsinfo',header:'出险原因',headerAlign:'center',visible:true,width:100,
							     formEditorConfig:{
								          newLine:true,
	  							          ...
	  							          colspan:3,
	  							            width:"100%"}},
						{field:'claimsafter',header:'出险经过及损失情况',	headerAlign:'center',visible:true,width:120,
							    formEditorConfig:{
								         newLine:true,
								            type:'textarea',
								         colspan:3,
