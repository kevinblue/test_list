  					...
  					columns:[ 
  					    ...
  					    {field:'id',header:'编号',headerAlign:'center',width:100,allowSort:true,visible:false ,
  							 formEditorConfig:{
  								     readOnly:true,
  								 fieldVisible:false}},
  						{field:'custname',header:'客户名',headerAlign:'center',visible:true,width:130,
	  					     formEditorConfig:{
						   		         type:'text',  
						   		     readOnly:true,
								 fieldVisible:true ,
							      ...
							      queryConfig:{		
								        width:200}} ,	
  						{field: 'contractid_',header:'合同编号',headerAlign:'center',visible:true,width:130,
  					   		 formEditorConfig:{
  					   			         type:'text',  
  					   			     readOnly:true,
								 fieldVisible:true ,
								   labelWidth:100,
								        width:200}},  	
  						{field:'contractnumber', header: '业务合同号', visible: true,width:130,
					  			  queryConfig:{  
 							       labelWidth:100,
				   			            width:200},
  						     formEditorConfig:{
 								 fieldVisible:false }},
					   	{field:'startdate',header:'租赁起始日',headerAlign:'center',visible:true,width:90, dateFormat:"yyyy-MM-dd",
  					     	 formEditorConfig:{
  					     		         type:'date',
  					     		      newLine:true,
  					     		     readOnly:true,
								 ...
								 fieldVisible:true ,
								   labelWidth:100,
								        width:200}},
					   	{field:'enddate',header:'租赁截至日',headerAlign:'center',visible:true,width:90,dateFormat:"yyyy-MM-dd ",
					   	 	 formEditorConfig:{
					   			         type:'date',  
					   			     readOnly:true,
						   		       format:'yyyy-MM-dd',
