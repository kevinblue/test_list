				...
				*/
				...
				columns : [ 
				    {type : 'indexcolumn'},
				   	...
				   	{field : 'contractid',width : 120,header : '合同号'},
				   	{field : 'contractnumber',width : 120,header : '业务合同号',queryConfig : {},renderer:function(e){
						return "<a href='javascript:void(0);' onclick='showContractDetail(\""+e.record.cid+"\")'>" + e.record.contractnumber + "</a>";
					}},
				   	{field : 'custname',width : 120,header : '客户名称',allowSort:true,queryConfig : {}},
				   	...
				   	{field : 'money',width : 120,header : '收款金额',dataType:"currency",align:'right',summary: true},
				   	
				   	{field : 'invoiceno',width : 120,header : '发票号码',queryConfig : {newLine: true}},
				   	{field : 'invoicemoney',width : 120,header : '含税总金额',dataType:"currency",align:'right',summary: true,
				   		formEditorConfig:{
				              vtype:'currency'
				        }
				   	},
				   	{field : 'invoicedate',header : '开票日期'},
				   	{field : 'taxmoney',width : 120,header : '合计税额',dataType:"currency",align:'right',summary: true,
				   		formEditorConfig:{
				              vtype:'currency'
				        }
				   	},
