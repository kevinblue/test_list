				...
				tools : [{
					...
					handler : function(miniTable, buttonText) {
						...
						if(row){
							...
							params['label.rentlist'] = row.rent_list;
							params['label.moneytype'] = row.moneytype;
							params['label.rent'] = row.rent;
							params['label.custname'] = row.cust_name;
							params['label.nowtime'] = new Date().format("yyyy 年 MM 月 dd 日");
							var fileTeplate=new fileTemplateConfig({
								templateno : 'F-201709015',
								tableid : 'table_id1',
								modelname : '延期付款申请书',
								returntype : 'file',
								parames : params
		...
		$.ajax({
			...
			success:function(res){
				...
				if(rent==0){
					...
					params['rent_list_total.totalRMB']=convertCurrency(parseFloat(rent));
				}
