...
function checkUsersDept(){
	var flag=false;
	$.ajax({
        url: urlPrefix+"/eleasing/jsp/cust_info/cust_company/get_users_dept.xml",
        type: "post",
        cache: false,
        async : false,
        success: function (text) {
        	...
        	var deptstr = "财务部,系统管理部";
        	var deptname=data.dept_name;
        	if(deptstr.indexOf(deptname)>-1){
        		flag=true;
        	}
        }
    });
