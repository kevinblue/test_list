...
<%
String invoiceid=request.getParameter("invoiceId");//ID
String toolsFlag = request.getParameter("toolsFlag");

%>
<script type="text/javascript">
	var invoiceid = '${param.invoiceId}';
	var toolsFlag = '${param.toolsFlag}';
	var buttonFlag = '${param.buttonFlag}';
</script>
	...
	<div id="mini-panel" title="发票基本信息" showCollapseButton="true" style="width: 100%;" >
		...
		<table class="fillTable" cellspacing="0" cellpadding="0" style="width:100%;" >   
		    ...
		    <tr class="tr-odd">
		        ...
		        <td class="td-content" width="38%">
					<input width="55%" name="invoicemoney" class="mini-textbox" required="true" vtype="float" onblur="checkAmt()" requiredErrorText="发票金额不能为空"/>
		        </td>
		    </tr>
		    <tr class="tr-even">
		    ...
		    <tr class="tr-odd">
		     ...
		     <tr class="tr-even" style="height:40px">
		        ...
		        <td class="td-content" colspan="3">
					<textarea style="width: 81%;height: 90%" name="memo" class="mini-textarea"></textarea>
		        </td>
		    </tr>
		    <tr class="tr-odd">
...
<!-- 页签 -->
	<div id="tabDeatils" class="mini-tabs" activeIndex="0" style="width: 100%;" bodyStyle="padding:0;border:0;">
	    <div title="合同登记" name="relatedInvoice" >
...
$.ajax({
	url : "<%=request.getContextPath() %>/table/getTableData.action?tracywindyRandom=1&decorate=none&xmlFileName=/eleasing/jsp/invoice_manage/vat_invoice/vat_invoice_record.xml&id=<%=invoiceid %>",
	cache : false,
