...
<body>
   ...
   function reloadcustcontactfile(message){
	...
	var custcontactData;
  		jQuery(function() {	
  			seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) { 				
  				...
  				var vxmlFileName="";
  				if(type=="one"){
  					 vxmlFileName="/eleasing/jsp/cust_info/cust_archives/cust_archives_file_list.xml";
  	  			}else{
  	  			     showTools=false;
  	  			     vxmlFileName="/eleasing/jsp/cust_info/cust_archives/cust_archives_file_all_list.xml";
  	  	  		}
  				new ApTable({  					
  					id:'table_id4',  					
  						    ...
  						    formEditorConfig:{
							    fieldVisible:false},
						            renderer:function(e){
						                 ...
						                 return "<a href='javascript:void(0);' onclick='downloadFileById(\"" + id + "\")'>下载 </a>"+"&nbsp&nbsp"+"<a href='javascript:void(0);' onclick='showFile4(\"" + id +"\",\""+filename+"\")'>预览</a>";
						}
						}
  					]
      ...
      function createAttachmentImageDiv4(appImage,filedict){
      	var $div = jQuery('<div/>');
      	if(appImage){
    ...
    //预览
      function showFile4(filedict,filename){
      	        ...
      	        success:function(res){
      			    ...
      			    if(datas && datas.length > 0){
      			    	...
      			    	jQuery.each(datas, function(index, appImage){
      			    		var img = createAttachmentImageDiv4(appImage,filedict);
      			    		if(img){
...
<div id="showfile4" class="mini-window" title="预览" showMaxButton="true"
