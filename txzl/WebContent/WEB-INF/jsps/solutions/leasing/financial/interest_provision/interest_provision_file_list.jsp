  		...
  		jQuery(function() {	
  			seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) { 				
  				...
  				new ApTable({  					
  					...
  					showPager:true,
  					lazyLoad:false,
  					xmlFileName:'/eleasing/jsp/finacial/interest_provision/interest_provision_file_list.xml',
  					showToolbar:showTools,
  					params:{filekey:id,modelname:'利息计提资料'},
  					tools:[
                           {
                             html:'上传资料',plain:true,iconCls:'icon-edit',
                             handler:function(miniTable, buttonText) {
	                            	  var uploadutil=new uploadUtil({
	                      			  url:'/leasing/file/uploadFile.action',modelname:'利息计提资料',
	                      			  title:'利息计提资料',
