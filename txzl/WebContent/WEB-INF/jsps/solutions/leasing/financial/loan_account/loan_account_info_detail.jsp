...
<div style="width: 100%;height: 100%;overflow: auto;">
	<div id="form1" style="padding: 5px;">
		<table id="id_table_cust_detail" cellpadding="0" cellspacing="0" align="center">
		    ...
		    <tr>
		        <td>借款期限：</td>
		        <td><input name="loantermnew" class="mini-textbox  asLabel"/></td>
		        <td></td>
		    	<td>合同利率：</td>
		    ...
		    <tr>
		        <td>已还款金额(元)：</td>
		        <td><input name="alreadycorpus" class="mini-textbox  asLabel"/></td>
		        <td></td>
		    	<td>剩余还款金额(元)：</td>
		        <td><input name="surpluscorpus" class="mini-textbox  asLabel"/></td>
		        <td></td>
		    </tr>
             <tr>
		        <td>未支付利息金额(元)：</td>
		    ...
		    <tr>
		     ...
		     <tr>
		        ...
		        <td>其它费用已付金额(元)：</td>
		        <td><input name="alreadyother" class="mini-textbox  asLabel"/></td>
		        <td></td>
		        <td>其它费用未付金额(元)：</td>
		        <td><input name="surplusother" class="mini-textbox  asLabel"/></td>
		        <td></td>
		    </tr>
		    <tr>
		        <td>担保抵押情况</td>
	...
	<div id="tabDeatils" class="mini-tabs" activeIndex="0" onactivechanged=changTab style="width: 100%;" bodyStyle="padding:0;border:0;">
	    ...
	    <div title="还款计划" name="loanrentplan" iconCls="icon-cut">
	    	<jsp:include page="../loan_rent_plan/loan_rent_plan_list.jsp" >
	    		<jsp:param value="<%=id%>" name="loanid"/>
	    		<jsp:param value="<%=loancontractid%>" name="loancontractid"/>
	    	</jsp:include>
	    </div>
	    <div title="还款" name="loanrentplan" iconCls="icon-cut">
	    	<jsp:include page="../loan_rent_plan/loan_rent_hire_list.jsp" >
	    		<jsp:param value="<%=id%>" name="loanid"/>
	    		<jsp:param value="<%=loancontractid%>" name="loancontractid"/>
	    	</jsp:include>
	    </div> 
	  <div title="预提" name="loan_rent_plan_interest" iconCls="icon-cut">
	    	<jsp:include page="../loan_rent_plan/loan_rent_plan_interest_list.jsp" >
	    		<jsp:param value="<%=id%>" name="loanid"/>
	    		<jsp:param value="<%=loancontractid%>" name="loancontractid"/>
	    	</jsp:include>
	    </div>    
	    
	    <div title="付息" name="loanrentplan" iconCls="icon-cut">
	    	<jsp:include page="../loan_rent_plan/loan_rent_hire_interest_list.jsp" >
	    		<jsp:param value="<%=id%>" name="loanid"/>
	    		<jsp:param value="<%=loancontractid%>" name="loancontractid"/>
	    	</jsp:include>
	    </div> 
