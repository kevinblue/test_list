...
jQuery(function() {
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			new ApTable({
				...
				//已经归档的合同
				xmlFileName:'/docexpress/contract_archives.xml',
				tools: [{
					html:'归档',
					plain : true,
					iconCls : 'icon-edit',
					handler : function(miniTable, buttonText) {
						...
						jQuery.ajax({
							...
							type : 'POST',
							timeout : 30 * 1000,
							data : {containerNumber:containerNumber,userName:userName,conid:"${param.id}"},
							dataType : 'json',
	...
	<div id="form1" class="mini-panel" style="width: 100%;">
		<table class="fillTable">
			...
			<tr class="tr-even">
				...
				<td class="td-content" width="35%">
		         	 <input id="id_realName" name="realname_" label="归档人" 
		         	 	class="mini-buttonedit mini-queryinput" 
		         	 	allowInput="false"
		             	required="true"
						text="${empty requestScope['rawValue_realname_'] ? sessionScope.loginUser.realname : requestScope['rawValue_realname_']}"
						value="${empty requestScope['realname_'] ? sessionScope.loginUser.id : requestScope['realname_']}"
						/>
					 <font class="required-tag">*</font>
					 <input id="rawValueRealname_" name="rawValue_realname_" value="${empty requestScope['rawValue_realname_'] ? sessionScope.loginUser.realname : requestScope['rawValue_realname_']}" 
	            ...
	            <td class="td-content" width="38%"> 
	             	...
	             	label="归档时间"  required="true" allowInput="false"/></td>
			</tr>
		</table>
	</div>
