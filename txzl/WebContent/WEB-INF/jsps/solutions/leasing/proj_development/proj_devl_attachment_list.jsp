  		...
  		jQuery(function() {	
  			seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) { 				
  				...
  				new ApTable({  					
  					...
  					showPager:true,
  					lazyLoad:false,
  					xmlFileName:'/eleasing/jsp/cust_info/cust_content/cust_content_file_list.xml',
  					showToolbar:showTools,
  					params:{filekey:filekeyid,modelname:'风资源分析报告'},
  					tools:[
                           {
                             ...
                             handler:function(miniTable, buttonText) {
	                            	  var uploadutil=new uploadUtil({
	                      			  ...
	                      			  modelname:'风资源分析报告',
	                      			  title:'风资源分析报告',
	                      		      parames:{id:'custcontactfile',filekey:filekeyid},
