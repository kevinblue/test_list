		...
		<div class="mini-tabs" activeIndex="0"   style="width: 99%" id="tabDetailsBase"  onactivechanged="changTab">
		   ...
		   <div title="文件清单" name="proj_file_detail"   iconCls="icon-cut" >
		    ...
		    <div title="评审会议记录" name="proj_file_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_meeting_record.jsp" ></jsp:include>
		    </div>
		    <div title="评审意见" name="proj_file_detail"   iconCls="icon-cut" >
		    	<jsp:include page="../proj_credit/common/proj_credit_committee_final.jsp">
		    	<jsp:param value="true" name="autoJudge"/>
		    	</jsp:include>
		    </div>
