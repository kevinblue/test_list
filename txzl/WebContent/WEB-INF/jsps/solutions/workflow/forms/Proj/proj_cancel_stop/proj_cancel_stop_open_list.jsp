	...
	jQuery(function() {
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			new ApTable({
				...
				showPager:true,
				xmlFileName:'/eleasing/workflow/proj/proj_cancel_stop/proj_cancel_stop_list.xml',
				...
				tools:[
					 {
						...
						handler:function(miniTable, buttonText) {
							...
							if(row){
				        		...
				        		startProcess("项目执行中止流程-1",attachmentParams); 
							}else{
								mini.alert('请你选择需要发起项目执行中止的项目！！！');
							}
				...
				columns:[ 
					...
					{field:'projectname',header:'项目名称'},
				   	...
				   	{field:'orgcodecardno',header:'身份证/组织机构代码',queryConfig:{}},
				   	{field:'custkind',header:'内部行业'},
				   	{field:'projmanager',header:'项目经理',queryConfig:{newLine:true,colspan:3}},
