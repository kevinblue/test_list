...
/* 	   if (miniui_ext.submitFormValidation(["proj_base_info_form","proj_rent_invoice_type"]) == false) return false;
	...
	<div id="contract_approval_form">
		...
		<div class="mini-tabs" activeIndex="0"   style="width: 100%" id="tabDetailsBase"  onactivechanged="changTab">
		 	<!-- <div title="投票信息汇总" style="display: none;" name="proj_vote" iconCls="icon-cut" >
		   ...
		   <c:if test="${requestScope['rawValue_proj_info.industrytype']=='风力发电'}">
		    <div title="经评模型" name="credit_report"   iconCls="icon-cut" >
		       <table class="fillTable" cellspacing="0" cellpadding="0">
		            <tr>
			            <td colspan=4>
			              <jsp:include page="../proj_credit/model_parameter_was_evaluated.jsp"><jsp:param value="true" name="isView"/></jsp:include>
			...
			<div title="项目建议书" name="proj_credit_proposal" iconCls="icon-cut" >
				<jsp:include page="../proj_credit/credit_report/proj_credit_proposal.jsp" >
					<jsp:param value="true" name="isView"/>
				</jsp:include>
			</div>    
	   </div>
