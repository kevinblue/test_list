	    ...
	    <table cellspacing="0" cellpadding="0" style="width:100%;border: 1px solid #99CCFF;" class="fillTable">
				<tr class="tr-even">
					...
					<td class="td-content" width="38%">
						<input name="proj_info.establishdate" id="proj_info.establishdate" label="成立时间" class="mini-textbox" value="${requestScope['proj_info.establishdate'] }" allowInput="true" readonly/>
	               </td>
					<td class="td-content-title">企业性质：</td>
					<td class="td-content">
						<input name="proj_info.ownershipname" id="proj_info.ownershipname" label="企业性质" class="mini-textbox"  value="${requestScope['proj_info.ownershipname'] }" allowInput="true"  readonly/></td>
				</tr>
