...
<script type="text/javascript">
	...
	{
	   if (miniui_ext.submitFormValidation(["proj_base_info_form","proj_rent_invoice_type","id_proj_choose_projresponsible"]) == false) return false;
	...
	<div id="contract_approval_form">
		<div class="fillTableContainer">
			<table class="fillTable" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td colspan=4> <jsp:include page="../proj_credit/common/proj_choose_fkjb.jsp"></jsp:include></td>
					</tr>
			</table>
		</div>
