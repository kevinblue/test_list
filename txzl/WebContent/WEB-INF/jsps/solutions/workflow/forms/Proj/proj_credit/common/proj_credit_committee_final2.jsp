			...
			success:function(response){
				...
				if(votes.length > 0 ){
					for(var i = 0 ; i < votes.length;i++){
						...
						$('#votes').append("<td style='width:70px;'>评审人：</td>");	
						$('#votes').append("<td  style='width:100px;'>"+vote.name+"</td>");
						$('#votes').append("<td style='width:70px;'>步骤名称：</td>");	
						$('#votes').append("<td  style='width:200px;'>"+vote.stepname+"</td>");	
						//$('#votes').append("<tr>");	
						$('#votes').append("<td style='width:70px;'>投票意见：</td>");	
						$('#votes').append("<td style='width:200px;'>"+vote.isview+"</td>");	
						$('#votes').append("<tr>");	
