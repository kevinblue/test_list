...
<script type="text/javascript">
	...
	{   
        ...
        //saveReportTable();
        //适用于处理没有选择意见，直接保存然后提交就会绕过表单必填校验。
	...
	<div id="contract_approval_form">
		<div class="fillTableContainer">
			<table class="fillTable" cellspacing="0" cellpadding="0">
					...
					<tr>
						<!-- 插入项目信审信息 -->
						<td colspan=4> <jsp:include page="common/proj_credit_committee.jsp"></jsp:include></td>
					</tr>
					<tr>
						<!-- 插入项目信审信息 -->
						<td colspan=4> <jsp:include page="common/proj_credit_committee_final.jsp"></jsp:include></td>
					</tr>
