					...
					{field:'custid',
						...
						formEditorConfig:{
							...
							params:{cust_id:'xxx',
									...
									docid2:'xxx',
									limited:'xxx',
								    xmlFileName:'/eleasing/workflow/proj/proj_contract/custinfo_judge_set_number.xml'}
						}
					},
					{
						field : 'contractmoney',
...
function setRegistcode($me,queryInput,rowData) {	
	mini.get("id_tasks_table1_editFormPopupWindow_form_contractmoney").disable(true);
   ...
   if("CONTRACT_TYPE.01" == rowDatas){
	   ...
	   conidparams.docidfilter2 = rowDatas;
	    ...
	    conidparams.projid1='xxx';
	   	...
	   	mini.get("id_tasks_table1_editFormPopupWindow_form_contractmoney").enable(true);
...
function  getContractNumInfo(){
	 var  row=null;
	row=mini.get("id_tasks_table1").getSelected();
	return row; 
}
