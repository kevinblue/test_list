		...
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable){ 
			...
			new ApTable({
				...
				columns:[
			          ...
			          {field:'contractid', header:'合同编号',width:120,queryConfig:{},renderer:function(e){
			          	            		 var rowData = e.record; 
			          	            		 var str="";
			          		                ...
			          		                return str;}},
					{field:'contractnumber', header:'业务合同编号',width:120,queryConfig:{}},
					{field:'custname', header:'承租客户',queryConfig:{newLine:true},
					    renderer:function(e){
					   	      var row=e.record;
				   ...
				   {field:'zdnet',header:'是否登记中登网', visible:true,
				    ...
				    {field:'registerdate',header:'中登网登记时间'},       	  
                  	...
                  	{field:'cleanleasemoney',header:'净融资额',align:"right"},
 		            ...
 		            {field:'projdeptname',header:'业务部',queryConfig:{}},
