...
<div id="contract_approval_form">
	...
	<div id="tabDetails" class="mini-tabs" activeIndex="0" style="width: 100%;" onactivechanged="changTab">
		...
		<div title="相关合同" name="contract_word" iconCls="icon-node">
			<jsp:include page="../contract_comm/contract_word_sign.jsp" >
			<jsp:param value="true" name="isView"/>
			</jsp:include>
		</div>
        <%-- <div title="签约信息" name="contract_subscription" iconCls="icon-node">
			<jsp:include page="../contract_comm/subscription_info.jsp" >
			<jsp:param value="true" name="isView"/>	
			</jsp:include>
		</div> --%>
	...
	<div title="面签声明" name="interview_statement" iconCls="icon-node" >
			<jsp:include page="../contract_comm/interview_statement.jsp" >
			<jsp:param value="true" name="isView"/>
			</jsp:include>
	</div>
	</div>
