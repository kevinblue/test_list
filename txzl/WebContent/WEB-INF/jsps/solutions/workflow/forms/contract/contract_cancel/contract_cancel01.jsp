...
<!--多行控件  -->
<input  style="display:none;"	class="mini-textarea" id="id_json_contract_equip_str" name="json_contract_equip_str" value='${empty json_contract_equip_str ? "[]" : json_contract_equip_str }' />
<input  style="display:none;"	class="mini-textarea" id="id_json_contract_fund_payin_str" name="json_contract_fund_payin_str" value='${empty json_contract_fund_payin_str ? "[]" : json_contract_fund_payin_str }' />
<input  style="display:none;"	class="mini-textarea" id="id_json_contract_fund_payout_str" name="json_contract_fund_payout_str" value='${empty json_contract_fund_payout_str ? "[]" : json_contract_fund_payout_str }' />
...
<div class="contract_cancel_form">
