...
jQuery(function(){
	tenwa.createTable({
		id: "income_discount",
		renderTo: "id_table_container_income_discount",
...
/* 		tools: [{
				...
				handler:function(miniTable, buttonText) {
					...
					if(row){
					  //alert(row);
						...
						startProcess("收入折现流程-1",attachmentParams); 
		...
		xmlFileName: '/eleasing/workflow/contract/finance/finance_income_discount_openlist.xml',
		columns: [
			{type: 'indexcolumn'},
			{type: 'checkcolumn'},
...
<div id="id_table_container_income_discount"></div>
</body>
</html>
