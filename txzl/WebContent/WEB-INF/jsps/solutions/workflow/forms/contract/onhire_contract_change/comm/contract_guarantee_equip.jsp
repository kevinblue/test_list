...
jQuery(function(){
	tenwa.createTable({
		...
		showPager: false,
		showToolbar: false,
		data: JsonUtil.decode('${empty json_old_contract_guarantee_equip_str ? "[]" : json_old_contract_guarantee_equip_str }'),
		columns: [
			{type: 'indexcolumn'},
			{type: 'checkcolumn'},
...
<div id="id_table_contract_guarantee_equip">
	<table cellspacing="0" cellpadding="0">
	    <tr>
	       <td class="x-panel-table-div-title">原抵质押物信息</td>
	    </tr>
	    <tr>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" >
	    <tr>
	       <td class="x-panel-table-div-title">现抵质押物信息</td>
	    </tr>
	    <tr>
