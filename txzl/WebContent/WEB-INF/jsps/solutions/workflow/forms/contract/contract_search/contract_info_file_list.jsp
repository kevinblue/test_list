   ...
   function reloadcustcontactfile(message){
    ...
    handler:function(miniTable, buttonText) {
       	  var uploadutil=new uploadUtil({
 			  url:'/leasing/file/uploadFile.action',modelname:'合同附件信息',
 			  title:'合同附件信息',
    ...
    },'-',
    {
  		...
  		jQuery(function() {	
  			seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) { 				
  				...
  				new ApTable({  					
  					...
  					showPager:true,
  					lazyLoad:false,
  					xmlFileName:"/eleasing/workflow/contract/contract_search/contract_info_file_list.xml",
  					showToolbar:showTools,
  					params:{filekey:id,modelname:'合同附件信息'},
  					tools:tools1,				
  					columns:[ 
  					    {type:'indexcolumn'},
  					    {type:'checkcolumn'}, 
  						    ...
  						    formEditorConfig:{
							    fieldVisible:false},
						            renderer:function(e){
						                 ...
						                 return "<a href='javascript:void(0);' onclick='downloadFileById(\"" + id + "\")'>下载 </a>"+"&nbsp&nbsp"+"<a href='javascript:void(0);' onclick='showFile3(\"" + id +"\",\""+filename+"\")'>预览</a>";
						}
						}
  					]
      ...
      function createAttachmentImageDiv3(appImage,filedict){
      	var $div = jQuery('<div/>');
      	if(appImage){
    ...
    //预览
      function showFile3(filedict,filename){
      	        ...
      	        success:function(res){
      			    ...
      			    if(datas && datas.length > 0){
      			    	...
      			    	jQuery.each(datas, function(index, appImage){
      			    		var img = createAttachmentImageDiv3(appImage,filedict);
      			    		if(img){
	...
	<div id="showfile3" class="mini-window" title="预览" showMaxButton="true"
