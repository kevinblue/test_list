		...
		<tr>
		 <td colspan="4">
		  <div  style="width:100%;">	
				<table cellspacing="0" cellpadding="0" width="100%" class="fillTable" id="contract_signatory_form_table">
					...
					<tr class="tr-lessor-info tr-even">
						...
						<td class="td-content" width="38%">
							<input id="contract_signatory_lessor" name="contract_signatory.lessor"  label="出租人"  class="mini-combobox" textField="raw_oid" valueField="raw_oid" dataField="datas" allowInput="false"
							data-options="{_xmlFileName:'/eleasing/jsp/sysmgr/sysdatamgr/owninfo_account.xml'}"  value="${requestScope['contract_signatory.lessor']}"
							text="${requestScope['contract_signatory.lessor']}"
							onvaluechanged="Lessorchange" onbeforeshowpopup="miniextonbeforeshowpopup"/>
						</td>
						
						<td class="td-content-title" width="12%">统一社会信用代码：</td>
						<td class="td-content" width="38%">
							<input require="true" label="注册号/统一社会信用代码" id="contract_signatory_orgCode" name="contract_signatory.orgcode" class="mini-textbox" value="${requestScope['contract_signatory.orgcode']}">
						</td>
					</tr>
					<tr class="tr-lessor-info tr-odd" id="hiddencontent1"  style="display: none">
					   
					   <td class="td-content-title" width="12%">法定代表人：</td>
						<td class="td-content" width="38%"><input require="true" label="法定代表人" id="contract_signatory_leaseperson" name="contract_signatory.leaseperson" class="mini-textbox" value="${requestScope['contract_signatory.leaseperson']}"></td>
					...
					<tr class="tr-lessor-info tr-even" id="hiddencontent2"  style="display: none">
					    <td class="td-content-title">联系地址：</td>
						<td class="td-content" colspan=3><input require="true" label="通讯地址" name="contract_signatory.leaseaddr" class="mini-textbox"  value="${requestScope['contract_signatory.leaseaddr']}" width="50%"></td>
					</tr>
					
					
					<tr class="tr-lessor-info tr-odd" id="hiddencontent3"  style="display: none">
					...
					<tr class="tr-lessor-info tr-even" id="hiddencontent4"  style="display: none">
					...
					<tr class="tr-lessor-info tr-odd" id="hiddencontent5"  style="display: none">
				...
				<div  align="center" ><a class="mini-button" name="moreContent" onclick="moreContent()">更多信息</a> <a class="mini-button" name="moreContent" onclick="closeMoreContent()">关闭</a></div>
			 </div>
			</td>
		</tr>
		<tr>
			<td colspan="4">
				<table cellspacing="0" cellpadding="0" width="100%" class="fillTable">
					...
					<tr class="tr-client-info tr-odd">
						<td class="td-content-title">开户账号：</td>
						<td class="td-content">
						<!-- mini-buttonedit mini-queryinput -->               
...
<script>
    function moreContent(){
    	$("#hiddencontent1").attr("style", "display:true;");
    	$("#hiddencontent2").attr("style", "display:true;");
    	$("#hiddencontent3").attr("style", "display:true;");
    	$("#hiddencontent4").attr("style", "display:true;");
    	$("#hiddencontent5").attr("style", "display:true;");
    	
    };
    function closeMoreContent(){
    	$("#hiddencontent1").attr("style", "display:none;");
    	$("#hiddencontent2").attr("style", "display:none;");
    	$("#hiddencontent3").attr("style", "display:none;");
    	$("#hiddencontent4").attr("style", "display:none;");
    	$("#hiddencontent5").attr("style", "display:none;");
    };
	...
	function addAccountNum(id,custclass){
		var params = "id="+id+"&isView=true"+"&accNumView=false";
	 	var url="";
	...
	function showcust(custid,custclass){
	...
	function Lessorchange(e){
		var selected = e.selected;
		mini.getbyName("contract_signatory.leaseperson").setValue(selected.leaseperson);//法定代表人
		mini.getbyName("contract_signatory.leaselinkman").setValue(selected.leaselinkman);//联系人
		mini.getbyName("contract_signatory.leaseaddr").setValue(selected.leaseaddr);//联系地址
		mini.getbyName("contract_signatory.leasetel").setValue(selected.leasetel);//电话
		mini.getbyName("contract_signatory.leasefax").setValue(selected.leasefax);//传真
		mini.getbyName("contract_signatory.leasepostcode").setValue(selected.leasepostcode);//邮编
		mini.getbyName("contract_signatory.orgcode").setValue(selected.orgcode);//注册号/统一社会信用代码
	}
							...
							{field:'sellername', header:'供应商', visible:true,
								   formEditorConfig:{
								       ...
								       renderer:function(e){
			          	            		...
			          	            		return "<a  style='text-decoration:underline;color:blue;'  onclick='showcust(\"" + rowData.seller +'"'+","+'"'+rowData.custclass+"\")'>" + rowData.sellername + "</a>";
			          		                } },
							...
							{field:'selleraccname', header:'开户户名',
								...
								fillFromFieldName:'selleraccnumber',
									 fillProperty:'account',
							   			 readonly:true,
							   			  newLine:true}},
				   			{field:'istotalcontractor', header:'是否为总承包方',
									 formEditorConfig:{
								   			  required:true,
								   			 type:'combobox',
								   			 valueField:'id',
