...
function workflowSubmitCallBack(buttonText)//返回true提交，返回false不提交 ，该回调函数可与用表单字段验证
{
	...
	miniui_ext.saveIncludeData("tabDetails");
	//miniui_ext.saveIncludeData("conditionDeatils");
	if (miniui_ext.submitFormValidation(["contrat_sign_info_form1","contract_sign_info_form"]) == false) return false;
...
<div id="contract_change_form">
	<div class="fillTableContainer"> 
		<table class="fillTable" cellspacing="0" cellpadding="0">
			<tr>
				<td >
				  <jsp:include page="contract_assets_base_info.jsp"><jsp:param value="true" name="isView"/></jsp:include>
			    </td>
			</tr>
		</table>
	</div>
	<div id="tabDetails" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;" bodyStyle="border:0px;">
		<div title="现场签约情况报告" class="mini-panel" name="assets_sign_report_info_tab" style="width: 100%;" id="assetssignreportinfotab" iconCls="icon-node">
			<jsp:include page="../contract_comm/sign_info.jsp" ></jsp:include>
			<jsp:include page="../contract_assets_sign_report/asset_sign_report_info.jsp" ></jsp:include>
		</div>
		<%-- <div title="资产签约报告" name="assets_sign_word" iconCls="icon-node">
			<jsp:include page="../contract_assets_sign_report/assets_sign_report_list.jsp" ></jsp:include>
		</div> --%>
		...
		<%-- <div title="商务条件" name="business_condition" iconCls="icon-node" style="display: none">
		...
		<%-- <div title="租金开票类型" name="rentInvoiceType" iconCls="icon-node">
	     ...
	     <%-- <div title="资产签约信息" name="signInfo" iconCls="icon-node">
			<jsp:include page="../contract_comm/sign_info.jsp" ></jsp:include>
		</div>  --%>
