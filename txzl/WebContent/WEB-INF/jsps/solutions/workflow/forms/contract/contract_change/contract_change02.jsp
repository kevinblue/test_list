...
<div id="contract_change_form">
	...
	<div id="tabDetails" class="mini-tabs" activeIndex="0"  onactivechanged="changTab"  style="width: 100%;">
		...
		<div title="租赁物明细" name="contract_equip_detail" iconCls="icon-node">
			<jsp:include page="../contract_change/contract_equip_detail_tmp.jsp" >
		...
		<div title="担保单位信息" name="contract_guarantee_method" iconCls="icon-node">
			<jsp:include page="../contract_change/contract_guarantee_method_tmp.jsp" >
			   <jsp:param value="true" name="isView"/>
			</jsp:include>
		</div>
		...
		<div title="相关合同" name="contract_word" iconCls="icon-node">
			<jsp:include page="../contract_comm/contract_word_change_numset_read.jsp" >
			      <jsp:param value="true" name="isView"/>
			</jsp:include>
		</div>
	</div>
