	...
	tenwa.createTable({
		...
		tools: [{
			...
			handler: function(miniTable, buttonText){
				...
				if(row){
					var attachmentParams = "contract_id="+row.id+"&contract_status="+row.contract_status;
					startProcess("合同签约流程-1",attachmentParams); 
				}else{
		...
		columns: [
			...
			{field: 'contract_status', header: '合同状态',visible: false},
