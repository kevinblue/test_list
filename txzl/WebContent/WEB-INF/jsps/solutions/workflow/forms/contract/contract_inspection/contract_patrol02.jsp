...
<div id="contract_patrol_form" title="租后巡视">
	...
	<div id="tabDetails" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;">
		...
		<div title="重点关注事项" name="risk_info_list" iconCls="icon-node">
			<jsp:include page="comm/risk_info_list.jsp" ><jsp:param value="true" name="isView"/></jsp:include>
		</div>
		
		<div title="本次检查评估结论" name="curpatrol_info_list" iconCls="icon-node">
			<jsp:include page="comm/curpatrol_info_list.jsp" ><jsp:param value="true" name="isView"/></jsp:include>
		</div>
		<div title="其他文件" name="proj_accessories_report_list" iconCls="icon-cut">
			<jsp:include page="comm/proj_other_report_list.jsp"></jsp:include>
		</div>
		<div title="生成租后检查报告" name="create_report_list" iconCls="icon-node">
			<jsp:include page="../../../../report/windfarmreport/generate_wind_farm_upfile.jsp" >
