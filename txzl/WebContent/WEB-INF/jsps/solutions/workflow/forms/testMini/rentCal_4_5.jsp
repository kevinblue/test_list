...
jQuery(function(){
	...
	var projtypeV = "${requestScope['proj_info.projtype']}";
	...
	var provinceV = "${requestScope['proj_info.province']}";
	var cityV = "${requestScope['proj_info.city']}";
	var countyV = "${requestScope['proj_info.county']}";
	...
	var projcustV = "${requestScope['proj_info.projcust']}";
	...
	<div class="mini-panel" title="合同信息" showCollapseButton="true" style="width: 100%;">
		<table class="fillTable" cellspacing="0" cellpadding="0">
			<tr class="tr-odd">
				...
				<td class="td-content"><input id="projname" name="proj_info.projname" value="${requestScope['proj_info.projname'] }" class="mini-textbox" style="width:165px;" emptyText="请输入项目名称"/></td>
				<td class="td-content-title">签约时间:</td>
				<td class="td-content"><div id="startdate" name="proj_info.startdate" value="${requestScope['proj_info.startdate'] }" class="mini-datepicker" style="width:165px;" value="2011-12-11" ></div></td>
			</tr>
			<tr class="tr-even">
				<td class="td-content-title">项目类型:</td>
				<td class="td-content"><input id="projtype" name="proj_info.projtype" value="${requestScope['proj_info.projtype'] }" class="mini-combobox" style="width:165px;" textField="name" valueField="code" showNullItem="true" allowInput="true"/></td>
				<td class="td-content-title">所在省份:</td>
				<td class="td-content"><input id="province" name="proj_info.province" value="${requestScope['proj_info.province'] }" class="mini-combobox" style="width:165px;" textField="name" valueField="id" showNullItem="true" allowInput="false"/></td>
			</tr>
			<tr class="tr-odd">
				<td class="td-content-title">所在市:</td>
				<td class="td-content"><input id="city" name="proj_info.city" value="${requestScope['proj_info.city'] }" class="mini-combobox" style="width:165px;" textField="name" valueField="id" showNullItem="true" allowInput="false"/></td>
				<td class="td-content-title">所在县:</td>
				<td class="td-content"><input id="county" name="proj_info.county" value="${requestScope['proj_info.county'] }" class="mini-combobox" style="width:165px;" textField="name" valueField="id" showNullItem="true" allowInput="false"/></td>
			</tr>
		</table>
	</div>
	<div class="mini-panel" title="承租人信息" showCollapseButton="true" style="width: 100%;">
		<table class="fillTable" cellspacing="0" cellpadding="0">
			<tr class="tr-odd">
				...
				<td class="td-content">
					<div id="projcust" name="proj_info.projcust" value="${requestScope['proj_info.projcust']}" class="mini-combobox" style="width:165px;" popupWidth="200" textField="realname" valueField="id" multiSelect="false">     
				...
				<td class="td-content"><input id="equipcount" name="proj_info.equipcount" value="${requestScope['proj_info.equipcount']}" class="mini-spinner" style="width:165px;" minValue="200" maxValue="250" increment="5"/></td>
			</tr>
			<tr class="tr-even">
				<td class="td-content-title">联系电话:</td>
				<td class="td-content"><input id="telphone" name="proj_info.telphone" value="${requestScope['proj_info.telphone']}" class="mini-textbox" style="width:165px;" emptyText="请输入联系电话"/></td>
				<td class="td-content-title">联系地址:</td>
				<td class="td-content"><input id="address" name="proj_info.address" value="${requestScope['proj_info.address']}" class="mini-textbox" style="width:165px;" emptyText="请输入联系地址"/></td>
			</tr>
		</table>
	</div>
