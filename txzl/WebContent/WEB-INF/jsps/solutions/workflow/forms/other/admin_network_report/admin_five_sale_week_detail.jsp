...
<script type="text/javascript">
	...
	jQuery(function() {		
		tenwa.createTable({
					id : "work_week_report4",
					renderTo : "id_table_work_week_report4",
					...
					xmlFileName : '/eleasing/jsp/other/get_admin_sale_week_report_detail_list4.xml',
					params:{projstatus:'新增',startdate:"${requestScope['startdate']}",registerid:"${requestScope['registerid']}",saleweekid:"${requestScope['saleweekid']}"},
					columns : [
							{type : 'indexcolumn'},
							/* {type : 'checkcolumn'}, */							
							...
							{field: 'projname', header:'项目名称', visible: true,
						          formEditorConfig:{
						        	  fieldVisible: false
						        	  }},
							{field: 'proj',header: '项目名称',visible: false,formEditorConfig: {
								...
								onSelect:function($me, inputObj, rowData){
									getMiniEditFormField("work_week_report4.projnumber").setValue(rowData.projid);
									getMiniEditFormField("work_week_report4.projmoney").setValue(rowData.equipamt);
									getMiniEditFormField("work_week_report4.area").setValue(rowData.areaname);
									getMiniEditFormField("work_week_report4.projname").setValue(rowData.projname);
								},
								params : {
							...
							{field : 'projmoney',header : '项目金额',summary:true,
								formEditorConfig:{
									newLine:true,
									readOnly:true,
								}
							...
							onupdate:function(){
								var data = mini.get("work_week_report4").getData();
								var len = data.length;
								$("#id_table_work_week_report4").height(150+len*20);									
								mini.get("id_panelContainer_work_week_report4").doLayout();
							}
				});
	});	
...
<body>
	<div id="id_table_work_week_report4"></div>
