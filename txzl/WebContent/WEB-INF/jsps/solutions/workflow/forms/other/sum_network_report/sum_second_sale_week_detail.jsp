...
<script type="text/javascript">
	...
	jQuery(function() {		
		tenwa.createTable({
					...
					xmlFileName : '/eleasing/jsp/other/get_sum_sale_week_report_detail_list1.xml',
					...
					columns : [
							...
							{field: 'contractidname', header:'项目名称', visible: true,align:'center',width:'150',
						          formEditorConfig:{
						        	  fieldVisible: false
							          }},
							...
							{field : 'projnumber',header : '业务合同编号',align:'center',
								formEditorConfig:{
									readOnly:true,
								}
							},  
							{field : 'projmoney',header : '合同金额',summary:true,align:'right',width:'80',
								formEditorConfig:{
									newLine:true,
									readOnly:true,
								}
							...
							onupdate:function(){
									var data = mini.get("work_week_report1").getData();
									var len = data.length;
									//console.info(data);
									$("#id_table_work_week_report1").height(150+len*20);
									mini.get("id_panelContainer_work_week_report1").doLayout();
								} 
				});
	});	
