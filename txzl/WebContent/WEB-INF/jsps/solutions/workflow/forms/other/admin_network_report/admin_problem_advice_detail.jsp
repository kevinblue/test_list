...
<script type="text/javascript">
	...
	jQuery(function() {		
		tenwa.createTable({
					...
					xmlFileName : '/eleasing/jsp/other/get_admin_problem_advice_detail_list.xml',
					...
					columns : [							
							...
							onupdate:function(){
								var data = mini.get("work_week_report7").getData();
								var len = data.length;
								$("#id_table_work_week_report7").height(150+len*20);									
								mini.get("id_panelContainer_work_week_report7").doLayout();
							}
				});
	});	
