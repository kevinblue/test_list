...
<script type="text/javascript">
	...
	jQuery(function() {		
		tenwa.createTable({
					...
					xmlFileName : '/eleasing/jsp/other/get_sum_channel_administration_detail_list.xml',
					...
					columns : [
							...
							{field : 'area',header : '区域',align:'center',width:'30',
								formEditorConfig:{
									type:'text'
								}
							},
							
							{field : 'company',header : '公司',align:'center',
								formEditorConfig:{
									type:'text'
								}
							},
							{field : 'name',header : '姓名',align:'center',
								formEditorConfig:{
									type:'text',
									newLine:true,
								}
							},
							{field : 'contactinformation',header : '联系方式',align:'center',
								formEditorConfig:{
									type:'text'
								}
							},
							...
							onupdate:function(){
								...
								var len = data.length;
								$("#id_table_work_week_report6").height(130+len*20);
