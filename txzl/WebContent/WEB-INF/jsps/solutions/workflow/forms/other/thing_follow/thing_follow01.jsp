...
<div id="contract_finish_form">
	<div class="fillTableContainer">
		<table class="fillTable" cellspacing="0" cellpadding="0">
			<tr>
				...
				<jsp:include page="../../contract/contract_inspection/contract_patrol_info.jsp"><jsp:param value="true" name="isView"/></jsp:include>
				</td>
			</tr>
		</table>
	</div>
	<%-- <div class="fillTableContainer">
		<div title="信息详情" name="thing_approve_detail" iconCls="icon-node">
			<jsp:include page="../thing_approve/thing_approve_addcolumn.jsp"></jsp:include>
		</div>
	</div> --%>
	<div id="tabDetails" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;">
		<div title="存续项目" name="accident_subsist_project" iconCls="icon-node">
			<jsp:include page="accident_subsist_list01.jsp"></jsp:include>
		</div>
		<div title="信息详情" name="thing_follow_detail" iconCls="icon-node">
			<jsp:include page="thing_follow_detail.jsp"></jsp:include>
		</div>
