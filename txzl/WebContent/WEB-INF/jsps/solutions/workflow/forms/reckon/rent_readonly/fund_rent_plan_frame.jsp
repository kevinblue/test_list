			...
			columns:[
				...
				{field:'interest', header:'财务利息',dataType :"currency",summary :true,align:'right',
					      formEditorConfig:{
						        ...
						        labelWidth:100,
						             width:200}},
				{field:'corpusbusiness', header:'业务本金',dataType :"currency",summary :true,align:'right',visible:false,
					      formEditorConfig:{
						          required:true,
						        labelWidth:100,
						             width:200}},
				{field:'interestbusiness', header:'业务利息',dataType :"currency",summary :true,align:'right',visible:false,
					      formEditorConfig:{
						          required:true,
						        labelWidth:100,	
						             width:200}},
