...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	 <div id="businessconditionForm">
			...
			<div class="mini-panel" title="租金推算方式" showCollapseButton="true" style="width: 100%;">
			    <table class="fillTable" cellspacing="0" cellpadding="0" id="proj_base_info" >
			     <tr class="tr-project-info tr-even">
			          ...
			          <tr class="tr-project-info tr-odd">
			              <td class="td-content-title">宽限期(月)：</td>
			...
			<tr class="tr-project-info tr-even">
			              ...
			              <td class="td-content"><input name="ratefloatamtbefore" id ="ratefloatamtbefore"  class="mini-textbox" value="${empty requestScope['ratefloatamtbefore'] ? 0 : requestScope['ratefloatamtbefore'] }"   vtype="rate"></td>
			              ...
			              <td class="td-content"><input name="yearratebefore" id ="yearratebefore"  vtype="double"   class="mini-textbox" value="${empty requestScope['yearratebefore'] ? 0 : requestScope['yearratebefore'] }"  ></td>
			             </tr>
			             <%-- <tr class="tr-project-info tr-odd">
...
<%-- 				<td class="td-content-title">还租频率：</td>
 ...
 function changeDate(e){	
			...
			$mini("startdate").setValue(DateUtil.dateAdd('m',3,sender.value));	//起租日默认为付款日之后三个月		
 }
 </script>