...
jQuery(function(){
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			id: "fund_cash_flow_new",
			renderTo: "id_fund_cash_plan_frame_compare",
			...
			showPager: false,
			multiSelect: true,
			data: mini.decode('${empty json_fund_cash_flow_new_str ? "[]" : json_fund_cash_flow_new_str	 }'),
			columns: [
				{type:'indexcolumn'},
				{type:'checkcolumn'},
...
<div id="id_fund_cash_plan_frame_compare"></div>