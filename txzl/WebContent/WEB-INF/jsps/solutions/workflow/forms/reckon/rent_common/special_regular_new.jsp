		...
		new ApTable({
			...
			afterShowWindowCallBack: function(miniTable,miniForm,operFlag){
				if("add" == operFlag){
					...
					var ratefloattype=getMiniEditFormField("special_regular.ratefloattype");//利率计算方式
					...
					var regular_incomenumberyear = getMiniEditFormField('special_regular.regularincomenumberyear');//支付频率
