	...
	tenwa.createTable({
		...
		tools: [{
			...
			handler: function(miniTable, buttonText){
				...
				selectedDatas = miniTable.getSelecteds();
				if(selectedDatas.length == 0){
					mini.alert("请先选择要生成罚息通知书的租金计划！");
					return false;			
				}else{
					return selectedDatas;
				}
		  }}],
		data: JsonUtil.decode('${empty json_rentandfund_income_plan_str ? "[]" : json_rentandfund_income_plan_str }'),
		columns: [
			...
			{field: 'rent', header: '计划租金/资金',type:'double',summary : true,dataType : "currency"},
			...
			{field: 'currentoverage', header: '租金/资金余额',type:'double',summary : true,dataType : "currency"},
