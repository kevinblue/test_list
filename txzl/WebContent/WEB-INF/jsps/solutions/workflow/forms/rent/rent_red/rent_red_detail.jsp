...
jQuery(function(){
	...
	tenwa.createTable({
		...
		columns: [
				...
				{field: 'ownbank', header: '本方银行',width:150,formEditorConfig:{newLine:true,readOnly:true}},
				{field: 'ownaccount', header: '本方银行账户',width:150,formEditorConfig:{readOnly:true}},
				{field: 'ownnumber', header: '本方银行账号',width:150,formEditorConfig:{newLine:true,readOnly:true}},
				{field: 'hireobject', header: '付款人',width:150,formEditorConfig:{readOnly:true}},
				{field: 'hirebank', header: '对方银行',width:150,formEditorConfig:{newLine:true,readOnly:true}},
				{field: 'hireaccout', header: '对方银行账户',width:150,formEditorConfig:{readOnly:true}},
				{field: 'hirenumbr', header: '对方银行账号',width:150,formEditorConfig:{newLine:true,readOnly:true,colspan:3}},
