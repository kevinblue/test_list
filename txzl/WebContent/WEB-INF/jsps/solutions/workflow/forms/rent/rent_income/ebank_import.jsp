		...
		<input name="fund_ebank_data.id" id="fund_ebank_data.id" class="mini-hidden" value="${requestScope['fund_ebank_data.id']}" />
			<table class="fillTable" cellspacing="0" cellpadding="0" id="ebank_import_table">
				...
				<tr class="tr-odd">
					...
					<td class="td-content"><input id="fund_ebank_data.clientbank" name="fund_ebank_data.clientbank" class="mini-textbox" readOnly type="text" value="${requestScope['fund_ebank_data.clientbank']}"></td>
					<td class="td-content-title">对方账户：</td>
					<td class="td-content"><input id="fund_ebank_data.clientaccount" name="fund_ebank_data.clientaccount" class="mini-textbox" type="text" value="${requestScope['fund_ebank_data.clientaccount']}" /></td>
