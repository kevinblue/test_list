...
jQuery(function() {
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			new ApTable({
				...
				showPager:true,				
				xmlFileName:'/eleasing/workflow/proj/proj_account_rece/transfer_receivables.xml',
				tools:[
					{html:'应收账款反转让',
					 plain:true,
				...
				columns:[ 
					...
					{field:'price',header:'应收账款总额',queryConfig:{newLine:false}},
 	...
 	function showDetail(id) {
		var url = getRootPath()
			+ "/acl/showTransferReceivables.acl?contractid="
			+ id + "&opertype=view";
