...
jQuery(function(){
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			...
			new ApTable({
				...
				showPager:true,
				xmlFileName : 'eleasing/workflow/factoring/factoring_red/factoring_saler_receipt_redout_open.xml',
				tools : toolsArray,
				remoteOper : false,
				columns : [ 
				    {type : 'indexcolumn'},
					...
					{field : 'contractnumber',header : '业务合同号号',headerAlign : 'center',queryConfig : {},formEditorConfig : { }},
...
var toolsArray =[
					{
						...
						handler : function(miniTable, buttonText) 
						{
							...
							if (null != row) {
								...
								startProcess("保理卖方收款红冲流程-1",attachmentParams); 
							}else {
						        mini.alert("请选中一条记录");
						    }
						}
