...
jQuery(function() {
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			xmlFileName:'eleasing/workflow/factoring/factoring_reminder/factoring_reminder_letter_list.xml',
			params:{},
			columns:[
				   {type:'indexcolumn'},
				   {type:'checkcolumn'},
				   {field:'id',header:'id',headerAlign:'center',width:100,allowSort:false,visible:false
		            },
				   ...
				   {field:'rawvalue_partdept',header:'催款员',headerAlign:'center',
				             queryConfig:{
					               width:200}},
				   {field:'senddate',header:'最后一次发送日期',headerAlign:'center',width:120,allowSort:true,
				             queryConfig:{
					          labelWidth:120,
					             newLine:false,
					               width:100,
