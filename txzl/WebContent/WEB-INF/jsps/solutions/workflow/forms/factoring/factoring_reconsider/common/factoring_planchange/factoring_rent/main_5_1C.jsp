...
<div class="fillTableContainer" id="reckonContainer">
	<table class="fillTable" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan=4>
				<jsp:include page="condition_frame_5_1C.jsp"></jsp:include>
		</td>
	</tr>
		<tr>
			 <td colspan=4>
				<div class="mini-panel" title="保理收款计划" showCollapseButton="true" style="width: 100%;">
				  	 <div id="conditionDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab"  style="width: 100%;" bodyStyle="padding:0;border:0;">
					  	<div title="保理明细" name="fund_rent_plan" iconCls="icon-cut" >
							 <jsp:include page="fund_rent_plan_frame_C.jsp" ></jsp:include>
						</div>  
						 <div title="现金流" name="fund_cash_flow" iconCls="icon-cut">
							<jsp:include page="fund_cash_plan_frame_C.jsp" ></jsp:include>
						</div>
						<div title="资金收付计划" name="fund_fund_charge" iconCls="icon-cut">
							<jsp:include page="fund_fund_plan_C.jsp" ></jsp:include>
						</div> 
					</div>
				</div>
			</td> 
