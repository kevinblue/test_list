   ...
   jQuery(function(){
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable){ 
			...
			new ApTable({
				...
				tools: tools,//添加对象
				remoteOper :true,
				xmlFileName:"/eleasing/workflow/factoring/factoring_contract_search/factoring_contract_query.xml",
				columns:[
			         ...
			         {field:'contractid', header:'合同编号',width:120,renderer:function(e){
			          		                ...
			          		                return str;}},			     
			         {field:'cleanleasemoney',dataType:"currency",header:'融资金额',align:"right",visible:false},
					...
					{field:'districtname',header:'区域',allowSort:true,width:80,
					         /*    queryConfig:{
							     ...
							     formEditorConfig:{
								     fieldVisible:false }},
					{field:'industrytypename',header:'内部行业',width:80, visible:false,
				    ...
				    {field:'advancebilling',header:'是否提前开票', visible:false,
				            	/* 	  queryConfig:{
				            			  newLine:true,
							              type:'combobox', 
							       multiSelect:false, 
				   ...
				   {field:'zdnet',header:'是否登记中登网', visible:true,
				    ...
				    {field:'registerdate',header:'中登网登记时间'},       	  
                  	{field:'actualstartdate',header:'实际起租日',width:100, visible:false},
 		           ...
 		           {field:'projimpotername',header:'项目导入人',visible:false},
		            {field:'projregistrarname',header:'信审经办',visible:false},
 		            {field:'projdeptname',header:'业务部'},
 		          
				   {field:'seller',header:'供应商(用","分隔)',visible:false,queryConfig:{ newLine:false},
				                	  renderer:function(e){
			 					   	      var row=e.record;
	...
	{
		var url = getRootPath()+"/acl/queryFactoringContractInfoDetail.acl?contractid="+cid;
		openFullScreenWindow(url);
	}
...
<div id="id_win_add_signdate" class="mini-window" title="维护签约日期" style="width:400px;height:100px;"   showModal="true" allowResize="true" allowDrag="true">
	...
	<div id="id_win_add_advancebilling" class="mini-window" title="维护是否提前开票" style="width:550px;height:100px;"   showModal="true" allowResize="true" allowDrag="true">
     ...
     <div id="id_win_add_zdnet" class="mini-window" title="维护是否登记中登网" style="width:30%;height:30%;" showModal="true" allowResize="true" allowDrag="true">
        <div id="id_div_distri_manager">
            <table class="miniext-form-table">
                <tr>
