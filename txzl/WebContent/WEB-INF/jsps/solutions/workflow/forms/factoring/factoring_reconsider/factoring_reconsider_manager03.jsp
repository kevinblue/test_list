...
<script type="text/javascript">
	...
	{	
		var result=miniui_ext.get("proj_info.projstatus");
		if (miniui_ext.submitFormValidation(["proj_factoring_base_info_form"]) == false||miniui_ext.submitFormValidation(["credit_result_form"])==false) {return false};
        miniui_ext.saveIncludeData("tabApprovalDeatils");
      //保存投票信息
...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;" bodyStyle="border:0px;">
	...
	<div title="信审信息" name="credit_message" iconCls="icon-cut">
		<jsp:include page="../factoring_credit/common/credit_result.jsp"></jsp:include>
	</div>
