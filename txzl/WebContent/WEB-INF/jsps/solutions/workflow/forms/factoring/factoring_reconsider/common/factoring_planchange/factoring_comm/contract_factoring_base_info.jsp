    ...
    <div class="mini-panel" title="保理合同基本信息" showCollapseButton="true" style="width: 100%;">
	    <table class="fillTable" cellspacing="0" cellpadding="0" id="contract_base_info" >
	          <tr class="tr-even">
				...
				<td class="td-content" width="38%"><input name="contract_info.proj_id" id="project_id" class="mini-textbox" label="项目编号"  type="text" value="${requestScope['contract_info.proj_id']}"></td>
				<td class="td-content-title" width="12%">项目启动时间：</td>
				<td class="td-content" width="38%"><input name="contract_info.proj_date" id="proj_date" class="mini-textbox" label="项目启动时间"  type="text" value="${requestScope['contract_info.projdate']}"></td>
			</tr>
			<tr class="tr-odd">
	          ...
	          <tr class="tr-project-info tr-odd">  
	             ...
	             <td class="td-content" colspan=3><input style="width:50%" id="cust_name" name="contract_info.custname" class="mini-textbox" readOnly require="true" label="供应商名称"  type="text" value="${requestScope['contract_info.custname'] }" >
	                     ...
	                     onclick="opencustdetail('${requestScope['contract_info.custInfo'] }','${requestScope['contract_info.custclass'] }')"/></a></td>
	         </tr>
	          <tr class="tr-project-info tr-even">
	             <td class="td-content-title">项目名称：</td>
	             <td class="td-content" colspan=3><input style="width:50%" name="contract_info.projectname" id="projectname"  required="true" label="项目名称" class="mini-textbox"  type="text" value="${requestScope['contract_info.projectname']}"></td>
	          </tr>	         
	   <tr class="tr-project-info tr-odd">
		           <td class="td-content-title">项目类型：</td>
	             <td class="td-content">
				 <input name="contract_info.projtype" label="项目类型" class="mini-combobox" textField="name"  required="true"
	             ...
	             <td class="td-content">
			             <input name="contract_info.projsource" class="mini-combobox" label="项目来源" textField="name"  required="true"
				                  	   valueField="value"  
									   dataField="datas"
									   allowInput="false" 
	           ...
	           <tr class="tr-project-info tr-even">
	               ...
	               <td class="td-content">
				    <input name="contract_info.transferdate" id="transferdate" label="应收账款转让通知时间" class="mini-combobox" textField="name"  required="true"
				                  	   valueField="value"    dataField="datas" allowInput="false"  
		          ...
		          <td class="td-content-title">买方付款方式：</td>
	                <td class="td-content">
			             <input name="contract_info.paymentway" id="contract_info.paymentway" class="mini-combobox" label="买方付款方式" textField="name"  required="true"
				                  	   valueField="value"  
									   dataField="datas"
									   allowInput="false" 
	          ...
	          <tr class="tr-project-info tr-odd" id="id_tr_factoring" >
	             ...
	             <td class="td-content">
		             <input name="contract_info.factoringtype" id="factoringtype" label="保理类型" class="mini-combobox" textField="name"  required="true"
			                  	   valueField="value"  
								   dataField="datas"
								   allowInput="false" 
	         ...
	         <td class="td-content-title" >供应商在金风融资的</br>总比例(含本次保理融资)：</td>
	             ...
	             <input style="width:50%;height:50px" label="其它情况说明" name="contract_info.proportion" value="${requestScope['contract_info.proportion'] }" class="mini-textarea"  type="text" >  </td>
	        
	        
	             <td class="td-content-title">其它情况说明：</td>
	             <td  style="padding-top: 5px;padding-bottom: 5px;"><input style="width:50%;height:50px" label="其它情况说明" name="contract_info.equipinfo" value="${requestScope['contract_info.equipinfo'] }" class="mini-textarea"  type="text" >  </td>
	       </tr>
