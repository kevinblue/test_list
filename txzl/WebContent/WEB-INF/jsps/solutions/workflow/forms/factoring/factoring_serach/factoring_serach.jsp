...
<body style="overflow:hidden;"> 
   ...
   jQuery(function(){
		seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
			var statusnamedate=[{id:'项目立项',text:'项目立项'},{id:'立项否决',text:'立项否决'},{id:'项目信审(审批通过)',text:'项目信审(审批通过)'},{id:'项目复议',text:'项目复议'},{id:'项目否决',text:'项目否决'},{id:'项目撤销',text:'项目撤销'}];
			...
			new ApTable({
				...
				remoteOper :true,
				loadMode:'ajax',
				xmlFileName:"/eleasing/workflow/factoring/factoring_search/factoring_query.xml",
				tools :tools,
				columns:[
