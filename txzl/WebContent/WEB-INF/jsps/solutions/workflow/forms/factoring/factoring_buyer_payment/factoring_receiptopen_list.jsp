...
jQuery(function(){
	...
	/* 	params:{ismaymoney:'and cp.currentoverage>0'},
		...
		columns: [
			...
			{field: 'cust_name', header: '保理申请人',queryConfig:{width: 165,newLine: false}},
			{field: 'industry_type', visible: false,header: '内部行业'},
	...
	tenwa.createTable({
		...
		columns: [
			...
			{field : 'custidname',header : '承租人名称',visible:false,queryConfig : {colspan:3}},
