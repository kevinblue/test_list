...
jQuery(function(){
	...
	tenwa.createTable({
		...
		data: JsonUtil.decode('${empty json_rent_red_detail_str ? "[]" : json_rent_red_detail_str }'),
		tools: ['edit', '-', {
			html: '撤销',
			plain: true,
			iconCls: 'icon-ok',
		...
		columns: [
				...
				{field: 'rent', header: '回笼债权总额',summary : true,dataType : "currency",formEditorConfig:{newLine:true,readOnly:true}},
				{field: 'corpus', header: '回笼应收账款',summary : true,dataType : "currency",formEditorConfig:{readOnly:true}},
				{field: 'interest', header: '回笼保理收入',summary : true,dataType : "currency",formEditorConfig:{newLine:true,readOnly:true}},
				{field: 'penalty', header: '回笼罚息',summary : true,dataType : "currency",formEditorConfig:{readOnly:true}},
				{field: 'rentadjust', header: '债权调整',summary : true,dataType : "currency",formEditorConfig:{newLine:true,readOnly:true}},
				{field: 'corpusadjust', header: '应收账款调整',summary : true,visible:false,dataType : "currency"},
				{field: 'interestadjust', header: '保理收入调整',summary : true,dataType : "currency",formEditorConfig:{readOnly:true}},
