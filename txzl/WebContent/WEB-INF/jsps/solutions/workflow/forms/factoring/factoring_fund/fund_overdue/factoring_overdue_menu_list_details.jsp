	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			columns : [ 
					 ...
					 {field:'assurorname',header:'担保人',headerAlign:'center',width:100,allowSort:true,visible:false},
					 {field:'personrep',header:'法人代表',headerAlign:'center',width:100,allowSort:true,visible:false},
					 {field:'moblie',header:'联系方式',headerAlign:'center',width:100,allowSort:true,width: 200,visible:false},
					 ...
					 {field:'incrent',header:'逾期租金',headerAlign:'center',width:100,allowSort:true,visible:false},
					 {field:'penalty',header:'逾期罚息',headerAlign:'center',width:100,allowSort:true},
					 {field:'incomenumber',header:'总期数',headerAlign:'center',width:100,allowSort:true,visible:false},
					 {field:'startdate',header:'起租日',headerAlign:'center',width:100,allowSort:true,visible:false},
					 {field:'clientaddress',header:'承租人邮寄地址',headerAlign:'center',width:100,allowSort:true},
					 {field:'custactualpeople',header:'实际负责人',headerAlign:'center',width:100,allowSort:true,visible:false} 
					]
		});
	});
});
