...
<div class="fillTableContainer">
   <table class="fillTable" cellspacing="0" cellpadding="0">
	  <tr>
	     <td colspan=4>
			 <!-- 插入合同基本信息 --> 
				<!-- 插入合同基本信息 --><jsp:include page="../factoring_comm/contract_factoring_base_info.jsp"><jsp:param value="true" name="isView"/></jsp:include>
		 </td>
	   </tr>
...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%" bodyStyle="padding:0;border:0;">
	<div title="资金历史明细" name="collection_his" iconCls="icon-expand">
	     <jsp:include page="factoring_collection_his_info.jsp" >  <jsp:param value="true" name="isView"/></jsp:include>
	</div>
	<div title="资金付款明细" name="pay_his" iconCls="icon-expand">
	     <jsp:include page="factoring_pay_his_info.jsp" >  <jsp:param value="true" name="isView"/></jsp:include>
	</div>
	<div title="本次红冲明细" name="redout_current" iconCls="icon-expand">
	     <jsp:include page="factoring_redout_current_info.jsp" >  <jsp:param value="true" name="isView"/></jsp:include>
	</div>
