		...
		new ApTable({
			...
			afterShowWindowCallBack: function(miniTable,miniForm,operFlag){
				if("edit" == operFlag){
				 ...
				 if("add" == operFlag){
						$.ajax({
					        url: urlPrefix+"/eleasing/workflow/factoring/fund_overdue/factoring_get_contract_list_by_custid.xml",
					        type: "post",
					        cache: false, 
					        async:false,
					        data :{"custid":custid},
			...
			showPager:true,
			lazyLoad:false,		
			xmlFileName:'/eleasing/workflow/factoring/fund_overdue/factoring_overdue_dunning_record.xml',
			...
			columns:[
                   ...
                   {field:'id',header:'记录编号',headerAlign:'center',width:100,allowSort:true,visible:false,
					...
					{field:'partdept',header:'催收人员',headerAlign:'center',width:100,visible:false,
							formEditorConfig:{
									type:'text',
									fieldVisible:true,
									width:200,
			       ...
			       {field: 'contractnumber', header: '业务合同号', visible: true,
				           formEditorConfig:{
					           fieldVisible:false}},
			       {field: 'contractid', header: '业务合同号', visible: false,
				           formEditorConfig:{
				        	   type:'text',
				        	   newLine:true,
					                required:true,
				   ...
				   {field:'contactway',header:'联系方式',visible:false,headerAlign:'center',width:100,allowSort:true,
					...
					{field:'nextcommitmentdate',header:'下次联系日期',headerAlign:'center',width:100,dateFormat:"yyyy-MM-dd",
					 ...
					 {field:'introduce',header:'说明',headerAlign:'center',width:100,allowSort:true,
			            formEditorConfig:{
			            	newLine:true,
				                 colspan:3,
				                    type:'textarea',
        ...
        url="${urlPrefix}/eleasing/jsp/fund/fund_overdue/get_contract_list_by_custid.xml&custid=<%=custid %>"  idField="id"
           ...
           dataField="datas" showColumnsMenu="true" multiSelect="true">
            <div property="columns">
                ...
                <div field="rawValue_partdept" width="200" headerAlign="center" allowSort="true">催款员</div>
            </div>
        </div>  
       </div>
</div>
