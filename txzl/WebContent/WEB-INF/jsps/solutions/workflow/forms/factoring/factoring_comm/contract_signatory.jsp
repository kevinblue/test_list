			...
			<td colspan="4">
				<table cellspacing="0" cellpadding="0" width="100%" class="fillTable">
					...
					<tr class="tr-client-info tr-even">
						...
						<td class="td-content"><input require="true" label="行号" id="contract_signatory_bankno" name="contract_signatory.bankno" readOnly class="mini-textbox" value="${requestScope['contract_signatory.bankno']}"></td>
					</tr>
				</table>
			</td>
		</tr>
