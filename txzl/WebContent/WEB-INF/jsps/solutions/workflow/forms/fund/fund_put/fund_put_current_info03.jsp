...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		...
		removeOperCallBack:function(miniTable, rowDatas){
			  ...
			  /*  guarantable=typeof(mini.get("rent_income_detail"))=="undefined"? [] :mini.get("rent_income_detail");
		...
		columns: [
			...
			{field: 'factdate', header: '投放日期',formEditorConfig:{newLine:true,type:'date',required: true}},
		...
		{field:'accountbank',header:'本方银行',formEditorConfig: {readonly:true}},
