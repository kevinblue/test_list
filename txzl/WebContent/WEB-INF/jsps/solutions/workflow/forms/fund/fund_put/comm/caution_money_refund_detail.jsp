	...
	tenwa.createTable({
		...
		removeOperCallBack:function(miniTable, rowDatas){
		      for(j=0;j<rowDatas.length;j++){
                var pid=rowDatas[j].fundfundchargeplan;
                var guarantable=mini.get("put_current");
		...
		columns: [
					...
					{field: 'comparemoney', header: '比较金额', visible: true,formEditorConfig:{readOnly : true}}, 
					...
					{field: 'fundtypename', header: '类型',visible: false,formEditorConfig:{readOnly : true}},
