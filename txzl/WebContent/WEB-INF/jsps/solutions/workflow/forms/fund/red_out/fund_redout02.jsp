...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%" bodyStyle="padding:0;border:0;">
	<div title="资金历史明细" name="collection_his" iconCls="icon-expand">
	     <jsp:include page="../../fund/fund_comm/fund_collection_his_info.jsp" >  <jsp:param value="true" name="isView"/></jsp:include>
	</div>
	<div title="资金付款明细" name="pay_his" iconCls="icon-expand">
	     <jsp:include page="../../fund/fund_comm/fund_pay_his_info.jsp" >  <jsp:param value="true" name="isView"/></jsp:include>
	</div>
	<div title="本次红冲明细" name="redout_current" iconCls="icon-expand">
	     <jsp:include page="fund_redout_current_info.jsp" >  <jsp:param value="true" name="isView"/></jsp:include>
	</div>
