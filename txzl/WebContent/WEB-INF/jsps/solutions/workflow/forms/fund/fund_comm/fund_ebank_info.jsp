	    ...
	    <table class="fillTable" cellspacing="0" cellpadding="0" id="ebank_info" >
		    <tr class="tr-project-info tr-even" style="display: none">
	         ...
	         <tr class="tr-project-info tr-odd">   
	             ...
	             <td class="td-content"><input   name="fund_ebank_data.hadmoney" class="mini-textbox" readOnly value="${requestScope['fund_ebank_data.hadmoney'] }"/></td>	             
	         </tr>
	         <tr class="tr-project-info tr-even">   
	          ...
	          <tr class="tr-project-info tr-odd">   
	             ...
	             <td class="td-content"><input name="fund_ebank_data.clientbank" id="projscale" class="mini-textbox" readOnly  value="${requestScope['fund_ebank_data.otherbank'] }"/> </td>
	         </tr>
	          <tr class="tr-project-info tr-even">  
	             ...
	             <td class="td-content"><input name="fund_ebank_data.clientaccount" class="mini-textbox" readOnly  value="${requestScope['fund_ebank_data.clientname'] }"/> </td>	             
	          </tr>
	         <tr class="tr-project-info tr-odd">
	          ...
	          <tr class="tr-project-info tr-odd" >
			      ...
			      <td class="td-content" colspan="3"><input style="width:87%;height: 80px;" id="fund_ebank_data.summary" name="fund_ebank_data.summary"  required="true" label="备注" readOnly class="mini-textarea"  type="text" value="${requestScope['fund_ebank_data.summary'] }"> </td>
	          </tr>    
	</table>
	</div>
</div>