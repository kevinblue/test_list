		    ...
		    <tr class="tr-project-info tr-even" style="display: none">
	         ...
	         <tr class="tr-project-info tr-odd">
	          ...
	          <tr class="tr-project-info tr-even">
                 ...
                 <td class="td-content"><input  name="fund_ebank_data.refundamount" class="mini-textbox" readonly value="${requestScope['fund_ebank_data.refundamount'] }"/></td>   
	          </tr>
	          <tr class="tr-project-info tr-odd" >
	           ...
	           <tr class="tr-project-info tr-odd" >
			      ...
			      <td class="td-content" colspan="3"><input style="width:87%;height: 80px;" id="fund_ebank_data.refundsummary" name="fund_ebank_data.refundsummary"  required="true" label="退还备注" class="mini-textarea"  type="text" readonly value="${requestScope['fund_ebank_data.refundsummary'] }"> </td>
	          </tr>    
	</table>
	</div>
</div>