     ...
     <div class="mini-panel" title="变更前信息" showCollapseButton="true" style="width: 50%; float:left">
	    <table class="fillTable" cellspacing="0" cellpadding="0" id="ebank_info" >
	     	...
	     	<tr class="tr-client-info tr-even">
				...
				<input id="contract_signatory_clientaccnumber" name="contract_signatory_clientaccnumber"   label="开户账号" readOnly class="mini-textbox"  value="${requestScope['contract_signatory.clientaccnumber'] }">                                                   
				</td>
	     	</tr>
	     	<tr class="tr-client-info tr-even">
