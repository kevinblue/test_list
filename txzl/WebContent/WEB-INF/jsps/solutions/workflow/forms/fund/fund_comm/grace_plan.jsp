	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			...
			removeOperCallBack:function(miniTable){
				$('#id_json_grace_plan_str').val(mini.encode(miniTable.getData()));
			},
			...
			columns: [
				...
				{field: 'planmoney', header: '应收金额',dataType : "currency",summary : true,align:'right',
					formEditorConfig:
					{
						vtype:'float',
						required: true,
				...
				{field: 'factmoney', header: '已收金额',summary : true,dataType : "currency",formEditorConfig:{fieldVisible:false}}, 
				{field: 'overmoney', header: '未收金额',summary : true,dataType : "currency",formEditorConfig:{fieldVisible:false}},
