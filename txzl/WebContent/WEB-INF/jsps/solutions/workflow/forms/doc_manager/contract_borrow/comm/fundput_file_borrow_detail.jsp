...
jQuery(function(){
	...
	seajs.use([ "js/apcomponent/aptable/aptable.js" ], function(ApTable) {
		new ApTable({
			id: "fundput_file_borrow",
			renderTo: "id_table_fundput_file_borrow",
			...
			data: JsonUtil.decode('${empty json_fundput_file_borrow_str ? "[]" : json_fundput_file_borrow_str }'),
			columns:[ 
			    {type:'indexcolumn'},
...
<div id="id_table_fundput_file_borrow"></div>