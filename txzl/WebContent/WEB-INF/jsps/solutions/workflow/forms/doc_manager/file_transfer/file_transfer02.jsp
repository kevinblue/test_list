...
<!--多行控件  -->
<input style="display:none;"    class="mini-textarea" id="id_json_handover_str" name="json_handover_str" value='${empty json_handover_str ? "[]" : json_handover_str }'></input>
...
<div id="tabApprovalDeatils" class="mini-tabs" activeIndex="0" onactivechanged="changTab" style="width: 100%;" bodyStyle="padding:0;border:0;">
	<div title="可交接资料" name="Handover_data" iconCls="icon-expand">
	     <jsp:include page="this_handover.jsp" >
