...
jQuery(function(){
	tenwa.createTable({
		id: "accident_subsist_project",
		renderTo: "id_table_accident_subsist_project",
		lazyLoad: false,
		isClickLoad:false,
		remoteOper : false,
		showPager: false,
		...
		columns:[
			...
			{field:'contractid', header:'合同编号', visible: true},
		   	...
		   	{field:'assuror',header:'担保人',visible:false},
		   	{field:'assurorname',header:'担保人',visible: true},
...
<div id="id_table_accident_subsist_project"></div>
