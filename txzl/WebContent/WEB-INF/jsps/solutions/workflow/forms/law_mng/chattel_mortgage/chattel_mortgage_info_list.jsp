							...
							new ApTable(
									{
										...
										entityClassName : 'com.tenwa.leasing.entity.chattelmortgage.ChattelMortgage',
										frozenStartColumn : 0,
										frozenEndColumn : 2,
										xmlFileName : '/eleasing/jsp/chattel_mortgage/chattel_mortgage_info_list.xml',
										tools : [ 'add', '-', 'edit', '-',
												'remove', '-', 'exportExcel' ],
										columns : [
												{
