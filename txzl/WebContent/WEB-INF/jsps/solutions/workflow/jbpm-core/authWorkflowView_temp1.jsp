...
<body style="overflow:hidden;"> 
   ...
   <script type="text/javascript" defer>
	...
	var processDefinitionsColumns = [
		...
		{header:'已办类型',name:'processinstancetype',renderer:function(value){return getTaskTypeChineseName(value);}},
	...
	var deployedIds = ("${applicationScope['userOwnedWorkflowViewSqlIds'][sessionScope['login_username']]}");
