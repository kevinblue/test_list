			...
			columns:[
				...
				{header:'记录编号',field:'id',visible : false},
				{
					...
					renderer:function(e){
						...
						var workflownamedisplay = e.record.display_name_;
						if(isreject == '0'){
	
							var html = "<input style='cursor:pointer;' type='checkbox'  onclick=\"distribute('" + workflownameparent+ "','" + workflownameselect +"','" +workflownamedisplay+"','" + "',this.checked);\"/>";
						}else{
	
							var html = "<input style='cursor:pointer;' type='checkbox' checked='checked'  onclick=\"distribute('" + workflownameparent + "','" + workflownameselect +"','" +workflownamedisplay+"','"+ "',this.checked);\"/>";
						}
