...
<title>${currentTaskFormTitle}打印预览</title>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery/easyui-lang-zh_CN.js"></script>
		...
		jQuery(function(){
		       ...
		       jQuery("#id_content_tabs .tabs-header").css("width",(all_width-containerWidthAdd+1)+"px");
			     ...
			     new tracywindyAttachmentFileUpload(
		                  ...
		                  '${currentTaskActivityDetailInfo.attachmentType}',
		                  '${currentHistoryTaskInfo.keyOne}',
		                  true,
		                  all_width-12,
   ...
   <div class="no-print">
    ...
    <div>
       <div class="x-panel-table-div-title" id="id_focusComponent">所用流程：${currentWorkFlowName}&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;${currentTaskName}&nbsp;&nbsp;]</div>
		        <!-- 弹出意见框结束-->
						       ...
						       <div class="x-panel-table-div-title" >
							       ...
							       <div id="id_workflowAdviseContainer">
									       <c:forEach items="${processedHistoryLogInfoList}" var="jbpmWorkflowHistoryInfo" varStatus="status">
										       ...
										       <div class="taskname">
                                                   <table><tr>
										           <td><strong>【<font color="red">${fromButtonTextToCome}</font>】${taskName}</strong></td>
										       ...
										       <c:forEach items="${jbpmWorkflowHistoryInfo.jbpmWorkflowHistoryInfoUsers}" var="jbpmWorkflowHistoryInfoUser" varStatus="userStatus">
										        ...
										        <div class="taskactor">
											           【处理人】&nbsp;&nbsp;&nbsp; ${userStatus.index+1}、${taskPlanActorRealName}&nbsp;&lt;&nbsp;${taskActualActorRealName}&nbsp;&gt;&nbsp;<br>
												【处理意见】 &nbsp;&nbsp;${processedAdvise}
											    </div>
										       </c:forEach>
									       </c:forEach>
						        </div>
