define(function(require,exports,module){	
	...
	exports.initPage = function(comboboxDatas){		
...
/************************ Report Section **************************/	
	...
	function changeNodePosition(e,entityClass,parentField,idField){
		...
		tenwa.ajax({
			...
			data:{'id':id,'position':newPos,'pid':newPid,'entityClass':entityClass,'parentField':parentField},
			dataType:'text',
...
/* Filter Function*/
	...
	function importReport(){
		...
		var intervalId = -1;
		var url = tenwa.getWebRoot() + '/report/config/uploadimportfile.action?timestamp=' + timestamp; 
		var tree = mini.get('report_tree');
		if(tree){
			var node = tree.getSelectedNode();
			if(node){
