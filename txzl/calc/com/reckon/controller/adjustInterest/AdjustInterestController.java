...
public class AdjustInterestController extends BaseController  {
	...
	public String addAdjustInterest(HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		String adjusttype= request.getParameter("adjusttype");//起租前调息和起租后调息要用，暂时保留
		//----Start加入调息算法
		String msg="无反馈";
		try{
			msg= transferInterest.updateConditionByTransferInterest(adjustId, docId, contractId ,adjusttype);
		}catch (Exception e) {
