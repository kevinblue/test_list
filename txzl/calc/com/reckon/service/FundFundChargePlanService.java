...
public interface FundFundChargePlanService {
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> createFundPlan(ConditionBean condition,  FundRentPlanBean frpb) throws Exception;
	
	
	public Map<String, Object> createFundPlanFatoring(ConditionBean condition,  String ownName) throws Exception;
