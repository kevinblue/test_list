...
public class IrrDetailsServiceByTranImpl {
	...
	public InterContBean processTranCashDetails(ConditionBean cb, InterContBean icb, TabCalBean tcb) throws Exception {
		...
		String cbsql = tcb.getCondition_tb() + "  where " + tcb.getContOrProjCName() + "='" + cb.getProjId() + "' and doc_id='" + tcb.getDocId() + "'";
		String fbsql = tcb.getContOrProjCName() + "='" + cb.getProjId() + "'  and doc_id='" + tcb.getDocId() + "'";
