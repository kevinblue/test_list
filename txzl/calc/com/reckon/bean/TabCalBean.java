...
public class TabCalBean {
	...
	private String fundFundPlan_tb = "";

	private String contOrProjCName = ""; // 项目号或合同号列名;
	private String contOrProjCValue = ""; // 项目号或合同号列值;
	
	private String BeforeInterest ="";//租前息表信息
	
	private String financeIncomeDiscount ="";//收入折现
	...
	public String getFundFundPlan_tb() {
		return fundFundPlan_tb;
	}

	public void setFundFundPlan_tb(String fundFundPlan_tb) {
		this.fundFundPlan_tb = fundFundPlan_tb;
	}
	...
	public String getFinanceIncomeDiscount() {
		return financeIncomeDiscount;
	}

	public void setFinanceIncomeDiscount(String financeIncomeDiscount) {
